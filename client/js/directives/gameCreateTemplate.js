...
angular.module('clickApp.directives').directive('clickGameCreateTemplate', [function () {
  var templates = {};
  return {
    restrict: 'A',
  ...
  function setSprayPosition(coord) {
    templates['spray'].element.setAttribute('transform', ['translate(', coord.x - 10, ',', coord.y, ')'].join(''));
  }

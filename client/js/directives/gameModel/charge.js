  ...
  .factory('clickGameModelCharge', [
    ...
    function(labelElementService,
      ...
      return {
        ...
        update: function clickGameModelLoSUpdate(map_flipped, zoom_factor, game,
          ...
          if(modelService.isCharging(model)) {
            ...
            if(gameModelSelectionService.in('local', model.state.stamp,
              ...
              var target = gameModelsService.findStamp(model.state.cha.t, game.models);
              if(R.exists(target)) {
                var target_info = gameFactionsService.getModelInfo(target.state.info, factions);
            ...
            charge_target.style.visibility = charge_target_visibility;
          }

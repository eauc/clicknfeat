...
(function () {
  angular.module('clickApp.directives').factory('labelElement', labelElementModelFactory);

  labelElementModelFactory.$inject = ['gameMap'];
  function labelElementModelFactory(gameMapService) {
    ...
    function labelElementModelUpdate(map_flipped, zoom_factor, flip_center, text_center, text, label) {

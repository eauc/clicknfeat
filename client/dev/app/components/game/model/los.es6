(function() {
  angular.module('clickApp.directives')
    .factory('clickGameModelLoS', gameModelLosModelFactory);
  ...
  function gameModelLosModelFactory() {
    ...
    function gameModelLoSCreate(svgNS, info, parent) {
      const direction_los = document.createElementNS(svgNS, 'line');
      ...
      const front_arc_los = document.createElementNS(svgNS, 'line');

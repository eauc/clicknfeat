...
(function () {
  ...
  gameEditLabelDirectiveFactory.$inject = ['appGame', 'gameMap'];
  function gameEditLabelDirectiveFactory(appGameService, gameMapService) {
    return {
      restrict: 'A',
    ...
    function link(scope, element) {
      ...
      function placeEditLabel() {
        ...
        var screen_pos = gameMapService.mapToScreenCoordinates(map, scope.edit_label.element.state);

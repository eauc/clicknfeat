  ...
  gameTemplatesModel, gameTemplateSelectionModel, gameTerrainsModel, gameTerrainSelectionModel) {
    ...
    function gameUndoLastCommandP(game) {
      ...
      function updateLogs(_ref11) {
        ...
        return R.thread(game)(R.over(R.lensProp('commands'), R.init), R.ifElse(gameConnectionModel.active, gameConnectionModel.sendUndoCommand$(command), R.over(R.lensProp('undo'), R.append(command))));
      }
    }
    ...
    function gameReplayCommandsBatchP(cmds, game) {
      return R.threadP(game)(commandsModel.replayBatchP$(cmds), R.over(R.lensProp('commands'), R.flip(R.concat)(cmds)));
    }
    function gameReplayNextCommandP(game) {
      ...
      function updateLogs(_ref13) {
        ...
        return R.threadP(game)(R.over(R.lensProp('undo'), R.init), R.ifElse(gameConnectionModel.active, gameConnectionModel.sendReplayCommand$(command), R.over(R.lensProp('commands'), R.append(command))));
      }
    }

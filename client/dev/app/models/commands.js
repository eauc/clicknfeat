...
(function () {
  ...
  // 'lockModelsCommand',
  // 'onModelsCommand',
  'createTemplateCommand', 'deleteTemplateCommand', 'lockTemplatesCommand', 'onTemplatesCommand', 'createTerrainCommand', 'deleteTerrainCommand', 'lockTerrainsCommand', 'onTerrainsCommand',
  // 'rollDiceCommand',
  'rollDeviationCommand', 'setBoardCommand', 'setLayersCommand',
  // 'setLosCommand',
  // 'setRulerCommand',
  // 'setScenarioCommand',
  function () {

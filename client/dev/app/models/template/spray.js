  ...
  function sprayTemplateModelFactory(templateModel, modelModel, pointModel) {
    ...
    function sprayTemplateSetOriginP(factions, origin, temp) {
      return R.threadP(temp)(R.rejectIfP(templateModel.isLocked, 'Template is locked'), function () {
        return modelModel.baseEdgeInDirection$(factions, temp.state.r, origin);
      }, function (position) {
    ...
    function sprayTemplateSetTargetP(factions, origin, target, temp) {
      return R.threadP(temp)(R.rejectIfP(templateModel.isLocked, 'Template is locked'), function () {
        ...
        return R.threadP(origin)(modelModel.baseEdgeInDirection$(factions, direction), function (position) {
    ...
    function buildSprayMove(move) {
      ...
      function sprayTemplateForwardMove(small, template) {
        return R.threadP(template)(R.rejectIfP(templateModel.isLocked, 'Template is locked'), R.assocPath(['state', 'o'], null), function (template) {
    ...
    function sprayTemplateRotateLeft(factions, origin, small, template) {
      ...
      function handleOrigin(template) {
        ...
        return R.threadP(origin)(modelModel.baseEdgeInDirection$(factions, template.state.r), function (base_edge) {

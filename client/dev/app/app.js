...
(function () {
  ...
  angular.module('clickApp', ['ui.router', 'clickApp.controllers', 'clickApp.services', 'clickApp.filters', 'clickApp.directives']).config(defaultRoute).config(allowBlobUrls);

...
angular.module('clickApp.services').factory('websocket', ['$document', 'jsonParser', 'jsonStringifier', function websocketServiceFactory($document, jsonParserService, jsonStringifierService) {
  return {

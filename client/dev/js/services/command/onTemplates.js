  ...
  var onTemplatesCommandService = {
    ...
    replay: function onTemplatesRedo(ctxt, scope, game) {
      return R.pipe(R.map(R.prop('stamp')), function (stamps) {
        return R.pipeP(gameTemplatesService.findAnyStamps$(stamps), R.addIndex(R.forEach)(function (template, index) {
          ...
          game.template_selection = gameTemplateSelectionService.set('remote', stamps, scope, game.template_selection);
        })(game.templates);
      })(ctxt.after);
    },

...
y.$current.navigable==b&&j(a,c)||y.transitionTo(b,a,{inherit:!0,location:!1})}]),p(c),b}function r(a){return a.indexOf("*")>-1}function s(a){for(var b=a.split("."),c=y.$current.name.split("."),d=0,e=b.length;e>d;d++)"*"===b[d]&&(c[d]="*");return"**"===b[0]&&(c=c.slice(h(c,b[1])),c.unshift("**")),"**"===b[b.length-1]&&(c.splice(h(c,b[b.length-2])+1,Number.MAX_VALUE),c.push("**")),b.length!=c.length?!1:c.join("")===b.join("")}function t(a,b){return J(a)&&!H(b)?C[a]:I(b)&&J(a)?(C[a]&&!C.$delegates[a]&&(C.$delegates[a]=C[a]),C[a]=b,this):this}function u(a,b){return K(a)?b=a:b.name=a,q(b),this}function v(a,e,f,h,l,n,p,q,t){function u(b,c,d,f){var g=a.$broadcast("$stateNotFound",b,c,d);if(g.defaultPrevented)return p.update(),D;if(!g.retry)return null;if(f.$retry)return p.update(),E;var h=y.transition=e.when(g.retry);return h.then(function(){return h!==y.transition?A:(b.options.$retry=!0,y.transitionTo(b.to,b.toParams,b.options))},function(){return D}),p.update(),h}function v(a,c,d,g,i,j){function m(){var c=[];return M(a.views,function(d,e){var g=d.resolve&&d.resolve!==a.resolve?d.resolve:{};g.$template=[function(){return f.load(e,{view:d,locals:i.globals,params:n,notify:j.notify})||""}],c.push(l.resolve(g,i.globals,i.resolve,a).then(function(c){if(I(d.controllerProvider)||L(d.controllerProvider)){var f=b.extend({},g,i.globals);c.$$controller=h.invoke(d.controllerProvider,null,f)}else c.$$controller=d.controller;c.$$state=a,c.$$controllerAs=d.controllerAs,i[e]=c}))}),e.all(c).then(function(){return i.globals})}var n=d?c:k(a.params.$$keys(),c),o={$stateParams:n};i.resolve=l.resolve(a.resolve,o,i.resolve,a);var p=[i.resolve.then(function(a){i.globals=a})];return g&&p.push(g),e.all(p).then(m).then(function(a){return i})}var A=e.reject(new Error("transition superseded")),C=e.reject(new Error("transition prevented")),D=e.reject(new Error("transition aborted")),E=e.reject(new Error("transition failed"));return x.locals={resolve:null,globals:{$stateParams:{}}},y={params:{},current:x.self,$current:x,transition:null},y.reload=function(a){return y.transitionTo(y.current,n,{reload:a||!0,inherit:!1,notify:!0})},y.go=function(a,b,c){return y.transitionTo(a,b,N({inherit:!0,relative:y.$current},c))},y.transitionTo=function(b,c,f){c=c||{},f=N({location:!0,inherit:!1,relative:null,notify:!0,reload:!1,$retry:!1},f||{});var g,j=y.$current,l=y.params,o=j.path,q=m(b,f.relative),r=c["#"];if(!H(q)){var s={to:b,toParams:c,options:f},t=u(s,j.self,l,f);if(t)return t;if(b=s.to,c=s.toParams,f=s.options,q=m(b,f.relative),!H(q)){if(!f.relative)throw new Error("No such state '"+b+"'");throw new Error("Could not resolve '"+b+"' from state '"+f.relative+"'")}}if(q[B])throw new Error("Cannot transition to abstract state '"+b+"'");if(f.inherit&&(c=i(n,c||{},y.$current,q)),!q.params.$$validates(c))return E;c=q.params.$$values(c),b=q;var z=b.path,D=0,F=z[D],G=x.locals,I=[];if(f.reload){if(J(f.reload)||K(f.reload)){if(K(f.reload)&&!f.reload.name)throw new Error("Invalid reload state object");var L=f.reload===!0?o[0]:m(f.reload);if(f.reload&&!L)throw new Error("No such reload state '"+(J(f.reload)?f.reload:f.reload.name)+"'");for(;F&&F===o[D]&&F!==L;)G=I[D]=F.locals,D++,F=z[D]}}else for(;F&&F===o[D]&&F.ownParams.$$equals(c,l);)G=I[D]=F.locals,D++,F=z[D];if(w(b,c,j,l,G,f))return r&&(c["#"]=r),y.params=c,O(y.params,n),f.location&&b.navigable&&b.navigable.url&&(p.push(b.navigable.url,c,{$$avoidResync:!0,replace:"replace"===f.location}),p.update(!0)),y.transition=null,e.when(y.current);if(c=k(b.params.$$keys(),c||{}),f.notify&&a.$broadcast("$stateChangeStart",b.self,c,j.self,l).defaultPrevented)return a.$broadcast("$stateChangeCancel",b.self,c,j.self,l),p.update(),C;for(var M=e.when(G),P=D;P<z.length;P++,F=z[P])G=I[P]=d(G),M=v(F,c,F===b,M,G,f);var Q=y.transition=M.then(function(){var d,e,g;if(y.transition!==Q)return A;for(d=o.length-1;d>=D;d--)g=o[d],g.self.onExit&&h.invoke(g.self.onExit,g.self,g.locals.globals),g.locals=null;for(d=D;d<z.length;d++)e=z[d],e.locals=I[d],e.self.onEnter&&h.invoke(e.self.onEnter,e.self,e.locals.globals);return r&&(c["#"]=r),y.transition!==Q?A:(y.$current=b,y.current=b.self,y.params=c,O(y.params,n),y.transition=null,f.location&&b.navigable&&p.push(b.navigable.url,b.navigable.locals.globals.$stateParams,{$$avoidResync:!0,replace:"replace"===f.location}),f.notify&&a.$broadcast("$stateChangeSuccess",b.self,c,j.self,l),p.update(!0),y.current)},function(d){return y.transition!==Q?A:(y.transition=null,g=a.$broadcast("$stateChangeError",b.self,c,j.self,l,d),g.defaultPrevented||p.update(),e.reject(d))});return Q},y.is=function(a,b,d){d=N({relative:y.$current},d||{});var e=m(a,d.relative);return H(e)?y.$current!==e?!1:b?j(e.params.$$values(b),n):!0:c},y.includes=function(a,b,d){if(d=N({relative:y.$current},d||{}),J(a)&&r(a)){if(!s(a))return!1;a=y.$current.name}var e=m(a,d.relative);return H(e)?H(y.$current.includes[e.name])?b?j(e.params.$$values(b),n,g(b)):!0:!1:c},y.href=function(a,b,d){d=N({lossy:!0,inherit:!0,absolute:!1,relative:y.$current},d||{});var e=m(a,d.relative);if(!H(e))return null;d.inherit&&(b=i(n,b||{},y.$current,e));var f=e&&d.lossy?e.navigable:e;return f&&f.url!==c&&null!==f.url?p.href(f.url,k(e.params.$$keys().concat("#"),b||{}),{absolute:d.absolute}):null},y.get=function(a,b){if(0===arguments.length)return o(g(z),function(a){return z[a].self});var c=m(a,b||y.$current);return c&&c.self?c.self:null},y}function w(a,b,c,d,e,f){function g(a,b,c){function d(b){return"search"!=a.params[b].location}var e=a.params.$$keys().filter(d),f=l.apply({},[a.params].concat(e)),g=new P.ParamSet(f);return g.$$equals(b,c)}return!f.reload&&a===c&&(e===c.locals||a.self.reloadOnSearch===!1&&g(c,d,b))?!0:void 0}var x,y,z={},A={},B="abstract",C={parent:function(a){if(H(a.parent)&&a.parent)return m(a.parent);var b=/^(.+)\.[^.]+$/.exec(a.name);return b?m(b[1]):x},data:function(a){return a.parent&&a.parent.data&&(a.data=a.self.data=N({},a.parent.data,a.data)),a.data},url:function(a){var b=a.url,c={params:a.params||{}};if(J(b))return"^"==b.charAt(0)?e.compile(b.substring(1),c):(a.parent.navigable||x).url.concat(b,c);if(!b||e.isMatcher(b))return b;throw new Error("Invalid url '"+b+"' in state '"+a+"'")},navigable:function(a){return a.url?a:a.parent?a.parent.navigable:null},ownParams:function(a){var b=a.url&&a.url.params||new P.ParamSet;return M(a.params||{},function(a,c){b[c]||(b[c]=new P.Param(c,null,a,"config"))}),b},params:function(a){return a.parent&&a.parent.params?N(a.parent.params.$$new(),a.ownParams):new P.ParamSet},views:function(a){var b={};return M(H(a.views)?a.views:{"":a},function(c,d){d.indexOf("@")<0&&(d+="@"+a.parent.name),b[d]=c}),b},path:function(a){return a.parent?a.parent.path.concat(a):[]},includes:function(a){var b=a.parent?N({},a.parent.includes):{};return b[a.name]=!0,b},$delegates:{}};x=q({name:"",url:"^",views:null,"abstract":!0}),x.navigable=null,this.decorator=t,this.state=u,this.$get=v,v.$inject=["$rootScope","$q","$view","$injector","$resolve","$stateParams","$urlRouter","$location","$urlMatcherFactory"]}function w(){function a(a,b){return{load:function(c,d){var e,f={template:null,controller:null,view:null,locals:null,notify:!0,async:!0,params:{}};return d=N(f,d),d.view&&(e=b.fromConfig(d.view,d.params,d.locals)),e&&d.notify&&a.$broadcast("$viewContentLoading",d),e}}}this.$get=a,a.$inject=["$rootScope","$templateFactory"]}function x(){var a=!1;this.useAnchorScroll=function(){a=!0},this.$get=["$anchorScroll","$timeout",function(b,c){return a?b:function(a){return c(function(){a[0].scrollIntoView()},0,!1)}}]}function y(a,c,d,e){function f(){return c.has?function(a){return c.has(a)?c.get(a):null}:function(a){try{return c.get(a)}catch(b){return null}}}function g(a,b){var c=function(){return{enter:function(a,b,c){b.after(a),c()},leave:function(a,b){a.remove(),b()}}};if(j)return{enter:function(a,b,c){var d=j.enter(a,null,b,c);d&&d.then&&d.then(c)},leave:function(a,b){var c=j.leave(a,b);c&&c.then&&c.then(b)}};if(i){var d=i&&i(b,a);return{enter:function(a,b,c){d.enter(a,null,b),c()},leave:function(a,b){d.leave(a),b()}}}return c()}var h=f(),i=h("$animator"),j=h("$animate"),k={restrict:"ECA",terminal:!0,priority:400,transclude:"element",compile:function(c,f,h){return function(c,f,i){function j(){l&&(l.remove(),l=null),n&&(n.$destroy(),n=null),m&&(r.leave(m,function(){l=null}),l=m,m=null)}function k(g){var k,l=A(c,i,f,e),s=l&&a.$current&&a.$current.locals[l];if(g||s!==o){k=c.$new(),o=a.$current.locals[l];var t=h(k,function(a){r.enter(a,f,function(){n&&n.$emit("$viewContentAnimationEnded"),(b.isDefined(q)&&!q||c.$eval(q))&&d(a)}),j()});m=t,n=k,n.$emit("$viewContentLoaded"),n.$eval(p)}}var l,m,n,o,p=i.onload||"",q=i.autoscroll,r=g(i,c);c.$on("$stateChangeSuccess",function(){k(!1)}),c.$on("$viewContentLoading",function(){k(!1)}),k(!0)}}};return k}function z(a,b,c,d){return{restrict:"ECA",priority:-400,compile:function(e){var f=e.html();return function(e,g,h){var i=c.$current,j=A(e,h,g,d),k=i&&i.locals[j];if(k){g.data("$uiView",{name:j,state:k.$$state}),g.html(k.$template?k.$template:f);var l=a(g.contents());if(k.$$controller){k.$scope=e,k.$element=g;var m=b(k.$$controller,k);k.$$controllerAs&&(e[k.$$controllerAs]=m),g.data("$ngControllerController",m),g.children().data("$ngControllerController",m)}l(e)}}}}}function A(a,b,c,d){var e=d(b.uiView||b.name||"")(a),f=c.inheritedData("$uiView");return e.indexOf("@")>=0?e:e+"@"+(f?f.state.name:"")}function B(a,b){var c,d=a.match(/^\s*({[^}]*})\s*$/);if(d&&(a=b+"("+d[1]+")"),c=a.replace(/\n/g," ").match(/^([^(]+?)\s*(\((.*)\))?$/),!c||4!==c.length)throw new Error("Invalid state ref '"+a+"'");return{state:c[1],paramExpr:c[3]||null}}function C(a){var b=a.parent().inheritedData("$uiView");return b&&b.state&&b.state.name?b.state:void 0}function D(a,c){var d=["location","inherit","reload","absolute"];return{restrict:"A",require:["?^uiSrefActive","?^uiSrefActiveEq"],link:function(e,f,g,h){var i=B(g.uiSref,a.current.name),j=null,k=C(f)||a.$current,l="[object SVGAnimatedString]"===Object.prototype.toString.call(f.prop("href"))?"xlink:href":"href",m=null,n="A"===f.prop("tagName").toUpperCase(),o="FORM"===f[0].nodeName,p=o?"action":l,q=!0,r={relative:k,inherit:!0},s=e.$eval(g.uiSrefOpts)||{};b.forEach(d,function(a){a in s&&(r[a]=s[a])});var t=function(c){if(c&&(j=b.copy(c)),q){m=a.href(i.state,j,r);var d=h[1]||h[0];return d&&d.$$addStateInfo(i.state,j),null===m?(q=!1,!1):void g.$set(p,m)}};i.paramExpr&&(e.$watch(i.paramExpr,function(a,b){a!==j&&t(a)},!0),j=b.copy(e.$eval(i.paramExpr))),t(),o||f.bind("click",function(b){var d=b.which||b.button;if(!(d>1||b.ctrlKey||b.metaKey||b.shiftKey||f.attr("target"))){var e=c(function(){a.go(i.state,j,r)});b.preventDefault();var g=n&&!m?1:0;b.preventDefault=function(){g--<=0&&c.cancel(e)}}})}}}function E(a,b,c){return{restrict:"A",controller:["$scope","$element","$attrs",function(b,d,e){function f(){g()?d.addClass(i):d.removeClass(i)}function g(){for(var a=0;a<j.length;a++)if(h(j[a].state,j[a].params))return!0;return!1}function h(b,c){return"undefined"!=typeof e.uiSrefActiveEq?a.is(b.name,c):a.includes(b.name,c)}var i,j=[];i=c(e.uiSrefActiveEq||e.uiSrefActive||"",!1)(b),this.$$addStateInfo=function(b,c){var e=a.get(b,C(d));j.push({state:e||{name:b},params:c}),f()},b.$on("$stateChangeSuccess",f)}]}}function F(a){var b=function(b){return a.is(b)};return b.$stateful=!0,b}function G(a){var b=function(b){return a.includes(b)};return b.$stateful=!0,b}var H=b.isDefined,I=b.isFunction,J=b.isString,K=b.isObject,L=b.isArray,M=b.forEach,N=b.extend,O=b.copy;b.module("ui.router.util",["ng"]),b.module("ui.router.router",["ui.router.util"]),b.module("ui.router.state",["ui.router.router","ui.router.util"]),b.module("ui.router",["ui.router.state"]),b.module("ui.router.compat",["ui.router"]),p.$inject=["$q","$injector"],b.module("ui.router.util").service("$resolve",p),q.$inject=["$http","$templateCache","$injector"],b.module("ui.router.util").service("$templateFactory",q);var P;r.prototype.concat=function(a,b){var c={caseInsensitive:P.caseInsensitive(),strict:P.strictMode(),squash:P.defaultSquashPolicy()};return new r(this.sourcePath+a+this.sourceSearch,N(c,b),this)},r.prototype.toString=function(){return this.source},r.prototype.exec=function(a,b){function c(a){function b(a){return a.split("").reverse().join("")}function c(a){return a.replace(/\\-/g,"-")}var d=b(a).split(/-(?!\\)/),e=o(d,b);return o(e,c).reverse()}var d=this.regexp.exec(a);if(!d)return null;b=b||{};var e,f,g,h=this.parameters(),i=h.length,j=this.segments.length-1,k={};if(j!==d.length-1)throw new Error("Unbalanced capture group in route '"+this.source+"'");for(e=0;j>e;e++){g=h[e];var l=this.params[g],m=d[e+1];for(f=0;f<l.replace;f++)l.replace[f].from===m&&(m=l.replace[f].to);m&&l.array===!0&&(m=c(m)),k[g]=l.value(m)}for(;i>e;e++)g=h[e],k[g]=this.params[g].value(b[g]);return k},r.prototype.parameters=function(a){return H(a)?this.params[a]||null:this.$$paramNames},r.prototype.validates=function(a){return this.params.$$validates(a)},r.prototype.format=function(a){function b(a){return encodeURIComponent(a).replace(/-/g,function(a){return"%5C%"+a.charCodeAt(0).toString(16).toUpperCase()})}a=a||{};var c=this.segments,d=this.parameters(),e=this.params;if(!this.validates(a))return null;var f,g=!1,h=c.length-1,i=d.length,j=c[0];for(f=0;i>f;f++){var k=h>f,l=d[f],m=e[l],n=m.value(a[l]),p=m.isOptional&&m.type.equals(m.value(),n),q=p?m.squash:!1,r=m.type.encode(n);if(k){var s=c[f+1];if(q===!1)null!=r&&(j+=L(r)?o(r,b).join("-"):encodeURIComponent(r)),j+=s;else if(q===!0){var t=j.match(/\/$/)?/\/?(.*)/:/(.*)/;j+=s.match(t)[1]}else J(q)&&(j+=q+s)}else{if(null==r||p&&q!==!1)continue;L(r)||(r=[r]),r=o(r,encodeURIComponent).join("&"+l+"="),j+=(g?"&":"?")+(l+"="+r),g=!0}}return j},s.prototype.is=function(a,b){return!0},s.prototype.encode=function(a,b){return a},s.prototype.decode=function(a,b){return a},s.prototype.equals=function(a,b){return a==b},s.prototype.$subPattern=function(){var a=this.pattern.toString();return a.substr(1,a.length-2)},s.prototype.pattern=/.*/,s.prototype.toString=function(){return"{Type:"+this.name+"}"},s.prototype.$normalize=function(a){return this.is(a)?a:this.decode(a)},s.prototype.$asArray=function(a,b){function d(a,b){function d(a,b){return function(){return a[b].apply(a,arguments)}}function e(a){return L(a)?a:H(a)?[a]:[]}function f(a){switch(a.length){case 0:return c;case 1:return"auto"===b?a[0]:a;default:return a}}function g(a){return!a}function h(a,b){return function(c){c=e(c);var d=o(c,a);return b===!0?0===n(d,g).length:f(d)}}function i(a){return function(b,c){var d=e(b),f=e(c);if(d.length!==f.length)return!1;for(var g=0;g<d.length;g++)if(!a(d[g],f[g]))return!1;return!0}}this.encode=h(d(a,"encode")),this.decode=h(d(a,"decode")),this.is=h(d(a,"is"),!0),this.equals=i(d(a,"equals")),this.pattern=a.pattern,this.$normalize=h(d(a,"$normalize")),this.name=a.name,this.$arrayMode=b}if(!a)return this;if("auto"===a&&!b)throw new Error("'auto' array mode is for query parameters only");return new d(this,a)},b.module("ui.router.util").provider("$urlMatcherFactory",t),b.module("ui.router.util").run(["$urlMatcherFactory",function(a){}]),u.$inject=["$locationProvider","$urlMatcherFactoryProvider"],b.module("ui.router.router").provider("$urlRouter",u),v.$inject=["$urlRouterProvider","$urlMatcherFactoryProvider"],b.module("ui.router.state").value("$stateParams",{}).provider("$state",v),w.$inject=[],b.module("ui.router.state").provider("$view",w),b.module("ui.router.state").provider("$uiViewScroll",x),y.$inject=["$state","$injector","$uiViewScroll","$interpolate"],z.$inject=["$compile","$controller","$state","$interpolate"],b.module("ui.router.state").directive("uiView",y),b.module("ui.router.state").directive("uiView",z),D.$inject=["$state","$timeout"],E.$inject=["$state","$stateParams","$interpolate"],b.module("ui.router.state").directive("uiSref",D).directive("uiSrefActive",E).directive("uiSrefActiveEq",E),F.$inject=["$state"],G.$inject=["$state"],b.module("ui.router.state").filter("isState",F).filter("includedByState",G)}(window,window.angular),function(a,b,c){function d(a,b,c){return a.addEventListener?void a.addEventListener(b,c,!1):void a.attachEvent("on"+b,c)}function e(a){if("keypress"==a.type){var b=String.fromCharCode(a.which);return a.shiftKey||(b=b.toLowerCase()),b}return r[a.which]?r[a.which]:s[a.which]?s[a.which]:String.fromCharCode(a.which).toLowerCase()}function f(a,b){return a.sort().join(",")===b.sort().join(",")}function g(a){var b=[];return a.shiftKey&&b.push("shift"),a.altKey&&b.push("alt"),a.ctrlKey&&b.push("ctrl"),a.metaKey&&b.push("meta"),b}function h(a){return a.preventDefault?void a.preventDefault():void(a.returnValue=!1)}function i(a){return a.stopPropagation?void a.stopPropagation():void(a.cancelBubble=!0)}function j(a){return"shift"==a||"ctrl"==a||"alt"==a||"meta"==a}function k(){if(!q){q={};for(var a in r)a>95&&112>a||r.hasOwnProperty(a)&&(q[r[a]]=a)}return q}function l(a,b,c){return c||(c=k()[a]?"keydown":"keypress"),"keypress"==c&&b.length&&(c="keydown"),c}function m(a){return"+"===a?["+"]:(a=a.replace(/\+{2}/g,"+plus"),a.split("+"))}function n(a,b){var c,d,e,f=[];for(c=m(a),e=0;e<c.length;++e)d=c[e],u[d]&&(d=u[d]),b&&"keypress"!=b&&t[d]&&(d=t[d],f.push("shift")),j(d)&&f.push(d);return b=l(d,f,b),{key:d,modifiers:f,action:b}}function o(a,c){return null===a||a===b?!1:a===c?!0:o(a.parentNode,c)}function p(a){function c(a){a=a||{};var b,c=!1;for(b in u)a[b]?c=!0:u[b]=0;c||(x=!1)}function k(a,b,c,d,e,g){var h,i,k=[],l=c.type;if(!s._callbacks[a])return[];for("keyup"==l&&j(a)&&(b=[a]),h=0;h<s._callbacks[a].length;++h)if(i=s._callbacks[a][h],(d||!i.seq||u[i.seq]==i.level)&&l==i.action&&("keypress"==l&&!c.metaKey&&!c.ctrlKey||f(b,i.modifiers))){var m=!d&&i.combo==e,n=d&&i.seq==d&&i.level==g;(m||n)&&s._callbacks[a].splice(h,1),k.push(i)}return k}function l(a,b,c,d){s.stopCallback(b,b.target||b.srcElement,c,d)||a(b,c)===!1&&(h(b),i(b))}function m(a){"number"!=typeof a.which&&(a.which=a.keyCode);var b=e(a);if(b)return"keyup"==a.type&&v===b?void(v=!1):void s.handleKey(b,g(a),a)}function o(){clearTimeout(t),t=setTimeout(c,1e3)}function q(a,b,d,f){function g(b){return function(){x=b,++u[a],o()}}function h(b){l(d,b,a),"keyup"!==f&&(v=e(b)),setTimeout(c,10)}u[a]=0;for(var i=0;i<b.length;++i){var j=i+1===b.length,k=j?h:g(f||n(b[i+1]).action);r(b[i],k,f,a,i)}}function r(a,b,c,d,e){s._directMap[a+":"+c]=b,a=a.replace(/\s+/g," ");var f,g=a.split(" ");return g.length>1?void q(a,g,b,c):(f=n(a,c),s._callbacks[f.key]=s._callbacks[f.key]||[],k(f.key,f.modifiers,{type:f.action},d,a,e),void s._callbacks[f.key][d?"unshift":"push"]({callback:b,modifiers:f.modifiers,action:f.action,seq:d,level:e,combo:a}))}var s=this;if(a=a||b,!(s instanceof p))return new p(a);s.target=a,s._callbacks={},s._directMap={};var t,u={},v=!1,w=!1,x=!1;s._handleKey=function(a,b,d){var e,f=k(a,b,d),g={},h=0,i=!1;for(e=0;e<f.length;++e)f[e].seq&&(h=Math.max(h,f[e].level));for(e=0;e<f.length;++e)if(f[e].seq){if(f[e].level!=h)continue;i=!0,g[f[e].seq]=1,l(f[e].callback,d,f[e].combo,f[e].seq)}else i||l(f[e].callback,d,f[e].combo);var m="keypress"==d.type&&w;d.type!=x||j(a)||m||c(g),w=i&&"keydown"==d.type},s._bindMultiple=function(a,b,c){for(var d=0;d<a.length;++d)r(a[d],b,c)},d(a,"keypress",m),d(a,"keydown",m),d(a,"keyup",m)}for(var q,r={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"ins",46:"del",91:"meta",93:"meta",224:"meta"},s={106:"*",107:"+",109:"-",110:".",111:"/",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'"},t={"~":"`","!":"1","@":"2","#":"3",$:"4","%":"5","^":"6","&":"7","*":"8","(":"9",")":"0",_:"-","+":"=",":":";",'"':"'","<":",",">":".","?":"/","|":"\\"},u={option:"alt",command:"meta","return":"enter",escape:"esc",plus:"+",mod:/Mac|iPod|iPhone|iPad/.test(navigator.platform)?"meta":"ctrl"},v=1;20>v;++v)r[111+v]="f"+v;for(v=0;9>=v;++v)r[v+96]=v;p.prototype.bind=function(a,b,c){var d=this;return a=a instanceof Array?a:[a],d._bindMultiple.call(d,a,b,c),d},p.prototype.unbind=function(a,b){var c=this;return c.bind.call(c,a,function(){},b)},p.prototype.trigger=function(a,b,c){var d=this;return d._directMap[a+":"+b]&&d._directMap[a+":"+b](c||{},a),d},p.prototype.reset=function(){var a=this;return a._callbacks={},a._directMap={},a},p.prototype.stopCallback=function(a,b){var c=this;return(" "+b.className+" ").indexOf(" mousetrap ")>-1?!1:o(b,c.target)?!1:"INPUT"==b.tagName||"SELECT"==b.tagName||"TEXTAREA"==b.tagName||b.isContentEditable},p.prototype.handleKey=function(){var a=this;return a._handleKey.apply(a,arguments)},p.init=function(){var a=p(b);for(var c in a)"_"!==c.charAt(0)&&(p[c]=function(b){return function(){return a[b].apply(a,arguments)}}(c))},p.init(),a.Mousetrap=p,"undefined"!=typeof module&&module.exports&&(module.exports=p),"function"==typeof define&&define.amd&&define(function(){return p})}(window,document),function(a){function b(a){return a.preventDefault?void a.preventDefault():void(a.returnValue=!1)}function c(a,c,f){var g=this;if(!g.recording)return void o.apply(g,arguments);if(b(f),"keydown"==f.type){for(1===a.length&&m&&e(),i=0;i<c.length;++i)d(c[i]);d(a)}else"keyup"==f.type&&l.length>0&&e()}function d(a){var b;for(b=0;b<l.length;++b)if(l[b]===a)return;l.push(a),1===a.length&&(m=!0)}function e(){j.push(l),l=[],m=!1,h()}function f(a){var b;for(b=0;b<a.length;++b)a[b].sort(function(a,b){return a.length>1&&1===b.length?-1:1===a.length&&b.length>1?1:a>b?1:-1}),a[b]=a[b].join("+")}function g(){k&&(f(j),k(j)),j=[],k=null,l=[]}function h(){clearTimeout(n),n=setTimeout(g,1e3)}var j=[],k=null,l=[],m=!1,n=null,o=a.prototype.handleKey;a.prototype.record=function(a){var b=this;b.recording=!0,k=function(){b.recording=!1,a.apply(b,arguments)}},a.prototype.handleKey=function(){var a=this;c.apply(a,arguments)},a.init()}(Mousetrap),R.countWatchers=function(){var a=angular.element(document.getElementsByTagName("body")),b=[],c=function e(a){angular.forEach(["$scope","$isolateScope"],function(c){a.data()&&a.data().hasOwnProperty(c)&&angular.forEach(a.data()[c].$$watchers,function(a){b.push(a)})}),angular.forEach(a.children(),function(a){e(angular.element(a))})};c(a);var d=[];angular.forEach(b,function(a){d.indexOf(a)<0&&d.push(a)})},R.curryService=function(){return function(a){R.pipe(R.keys,R.filter(R.compose(R.equals("Function"),R.type,R.flip(R.prop)(a))),R.reject(R.compose(R.not,R.isEmpty,R.match(/\$$/))),R.forEach(function(b){a[b+"$"]=R.curry(a[b])}))(a)}}(),function(){R.extend=function(a){for(var b=arguments.length,c=Array(b>1?b-1:0),d=1;b>d;d++)c[d-1]=arguments[d];return R.forEach(function(b){for(var c in b)a[c]=b[c]},c),a},R.deepExtend=function(a){for(var b=/#{\s*?_\s*?}/,c=arguments.length,d=Array(c>1?c-1:0),e=1;c>e;e++)d[e-1]=arguments[e];return R.forEach(function(c){for(var d in c)if(R.isNil(a[d])||"Function"===R.type(a[d])||"Date"===R.type(c[d]))a[d]=c[d];else if("String"===R.type(c[d])&&b.test(c[d]))"String"===R.type(a[d])&&(a[d]=c[d].replace(b,a[d]));else if("Array"===R.type(a[d])||"Array"===R.type(c[d])){if("Array"!==R.type(a[d])||"Array"!==R.type(c[d]))throw new Error("Trying to combine an array with a non-array ("+d+")");a[d]=R.deepExtend(a[d],c[d])}else if("Object"===R.type(a[d])||"Object"===R.type(c[d])){if("Object"!==R.type(a[d])||"Object"!==R.type(c[d]))throw new Error("Trying to combine an object with a non-object ("+d+")");a[d]=R.deepExtend(a[d],c[d])}else a[d]=c[d]},d),a}}(),R.exists=function(a){return!R.isNil(a)},function(){R.allP=R.bind(self.Promise.all,self.Promise),R.resolveP=R.bind(self.Promise.resolve,self.Promise),R.rejectP=R.bind(self.Promise.reject,self.Promise),R.rejectIfP=R.curry(function(a,b,c){return a(c)?self.Promise.reject(b):c}),R.condErrorP=R.curry(function(a,b){return b["catch"](R.cond(R.append([R.T,R.rejectP],a)))})}(),function(){function a(b,c){var d=0,e=c-b,f=R.exists(Math.log2)?Math.ceil(Math.log2(e)):30;if(f>53)throw new self.Exception("We cannot generate numbers larger than 53 bits.");var g=Math.ceil(f/8),h=Math.pow(2,f)-1,i=new Uint8Array(g);self.crypto.getRandomValues(i);for(var j=8*(g-1),k=0;g>k;k++)d+=i[k]*Math.pow(2,j),j-=8;return d&=h,d>=e?a(b,c):b+d}R.random=function(){return a(0,1e9)/1e9},R.randomRange=function(a,b){return a+R.random()*(b-a+1)|0},R.guid=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*R.random()|0,c="x"==a?b:3&b|8;return c.toString(16)})}}(),function(){R.spy=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return function(a){return a}},R.spyDebug=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return function(a){return a}},R.spyInfo=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return function(a){return a}},R.spyWarn=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return function(a){return a}},R.spyError=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return function(a){return a}},R.spyAndDiscardError=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return R.pipe(R.spyError.apply(R,b),R.always(null))}}(),function(){R.thread=function(a){return function(){for(var b=arguments.length,c=Array(b),d=0;b>d;d++)c[d]=arguments[d];return R.pipe.apply(R,c)(a)}},R.threadP=function(a){return function(){for(var b=arguments.length,c=Array(b),d=0;b>d;d++)c[d]=arguments[d];return R.pipeP.apply(R,[R.always(self.Promise.resolve(a))].concat(c))()}}}(),function(){R.viewOr=R.curry(function(a,b,c){return R.defaultTo(a,R.view(b,c))})}(),function(){angular.module("clickApp.controllers",[]),angular.module("clickApp.directives",[]),angular.module("clickApp.filters",[]),angular.module("clickApp.models",[]),angular.module("clickApp.services",[]),angular.module("clickApp",["ui.router","clickApp.controllers","clickApp.directives","clickApp.filters","clickApp.models","clickApp.services"])}(),function(){function a(a){a.otherwise("/lounge")}function b(a){a.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|blob):/)}angular.module("clickApp").config(a).config(b),a.$inject=["$urlRouterProvider"],b.$inject=["$compileProvider"]}(),function(){function a(a,b,c,d,e){function f(){h(function(b){a.state=b},d.state,a)}function g(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];e.action.send(b)}function h(a,b,d){var e=function(){a(b.sample())};c.addTickListener(e),d.$on("$destroy",function(){c.removeTickListener(e)}),e()}function i(a){return b.is(a)}function j(a){return 0<=b.current.name.indexOf(a)}function k(){for(var a=arguments.length,c=Array(a),d=0;a>d;d++)c[d]=arguments[d];self.setTimeout(function(){b.go.apply(b,c)},100)}var l=this;l.stateIs=i,l.stateMatches=j,a.goToState=k,a.sendAction=g,a.bindCell=h,f()}angular.module("clickApp.controllers").controller("appCtrl",a),a.$inject=["$rootScope","$state","appTick","appState","appAction","appUser"]}(),function(){function a(){return function(a){return s.capitalize(a)}}function b(a){return function(b,c){if(R.isNil(a[c]))return null;if(R.isNil(b))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function c(a){return function(b,c){if(R.isNil(a[c]))return null;if(R.isNil(b))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function d(a){return function(b,c){if(R.isNil(a[c]))return null;if(R.isNil(b))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function e(a){return function(b,c){if(R.isNil(a[c]))return null;if(R.isNil(b))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function f(a){return function(b,c){if(R.isNil(a[c]))return null;if(R.isNil(b))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function g(a){return function(b,c){if(R.isNil(a[c]))return null;if(R.isNil(b))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function h(a){return function(b,c){if(R.isNil(a[c]))return null;if(R.isNil(b))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}angular.module("clickApp.filters").filter("capitalize",a).filter("game",b).filter("gameConnection",c).filter("gameLayers",d).filter("gameLos",e).filter("gameRuler",f).filter("user",g).filter("userConnection",h),a.$inject=[],b.$inject=["game"],c.$inject=["gameConnection"],d.$inject=["gameLayers"],e.$inject=["gameLos"],f.$inject=["gameRuler"],g.$inject=["user"],h.$inject=["userConnection"]}(),function(){function a(a){a.state("debug",{url:"/debug",templateUrl:"app/views/debug/debug.html",controller:"debugCtrl",controllerAs:"debug"})}angular.module("clickApp").config(a),a.$inject=["$stateProvider"]}(),function(){function a(a){function b(b,c){e.result=c,a.$digest()}function c(b,c){a.app.goToState("game.main",{online:"offline","private":"private",id:c})}function d(b){a.stateEvent("State.loadDumpFile",b[0])}var e=this;a.onStateChangeEvent("State.loadDumpFile",b,a),a.onStateChangeEvent("Games.local.load",c,a),e.doLoadDumpFile=d}angular.module("clickApp.controllers").controller("debugCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){a.state("game",{"abstract":!0,url:"/game/:online/:private/:id",templateUrl:"app/views/game/game.html",controller:"gameCtrl",controllerAs:"game"}).state("game.main",{url:"/main",templateUrl:"app/views/game/main/game_main.html",controller:"gameMainCtrl",controllerAs:"game_main",data:{hide_nav:!0}}).state("game.model",{url:"/model",templateUrl:"app/views/game/model/game_model.html",controller:"gameModelCtrl",controllerAs:"game_model",data:{hide_nav:!0}}).state("game.setup",{url:"/setup",templateUrl:"app/views/game/setup/game_setup.html",controller:"gameSetupCtrl",controllerAs:"game_setup",data:{hide_nav:!0}}).state("game.save",{url:"/save",templateUrl:"app/views/game/save/game_save.html",controller:"gameSaveCtrl",controllerAs:"game_save",data:{hide_nav:!0}}).state("game.help",{url:"/help",templateUrl:"app/views/game/help/game_help.html",controller:"gameHelpCtrl",controllerAs:"game_help",data:{hide_nav:!0}}).state("game.log",{url:"/log",templateUrl:"app/views/game/log/game_log.html",controller:"gameLogCtrl",controllerAs:"log",data:{hide_nav:!0}}).state("game.online",{url:"/online",templateUrl:"app/views/game/online/game_online.html",controller:"gameOnlineCtrl",controllerAs:"game_online",data:{hide_nav:!0}})}angular.module("clickApp").config(a),a.$inject=["$stateProvider"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c){function d(){l.show_action_group=null,l.invite_player=null,a.stateEvent("Game.load",m,n,o),a.digestOnStateChangeEvent("Game.layers.change",a),a.digestOnStateChangeEvent("Game.board.change",a),a.digestOnStateChangeEvent("Game.scenario.change",a),a.digestOnStateChangeEvent("User.connection.change",a),a.onStateChangeEvent("Modes.change",e,a),a.$on("$destroy",function(){a.stateEvent("Modes.exit")})}function e(){l.action_bindings=R.thread(a)(R.path(["state","modes"]),c.currentModeBindings,R.clone),l.action_buttons=R.thread(a)(R.path(["state","modes"]),c.currentModeButtons,R.clone),a.$digest()}function f(){return R.thread(a)(R.pathOr({},["state","modes"]),c.currentModeName)}function g(a){
return f()===a}function h(b){for(var c=arguments.length,d=Array(c>1?c-1:0),e=1;c>e;e++)d[e-1]=arguments[e];a.stateEvent("Modes.current.action",b,[].concat(d,[{}]))}function i(b){var c=_slicedToArray(b,3),d=(c[0],c[1]),e=c[2];return"toggle"===d?void(l.show_action_group=l.show_action_group===e?null:e):void a.stateEvent("Modes.current.action",d,[{}])}function j(){R.isNil(l.invite_player)||a.stateEvent("Game.invitePlayer",l.invite_player)}function k(b){a.stateEvent("Game.update",b)}var l=this,m=R.propEq("online","online",b),n=R.propEq("private","private",b),o=R.prop("id",b);l.currentModeName=f,l.currentModeIs=g,l.doModeAction=h,l.doActionButton=i,l.doInvitePlayer=j,self.window.gameUpdate=k,d()}angular.module("clickApp.controllers").controller("gameCtrl",a),a.$inject=["$scope","$stateParams","modes"]}(),function(){function a(a,b){function c(){d.bindings_pairs=R.thread(a)(R.path(["state","modes"]),b.currentModeBindingsPairs,R.sortBy(R.head)),a.$digest()}var d=this;a.onStateChangeEvent("Modes.change",c,a),self.requestAnimationFrame(c)}angular.module("clickApp.controllers").controller("gameHelpCtrl",a),a.$inject=["$scope","modes"]}(),function(){function a(a){function b(){a.onStateChangeEvent("Game.command.change",c,a),self.requestAnimationFrame(c)}function c(){d.undo=R.path(["state","game","undo"],a),d.undo_log=R.path(["state","game","undo_log"],a),d.commands_log=R.path(["state","game","commands_log"],a),d.commands=R.path(["state","game","commands"],a),a.$digest()}var d=this;b()}angular.module("clickApp.controllers").controller("gameLogCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){}angular.module("clickApp.controllers").controller("gameMainCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){function b(){o.import_list=null,a.state.data_ready.then(c)}function c(){o.factions=R.path(["state","factions","current"],a),o.faction=R.head(R.keys(o.factions)),o.onFactionChange(),a.$digest()}function d(){o.section=R.head(R.keys(o.factions[o.faction].models)),o.onSectionChange()}function e(){o.entry=R.head(R.keys(o.factions[o.faction].models[o.section])),o.onEntryChange()}function f(){var b=o.getEntries();return R.isNil(b)?(o.model=a.entry,void o.onModelChange()):(o.type=R.head(R.keys(b)),void o.onTypeChange())}function g(){var a=o.getEntries();o.model=R.thread(a)(R.defaultTo({}),R.prop(o.type),R.defaultTo({}),R.keys(),R.head()),o.onModelChange()}function h(){o.repeat=1}function i(){return R.path([o.faction,"models",o.section,o.entry,"entries"],o.factions)}function j(){var a=o.getEntries();return R.isNil(a)?R.path([o.faction,"models",o.section,o.entry],o.factions):R.path([o.type,o.model],a)}function k(){var a=o.getEntries();return R.isNil(a)?[o.faction,"models",o.section,o.entry]:[o.faction,"models",o.section,o.entry,"entries",o.type,o.model]}function l(){var b=k();a.stateEvent("Game.model.create",b,o.repeat)}function m(){a.stateEvent("Game.model.importList",o.import_list)}function n(b){a.stateEvent("Game.model.importFile",b[0])}var o=this;o.onFactionChange=d,o.onSectionChange=e,o.onEntryChange=f,o.onTypeChange=g,o.onModelChange=h,o.getEntries=i,o.getModel=j,o.doCreateModel=l,o.doImportList=m,o.doImportModelsFile=n,b()}angular.module("clickApp.controllers").controller("gameModelCtrl",a),a.$inject=["$scope"]}(),function(){function a(a,b){function c(){g.games_selection={},a.onStateChangeEvent("Games.online.load",f,a),a.state.user_ready.then(d)}function d(){b.online(a.state.user)||a.goToState("^.main")}function e(){R.thread(a.state)(R.pathOr([],["user","connection","games"]),R.nth(g.games_selection.list[0]),R.defaultTo({}),R.propOr("null","public_stamp"),function(b){a.stateEvent("Games.online.load",b)})}function f(b,c,d){a.goToState("game.main",{online:"online","private":c,id:d}),a.$digest()}var g=this;g.doLoadOnlineGame=e,c()}angular.module("clickApp.controllers").controller("gameOnlineCtrl",a),a.$inject=["$scope","user"]}(),function(){function a(a){function b(){a.bindCell(a.state.exports.game,function(b){c.game_export=b,a.$digest()},a),a.bindCell(a.state.exports.board,function(b){c.board_export=b,a.$digest()},a),a.bindCell(a.state.exports.models,function(b){c.models_export=b,a.$digest()},a)}var c=this;self.window.requestAnimationFrame(b)}angular.module("clickApp.controllers").controller("gameSaveCtrl",a),a.$inject=["$scope"]}(),function(){function a(a,b){function c(){a.state.data_ready.then(d),a.onStateChangeEvent("Game.board.change",e,a),self.requestAnimationFrame(e),a.onStateChangeEvent("Game.scenario.change",h,a),self.requestAnimationFrame(h),a.onStateChangeEvent("Game.layers.change",l,a),self.requestAnimationFrame(l)}function d(){v.boards=a.state.boards,v.terrains=a.state.terrains,v.ambiance=R.head(R.keys(v.terrains)),v.onAmbianceChange(),v.scenarios=a.state.scenarios,a.$digest()}function e(){v.board_name=R.path(["game","board","name"],a.state),a.$digest()}function f(){a.stateEvent("Game.board.set",v.board_name)}function g(){a.stateEvent("Game.board.setRandom")}function h(){v.scenario_name=R.path(["state","game","scenario","name"],a),v.scenario_group=b.groupForName(v.scenario_name,v.scenarios),a.$digest()}function i(){R.isNil(v.scenario_name)||a.stateEvent("Game.scenario.set",v.scenario_name,v.scenario_group)}function j(){a.stateEvent("Game.scenario.setRandom")}function k(){a.stateEvent("Game.scenario.generateObjectives")}function l(){v.layers=R.path(["state","game","layers"],a),a.$digest()}function m(b){a.stateEvent("Game.command.execute","setLayers",["toggle",b])}function n(){v.category=R.head(R.keys(v.terrains[v.ambiance])),v.onCategoryChange()}function o(){v.entry=R.head(R.keys(v.terrains[v.ambiance][v.category])),v.onEntryChange()}function p(){}function q(){return[v.ambiance,v.category,v.entry]}function r(){return R.path([v.ambiance,v.category,v.entry],v.terrains)}function s(){var b=q();a.stateEvent("Game.terrain.create",b)}function t(){a.stateEvent("Game.terrain.reset")}function u(b){a.stateEvent("Game.board.importFile",b[0])}var v=this;v.doSetBoard=f,v.doSetRandomBoard=g,v.doSetScenario=i,v.doSetRandomScenario=j,v.doGenerateObjectives=k,v.doToggleLayer=m,v.onAmbianceChange=n,v.onCategoryChange=o,v.onEntryChange=p,v.getTerrain=r,v.doCreateTerrain=s,v.doResetTerrain=t,v.doImportBoardFile=u,c()}angular.module("clickApp.controllers").controller("gameSetupCtrl",a),a.$inject=["$scope","gameScenario"]}(),function(){function a(a){a.state("info",{url:"/info",templateUrl:"app/views/info/info.html",controller:"infoCtrl",controllerAs:"info",data:{}})}function b(a){a.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|blob):/)}angular.module("clickApp").config(a),a.$inject=["$stateProvider"],b.$inject=["$compileProvider"]}(),function(){function a(){}angular.module("clickApp.controllers").controller("infoCtrl",a),a.$inject=[]}(),function(){function a(a){a.state("lounge",{url:"/lounge",templateUrl:"app/views/lounge/lounge.html",controller:"loungeCtrl",controllerAs:"lounge",data:{}})}angular.module("clickApp").config(a),a.$inject=["$stateProvider"]}(),function(){function a(a){}angular.module("clickApp.controllers").controller("loungeCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){a.state("settings",{"abstract":!0,url:"/settings",templateUrl:"app/views/settings/settings.html",controller:"settingsCtrl",controllerAs:"settings",data:{}}).state("settings.Main",{url:"/main",templateUrl:"app/views/settings/main/settings_main.html",controller:"settingsMainCtrl",controllerAs:"settings_main"}).state("settings.Models",{url:"/models",templateUrl:"app/views/settings/models/settings_models.html",controller:"settingsModelsCtrl",controllerAs:"settings_models"}).state("settings.Bindings",{url:"/bindings",templateUrl:"app/views/settings/bindings/settings_bindings.html",controller:"settingsBindingsCtrl",controllerAs:"settings_bindings"}).state("settings.Misc",{url:"/misc",templateUrl:"app/views/settings/misc/settings_misc.html",controller:"settingsMiscCtrl",controllerAs:"settings_misc"})}angular.module("clickApp").config(a),a.$inject=["$stateProvider"]}(),function(){function a(a){function b(){a.state.data_ready.then(c),a.onStateChangeEvent("Settings.current.change",c,a)}function c(){e.edit=R.thread(a.state)(R.path(["settings","current"]),JSON.stringify,JSON.parse),e.menu=R.thread(a.state)(R.path(["settings","default"]),R.keys,R.concat(["Main","Models"])),a.$digest()}function d(){a.stateEvent("Settings.reset",e.edit)}var e=this;e.doUpdateSettings=d,b()}angular.module("clickApp.controllers").controller("settingsCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){function b(){a.state.data_ready.then(d),a.$on("$destroy",a.settings.doUpdateSettings)}function c(){return R.thread(a.state)(R.path(["settings","default","Bindings",f.mode]),R.keys,R.sortBy(R.identity))}function d(){f.modes=R.thread(a.state)(R.path(["settings","default","Bindings"]),R.keys,R.sortBy(R.identity)),f.mode=R.defaultTo(R.head(f.modes),f.mode),a.$digest()}function e(b){function c(a){Mousetrap.record(function(b){a(b)})}function d(c){R.isNil(c)||R.isEmpty(c)||(a.settings.edit.Bindings[f.mode][b]=c.join(" "))}function e(){f.recording=null,a.$digest()}return f.recording?null:(f.recording=b,R.threadP(new self.Promise(c))(d,e))}var f=this;f.getBindingsKeysForMode=c,f.doRecordBinding=e,b()}angular.module("clickApp.controllers").controller("settingsBindingsCtrl",a),a.$inject=["$scope"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){function b(){a.onStateChangeEvent("Settings.loadFile",c,a),a.bindCell(a.state.exports.settings,function(a){f["export"]=a},a)}function c(b,c){var d=_slicedToArray(c,1),e=d[0];f.load_settings_result=e,a.$digest()}function d(b){a.stateEvent("Settings.loadFile",b[0])}function e(){a.stateEvent("Settings.reset",{})}var f=this;f.doLoadSettingsFile=d,f.doResetSettings=e,b()}angular.module("clickApp.controllers").controller("settingsMainCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){function b(){a.state.data_ready.then(c),a.$on("$destroy",a.settings.doUpdateSettings)}function c(){d.modes=R.thread(a.state)(R.path(["settings","default","Misc"]),R.keys,R.sortBy(R.identity)),d.mode=R.defaultTo(R.head(d.modes),d.mode),a.$digest()}var d=this;b()}angular.module("clickApp.controllers").controller("settingsMiscCtrl",a),a.$inject=["$scope"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){function b(){a.state.data_ready.then(c),a.onStateChangeEvent("Factions.loadDescFile",d,a)}function c(){i.factions=R.path(["factions","base"],a.state),a.$digest()}function d(b,c){var d=_slicedToArray(c,1),e=d[0];a.result=e,a.$digest()}function e(b){return R.thread(a.state)(R.path(["factions","desc",b]),R.type,R.equals("Object"))}function f(b,c){a.stateEvent("Factions.loadDescFile",b,c[0])}function g(b){a.stateEvent("Factions.clearDesc",b)}function h(){a.stateEvent("Factions.clearAllDesc")}var i=this;i.hasDesc=e,i.doOpenFactionFile=f,i.doClearFactionDesc=g,i.doClearAllDesc=h,b()}angular.module("clickApp.controllers").controller("settingsModelsCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){a.state("user",{url:"/user",templateUrl:"app/views/user/user.html",controller:"userCtrl",controllerAs:"user",data:{}})}function b(a,b,c){a.$on("$stateChangeStart",function(d,e){R.path(["state","user"],a)&&"user"!==e.name&&(c.isValid(a.state.user)||(b.transitionTo("user"),d.preventDefault()))})}angular.module("clickApp").config(a).run(b),a.$inject=["$stateProvider"],b.$inject=["$rootScope","$state","user"]}(),function(){function a(a,b){function c(){a.sendAction("User.updateState",e.edit),a.goToState("lounge")}function d(){a.bindCell(function(a){e.edit=R.clone(a.state)},b.user,a)}var e=this;e.doSave=c,d()}angular.module("clickApp.controllers").controller("userCtrl",a),a.$inject=["$scope","appUser"]}(),function(){function a(a){function b(){var a=arguments.length<=0||void 0===arguments[0]?R.always(null):arguments[0],b=arguments[1];return{_value:b,_getValue:a,sample:c,map:d,changes:e,delay:f,reduce:g}}function c(){var b=a.now();return this._last_tick===b?this._value:(this._last_tick=b,this._value=this._getValue(),this._value)}function d(a){var c=this;return b(function(){return a(c.sample())})}function e(){var a=this,b=h(function(){var c=b._last_value;return b._last_value=a.sample(),b._last_value!==c?b._last_value:null});return b._last_value=this._value,b}function f(){var c=this,d=b(function(){return d._value},this._value);return a.addEndListener(function(){d._value=c.sample()}),d}function g(a,b){var c=this.changes().snapshot(a,function(){return d}).hold(b),d=c.delay();return c}function h(){var a=arguments.length<=0||void 0===arguments[0]?j:arguments[0];return{_getValue:a,_sample:i,send:k,listen:s,hold:l,map:m,filter:n,snapshot:o,merge:p,orElse:q,all:r}}function i(){var b=a.now();return this._last_tick===b?this._value:(this._last_tick=b,this._value=this._getValue(),this._value)}function j(){var a=this._new_value;return this._new_value=null,a}function k(b){var c=this;a.inTransaction(function(){c._new_value=b})}function l(a){var c=this,d=b(function(){return R.when(R.isNil,function(){return d._value},c._sample())},a);return d}function m(a){var b=this;return h(function(){return R.when(R.exists,a,b._sample())})}function n(a){var b=this;return h(function(){return R.unless(R.allPass([R.exists,a]),function(){return null},b._sample())})}function o(a,b){var c=this,d="Function"===R.type(b)?b:R.always(b);return h(function(){return R.unless(R.isNil,function(b){return a(d().sample(),b)},c._sample())})}function p(a,b){var c=this;return h(function(){var d=c._sample(),e=b._sample();return R.isNil(e)?d:R.isNil(d)?e:a(d,e)})}function q(a){return this.merge(function(a,b){return R.exists(a)?a:b},a)}function r(a){return this.map(R.of).merge(R.concat,a.map(R.of))}function s(b){var c=this,d=function(){var a=c._sample();R.exists(a)&&b(a)};return a.addTickListener(d),function(){a.removeTickListener(d)}}var t={create:h},u={create:b};R.curryService(t),R.curryService(u);var v={signalModel:t,cellModel:u};return v}angular.module("clickApp.services").factory("behaviours",a),a.$inject=["appTick"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(){function a(a,b){h[a]=b}function b(a,b,c){function d(b){var c=_slicedToArray(b,2),d=c[0],e=c[1];return[R.assoc("type",a,d),e]}return R.threadP(a)(e,function(a){return a.executeP.apply(a,[].concat(_toConsumableArray(b),[c]))},d)}function c(a,b){return R.threadP(a)(f,function(c){return c.undoP(a,b)})}function d(a,b){return R.threadP(a)(f,function(c){return c.replayP(a,b)})}function e(a){return R.threadP(h)(R.prop(a),R.rejectIfP(R.isNil,'Game: unknown command "'+a+'"'))}function f(a){return R.threadP(a)(R.prop("type"),e)}function g(a,b){function c(b){return i.replayP(a[0],b)["catch"](function(){return b})}function d(b){return g(R.tail(a),b)}return R.isEmpty(a)?R.resolveP(b):R.threadP(b)(c,d)}var h={},i={registerCommand:a,executeP:b,undoP:c,replayP:d,replayBatchP:g};return R.curryService(i),i}angular.module("clickApp.services").factory("commands",a).factory("allCommands",["createModelCommand","deleteModelCommand","setModelSelectionCommand","lockModelsCommand","onModelsCommand","createTemplateCommand","deleteTemplateCommand","lockTemplatesCommand","onTemplatesCommand","createTerrainCommand","deleteTerrainCommand","lockTerrainsCommand","onTerrainsCommand","rollDiceCommand","rollDeviationCommand","setBoardCommand","setLayersCommand","setLosCommand","setRulerCommand","setScenarioCommand",function(){return{}}]),a.$inject=[]}(),function(){function a(a){return function(b,c,d,e,f){function g(d,e,g){function h(a){return R.thread(a)(j(d.base),R.omit(["stamp"]),f)}function i(a){var d,e=(d={},_defineProperty(d,b+"s",R.map(c.saveState,a)),_defineProperty(d,"desc",R.thread(a)(R.head,R.pathOr([],["state","info"]),R.join("."))),d);return R.thread(a)(m("local",g),function(a){return[e,a]})}var j=a.addToWithFlip$(e);return R.threadP(d)(R.prop(b+"s"),R.map(h),R.reject(R.isNil),R.rejectIfP(R.isEmpty,"No valid "+b+" definition"),i)}function h(a,c){return R.threadP(a)(R.prop(b+"s"),R.map(f),R.reject(R.isNil),R.rejectIfP(R.isEmpty,"No valid "+b+" definition"),m("remote",c))}function i(a,c){var f=R.pluck("stamp",R.prop(b+"s",a));return R.thread(c)(R.over(R.lensProp(b+"s"),d.removeStamps$(f)),R.over(R.lensProp(b+"_selection"),e.removeFrom$("local",f)),R.over(R.lensProp(b+"_selection"),e.removeFrom$("remote",f)))}function j(a){return c.create(a)}function k(a,c,f){function g(a){return R.over(R.lensProp(b+"s"),d.add$(f),a)}function h(c){var d=R.map(R.path(["state","stamp"]),f);return R.over(R.lensProp(b+"_selection"),e.set$(a,d),c)}return R.thread(c)(g,h)}var l={executeP:g,replayP:h,undoP:i},m=R.curry(k);return f=R.thread(f)(R.defaultTo(j),R.curry),l}}angular.module("clickApp.services").factory("createElementCommand",a),a.$inject=["point"]}(),function(){function a(a,b,c,d,e,f){function g(b){var c=a.current();return d.create(c.factions,b)}var h=b("model",d,e,f,g);return c.registerCommand("createModel",h),h}angular.module("clickApp.services").factory("createModelCommand",a),a.$inject=["appState","createElementCommand","commands","model","gameModels","gameModelSelection"]}(),function(){function a(a,b,c,d,e){var f=a("template",c,d,e);return b.registerCommand("createTemplate",f),f}angular.module("clickApp.services").factory("createTemplateCommand",a),a.$inject=["createElementCommand","commands","template","gameTemplates","gameTemplateSelection"]}(),function(){function a(a,b,c,d,e){var f=a("terrain",c,d,e);return b.registerCommand("createTerrain",f),f}angular.module("clickApp.services").factory("createTerrainCommand",a),a.$inject=["createElementCommand","commands","terrain","gameTerrains","gameTerrainSelection"]}(),function(){function a(){return function(a,b,c,d,e){function f(d,e){function f(b){var c,d=(c={},_defineProperty(c,a+"s",b),_defineProperty(c,"desc",""),c);return R.thread(b)(l(e),function(a){return[d,a]})}return R.thread(e)(R.prop(a+"s"),c.findAnyStamps$(d),R.reject(R.isNil),R.map(b.saveState),f)}function g(b,c){return i(c,b[a+"s"])}function h(b,f){function g(b){function e(d){return R.thread(d)(R.prop(a+"s"),c.add$(b),R.assoc(a+"s",R.__,d))}function g(b){return R.thread(b)(R.prop(a+"_selection"),d.set$("remote",h),R.assoc(a+"_selection",R.__,b))}var h=R.map(R.path(["state","stamp"]),b);return R.thread(f)(e,g)}return R.threadP(b)(R.prop(a+"s"),R.map(e),R.reject(R.isNil),R.rejectIfP(R.isEmpty,"No valid "+a+" definition"),g)}function i(b,e){function f(b){return R.thread(b)(R.prop(a+"s"),c.removeStamps$(h),R.assoc(a+"s",R.__,b))}function g(b){return R.thread(b)(R.prop(a+"_selection"),d.removeFrom$("local",h),d.removeFrom$("remote",h),R.assoc(a+"_selection",R.__,b))}var h=R.pluck("stamp",e);return R.thread(b)(f,g)}function j(a){return b.create(a)}var k={executeP:f,replayP:g,undoP:h},l=R.curry(i);return e=R.thread(e)(R.defaultTo(j),R.curry),k}}angular.module("clickApp.models").factory("deleteElementCommand",a),a.$inject=[]}(),function(){function a(a,b,c,d,e,f){function g(b){var c=a.current();return d.create(c.factions,b)}var h=b("model",d,e,f,g);return c.registerCommand("deleteModel",h),h}angular.module("clickApp.services").factory("deleteModelCommand",a),a.$inject=["appState","deleteElementCommand","commands","model","gameModels","gameModelSelection"]}(),function(){function a(a,b,c,d,e){var f=a("template",c,d,e);return b.registerCommand("deleteTemplate",f),f}angular.module("clickApp.models").factory("deleteTemplateCommand",a),a.$inject=["deleteElementCommand","commands","template","gameTemplates","gameTemplateSelection"]}(),function(){function a(a,b,c,d,e){var f=a("terrain",c,d,e);return b.registerCommand("deleteTerrain",f),f}angular.module("clickApp.models").factory("deleteTerrainCommand",a),a.$inject=["deleteElementCommand","commands","terrain","gameTerrains","gameTerrainSelection"]}(),function(){function a(){return function(a,b){function c(a,b,c){var d={desc:a,stamps:b};return R.thread(c)(h(a,b),function(a){return[d,a]})}function d(a,b){return f(a.desc,a.stamps,b)}function e(a,b){return f(!a.desc,a.stamps,b)}function f(c,d,e){return R.over(R.lensProp(a+"s"),b.lockStamps$(c,d),e)}var g={executeP:c,replayP:d,undoP:e},h=R.curry(f);return g}}angular.module("clickApp.services").factory("lockElementsCommand",a),a.$inject=[]}(),function(){function a(a,b,c){var d=a("model",c);return b.registerCommand("lockModels",d),d}angular.module("clickApp.services").factory("lockModelsCommand",a),a.$inject=["lockElementsCommand","commands","gameModels"]}(),function(){function a(a,b,c){var d=a("template",c);return b.registerCommand("lockTemplates",d),d}angular.module("clickApp.models").factory("lockTemplatesCommand",a),a.$inject=["lockElementsCommand","commands","gameTemplates"]}(),function(){function a(a,b,c){var d=a("terrain",c);return b.registerCommand("lockTerrains",d),d}angular.module("clickApp.services").factory("lockTerrainsCommand",a),a.$inject=["lockElementsCommand","commands","gameTerrains"]}(),function(){function a(){return function(a,b,c,d){function e(c,d,e,f){function g(){return n?R.threadP(b)(R.prop(c),R.type,R.rejectIfP(R.complement(R.equals("Function")),'Unknown method "'+c+'" on '+a)):!0}var h={before:[],after:[],desc:c};return R.threadP(b)(g,function(){return f},r(h,"before",e),p(c,d,e),r(h,"after",e),function(a){return[h,a]})}function f(a,b){var c=R.pluck("stamp",a.after);return R.thread(b)(q(a.after,c),s(c))}function g(a,b){var c=R.pluck("stamp",a.before);return R.thread(b)(q(a.before,c),s(c))}function h(b,d,e,f){return R.threadP(f)(R.prop(a+"s"),c.onStampsP$(b,d,e),R.assoc(a+"s",R.__,f))}function i(b,d,e){return R.over(R.lensProp(a+"s"),c.setStateStamps$(b,d),e)}function j(b,d,e,f){return R.threadP(f)(R.prop(a+"s"),c.fromStampsP$("saveState",[],e),function(a){return b[d]=a,f})}function k(b,c){return R.over(R.lensProp(a+"_selection"),d.set$("remote",b),c)}var l=arguments.length<=4||void 0===arguments[4]?{}:arguments[4],m=l.checkIfModelRespondToMethod,n=void 0===m?!0:m,o={executeP:e,replayP:f,undoP:g},p=R.curry(h),q=R.curry(i),r=R.curry(j),s=R.curry(k);return o}}angular.module("clickApp.services").factory("onElementsCommand",a),a.$inject=[]}(),function(){function a(a,b,c,d,e){var f=a("model",c,d,e,{checkIfModelRespondToMethod:!0});return b.registerCommand("onModels",f),f}angular.module("clickApp.services").factory("onModelsCommand",a),a.$inject=["onElementsCommand","commands","model","gameModels","gameModelSelection"]}(),function(){function a(a,b,c,d,e){var f=a("template",c,d,e,{checkIfModelRespondToMethod:!1});return b.registerCommand("onTemplates",f),f}angular.module("clickApp.services").factory("onTemplatesCommand",a),a.$inject=["onElementsCommand","commands","template","gameTemplates","gameTemplateSelection"]}(),function(){function a(a,b,c,d,e){var f=a("terrain",c,d,e);return b.registerCommand("onTerrains",f),f}angular.module("clickApp.services").factory("onTerrainsCommand",a),a.$inject=["onElementsCommand","commands","terrain","gameTerrains","gameTerrainSelection"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b){function c(a,c){var d=R.randomRange(1,6),e=R.randomRange(1,6);return R.threadP()(function(){return b.executeP("deviate",[d,e],a,c)},function(a){var b=_slicedToArray(a,2),c=b[0],f=b[1];return c=R.thread(c)(R.assoc("desc","AoE deviation : direction "+d+", distance "+e+'"'),R.assoc("r",d),R.assoc("d",e)),[c,f]})}function d(a,c){return R.threadP()(function(){return b.replayP(a,c)},R.over(f,R.pipe(R.defaultTo([]),R.append(a))))}function e(a,c){return R.threadP()(function(){return b.undoP(a,c)},R.over(f,R.pipe(R.defaultTo([]),R.reject(R.propEq("stamp",a.stamp)))))}var f=R.lensProp("dice"),g={executeP:c,replayP:d,undoP:e};return a.registerCommand("rollDeviation",g),g}angular.module("clickApp.services").factory("rollDeviationCommand",a),a.$inject=["commands","onTemplatesCommand"]}(),function(){function a(a){function b(a,b,c){var d=R.times(function(){return R.randomRange(1,a)},b),e=R.reduce(R.add,0,d),f={desc:"d"+a+"["+d.join(",")+"] = "+e,s:a,n:b,d:d};return[f,c]}function c(a,b){return R.over(e,R.append(a),b)}function d(a,b){return R.over(e,R.reject(R.propEq("stamp",a.stamp)),b)}var e=R.lensProp("dice"),f={executeP:b,replayP:c,undoP:d};return a.registerCommand("rollDice",f),f}angular.module("clickApp.services").factory("rollDiceCommand",a),a.$inject=["commands"]}(),function(){function a(a){function b(a,b){var c={before:b.board,after:a,desc:a.name};return b=R.assoc("board",a,b),[c,b]}function c(a,b){return b=R.assoc("board",a.after,b)}function d(a,b){return b=R.assoc("board",a.before,b)}var e={executeP:b,replayP:c,undoP:d};return a.registerCommand("setBoard",e),e}angular.module("clickApp.services").factory("setBoardCommand",a),a.$inject=["commands"]}(),function(){function a(a,b){function c(a,c,d){return R.threadP(a)(f,function(){return{before:R.view(g,d),desc:a+"("+c+")"}},function(e){return d=R.over(g,b[a+"$"](c),d),e.after=R.view(g,d),[e,d]})}function d(a,b){return R.set(g,a.after,b)}function e(a,b){return R.set(g,a.before,b)}function f(a){return R.thread(a)(R.prop(R.__,b),R.type,R.rejectIfP(R.complement(R.equals)("Function"),'Layers unknown method "'+a+'"'))}var g=R.lensProp("layers"),h={executeP:c,replayP:d,undoP:e};return a.registerCommand("setLayers",h),h}angular.module("clickApp.services").factory("setLayersCommand",a),a.$inject=["commands","gameLayers"]}(),function(){function a(a,b,c){var d=a("los",c),e=Object.create(d);return b.registerCommand("setLos",e),e}angular.module("clickApp.services").factory("setLosCommand",a),a.$inject=["setSegmentCommand","commands","gameLos"]}(),function(){function a(a,b){function c(a,c,d){return R.threadP(b)(R.prop(a),R.type,R.rejectIfP(R.complement(R.equals("Function")),"SetModelSelection unknown method "+a),function(){return R.isNil(c)?["local",d.model_selection]:["local",c,d.model_selection]},function(c){return b[a].apply(b,c)},function(a){return R.assoc("model_selection",a,d)},function(a){var c={after:b.get("local",a.model_selection),desc:"",do_not_log:!0};return[c,a]})}function d(a,c){return R.over(f,b.set$("remote",a.after),c)}function e(){return R.rejectP("!!! ERROR : WE SHOULD NOT BE HERE !!!")}var f=R.lensProp("model_selection"),g={executeP:c,replayP:d,undoP:e};return a.registerCommand("setModelSelection",g),g}angular.module("clickApp.services").factory("setModelSelectionCommand",a),a.$inject=["commands","gameModelSelection"]}(),function(){function a(a,b,c){var d=a("ruler",c),e=Object.create(d);return b.registerCommand("setRuler",e),e}angular.module("clickApp.services").factory("setRulerCommand",a),a.$inject=["setSegmentCommand","commands","gameRuler"]}(),function(){function a(a){function b(a,b){var c={before:b.scenario,after:a,desc:a.name};return b=R.assoc("scenario",a,b),[c,b]}function c(a,b){return b=R.assoc("scenario",a.after,b)}function d(a,b){return b=R.assoc("scenario",a.before,b)}var e={executeP:b,replayP:c,undoP:d};return a.registerCommand("setScenario",e),e}angular.module("clickApp.services").factory("setScenarioCommand",a),a.$inject=["commands"]}(),function(){function a(){return function(a,b){function c(c,d,e){function f(b){return R.threadP(b)(R.prop(c),R.type,R.rejectIfP(R.complement(R.equals("Function")),s.capitalize(a)+' unknown method "'+c+'"'))}function g(c,d){return h[c]=b.saveRemoteState(R.prop(a,d)),d}var h={before:[],after:[],desc:c};return R.threadP(b)(f,function(){return g("before",e)},function(){return b[c].apply(null,[].concat(_toConsumableArray(d),[R.prop(a,e)]))},function(b){return R.assoc(a,b,e)},function(a){return g("after",a)},function(a){return[h,a]})}function d(c,d){return R.over(R.lensProp(a),b.resetRemote$(c.after),d)}function e(c,d){return R.over(R.lensProp(a),b.resetRemote$(c.before),d)}var f={executeP:c,replayP:d,undoP:e};return f}}angular.module("clickApp.services").factory("setSegmentCommand",a),a.$inject=[]}(),function(){function a(a){return function(b,c){function d(){return{state:{x:0,y:0,r:0,l:[],lk:!1,stamp:R.guid()}}}function e(a){return R.thread(a)(this.createDefault,function(b){return R.deepExtend(b.state,a),b},this.checkState)}function f(a){return R.path(["state","stamp"],a)}function g(a){return R.prop("state",a)}function h(a){return R.clone(R.prop("state",a))}function i(a,b){return R.assoc("state",R.clone(a),b)}function j(a){return R.thread(a)(R.over(R.lensPath(["state","x"]),R.compose(R.max(0),R.min(480))),R.over(R.lensPath(["state","y"]),R.compose(R.max(0),R.min(480))))}function k(a){return R.path(["state","lk"],a)}function l(a,b){return R.assocPath(["state","lk"],a,b)}function m(a){return function(){for(var c=arguments.length,d=Array(c),e=0;c>e;e++)d[e]=arguments[e];var f=R.last(d),g=R.init(d);return R.threadP(f)(R.rejectIfP(this.isLocked,s.capitalize(b)+" is locked"),function(b){return a.apply(null,[].concat(_toConsumableArray(g),[b]))},this.checkState)}}function n(a,b){return R.thread(b)(R.assocPath(["state","x"],a.x),R.assocPath(["state","y"],a.y))}function o(a,b){return R.thread(b)(R.assocPath(["state","x"],b.state.x+a.x),R.assocPath(["state","y"],b.state.y+a.y))}function p(a,b){return R.thread(b)(R.assocPath(["state","r"],a))}function q(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.moveFront$(e)))}function r(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.moveBack$(e)))}function t(b,d){var e=c[b?"RotateSmall":"Rotate"];return R.thread(d)(R.over(R.lensProp("state"),a.rotateLeft$(e)))}function u(b,d){var e=c[b?"RotateSmall":"Rotate"];return R.thread(d)(R.over(R.lensProp("state"),a.rotateRight$(e)))}function v(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.shiftLeft$(e)))}function w(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.shiftRight$(e)))}function x(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.shiftUp$(e)))}function y(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.shiftDown$(e)))}function z(a,b){return R.over(R.lensPath(["state","l"]),R.compose(R.uniq,R.append(a)),b)}function A(a,b){return R.over(R.lensPath(["state","l"]),R.reject(R.equals(a)),b)}function B(a){return R.assocPath(["state","l"],[],a)}function C(a){return R.pathOr([],["state","l"],a).join(" ")}function D(a,b){var c=a.rotate_with_model,d=void 0===c?!1:c,e=a.flipped,f=void 0===e?!1:e,g=a.flip_center,h=void 0===g?{x:240,y:240}:g,i=a.text_center,j=void 0===i?{x:240,y:240}:i,k=R.propOr([],"l",b).join(" "),l=R.length(k)>0?!0:!1,m=d?b.r:0,n=F.renderText({
rotate:m,flipped:f,flip_center:h,text_center:j},k);return n.show=l,n}function E(a,b){var c=a.rotate,d=void 0===c?0:c,e=a.flipped,f=void 0===e?!1:e,g=a.flip_center,h=void 0===g?{x:240,y:240}:g,i=a.text_center,j=void 0===i?{x:240,y:240}:i;b+="",d+=f?180:0;var k="rotate("+d+","+h.x+","+h.y+")",l=j.x,m=j.y,n=5*R.length(b),o=j.x-n/2,p=j.y-5;return{text:b,x:l,y:m,transform:k,bkg_x:o,bkg_y:p,bkg_width:n}}var F={createDefault:d,create:e,stamp:f,state:g,saveState:h,setState:i,checkState:j,isLocked:k,setLock:l,addLabel:z,removeLabel:A,fullLabel:C,clearLabel:B,setPositionP:m(n),shiftPositionP:m(o),setOrientationP:m(p),moveFrontP:m(q),moveBackP:m(r),rotateLeftP:m(t),rotateRightP:m(u),shiftLeftP:m(v),shiftRightP:m(w),shiftUpP:m(x),shiftDownP:m(y),renderLabel:D,renderText:E};return R.curryService(F),F}}angular.module("clickApp.services").factory("element",a),a.$inject=["point"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g,h,i,j,k,l,m){function n(a){var b={players:{p1:{name:R.propOr("player1","name",a)},p2:{name:null}}};return b}function o(a){return a.public_stamp||a.private_stamp}function p(a){function b(b){return R.deepExtend(b,q(),a)}return R.threadP(Object.create(G))(b,d.create,D)}function q(){return{players:{p1:{name:null},p2:{name:null}},board:{},scenario:{},chat:[],commands:[],commands_log:[],undo:[],undo_log:[],dice:[],ruler:i.create(),los:f.create(),models:g.create(),model_selection:h.create(),templates:j.create(),template_selection:k.create(),terrains:l.create(),terrain_selection:m.create(),layers:e.create()}}function r(a){return R.pick(["players","commands","undo","chat","local_stamp","private_stamp","public_stamp"],a)}function t(a){return R.thread(a)(r,b.stringify)}function u(a,b){return R.pathOr("John Doe",["players",a,"name"],b)}function v(a){return[s.capitalize(u("p1",a)),"vs",s.capitalize(u("p2",a))].join(" ")}function w(b,e,f){function g(b){var c=_slicedToArray(b,2),d=c[0],e=c[1],f=a.current();return[R.thread(d)(R.assoc("user",R.pathOr("Unknown",["user","state","name"],f)),R.assoc("stamp",R.guid())),e]}function h(a){var b=_slicedToArray(a,2),c=b[0],e=b[1];return R.thread(e)(d.sendReplayCommand$(c),function(a){return[c,a]})}function i(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];return[c,R.unless(function(){return c.do_not_log},R.over(R.lensProp("commands"),R.append(c)),d)]}return R.threadP(c.executeP(b,e,f))(g,R.ifElse(function(a){var b=_slicedToArray(a,2),c=(b[0],b[1]);return d.active(c)},h,i),function(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];return R.when(function(){return"rollDice"===c.type||"rollDeviation"===c.type},R.over(R.lensProp("dice"),R.append(c)),d)},R.tap(function(){a.emit("Game.command.execute")}))}function x(a,b){function d(b){return R.thread(b)(R.propOr([],"undo_log"),R.find(R.propEq("stamp",a.stamp)))}function e(b){return R.over(R.lensProp("undo_log"),R.compose(R.reject(R.propEq("stamp",a.stamp)),R.defaultTo([])),b)}function f(b){return R.thread(b)(R.over(R.lensProp("commands"),R.reject(R.propEq("stamp",a.stamp))),R.over(R.lensProp("undo"),R.append(a)))}return R.threadP(b)(R.ifElse(d,e,c.undoP$(a)),f)}function y(a){function b(a){return R.threadP(a)(R.propOr([],"commands"),R.last,R.rejectIfP(R.isNil,"Command history empty"))}function e(b){return R.threadP(a)(c.undoP$(b),function(a){return[b,a]})}function f(a){var b=_slicedToArray(a,2),c=b[0],e=b[1];return R.thread(e)(R.over(R.lensProp("commands"),R.init),R.ifElse(d.active,d.sendUndoCommand$(c),R.over(R.lensProp("undo"),R.append(c))))}return R.threadP(a)(b,e,f)}function z(a,b){function d(b){return R.thread(b)(R.propOr([],"commands_log"),R.find(R.propEq("stamp",a.stamp)))}function e(b){return R.over(R.lensProp("commands_log"),R.reject(R.propEq("stamp",a.stamp)),b)}function f(b){return R.thread(b)(R.over(R.lensProp("undo"),R.reject(R.propEq("stamp",a.stamp))),R.unless(function(){return a.do_not_log},R.over(R.lensProp("commands"),R.append(a))))}return R.threadP(b)(R.ifElse(d,e,c.replayP$(a)),f)}function A(a,b){return R.threadP(b)(c.replayBatchP$(a),R.over(R.lensProp("commands"),R.flip(R.concat)(a)))}function B(a){function b(a){return R.threadP(a)(R.propOr([],"undo"),R.last,R.rejectIfP(R.isNil,"Undo history empty"))}function e(b){return R.threadP(a)(c.replayP$(b),function(a){return[b,a]})}function f(a){var b=_slicedToArray(a,2),c=b[0],e=b[1];return R.threadP(e)(R.over(R.lensProp("undo"),R.init),R.ifElse(d.active,d.sendReplayCommand$(c),R.over(R.lensProp("commands"),R.append(c))))}return R.threadP(a)(b,e,f)}function C(a,b,c){return d.sendEvent({type:"chat",chat:{from:a,msg:b}},c)}function D(a){return new self.Promise(function(b){R.isEmpty(a.commands)&&b(a);var c=R.splitEvery(a.commands.length,a.commands);self.requestAnimationFrame(function(){b(E(c,a))})})}function E(a,b){function d(b){return new self.Promise(function(c){self.requestAnimationFrame(function(){c(E(R.tail(a),b))})})}return R.isEmpty(a)?self.Promise.resolve(b):R.threadP(b)(c.replayBatchP$(a[0]),d)}var F={create:n,isOnline:o,loadP:p,pickForJson:r,toJson:t,description:v,executeCommandP:w,undoCommandP:x,undoLastCommandP:y,replayCommandP:z,replayCommandsBatchP:A,replayNextCommandP:B,sendChat:C},G={toJSON:function(){return r(this)}};return R.curryService(F),F}angular.module("clickApp.services").factory("game",a),a.$inject=["appState","jsonStringifier","commands","gameConnection","gameLayers","gameLos","gameModels","gameModelSelection","gameRuler","gameTemplates","gameTemplateSelection","gameTerrains","gameTerrainSelection","allTemplates"]}(),function(){function a(a){function b(){return a.getP("/data/boards.json")["catch"](function(a){return R.spyError("Error getting boards.json")(a),[]})}function c(a){return R.prop("name",a)}function d(a,b){return R.find(R.propEq("name",a),b)}var e={initP:b,name:c,forName:d};return R.curryService(e),e}angular.module("clickApp.services").factory("gameBoard",a),a.$inject=["http"]}(),function(){function a(a,b){function c(a){var b={state:{socket:null}};return R.assoc("connection",b,a)}function d(b,c){if(r.active(c))return R.resolveP(c);b=s.trim(b);var d={close:k,chat:o,replayCmd:l,undoCmd:m,cmdBatch:n,setCmds:p,players:q};c=R.assocPath(["connection","state","socket"],null,c);var e=["/api/games",R.prop("private_stamp",c)?"private":"public",R.prop("private_stamp",c)?R.prop("private_stamp",c):R.prop("public_stamp",c)].join("/");return e+="?name="+b,R.threadP()(function(){return a.createP(e,"game",d)},function(a){return R.assocPath(["connection","state","socket"],a,c)})}function e(b){return r.active(b)&&a.close(b.connection.state.socket),r.cleanup(b)}function f(a){return R.assocPath(["connection","state","socket"],null,a)}function g(a){return R.thread(a)(R.path(["connection","state","socket"]),R.exists)}function h(a,b){return R.threadP(b)(r.sendEvent$({type:"replayCmd",cmd:a}),R.over(R.lensProp("commands_log"),R.compose(R.append(a),R.defaultTo([]))))}function i(a,b){return R.thread(b)(r.sendEvent$({type:"undoCmd",cmd:a}),R.over(R.lensProp("undo_log"),R.compose(R.append(a),R.defaultTo([]))))}function j(c,d){return R.thread(d)(R.ifElse(r.active,function(){return a.send(c,d.connection.state.socket)},function(){return b.emit("Error","gameConnection","sendEvent/not active")}),R.always(d))}function k(){b.reduce("Game.connection.close")}function l(a){b.reduce("Game.command.replay",a.cmd)}function m(a){b.reduce("Game.command.undo",a.cmd)}function n(a){b.reduce("Game.command.replayBatch",a.cmds)}function o(a){b.reduce("Game.newChatMsg",a)}function p(a){b.reduce("Game.setCmds",a)}function q(a){b.reduce("Game.setPlayers",a.players)}var r={create:c,openP:d,close:e,cleanup:f,active:g,sendReplayCommand:h,sendUndoCommand:i,sendEvent:j};return R.curryService(r),r}angular.module("clickApp.services").factory("gameConnection",a),a.$inject=["websocket","appState"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){return function(b,c){function d(){return{active:[],locked:[]}}function e(a){return R.concat(a.active,a.locked)}function f(a,b){return R.thread(b)(q.all,R.find(R.pathEq(["state","stamp"],a)))}function g(a,b){return R.map(q.findStamp$(R.__,b),a)}function h(a,b,c,d){return o(function(){return R.always(null)},a,b,c,d)}function i(a,b,c,d){return R.threadP(d)(r(R.always,a,b,c),s(d))}function j(a,b,d){function e(b,d){return R.isNil(b)?null:c.setState(a[d],b)}return R.thread(d)(q.findAnyStamps$(b),R.addIndex(R.map)(e),R.reject(R.isNil),s(d))}function k(a,b,d){return R.thread(d)(q.findAnyStamps$(b),R.reject(R.isNil),R.map(c.setLock$(a)),s(d))}function l(a,b){var c=R.map(R.path(["state","stamp"]),a);return R.thread(b)(q.removeStamps$(c),s(R.__,a))}function m(a,b){function c(b){return R.find(R.equals(R.path(["state","stamp"],b)),a)}return R.thread(b)(R.over(R.lensProp("active"),R.reject(c)),R.over(R.lensProp("locked"),R.reject(c)))}function n(d,e){function f(d){var e=R.thread(d)(R.head,R.defaultTo({state:{x:240,y:240,r:0}}),R.prop("state"),R.pick(["x","y","r"]));return _defineProperty({base:e},b+"s",R.map(R.compose(a.differenceFrom$(e),c.saveState),d))}return R.thread(e)(q.findAnyStamps$(d),R.reject(R.isNil),f)}function o(a,d,e,f,g){function h(){return R.threadP(c)(R.prop(d),R.type,R.rejectIfP(R.complement(R.equals("Function")),'Unknown method "'+d+'" on '+b+"s"))}function i(b){return R.resolveP(c[d].apply(c,[].concat(_toConsumableArray(e),[b])))["catch"](a(b))}return R.threadP()(h,function(){return q.findAnyStamps(f,g)},R.reject(R.isNil),R.map(i),R.allP)}function p(a,b){return R.thread(a)(q.all,R.concat(b),R.uniqBy(R.path(["state","stamp"])),R.partition(c.isLocked),function(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];return{active:d,locked:c}})}var q={create:d,all:e,findStamp:f,findAnyStamps:g,fromStampsP:h,onStampsP:i,setStateStamps:j,lockStamps:k,add:l,removeStamps:m,copyStamps:n},r=R.curry(o),s=R.curry(p);return R.curryService(q),q}}angular.module("clickApp.services").factory("gameElements",a),a.$inject=["point"]}(),function(){function a(){return function(a){function b(){return{local:[],remote:[]}}function c(a,b,c){var d=R.prop(a,c);return R.find(R.equals(b),d)}function d(a,b){return R.propOr([],a,b)}function e(a,b){return R.thread(b)(k.get$(a),R.isEmpty)}function f(b){return R.thread(b)(k.get$("local"),R.ifElse(R.isEmpty,function(){return null},function(){return s.capitalize(a)}))}function g(a,b,c){return R.assoc(a,b,c)}function h(a,b,c){var d=k.get(a,c),e=R.uniq(R.concat(d,b));return R.assoc(a,e,c)}function i(a,b,c){var d=R.prop(a,c),e=R.difference(d,b);return R.assoc(a,e,c)}function j(a,b){var c=R.prop(a,b);return k.removeFrom(a,c,b)}var k={create:b,"in":c,get:d,isEmpty:e,checkMode:f,set:g,addTo:h,removeFrom:i,clear:j};return R.curryService(k),k}}angular.module("clickApp.services").factory("gameElementSelection",a),a.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b){function c(){return R.threadP()(S.loadDefaultP,function(a){return R.threadP()(S.loadDescP,function(b){return{base:a,desc:b}})},S.updateDesc,R.spyWarn("Factions"))}function d(){return R.threadP("/data/model/factions.json")(b.getP,function(a){return R.thread(a)(R.keys,R.map(function(c){return b.getP(a[c]).then(function(a){return[c,a]})}))},R.allP,R.reduce(function(a,b){var c=_slicedToArray(b,2),d=c[0],e=c[1];return R.assoc(d,e,a)},{}))}function e(a){return R.thread(a)(S.applyDesc,S.updateInfo,S.buildReferences)}function f(){return R.threadP()(function(){return a.loadP(Q)["catch"](R.spyError("Factions: no stored desc"))},R.defaultTo({}),R.spyWarn("Factions Desc load"))}function g(a){var b=a.base,c=a.desc;return{base:b,desc:c,current:R.deepExtend(b,c)}}function h(a){var b=a.base,c=a.desc,d=a.current;return{base:b,desc:c,current:R.thread(d)(R.toPairs,R.sortBy(R.compose(R.prop("name"),R.nth(1))),R.reduce(function(a,b){var c=_slicedToArray(b,2),d=c[0],e=c[1];return R.assoc(d,t(e),a)},{}))}}function i(b){return R.thread(b)(R.prop("desc"),R.spyWarn("Factions Desc store"),a.save$(Q))}function j(a){var b=a.base,c=a.desc,d=a.current;return{base:b,desc:c,current:d,references:R.reduce(T(d),{},R.keys(d))}}function k(a,b){return R.path(["current"].concat(_toConsumableArray(a)),b)}function l(a,b){function c(a){return R.thread(b)(R.values,R.find(d(a)),e(a))}var d=R.curry(m),e=R.curry(n);return R.thread(a)(s.lines,R.map(c),R.reject(R.isNil))}function m(a,b){return XRegExp.exec(a,b.regexp)}function n(a,b){if(R.isNil(b))return b;var c=XRegExp.exec(a,b.regexp);return[R.prop("entries",b),o(c.nb_grunts),p(c.nb_repeat)]}function o(a){return R.thread(a)(R.defaultTo("0"),function(a){return parseFloat(a)+1})}function p(a){return R.thread(a)(R.defaultTo("0"),function(a){return parseFloat(a)})}function q(a,b,c){function d(a){var b=_slicedToArray(a,3),c=b[0],d=b[1],g=b[2],i=e(c,d),j=f(c,g),k=[].concat(_toConsumableArray(i),_toConsumableArray(j));return h(c,R.length(i),k),k}function e(a,b){var c=[],d=R.propOr([],"grunt",a),e=_slicedToArray(d,1),f=e[0];if(R.exists(f)&&R.exists(f.fk_grunts)&&(b=f.fk_grunts),b>0){var h=R.propOr([],"leader",a),i=_slicedToArray(h,1),j=i[0];R.exists(j)&&(c=R.concat(c,g(1,j)),b--),R.exists(f)&&R.times(function(){c=R.concat(c,g(1,f))},b),R.isEmpty(c)||(c[0].dsp=["l","i"])}return c}function f(a,b){return R.thread(a)(R.omit(["grunt","leader"]),R.values,R.flatten,R.chain(function(a){return g(b,a)}))}function g(a,c){function d(){e.push({user:b,info:c.path,x:l+c.base_radius,y:m+c.base_radius,r:0}),l+=2*c.base_radius,n=Math.max(n,2*c.base_radius),l>k&&(l=0,m+=n,n=0)}var e=[];return R.thread(c)(R.propOr(1,"fk_repeat"),R.max(a),R.times(d)),e}function h(a,b,c){var d=i(a);(R.isNil(d)||d!==o.name||b>0)&&o.number++,o.name=d,R.forEach(function(a){a.u=o.number},c)}function i(a){return R.thread(a)(R.values,R.find(function(a){return R.find(function(a){return R.exists(a.unit_name)},a)}),R.defaultTo([{}]),R.head,R.prop("unit_name"))}var j=S.getListInfo(a,c),k=240,l=0,m=0,n=0,o={name:null,number:0};return{base:{x:240,y:240,r:0},models:R.chain(d,j)}}function r(a){var b="^\\**\\s*"+a;return XRegExp(b,"i")}function t(a){return R.thread(a)(R.assoc("wreck",C(a.wreck)),function(a){return R.assoc("models",u(a,a.models),a)})}function u(a,b){return R.reduce(function(c,d){return R.assoc(d,v(a,b[d]),c)},{},R.keys(b))}function v(a,b){return R.thread(b)(R.keys,R.sortBy(function(a){return b[a].name}),R.reduce(function(c,d){return R.assoc(d,w(a,b[d]),c)},{}))}function w(a,b){return R.exists(b.entries)?x(a,b):A(a,null,b)}function x(a,b){return R.assoc("entries",y(a,b,b.entries),b)}function y(a,b,c){return R.reduce(function(d,e){return R.assoc(e,z(a,b,c[e]),d)},{},R.keys(c))}function z(a,b,c){return R.reduce(function(d,e){return R.assoc(e,A(a,b,c[e]),d)},{},R.keys(c))}function A(a,b,c){var d=c.name;return R.exists(b)&&(d=R.exists(b.fk_name)?b.fk_name:b.name+".*(?<nb_grunts>\\d+)\\s+grunt"),b=R.defaultTo({},b),R.thread(c)(R.assoc("fk_name",R.defaultTo(d,c.fk_name)),R.assoc("unit_name",b.name),R.assoc("img",B(c.img)),R.assoc("damage",E(c.damage)),R.assoc("base_color",a.color),R.assoc("base_radius",P[c.base]),function(b){return"jack"===b.type&&R.exists(a.wreck)&&R.exists(a.wreck[b.base])?R.assoc("img",R.append(a.wreck[b.base],b.img),b):b})}function B(a){return R.thread(a)(R.defaultTo([]),function(a){return R.isEmpty(a)?R.append({},a):a},R.map(D))}function C(a){return R.thread(a)(R.defaultTo({}),function(a){return R.thread(a)(R.keys,R.reduce(function(b,c){return R.assoc(c,D(R.assoc("type","wreck",a[c])),b)},{}))})}function D(a){return R.thread(a)(R.assoc("type",R.defaultTo("default",a.type)),R.assoc("width",R.defaultTo(60,a.width)),R.assoc("height",R.defaultTo(60,a.height)))}function E(a){return R.thread(a)(R.defaultTo({type:"warrior",n:1}),function(a){return R.assoc("type",R.defaultTo("warrior",a.type),a)},function(a){return R.assoc("total",F(a),a)},function(a){return R.assoc("depth",G(a),a)})}function F(a){return"warrior"===a.type?a.n:R.thread(a)(R.keys,R.reject(R.equals("type")),R.reject(R.equals("total")),R.reject(R.equals("field")),R.reduce(function(b,c){return b+R.thread(a[c])(R.reject(R.isNil),R.length)},0))}function G(a){return"warrior"===a.type?a.n:R.thread(a)(R.keys,R.reject(R.equals("type")),R.reject(R.equals("total")),R.reject(R.equals("field")),R.map(function(b){return R.length(a[b])}),R.reduce(R.max,0))}function H(a,b,c){var d=a[c].models;return R.reduce(U(c,d),b,R.keys(d))}function I(a,b,c,d){var e=b[d];return R.reduce(V(a,d,e),c,R.keys(e))}function J(a,b,c,d,e){var f=c[e].entries;return R.isNil(f)?K(a,b,c,e,d):R.reduce(W(a,b,e,f),d,R.keys(f))}function K(a,b,c,d,e){return d=R.assoc("path",[a,"models",b,d],c[d]),N("default",d,e),e}function L(a,b,c,d,e,f){var g=d[f];return R.reduce(X(a,b,c,f,g),e,R.keys(g))}function M(a,b,c,d,e,f,g){var h=R.assoc("path",[a,"models",b,c,"entries",d,g],e[g]);return N(g,h,f),f}function N(a,b,c){var d=O(b.fk_name,c),e=R.defaultTo([],d.entries[a]);e.push(b),d.entries[a]=e,c[b.fk_name]=d}function O(a,b){var c=S.buildReferenceRegexp(a);return R.defaultTo({regexp:c,entries:{}},b[a])}var P={huge:24.605,large:9.842,medium:7.874,small:5.905},Q="clickApp.factions_desc",S={initP:c,loadDefaultP:d,updateDesc:e,loadDescP:f,applyDesc:g,updateInfo:h,storeDesc:i,buildReferences:j,getModelInfo:k,getListInfo:l,buildModelsList:q,buildReferenceRegexp:r},T=R.curry(H),U=R.curry(I),V=R.curry(J),W=R.curry(L),X=R.curry(M);return R.curryService(S),S}angular.module("clickApp.services").factory("gameFactions",a),a.$inject=["localStorage","http"]}(),function(){function a(){function a(){return["b","d","s","m","t"]}function b(a){var b=arguments.length<=1||void 0===arguments[1]?[]:arguments[1];return R.find(R.equals(a),b)}function c(a){var b=arguments.length<=1||void 0===arguments[1]?[]:arguments[1];return R.uniq(R.append(a,b))}function d(a){var b=arguments.length<=1||void 0===arguments[1]?[]:arguments[1];return R.reject(R.equals(a),b)}function e(a,b){return f.isDisplayed(a,b)?f.unset(a,b):f.set(a,b)}var f={create:a,isDisplayed:b,set:c,unset:d,toggle:e};return R.curryService(f),f}angular.module("clickApp.services").factory("gameLayers",a),a.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d){function e(){return R.deepExtend(z.create(),{computed:{}})}function f(a){return R.thread(a)(z.toggleDisplay,B({}))}function g(a,b,c,d){return R.thread(d)(z.setRemote$(a,b),B({}))}function h(a,b){return R.thread(b)(z.resetRemote$(a),B({}))}function i(a){return R.path(["remote","origin"],a)}function j(a){return r({origin:null,ignore:null,display:!1},a)}function k(a,b){var c=a.state.stamp,d=A.target(b);d=d===c?null:d;var e=d&&c;return r({origin:c,target:d,ignore:null,display:e},b)}function l(a,b,c){var d=a.state.stamp;return r({origin:d,target:null,ignore:null,display:!0},c)}function m(a){return R.path(["remote","target"],a)}function n(a){return r({target:null,ignore:null,display:!1},a)}function o(a,b){var c=A.origin(b),d=a.state.stamp;c=c===d?null:c;var e=d&&c;return r({origin:c,target:d,ignore:null,display:e},b)}function p(a,b){var c=R.pathOr([],["remote","ignore"],b),d=R.find(R.equals(a.state.stamp),c);return c=d?R.reject(R.equals(a.state.stamp),c):R.append(a.state.stamp,c),r({ignore:c},b)}function q(a){return r({},a)}function r(a,b){var c=a.origin,d=void 0===c?R.path(["remote","origin"],b):c,e=a.target,f=void 0===e?R.path(["remote","target"],b):e,g=a.ignore,h=void 0===g?R.pathOr([],["remote","ignore"],b):g,i=a.display,j=void 0===i?R.path(["remote","display"],b):i;return b=R.thread(b)(R.assocPath(["remote","origin"],d),R.assocPath(["remote","target"],f),R.assocPath(["remote","display"],j),R.assocPath(["remote","ignore"],R.defaultTo([],h)))}function s(a,b){var e=a.in_los_mode,f=a.factions,g=a.models,h={show:b.local.display,x1:b.local.start.x,y1:b.local.start.y,x2:b.local.end.x,y2:b.local.end.y},i={show:b.remote.display,x1:b.remote.start.x,y1:b.remote.start.y,x2:b.remote.end.x,y2:b.remote.end.y},j=void 0;if(R.exists(b.remote.origin)&&(b.remote.display||e)){var k=d.findStamp(b.remote.origin,g);if(R.exists(k)){var l=c.getModelInfo(k.state.info,f);R.exists(l)&&(j={cx:k.state.x,cy:k.state.y,radius:l.base_radius})}}var m=void 0;if(R.exists(b.remote.target)&&(b.remote.display||e)){var n=d.findStamp(b.remote.target,g);if(R.exists(n)){var o=c.getModelInfo(n.state.info,f);R.exists(o)&&(m={cx:n.state.x,cy:n.state.y,radius:o.base_radius})}}return{local:h,remote:i,origin:j,target:m}}function t(a,b){b.computed={envelope:null,darkness:[],shadow:[]};var c=b.remote.display&&b.remote.origin&&b.remote.target;c&&u(a,b);var d=R.pathOr({},["computed","envelope"],b),e=d.left;e=void 0===e?{}:e;var f=e.start;f=void 0===f?{}:f;var g=f.x,h=void 0===g?0:g,i=f.y,j=void 0===i?0:i,k=e.end;k=void 0===k?{}:k;var l=k.x,m=void 0===l?0:l,n=k.y,o=void 0===n?0:n,p=d.right;p=void 0===p?{}:p;var q=p.start;q=void 0===q?{}:q;var r=q.x,s=void 0===r?0:r,t=q.y,v=void 0===t?0:t,w=p.end;w=void 0===w?{}:w;var x=w.x,y=void 0===x?0:x,z=w.y,A=void 0===z?0:z,B=[[h,j].join(","),[m,o].join(","),[y,A].join(","),[s,v].join(",")].join(" "),C=R.map(function(a){var b=a.left;b=void 0===b?{}:b;var c=b.start;c=void 0===c?{}:c;var d=c.x,e=void 0===d?0:d,f=c.y,g=void 0===f?0:f,h=b.end;h=void 0===h?{}:h;var i=h.x,j=void 0===i?0:i,k=h.y,l=void 0===k?0:k,m=a.right;m=void 0===m?{}:m;var n=m.start;n=void 0===n?{}:n;var o=n.x,p=void 0===o?0:o,q=n.y,r=void 0===q?0:q,s=m.end;s=void 0===s?{}:s;var t=s.x,u=void 0===t?0:t,v=s.y,w=void 0===v?0:v;return[[e,g].join(","),[j,l].join(","),[u,w].join(","),[p,r].join(",")].join(" ")},R.pathOr([],["computed","shadow"],b)),D=R.map(function(a){var b=a.left;b=void 0===b?{}:b;var c=b.start;c=void 0===c?{}:c;var d=c.x,e=void 0===d?0:d,f=c.y,g=void 0===f?0:f,h=b.end;h=void 0===h?{}:h;var i=h.x,j=void 0===i?0:i,k=h.y,l=void 0===k?0:k,m=a.right;m=void 0===m?{}:m;var n=m.start;n=void 0===n?{}:n;var o=n.x,p=void 0===o?0:o,q=n.y,r=void 0===q?0:q,s=m.end;s=void 0===s?{}:s;var t=s.x,u=void 0===t?0:t,v=s.y,w=void 0===v?0:v;return[[e,g].join(","),[j,l].join(","),[u,w].join(","),[p,r].join(",")].join(" ")},R.pathOr([],["computed","darkness"],b));return{display:c,enveloppe:B,shadow:C,darkness:D}}function u(a,c){R.thread()(function(){return v(a,c.remote.origin,c.remote.target)},function(d){var e=_slicedToArray(d,4),f=e[0],g=e[1],h=e[2],i=e[3],j={x:f.x,y:f.y,radius:g.base_radius},k={x:h.x,y:h.y,radius:i.base_radius},l=b.envelopeTo(k,j);return c.computed.envelope=l,R.thread()(function(){return w(a,c.remote.ignore,c.remote.target,k,c.remote.origin,l)},function(a){return[j,a]})},function(a){var b=_slicedToArray(a,2),d=b[0],e=b[1],f=x(d,e);c.computed.darkness=f;var g=y(d,e);c.computed.shadow=g})}function v(a,b,e){return R.thread()(function(){return[d.findStamp(b,a.game.models),d.findStamp(e,a.game.models)]},function(b){var d=_slicedToArray(b,2),e=d[0].state,f=d[1].state;return R.thread()(function(){return[c.getModelInfo(e.info,a.factions),c.getModelInfo(f.info,a.factions)]},function(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];return[e,c,f,d]})})}function w(a,e,f,g,h,i){function j(b){return R.thread()(function(){return c.getModelInfo(b.state.info,a.factions)},function(a){return R.assoc("radius",a.base_radius,b.state)})}function k(a){return f===a.stamp||h===a.stamp||g.radius>a.radius||R.find(R.equals(a.stamp),e)}return R.thread(a.game.models)(d.all,R.map(j),R.reject(k),R.filter(b.isInEnvelope$(i)))}function x(a,c){return R.map(function(c){return b.outsideEnvelopeTo(c,[],a)},c)}function y(a,c){return R.map(function(d){return b.outsideEnvelopeTo(d,c,a)},c)}var z=a("los"),A=Object.create(z);R.deepExtend(A,{create:e,toggleDisplay:f,setRemote:g,resetRemote:h,origin:i,clearOrigin:j,setOrigin:k,target:m,setOriginResetTarget:l,clearTarget:n,setTarget:o,toggleIgnoreModel:p,updateOriginTarget:q,render:s,renderEnveloppe:t});var B=R.curry(r);return R.curryService(A),A}angular.module("clickApp.services").factory("gameLos",a),a.$inject=["gameSegment","circle","gameFactions","gameModels"]}(),function(){function a(a,b){function c(a,c,d){return R.thread(d)(f.all,R.filter(b.isBetweenPoints$(a,c)),R.map(R.path(["state","stamp"])))}function d(a,c){return R.thread(c)(f.findStamp$(a),R.when(R.exists,b.modeFor))}var e=a("model",b),f=Object.create(e);return R.deepExtend(f,{findStampsBetweenPoints:c,modeForStamp:d}),R.curryService(f),f}angular.module("clickApp.services").factory("gameModels",a),a.$inject=["gameElements","model"]}(),function(){function a(a,b){function c(a,b,c){var d=R.prop(a,c);return 1===R.length(d)&&d[0]===b}function d(a,c){var d=f.get("local",c);return R.isEmpty(d)?null:1===R.length(d)?b.modeForStamp(d[0],a):"Models"}var e=a("model"),f=Object.create(e);return R.deepExtend(f,{inSingle:c,checkMode:d}),R.curryService(f),f}angular.module("clickApp.services").factory("gameModelSelection",a),a.$inject=["gameElementSelection","gameModels"]}(),function(){function a(a,b,c,d){function e(){return R.deepExtend(w.create(),{local:{length:null},remote:{length:null}})}function f(a){return R.pathOr(0,["remote","max"],a)}function g(a,b,c){return R.thread(c)(R.assocPath(["local","max"],a),R.assocPath(["remote","max"],a),z(b))}function h(a){return R.path(["remote","origin"],a)}function i(a,b){return u({origin:null},a,b)}function j(a,b,d){var e=a.state.stamp,f=x.target(d);f=f===e?null:f;var g=R.defaultTo(R.path(["remote","max"],d),c.rulerMaxLength(a));return u({origin:e,target:f,max_length:g},b,d)}function k(a,b,d){var e=a.state.stamp,f=R.defaultTo(R.path(["remote","max"],d),c.rulerMaxLength(a));return u({origin:e,target:null,max_length:f},b,d)}function l(a){return R.path(["remote","target"],a)}function m(a){return R.path(["remote","reached"],a)}function n(a,b){return u({target:null},a,b)}function o(a,b,c){var d=x.origin(c),e=a.state.stamp;return d=d===e?null:d,u({origin:d,target:e},b,c)}function p(a,b){return v(a,b)}function q(a,b,c){return R.over(R.lensProp("local"),R.pipe(R.assoc("start",R.clone(a)),y(b),R.assoc("length",null),R.assoc("display",!0)),c)}function r(a,b,c,d){return R.thread(d)(R.over(R.lensProp("local"),R.assoc("display",!1)),R.over(R.lensProp("remote"),R.pipe(R.assoc("origin",null),R.assoc("target",null),R.assoc("start",R.clone(a)),R.assoc("end",R.clone(b)),R.assoc("display",!0))),z(c))}function s(a,c){var e=b.directionTo(c.remote.end,c.remote.start),f=c.remote.length/2,g=c.remote.end,h=x.target(c);return R.thread(g)(function(b){return R.exists(h)&&x.targetReached(c)?R.thread(a)(d.findStamp$(h),R.ifElse(R.isNil,R.defaultTo(b),R.prop("state"))):b},R.pick(["x","y"]),R.assoc("r",e),R.assoc("m",f))}function t(a,c){var d=b.distanceTo(a,c.start),e=b.directionTo(a,c.start),f=10*R.defaultTo(d/10,c.max);return d=Math.min(d,f),a=b.translateInDirection(d,e,c.start),R.assoc("end",a,c)}function u(a,b,c){var d=a.origin,e=void 0===d?x.origin(c):d,f=a.target,g=void 0===f?x.target(c):f,h=a.max_length,i=void 0===h?R.path(["remote","max"],c):h,j=R.exists(e)&&R.exists(g);return R.thread(c)(R.over(R.lensProp("remote"),R.pipe(R.assoc("origin",e),R.assoc("target",g),R.assoc("display",j),R.assoc("max",i))),z(b))}function v(a,e){function f(b){var c=R.path(["remote","origin"],b);return R.exists(c)?d.findStamp(c,a.game.models):null}function g(b){var c=R.path(["remote","target"],b);return R.exists(c)?d.findStamp(c,a.game.models):null}function h(b,d){return R.exists(b)&&R.exists(d)?c.shortestLineTo(a.factions,d,b):R.exists(b)?{start:R.pick(["x","y"],b.state),end:R.pick(["x","y"],b.state)}:R.exists(d)?{start:R.pick(["x","y"],d.state),end:R.pick(["x","y"],d.state)}:R.pick(["start","end"],R.prop("remote",e))}return R.threadP(e)(f,function(a){return R.threadP(e)(g,function(b){return h(a,b)})},function(a){var c=a.start,d=a.end,f=b.distanceTo(d,c);return R.over(R.lensProp("remote"),R.pipe(R.assoc("start",c),y(d),function(a){var c=b.distanceTo(a.end,a.start);return R.thread(a)(R.assoc("reached",c>=f-.1),R.assoc("length",Math.round(10*c)/100))}),e)})}var w=a(),x=Object.create(w);R.deepExtend(x,{create:e,maxLength:f,setMaxLength:g,setLocal:q,setRemote:r,origin:h,clearOrigin:i,setOrigin:j,setOriginResetTarget:k,target:l,targetReached:m,clearTarget:n,setTarget:o,updateOriginTarget:p,targetAoEPosition:s});var y=R.curry(t),z=R.curry(v);return R.curryService(x),x}angular.module("clickApp.services").factory("gameRuler",a),a.$inject=["gameSegment","point","model","gameModels"]}(),function(){function a(a,b,c,d){function e(){return a.getP("/data/scenarios.json")["catch"](function(a){return[]})}function f(a){return R.prop("name",a)}function g(a,b){return R.find(R.compose(R.equals(a),R.head),b)}function h(a,b){return R.find(R.propEq("name",a),b[1])}function i(a,b){return R.isNil(a)?void 0:R.find(R.compose(R.find(R.propEq("name",a)),R.last),b)}function j(a){var c=R.concat(R.propOr([],"objectives",a),R.propOr([],"flags",a));if(R.isEmpty(c))return null;var d=R.assoc("r",0,R.head(c));return{base:R.pick(["x","y","r"],d),models:R.map(function(a){return R.thread(a)(R.assoc("r",0),R.assoc("info",R.concat(["scenario","models"],R.prop("info",a))),b.differenceFrom$(d))},c)}}function k(a,b){return R.exists(R.find(function(b){return m(a,b)},R.propOr([],"circle",b))||R.find(function(b){return o(a,b)},R.propOr([],"rect",b))||R.find(function(b){return n(a,b)},R.propOr([],"flags",b)))}function l(a,b){return R.exists(b.killbox)&&p(a,b.killbox)}function m(a,b){var d={start:a,end:b},e=c.length(d);return e<=a.radius+b.r}function n(a,b){var d={start:a,end:b},e=c.length(d);return e<=a.radius+40+7.874}function o(a,b){var c={low:{x:b.x-b.width/2,y:b.y-b.height/2},high:{x:b.x+b.width/2,y:b.y+b.height/2}};return d.isInBox(c,a)}function p(a,b){var c={low:{x:b,y:b},high:{x:480-b,y:480-b}};return!d.isInBox(c,a)}var q={initP:e,name:f,group:g,forName:h,groupForName:i,createObjectives:j,isContesting:k,isKillboxing:l};return R.curryService(q),q}angular.module("clickApp.services").factory("gameScenario",a),a.$inject=["http","point","line","circle"]}(),function(){function a(){var a=R.lensPath(["remote","display"]);return function(){function b(){return{local:{display:!1,start:{x:0,y:0},end:{x:0,y:0}},remote:{display:!1,start:{x:0,y:0},end:{x:0,y:0}}}}function c(b){return R.view(a,b)}function d(b){return R.over(a,R.not,b)}function e(a,b,c){return R.over(R.lensProp("local"),R.pipe(R.assoc("start",R.clone(a)),R.assoc("end",R.clone(b)),R.assoc("display",!0)),c)}function f(a,b,c){return R.thread(c)(R.assocPath(["local","display"],!1),R.assocPath(["remote","start"],R.clone(a)),R.assocPath(["remote","end"],R.clone(b)),R.assocPath(["remote","display"],!0))}function g(a){return R.clone(R.prop("remote",a))}function h(a,b){return R.assoc("remote",R.clone(a),b)}var i={create:b,isDisplayed:c,toggleDisplay:d,
setLocal:e,setRemote:f,saveRemoteState:g,resetRemote:h};return R.curryService(i),i}}angular.module("clickApp.services").factory("gameSegment",a),a.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b){function c(a,b,c,d){return i(R.compose(R.always,R.always(null)),a,b,c,d)}function d(a,b,c,d){return R.threadP(d)(i(R.always,a,b,c),j(d))}function e(b,c,d,e,f){function g(e){return R.resolveP(a.callP(c,d,e))["catch"](b(e))}return R.threadP(f)(h.findAnyStamps$(e),R.reject(R.isNil),R.map(g),R.allP)}function f(b,c){return R.thread(b)(h.all,R.concat(c),R.uniqBy(R.path(["state","stamp"])),R.partition(a.isLocked),function(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];return{active:d,locked:c}})}var g=b("template",a),h=Object.create(g);R.deepExtend(h,{fromStampsP:c,onStampsP:d});var i=R.curry(e),j=R.curry(f);return R.curryService(h),h}angular.module("clickApp.services").factory("gameTemplates",a),a.$inject=["template","gameElements"]}(),function(){function a(a,b,c){function d(b){var d=a.current();return R.thread(b)(f.get$("local"),R.ifElse(R.isEmpty,function(){return null},function(a){return R.thread(a)(R.head,c.findStamp$(R.__,d.game.templates),function(a){return a.state.type+"Template"})}))}var e=b("template"),f=Object.create(e);return R.deepExtend(f,{checkMode:d}),R.curryService(f),f}angular.module("clickApp.models").factory("gameTemplateSelection",a),a.$inject=["appState","gameElementSelection","gameTemplates"]}(),function(){function a(a){function b(){return a.getP("/data/terrains.json")["catch"](function(a){return R.spyError("Error getting terrains.json")(a),[]}).then(d)}function c(a,b){return R.pathOr(null,a,b)}function d(a){return R.thread(a)(R.keys,R.sortBy(R.identity),R.reduce(function(b,c){return b[c]=e(a[c]),b},{}))}function e(a){return R.thread(a)(R.keys,R.sortBy(R.identity),R.reduce(function(b,c){return b[c]=f(a[c]),b},{}))}function f(a){return R.thread(a)(R.keys,R.sortBy(R.identity),R.reduce(function(b,c){return b[c]=g(a[c]),b},{}))}function g(a){return R.thread(a)(R.over(R.lensPath(["img","width"]),R.divide(R.__,3)),R.over(R.lensPath(["img","height"]),R.divide(R.__,3)))}var h={initP:b,getInfo:c};return R.curryService(h),h}angular.module("clickApp.services").factory("gameTerrainInfo",a),a.$inject=["http"]}(),function(){function a(a,b){return b("terrain",a)}angular.module("clickApp.services").factory("gameTerrains",a),a.$inject=["terrain","gameElements"]}(),function(){function a(a){return a("terrain")}angular.module("clickApp.services").factory("gameTerrainSelection",a),a.$inject=["gameElementSelection"]}(),function(){function a(a,b,c){function d(){return R.threadP(a.keys())(R.filter(function(a){return a.startsWith(l)}),R.map(function(b){return a.loadP(b)["catch"](R.spyAndDiscardError("GamesModel: Failed to load local game",b))}),R.allP,R.reject(R.isNil),R.defaultTo([]),R.spyWarn("Games local load"))}function e(b){var c=l+b.local_stamp;return a.save(c,b)}function f(b){var c=l+b;return a.loadP(c)}function g(a,b){return R.thread(a)(R.assoc("local_stamp",R.guid()),m.saveLocalGame,R.append(R.__,b))}function h(b,c){return R.thread(l+b)(a.removeItem,function(){return R.reject(R.propEq("local_stamp",b),c)})}function i(a,b){var c=R.findIndex(R.propEq("local_stamp",a.local_stamp),b);return R.thread(a)(m.saveLocalGame,function(){return R.update(c,a,b)})}function j(a){return R.threadP(a)(c.pickForJson,R.spyWarn("upload game"),b.postP$("/api/games"),R.spyWarn("upload game response"))}function k(a,c){var d=["/api/games",a?"private":"public",c].join("/");return R.threadP(d)(b.getP,R.spyWarn("Games: load online game"))}var l="clickApp.game.",m={loadLocalGamesP:d,saveLocalGame:e,loadLocalGameP:f,newLocalGame:g,removeLocalGame:h,updateLocalGame:i,newOnlineGameP:j,loadOnlineGameP:k};return R.curryService(m),m}angular.module("clickApp.services").factory("games",a),a.$inject=["localStorage","http","game"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b){function c(c,d){var e=a.differenceFrom(c.start,d),f=b.length(c),g=b.vector(c),h=a.vectorProduct(g,e),i=a.scalarProduct(g,e);return[h,i,f]}function d(a,b){var c=p.positionToLine(a,b),d=_slicedToArray(c,3),e=d[0],f=d[1],g=d[2];return e+b.radius>=0&&f+b.radius>=0&&f-b.radius<=g}function e(a,b){var c=p.positionToLine(a,b),d=_slicedToArray(c,3),e=d[0],f=d[1],g=d[2];return e-b.radius<=0&&f+b.radius>=0&&f-b.radius<=g}function f(a,b){return p.isRightOfLine(a.left,b)&&p.isLeftOfLine(a.right,b)}function g(a,b){var c=void 0,d=void 0;return b.x>=a.low.x&&b.x<=a.high.x&&b.y>=a.low.y&&b.y<=a.high.y?!0:b.x>=a.low.x-b.radius&&b.x<a.low.x?(c=a.low.x-b.x,d=Math.sqrt(b.radius*b.radius-c*c),b.y+d>=a.low.y&&b.y-d<=a.high.y):b.x<=a.high.x+b.radius&&b.x>a.high.x?(c=a.high.x-b.x,d=Math.sqrt(b.radius*b.radius-c*c),b.y+d>=a.low.y&&b.y-d<=a.high.y):b.y>=a.low.y-b.radius&&b.y<a.low.y?(d=a.low.y-b.y,c=Math.sqrt(b.radius*b.radius-d*d),b.x+c>=a.low.x&&b.x-c<=a.high.x):b.y<=a.high.y+b.radius&&b.y>a.high.y?(d=a.high.y-b.y,c=Math.sqrt(b.radius*b.radius-d*d),b.x+c>=a.low.x&&b.x-c<=a.high.x):!1}function h(a,b){var c=p.positionToLine(a,b),d=_slicedToArray(c,3),e=d[0],f=d[1],g=d[2];return Math.abs(e)<b.radius&&f+b.radius>=0&&f-b.radius<=g}function i(a,b){return{x:b.x+Math.sin(Math.PI*a/180)*b.radius,y:b.y-Math.cos(Math.PI*a/180)*b.radius}}function j(b,c,d){var e=a.distanceTo(d,b),f=a.directionTo(d,b),g=180*Math.acos(d.radius/e)/Math.PI,h=c?f-180+g:f+180-g;return p.pointOnEdgeInDirection(h,d)}function k(b,c){var d=a.directionTo(b,c),e=a.distanceTo(b,c),f=Math.abs(c.radius-b.radius),g=180*(Math.asin(f/e)*(c.radius>=b.radius?1:-1))/Math.PI;return{right:d-g+90,left:d+g-90}}function l(a,b){var c=p.envelopeDirectionsTo(a,b),d={left:{start:p.pointOnEdgeInDirection(c.left,b),end:p.pointOnEdgeInDirection(c.left,a)},right:{start:p.pointOnEdgeInDirection(c.right,b),end:p.pointOnEdgeInDirection(c.right,a)}};return d}function m(c,d,e){var f=p.envelopeDirectionsTo(c,e),g={left:n(f,c,d,e),right:o(f,c,d,e)};g.left.vector=b.vector(g.left),g.right.vector=b.vector(g.right);var h={left:{start:{x:g.left.end.x,y:g.left.end.y}},right:{start:{x:g.right.end.x,y:g.right.end.y}}},i=800,j=800,k=a.vectorProduct(g.left.vector,g.right.vector);if(k>.001){var l={start:g.left.end,end:g.right.end};l.length=b.length(l),l.vector=b.vector(l);var m=Math.acos(a.scalarProduct(l.vector,g.left.vector)),q=Math.acos(-a.scalarProduct(l.vector,g.right.vector));i=l.length*Math.sin(m)/Math.sin(m+q),j=l.length*Math.sin(q)/Math.sin(m+q)}return i=Math.min(800,i),j=Math.min(800,j),h.left.end=a.translateInVector(i,g.left.vector,h.left.start),h.right.end=a.translateInVector(j,g.right.vector,h.right.start),h}function n(a,c,d,e){for(var f=(a.right-a.left)/180,g={start:null,end:null},h=a.left;h<a.right;h+=f){g.start=p.pointOnEdgeInDirection(h,e),g.end=p.pointOnEdgeTangentTo(g.start,!0,c),g.length=b.length(g),g.vector=b.vector(g);var i=R.find(function(a){return p.intersectLine(g,a)},d);if(R.isNil(i))return g}return g}function o(a,c,d,e){for(var f=(a.right-a.left)/180,g={start:null,end:null},h=a.right;h>a.left;h-=f){g.start=p.pointOnEdgeInDirection(h,e),g.end=p.pointOnEdgeTangentTo(g.start,!1,c),g.length=b.length(g),g.vector=b.vector(g);var i=R.find(function(a){return p.intersectLine(g,a)},d);if(R.isNil(i))return g}return g}var p={positionToLine:c,isLeftOfLine:d,isRightOfLine:e,isInEnvelope:f,isInBox:g,intersectLine:h,pointOnEdgeInDirection:i,pointOnEdgeTangentTo:j,envelopeDirectionsTo:k,envelopeTo:l,outsideEnvelopeTo:m};return R.curryService(p),p}angular.module("clickApp.services").factory("circle",a),a.$inject=["point","line"]}(),function(){function a(a){function b(b){return a.distanceTo(b.end,b.start)}function c(a){var b=d.length(a);return{x:(a.end.x-a.start.x)/b,y:(a.end.y-a.start.y)/b}}var d={length:b,vector:c};return R.curryService(d),d}angular.module("clickApp.services").factory("line",a),a.$inject=["point"]}(),function(){function a(){function a(a,b){var c=b.r*Math.PI/180;return R.pipe(R.assoc("x",b.x+a*Math.sin(c)),R.assoc("y",b.y-a*Math.cos(c)))(b)}function b(a,b){var c=b.r*Math.PI/180;return R.pipe(R.assoc("x",b.x-a*Math.sin(c)),R.assoc("y",b.y+a*Math.cos(c)))(b)}function c(a,b){return R.assoc("r",b.r-a,b)}function d(a,b,c){var d=t.directionTo(c,b),e=t.distanceTo(c,b),f=d-a;return R.pipe(R.assoc("x",b.x+e*Math.sin(f*Math.PI/180)),R.assoc("y",b.y-e*Math.cos(f*Math.PI/180)))(c)}function e(a,b){return R.assoc("r",b.r+a,b)}function f(a,b,c){var d=t.directionTo(c,b),e=t.distanceTo(c,b),f=d+a;return R.pipe(R.assoc("x",b.x+e*Math.sin(f*Math.PI/180)),R.assoc("y",b.y-e*Math.cos(f*Math.PI/180)))(c)}function g(a,b,c){var d=t.distanceTo(c,b);return R.pipe(R.assoc("x",b.x+d*Math.sin(a*Math.PI/180)),R.assoc("y",b.y-d*Math.cos(a*Math.PI/180)))(c)}function h(a,b){return R.assoc("x",b.x-a,b)}function i(a,b){return R.assoc("x",b.x+a,b)}function j(a,b){return R.assoc("y",b.y-a,b)}function k(a,b){return R.assoc("y",b.y+a,b)}function l(a,b){return Math.sqrt(Math.pow(a.x-b.x,2)+Math.pow(a.y-b.y,2))}function m(a,b){return 180*Math.atan2(a.x-b.x,b.y-a.y)/Math.PI}function n(a,b,c){return b=b*Math.PI/180,R.pipe(R.assoc("x",c.x+a*Math.sin(b)),R.assoc("y",c.y-a*Math.cos(b)))(c)}function o(a,b,c){return R.pipe(R.assoc("x",c.x+a*b.x),R.assoc("y",c.y+a*b.y))(c)}function p(a,b,c){var d=a?-1:1,e=a?180:0;return R.pipe(R.assoc("x",b.x+d*c.x),R.assoc("y",b.y+d*c.y),R.assoc("r",b.r+c.r+e))(c)}function q(a,b){return R.pipe(R.assoc("x",b.x-a.x),R.assoc("y",b.y-a.y),R.assoc("r",b.r-a.r))(b)}function r(a,b){return a.y*b.x-a.x*b.y}function s(a,b){return a.x*b.x+a.y*b.y}var t={moveFront:a,moveBack:b,rotateLeft:c,rotateLeftAround:d,rotateRight:e,rotateRightAround:f,rotateAroundTo:g,shiftLeft:h,shiftRight:i,shiftUp:j,shiftDown:k,distanceTo:l,directionTo:m,translateInDirection:n,translateInVector:o,addToWithFlip:p,differenceFrom:q,vectorProduct:r,scalarProduct:s};return R.curryService(t),t}angular.module("clickApp.services").factory("point",a),a.$inject=[]}(),function(){function a(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s){function t(a,b){return R.thread(a)(c.getModelInfo$(b.info),R.unless(R.isNil,function(c){var d={state:{x:0,y:0,r:0,img:0,dsp:["i"],eff:[],l:[],c:0,s:0,u:null,aur:null,are:null,rml:null,cml:null,pml:[null,!1],cha:null,pla:null,dmg:z(c.damage),stamp:R.guid()}};return("wardude"===c.type||"beast"===c.type||"jack"===c.type)&&(d.state.dsp=R.append("c",d.state.dsp)),c.immovable&&(d.state.lk=!0),d.state=R.deepExtend(d.state,b),E.checkState(a,null,d)}))}function u(a){return R.path(["state","user"],a)}function v(a,b){return R.pathEq(["state","user"],a,b)}function w(a,b,d){return R.thread(a)(c.getModelInfo$(d.state.info),R.ifElse(R.isNil,function(){return R.prop("state",d)},function(a){var c=a.base_radius;return R.thread(d.state)(R.assoc("x",Math.max(0+c,Math.min(480-c,d.state.x))),R.assoc("y",Math.max(0+c,Math.min(480-c,d.state.y))),function(c){return R.reduce(function(c,d){return d(a,b,c)},c,E.state_checkers)},function(a){return R.reduce(function(a,b){return b(a)},a,E.state_updaters)})}),function(a){return R.assoc("state",a,d)})}function x(a){return E.isCharging(a)?"ModelCharge":E.isPlacing(a)?"ModelPlace":"Model"}function y(a,b){return R.thread(a)(R.props(["unit_name","name"]),R.prepend(E.user(b)),R.reject(R.isNil),R.join("/"))}function z(a){return"warrior"===a.type?{n:0,t:0}:R.thread(a)(R.keys,R.reject(R.equals("type")),R.reject(R.equals("field")),R.reject(R.equals("total")),R.reject(R.equals("depth")),R.reduce(function(b,c){return R.assoc(c,R.map(R.always(0),a[c]),b)},{}),R.assoc("f",0),R.assoc("t",0))}function A(a,b,d){var e=a.is_flipped,f=a.charge_target,g=R.thread(b)(c.getModelInfo$(d.info),R.defaultTo({base_radius:5.905})),h=E.isWreckDisplayed({state:d}),i=h?E.getWreckImage(b,{state:d}):E.getImage(b,{state:d}),j=i.width/2,k=i.height/2,l=g.base_radius,m=j,n=k-g.base_radius,o=j-g.base_radius,p=j+g.base_radius,q={dy:k-700,lx:j-700,rx:j+700},r={show:E.isLocked({state:d}),x:j+l-5,y:k-5},s={show:!1,x:0,y:0,transform:"",length:{}},t={flipped:e,flip_center:{x:j,y:k},text_center:{x:j,y:j+l+8}},u=D.renderLabel(t,d);return R.deepExtend({stamp:d.stamp,x:d.x,y:d.y,transform:["translate("+(d.x-j)+","+(d.y-k)+")","rotate("+d.r+","+j+","+k+")"].join(" "),cx:j,cy:k,radius:l,dx:m,dy:n,frx:o,flx:p,los:q,width:i.width,height:i.height,base_color:g.base_color,title:E.descriptionFromInfo(g,{state:d}),label:u,lock:r,path:s},E.renderArea({info:g,radius:l},b,d),E.renderAura({radius:l},d),E.renderCharge({base:D,charge_target:f,radius:l},s,d),E.renderCounter({base:D,cx:j,cy:k,is_flipped:e,radius:l},d),E.renderDamage({cx:j,cy:k,info:g,radius:l},d),E.renderEffect({img:i,info:g},d),E.renderImage({img:i},d),E.renderLeader({cx:j,cy:k,radius:l},d),E.renderMelee({img:i,info:g},d),E.renderPlace({base:D,info:g,path:s},d),E.renderUnit({base:D,cx:j,cy:k,radius:l},d))}var B={Move:10,MoveSmall:5,Rotate:15,RotateSmall:5,Shift:10,ShiftSmall:1,RotateCharge:10,RotateChargeSmall:2},C=R.clone(B);a.register("Misc","Model",B,function(a){R.extend(C,a)});var D=b("model",C),E=Object.create(D);return R.deepExtend(E,{create:t,state_checkers:[],state_updaters:[],checkState:w,descriptionFromInfo:y,user:u,userIs:v,modeFor:x,render:A},d(E),e(E),f(C,E),g(E),h(E),i(E),j(E),k(E),l(E),m(E),n(E),o(C,E),p(C,E),s(E),q(E),r(E)),R.curryService(E),E}angular.module("clickApp.services").factory("model",a),a.$inject=["settings","element","gameFactions","modelArea","modelAura","modelCharge","modelCounter","modelDamage","modelEffect","modelGeom","modelImage","modelIncorporeal","modelLeader","modelMelee","modelMove","modelPlace","modelRuler","modelUnit","modelWreck"]}(),function(){function a(a){var b=R.lensPath(["state","dsp"]),c=R.lensPath(["state","are"]);return function(){function d(c,d){return R.thread(c)(a.getModelInfo$(d.state.info),R.ifElse(R.isNil,function(){return!1},function(a){return"wardude"===a.type&&("Number"===R.type(a.focus)||"Number"===R.type(a.fury))&&!!R.find(R.equals("a"),R.viewOr([],b,d))}))}function e(a,c){var d=a?R.compose(R.uniq,R.append("a")):R.reject(R.equals("a"));return R.over(b,d,c)}function f(a){var c=R.find(R.equals("a"),a.state.dsp)?R.reject(R.equals("a")):R.append("a");return R.over(b,c,a)}function g(a){return R.exists(R.view(c,a))}function h(a){return R.view(c,a)}function i(a,b){return R.set(c,a,b)}function j(a,b){return R.over(c,function(b){return a===b?null:a},b)}function k(a,b,c){var d=a.info,e=a.radius,f=l.isAreaDisplayed({state:c})?10*l.areaDisplay({state:c})+e:null,g=l.isCtrlAreaDisplayed(b,{state:c})?20*(d.focus||d.fury)+e:null;return{area:f,ctrl:g}}var l={isCtrlAreaDisplayed:d,setCtrlAreaDisplay:e,toggleCtrlAreaDisplay:f,isAreaDisplayed:g,areaDisplay:h,setAreaDisplay:i,toggleAreaDisplay:j,renderArea:k};return l}}angular.module("clickApp.services").factory("modelArea",a),a.$inject=["gameFactions"]}(),function(){function a(){var a=R.lensPath(["state","aur"]);return function(){function b(b){return R.exists(R.view(a,b))}function c(b){return R.view(a,b)}function d(b,c){return R.set(a,b,c)}function e(b,c){return R.over(a,function(a){return b===a?null:b},c)}function f(a,b){var c=a.radius,d={show:g.isAuraDisplayed({state:b}),radius:1.2*c,color:g.auraDisplay({state:b})};return{aura:d}}var g={isAuraDisplayed:b,auraDisplay:c,setAuraDisplay:d,toggleAuraDisplay:e,renderAura:f};return g}}angular.module("clickApp.services").factory("modelAura",a),a.$inject=[]}(),function(){function a(a){var b=.1,c=R.lensProp("state"),d=R.lensPath(["state","cha"]),e=R.lensPath(["state","cha","t"]),f=R.lensPath(["state","cml"]);return function(g,h){function i(a){return R.threadP(a)(R.rejectIfP(h.isLocked,"Model is locked"),R.set(d,{s:R.pick(["x","y","r"],a.state),t:null}))}function j(a){return R.exists(R.view(d,a))}function k(a){return R.view(e,a)}function l(a){return R.set(d,null,a)}function m(b,f,g){return R.threadP(g)(R.rejectIfP(h.isLocked,"Model is locked"),function(b){return R.exists(f)?R.thread(b)(R.over(d,R.assoc("t",f.state.stamp)),R.over(c,R.assoc("r",a.directionTo(f.state,b.state)))):R.set(e,null,b)},h.checkState$(b,f))}function n(a){return R.view(f,a)}function o(a,b,c){return c=R.set(f,b,c),h.checkState(a,null,c)}function p(b,d,e,f){return R.threadP(f)(R.rejectIfP(h.isLocked,"Model is locked"),function(b){var d=g[e?"MoveSmall":"Move"],f=b.state.cha.s.r;return R.over(c,a.translateInDirection$(d,f),b)},h.checkState$(b,d))}function q(b,d,e,f){return R.threadP(f)(R.rejectIfP(h.isLocked,"Model is locked"),function(b){var d=g[e?"MoveSmall":"Move"],f=b.state.cha.s.r+180,h=a.distanceTo(b.state,b.state.cha.s);return d>h&&(d=h),R.over(c,a.translateInDirection$(d,f),b)},h.checkState$(b,d))}function r(b,d,e,f){return R.threadP(f)(R.rejectIfP(h.isLocked,"Model is locked"),function(b){var d=g[e?"RotateChargeSmall":"RotateCharge"];return R.thread(b)(R.over(c,a.rotateLeftAround$(d,b.state.cha.s)),R.over(R.lensPath(["state","cha","s","r"]),R.subtract(R.__,d)))},h.checkState$(b,d))}function s(b,d,e,f){return R.threadP(f)(R.rejectIfP(h.isLocked,"Model is locked"),function(b){var d=g[e?"RotateChargeSmall":"RotateCharge"];return R.thread(b)(R.over(c,a.rotateRightAround$(d,b.state.cha.s)),R.over(R.lensPath(["state","cha","s","r"]),R.add(d)))},h.checkState$(b,d))}function t(b,d,e,f){return R.threadP(f)(R.rejectIfP(h.isLocked,"Model is locked"),function(b){var d=g[e?"ShiftSmall":"Shift"];return R.over(c,a.shiftLeft$(d),b)},h.checkState$(b,d))}function u(b,d,e,f){return R.threadP(f)(R.rejectIfP(h.isLocked,"Model is locked"),function(b){var d=g[e?"ShiftSmall":"Shift"];return R.over(c,a.shiftRight$(d),b)},h.checkState$(b,d))}function v(b,d,e,f){return R.threadP(f)(R.rejectIfP(h.isLocked,"Model is locked"),function(b){var d=g[e?"ShiftSmall":"Shift"];return R.over(c,a.shiftUp$(d),b)},h.checkState$(b,d))}function w(b,d,e,f){return R.threadP(f)(R.rejectIfP(h.isLocked,"Model is locked"),function(b){var d=g[e?"ShiftSmall":"Shift"];return R.over(c,a.shiftDown$(d),b)},h.checkState$(b,d))}function x(b,c,d){if(R.exists(d.cha)&&R.exists(d.cml)&&d.cml>0){var e=a.distanceTo(d,d.cha.s);if(e>10*d.cml){var f=a.directionTo(d,d.cha.s),g=a.translateInDirection(10*d.cml,f,d.cha.s);return R.thread(d)(R.assoc("x",g.x),R.assoc("y",g.y))}}return d}function y(c,d,e){if(R.exists(e.cha)){if(R.exists(d))return R.assoc("r",a.directionTo(d.state,e),e);var f=a.distanceTo(e,e.cha.s),g=b>f?e.r:a.directionTo(e,e.cha.s);return R.assoc("r",g,e)}return e}function z(c){if(R.exists(c.cha)){var d=a.distanceTo(c,c.cha.s);if(d>b){var e=a.directionTo(c,c.cha.s);return R.assocPath(["cha","s","r"],e,c)}}return c}function A(b,c,d){var e=b.base,f=b.charge_target,g=b.radius,i={};if(h.isCharging({state:d})){c.show=!0;var j=d.cha.s.r,k=a.translateInDirection(400,j,d.cha.s);c.x=k.x-g,c.y=k.y-400,c.transform="rotate("+j+","+k.x+","+k.y+")";var l=a.distanceTo(d,d.cha.s),m=Math.round(10*l)/100+'"',n=h.chargeMaxLength({state:d});R.exists(n)&&(m+="/"+n+'"');var o={rotate:0,flip_center:d.cha.s,text_center:d.cha.s},p=e.renderText(o,m);if(p.show=!0,c.length=p,f){i.show=!0,i.cx=f.state.x,i.cy=f.state.y,i.radius=f.info.base_radius;var q=0;h.isMeleeDisplayed("mm",{state:d})&&(q=5),h.isMeleeDisplayed("mr",{state:d})&&(q=20),h.isMeleeDisplayed("ms",{state:d})&&(q=40);var r=a.distanceTo(f.state,d);i.reached=r<=q+g+f.info.base_radius}}return{charge_target:i}}var B={startChargeP:i,isCharging:j,chargeTarget:k,endCharge:l,setChargeTargetP:m,chargeMaxLength:n,setChargeMaxLength:o,moveFrontChargeP:p,moveBackChargeP:q,rotateLeftChargeP:r,rotateRightChargeP:s,shiftLeftChargeP:t,shiftRightChargeP:u,shiftUpChargeP:v,shiftDownChargeP:w,renderCharge:A},C=R.curry(x);h.state_checkers=R.append(C,h.state_checkers);var D=R.curry(y);h.state_checkers=R.append(D,h.state_checkers);var E=R.curry(z);return h.state_updaters=R.append(E,h.state_updaters),B}}angular.module("clickApp.services").factory("modelCharge",a),a.$inject=["point"]}(),function(){function a(){var a=R.lensPath(["state","dsp"]);return function(b){function c(b,c){return!!R.find(R.equals(b),R.viewOr([],a,c))}function d(a,b){var c=R.defaultTo(0,b.state[a])+1;return R.assocPath(["state",a],c,b)}function e(a,b){var c=Math.max(0,R.defaultTo(0,b.state[a])-1);return R.assocPath(["state",a],c,b)}function f(b,c,d){var e=c?R.compose(R.uniq,R.append(b)):R.reject(R.equals(b));return R.over(a,e,d)}function g(c,d){var e=b.isCounterDisplayed(c,d)?R.reject(R.equals(c)):R.append(c);return R.over(a,e,d)}function h(a,c){var d=a.base,e=a.cx,f=a.cy,g=a.is_flipped,h=a.radius,i={rotate:-c.r,flipped:g,flip_center:{x:e,y:f},text_center:{x:e,y:f+2}},j=d.renderText(i,c.c);j.show=b.isCounterDisplayed("c",{state:c});var k={rotate:-c.r,flip_center:{x:e,y:f},text_center:{x:e+.8*h+5,y:f-h-5}},l=d.renderText(k,c.s);return l.show=b.isCounterDisplayed("s",{state:c}),l.cx=l.x-10,l.cy=l.y-10,{counter:j,souls:l}}var i={isCounterDisplayed:c,incrementCounter:d,decrementCounter:e,setCounterDisplay:f,toggleCounterDisplay:g,renderCounter:h};return i}}angular.module("clickApp.services").factory("modelCounter",a),a.$inject=[]}(),function(){function a(a){var b=R.lensPath(["state","dmg"]),c=R.lensPath(["state","dmg","f"]);return function(){function d(a){function c(b,c){var d=a.state.dmg[c];return d="Array"===R.type(d)?R.map(R.always(0),d):0,R.assoc(c,d,b)}return R.over(b,R.pipe(R.keys,R.reduce(c,{})),a)}function e(c,d,e){return R.thread(c)(a.getModelInfo$(e.state.info),R.ifElse(R.isNil,function(){return e},function(a){var c=R.defaultTo(0,e.state.dmg.n);return c=c===d?0:d,c=Math.min(c,a.damage.n),R.over(b,R.pipe(R.assoc("n",c),R.assoc("t",c)),e)}))}function f(b,d,e){return R.thread(b)(a.getModelInfo$(e.state.info),R.ifElse(R.isNil,function(){return e},function(a){var b=R.defaultTo(0,e.state.dmg.f);return b=b===d?0:d,b=Math.min(b,a.damage.field),R.set(c,b,e)}))}function g(c,d,e,f){return R.thread(c)(a.getModelInfo$(f.state.info),R.ifElse(R.isNil,function(){return f},function(a){var c=f.state.dmg[e][d];return c=0===c?1:0,c=R.exists(a.damage[e][d])?c:0,R.over(b,R.pipe(R.over(R.lensProp(e),R.update(d,c)),function(a){return R.assoc("t",i(a),a)}),f)}))}function h(c,d,e){return R.thread(c)(a.getModelInfo$(e.state.info),R.ifElse(R.isNil,function(){return e},function(a){var c=R.thread(e.state.dmg[d])(R.addIndex(R.filter)(function(b,c){return R.exists(a.damage[d][c])}),R.reject(R.equals(1)),R.isEmpty),f=c?0:1;return R.over(b,R.pipe(R.over(R.lensProp(d),R.addIndex(R.map)(function(b,c){return R.exists(a.damage[d][c])?f:0})),function(a){return R.assoc("t",i(a),a)}),e)}))}function i(a){return R.thread(a)(R.keys,R.reject(R.equals("t")),R.reject(R.equals("f")),R.reject(R.equals("n")),R.reduce(function(b,c){return b+R.reduce(R.add,0,a[c])},0))}function j(a,b){var c=a.cx,d=a.cy,e=a.info,f=a.radius,g=R.propOr({},"dmg",b),h=g.t/e.damage.total,i=c-f+2*f*h,j={show:!("warrior"===e.damage.type&&1===e.damage.n),lx:c-f,ly:d+f+2,rx:c+f,ry:c+f+2,x:i},k=g.f/e.damage.field,l=c-f+2*f*k,m={show:R.exists(e.damage.field),lx:j.lx,ly:j.ly+1,rx:j.rx,ry:j.ry+1,x:l};return{dmg:j,field:m}}var k={resetDamage:d,setWarriorDamage:e,setFieldDamage:f,setGridDamage:g,setGridColDamage:h,renderDamage:j};return k}}angular.module("clickApp.services").factory("modelDamage",a),a.$inject=["gameFactions"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(){var a=[["b","/data/icons/Blind.png"],["c","/data/icons/Corrosion.png"],["d","/data/icons/BoltBlue.png"],["f","/data/icons/Fire.png"],["e","/data/icons/BoltYellow.png"],["k","/data/icons/KD.png"],["t","/data/icons/Stationary.png"]],b=R.lensPath(["state","eff"]);return function(c){function d(a,c){return!!R.find(R.equals(a),R.viewOr([],b,c))}function e(a,c,d){var e=c?R.compose(R.uniq,R.append(a),R.defaultTo([])):R.compose(R.reject(R.equals(a)),R.defaultTo([]));return R.over(b,e,d)}function f(a,d){var e=c.isEffectDisplayed(a,d)?R.compose(R.reject(R.equals(a)),R.defaultTo([])):R.compose(R.append(a),R.defaultTo([]));return R.over(b,e,d)}function g(b,c){var d=b.img,e=b.info,f=R.thread(a)(R.filter(function(a){var b=_slicedToArray(a,1),d=b[0];return h.isEffectDisplayed(d,{state:c})}),function(a){var b=d.width/2-10*R.length(a)/2,f=d.height/2+e.base_radius+1;return R.addIndex(R.reduce)(function(a,d,e){var g=_slicedToArray(d,2),i=g[0],j=g[1];return R.assoc(i,{show:h.isEffectDisplayed(i,{state:c}),x:b+10*e,y:f,link:j},a)},{},a)});return{effects:f}}var h={isEffectDisplayed:d,setEffectDisplay:e,toggleEffectDisplay:f,renderEffect:g};return h}}angular.module("clickApp.services").factory("modelEffect",a),a.$inject=[]}(),function(){function a(a,b){return function(c){function d(a,b,c){var d=R.path(["state","x"],c),e=R.path(["state","y"],c);return a.x<=d&&d<=b.x&&a.y<=e&&e<=b.y}function e(c,d,e){var f=b.getModelInfo(e.state.info,c),g=b.getModelInfo(d.state.info,c),h=a.directionTo(d.state,e.state),i=a.translateInDirection(f.base_radius,h,e.state),j=a.translateInDirection(g.base_radius,h+180,d.state);return{start:R.pick(["x","y"],i),end:R.pick(["x","y"],j)}}function f(c,d,e){var f=b.getModelInfo(e.state.info,c);return R.thread(e.state)(a.translateInDirection$(f.base_radius,d),R.pick(["x","y"]))}function g(c,d,e){var f=b.getModelInfo(e.state.info,c),g=b.getModelInfo(d.state.info,c);return a.distanceTo(d.state,e.state)-f.base_radius-g.base_radius}function h(c,d,e){var f=b.getModelInfo(e.state.info,c),g=d.state.s;return a.distanceTo(d.state,e.state)-f.base_radius-g}function i(d,e,f){var g=b.getModelInfo(f.state.info,d),h=b.getModelInfo(e.state.info,d);return R.threadP(f)(R.rejectIfP(c.isLocked,"Model is locked"),function(b){var f=a.directionTo(b.state,e.state),i=g.base_radius+h.base_radius,j=a.translateInDirection(i,f,e.state);return R.thread(b)(R.assocPath(["state","x"],j.x),R.assocPath(["state","y"],j.y),c.checkState$(d,null))})}var j={isBetweenPoints:d,shortestLineTo:e,baseEdgeInDirection:f,distanceTo:g,distanceToAoE:h,setB2BP:i};return j}}angular.module("clickApp.services").factory("modelGeom",a),a.$inject=["point","gameFactions"]}(),function(){function a(a){var b=R.lensPath(["state","dsp"]);return function(c){function d(a){return!!R.find(R.equals("i"),R.viewOr([],b,a))}function e(b,d){return R.thread(b)(a.getModelInfo$(d.state.info),R.prop("img"),function(a){var b=R.thread(a)(R.filter(R.propEq("type","default")),R.prop(d.state.img));c.isLeaderDisplayed(d)&&(b=R.thread(a)(R.filter(R.propEq("type","leader")),R.head,R.defaultTo(b))),c.isIncorporealDisplayed(d)&&(b=R.thread(a)(R.filter(R.propEq("type","incorporeal")),R.head,R.defaultTo(b)));var e=c.isImageDisplayed(d)?b.link:null;return R.assoc("link",e,b)})}function f(b,c){return R.thread(b)(a.getModelInfo$(c.state.info),R.prop("img"),R.filter(R.propEq("type","default")),function(a){return c.state.img>=a.length-1?0:c.state.img+1},function(a){return R.assocPath(["state","img"],a,c)})}function g(a,c){var d=a?R.compose(R.uniq,R.append("i")):R.reject(R.equals("i"));return R.over(b,d,c)}function h(a){var d=c.isImageDisplayed(a)?R.reject(R.equals("i")):R.append("i");return R.over(b,d,a)}function i(a,b){var c=a.img;return{img:c.link}}var j={isImageDisplayed:d,getImage:e,setNextImage:f,setImageDisplay:g,toggleImageDisplay:h,renderImage:i};return j}}angular.module("clickApp.services").factory("modelImage",a),a.$inject=["gameFactions"]}(),function(){function a(){var a=R.lensPath(["state","dsp"]);return function(b){function c(b){return!!R.find(R.equals("in"),R.viewOr([],a,b))}function d(b,c){var d=b?R.compose(R.uniq,R.append("in")):R.reject(R.equals("in"));return R.over(a,d,c)}function e(c){var d=b.isIncorporealDisplayed(c)?R.reject(R.equals("in")):R.append("in");return R.over(a,d,c)}var f={isIncorporealDisplayed:c,setIncorporealDisplay:d,toggleIncorporealDisplay:e};return f}}angular.module("clickApp.services").factory("modelIncorporeal",a),a.$inject=[]}(),function(){function a(){var a=R.lensPath(["state","dsp"]);return function(b){function c(b){return!!R.find(R.equals("l"),R.viewOr([],a,b))}function d(b,c){var d=b?R.compose(R.uniq,R.append("l")):R.reject(R.equals("l"));return R.over(a,d,c)}function e(c){var d=b.isLeaderDisplayed(c)?R.reject(R.equals("l")):R.append("l");return R.over(a,d,c)}function f(a,c){var d=a.cx,e=a.cy,f=a.radius,g={l:{show:b.isLeaderDisplayed({state:c}),link:"/data/icons/Leader.png",x:d-.7*f-5,y:e-.7*f-5}};return{effects:g}}var g={isLeaderDisplayed:c,setLeaderDisplay:d,toggleLeaderDisplay:e,renderLeader:f};return g}}angular.module("clickApp.services").factory("modelLeader",a),a.$inject=[]}(),function(){function a(){var a=R.lensPath(["state","dsp"]);return function(b){function c(b,c){return!!R.find(R.equals(b),R.viewOr([],a,c))}function d(b,c,d){var e=c?R.compose(R.uniq,R.append(b)):R.reject(R.equals(b));return R.over(a,e,d)}function e(c,d){var e=b.isMeleeDisplayed(c,d)?R.reject(R.equals(c)):R.append(c);return R.over(a,e,d)}function f(a,b){var c=a.img,d=a.info,e={melee:{show:h.isMeleeDisplayed("mm",{state:b}),path:g(5,c,d)},reach:{show:h.isMeleeDisplayed("mr",{state:b}),path:g(20,c,d)},strike:{show:h.isMeleeDisplayed("ms",{state:b}),path:g(40,c,d)}};return{melee:e}}function g(a,b,c){return["M"+(b.width/2-c.base_radius-a)+","+b.height/2,"L"+(b.width/2+c.base_radius+a)+","+b.height/2,"A"+(c.base_radius+a)+","+(c.base_radius+a)+" 0 0,0",b.width/2-c.base_radius-a+","+b.height/2,"M"+b.width/2+","+b.height/2,"L"+b.width/2+","+(b.height/2-c.base_radius-a)].join(" ")}var h={isMeleeDisplayed:c,setMeleeDisplay:d,toggleMeleeDisplay:e,renderMelee:f};return h}}angular.module("clickApp.services").factory("modelMelee",a),a.$inject=[]}(),function(){function a(a){var b=R.lensProp("state"),c=R.lensPath(["state","x"]),d=R.lensPath(["state","y"]);return function(e,f){function g(a,b){return function(){for(var c=this,d=arguments.length,e=Array(d),g=0;d>g;g++)e[g]=arguments[g];var h=R.last(e),i=R.head(e),j=b?R.nth(1,e):null;return R.threadP(h)(R.rejectIfP(f.isLocked,"Model is locked"),function(){return a.apply(c,e)},f.checkState$(i,j))}}function h(a,b,e,f){return R.pipe(R.set(c,e.x),R.set(d,e.y))(f)}function i(a,b,e,g){return R.threadP(g)(R.rejectIfP(f.isLocked,"Model is locked"),R.set(c,e.x),R.set(d,e.y),f.checkState$(a,b),function(a){return g.state=a.state,g})}function j(a,b,e,f){return R.pipe(R.over(c,R.add(e.x)),R.over(d,R.add(e.y)))(f)}function k(a,b,c){return R.assocPath(["state","r"],b,c)}function l(b,c,d){return R.assocPath(["state","r"],a.directionTo(c.state,d.state),d)}function m(c,d,f){var g=e[d?"MoveSmall":"Move"];return R.over(b,a.moveFront$(g),f)}function n(c,d,f){var g=e[d?"MoveSmall":"Move"];return R.over(b,a.moveBack$(g),f)}function o(c,d,f){var g=e[d?"RotateSmall":"Rotate"];return R.over(b,a.rotateLeft$(g),f)}function p(c,d,f){var g=e[d?"RotateSmall":"Rotate"];return R.over(b,a.rotateRight$(g),f)}function q(c,d,f){var g=e[d?"ShiftSmall":"Shift"];return R.over(b,a.shiftLeft$(g),f)}function r(c,d,f){var g=e[d?"ShiftSmall":"Shift"];return R.over(b,a.shiftRight$(g),f)}function s(c,d,f){var g=e[d?"ShiftSmall":"Shift"];return R.over(b,a.shiftUp$(g),f)}function t(c,d,f){var g=e[d?"ShiftSmall":"Shift"];return R.over(b,a.shiftDown$(g),f)}var u={
setPositionP:g(h,!0),setPositionP_:i,shiftPositionP:g(j,!0),setOrientationP:g(k,!1),orientToP:g(l,!1),moveFrontP:g(m,!1),moveBackP:g(n,!1),rotateLeftP:g(o,!1),rotateRightP:g(p,!1),shiftLeftP:g(q,!1),shiftRightP:g(r,!1),shiftUpP:g(s,!1),shiftDownP:g(t,!1)};return u}}angular.module("clickApp.services").factory("modelMove",a),a.$inject=["point"]}(),function(){function a(a){var b=.1,c=R.lensProp("state"),d=R.lensPath(["state","pla"]),e=R.lensPath(["state","pml"]);return function(f,g){function h(a){return R.threadP(a)(R.rejectIfP(g.isLocked,"Model is locked"),R.set(d,{s:R.pick(["x","y","r"],a.state)}))}function i(a){return R.exists(R.view(d,a))}function j(a){return R.set(d,null,a)}function k(b,d,e){return R.threadP(e)(R.rejectIfP(g.isLocked,"Model is locked"),function(){var b=a.directionTo(e.state.pla.s,d.state);return R.thread(e)(R.over(c,a.rotateAroundTo$(b,e.state.pla.s)),R.assocPath(["state","pla","s","r"],b))},g.checkState$(b,null))}function l(b,d,e){return R.threadP(e)(R.rejectIfP(g.isLocked,"Model is locked"),function(){var b=a.directionTo(d.state,e.state.pla.s);return R.thread(e)(R.over(c,a.rotateAroundTo$(b,e.state.pla.s)),R.assocPath(["state","pla","s","r"],b))},g.checkState$(b,null))}function m(a){return R.head(R.view(e,a))}function n(a,b,c){return c=R.set(e,[b,R.viewOr([],e,c)[1]],c),g.checkState(a,null,c)}function o(a){return R.nth(1,R.viewOr([],e,a))}function p(a,b,c){return c=R.set(e,[R.viewOr([],e,c)[0],b],c),g.checkState(a,null,c)}function q(b,d,e){return R.threadP(e)(R.rejectIfP(g.isLocked,"Model is locked"),function(){var b=f[d?"MoveSmall":"Move"],g=e.state.pla.s.r;return R.over(c,a.translateInDirection$(b,g),e)},g.checkState$(b,null))}function r(b,d,e){return R.threadP(e)(R.rejectIfP(g.isLocked,"Model is locked"),function(){var b=f[d?"MoveSmall":"Move"],g=e.state.pla.s.r+180,h=a.distanceTo(e.state,e.state.pla.s);return b>h&&(b=h),R.over(c,a.translateInDirection$(b,g),e)},g.checkState$(b,null))}function s(b,d,e){return R.threadP(e)(R.rejectIfP(g.isLocked,"Model is locked"),function(){var b=f[d?"RotateChargeSmall":"RotateCharge"];return R.thread(e)(R.over(c,a.rotateLeftAround$(b,e.state.pla.s)),R.over(R.lensPath(["state","pla","s","r"]),R.subtract(R.__,b)))},g.checkState$(b,null))}function t(b,d,e){return R.threadP(e)(R.rejectIfP(g.isLocked,"Model is locked"),function(){var b=f[d?"RotateChargeSmall":"RotateCharge"];return R.thread(e)(R.over(c,a.rotateRightAround$(b,e.state.pla.s)),R.over(R.lensPath(["state","pla","s","r"]),R.add(b)))},g.checkState$(b,null))}function u(b,d,e){return R.threadP(e)(R.rejectIfP(g.isLocked,"Model is locked"),function(){var b=f[d?"ShiftSmall":"Shift"];return R.over(c,a.shiftLeft$(b),e)},g.checkState$(b,null))}function v(b,d,e){return R.threadP(e)(R.rejectIfP(g.isLocked,"Model is locked"),function(){var b=f[d?"ShiftSmall":"Shift"];return R.over(c,a.shiftRight$(b),e)},g.checkState$(b,null))}function w(b,d,e){return R.threadP(e)(R.rejectIfP(g.isLocked,"Model is locked"),function(){var b=f[d?"ShiftSmall":"Shift"];return R.over(c,a.shiftUp$(b),e)},g.checkState$(b,null))}function x(b,d,e){return R.threadP(e)(R.rejectIfP(g.isLocked,"Model is locked"),function(){var b=f[d?"ShiftSmall":"Shift"];return R.over(c,a.shiftDown$(b),e)},g.checkState$(b,null))}function y(b,c,d){if(R.exists(d.pla)&&R.exists(d.pml)&&d.pml[0]>0){var e=a.distanceTo(d,d.pla.s),f=10*d.pml[0]+(d.pml[1]?2*b.base_radius:0);if(e>f){var g=a.directionTo(d,d.pla.s),h=a.translateInDirection(f,g,d.pla.s);return R.thread(d)(R.assoc("x",h.x),R.assoc("y",h.y))}}return d}function z(c){if(R.exists(c.pla)){var d=a.distanceTo(c,c.pla.s);if(d>b){var e=a.directionTo(c,c.pla.s);return R.assocPath(["pla","s","r"],e,c)}}return c}function A(b,c){var d=b.base,e=b.info,f=b.path;if(g.isPlacing({state:c})){f.show=!0;var h=c.pla.s.r,i=a.translateInDirection(400,h,c.pla.s);f.x=i.x-e.base_radius,f.y=i.y-400,f.transform="rotate("+h+","+i.x+","+i.y+")";var j=a.distanceTo(c,c.pla.s),k=Math.round(10*j)/100+'"',l=g.placeWithin({state:c}),m=g.placeMaxLength({state:c});R.exists(m)&&(k+="/"+(l?"w.":"")+m+'"');var n={rotate:0,flip_center:c.pla.s,text_center:c.pla.s},o=d.renderText(n,k);o.show=!0,f.length=o}return{}}var B={startPlaceP:h,isPlacing:i,endPlace:j,setPlaceOriginP:k,setPlaceTargetP:l,placeMaxLength:m,setPlaceMaxLengthP:n,placeWithin:o,setPlaceWithinP:p,moveFrontPlaceP:q,moveBackPlaceP:r,rotateLeftPlaceP:s,rotateRightPlaceP:t,shiftLeftPlaceP:u,shiftRightPlaceP:v,shiftUpPlaceP:w,shiftDownPlaceP:x,renderPlace:A},C=R.curry(y);g.state_checkers=R.append(C,g.state_checkers);var D=R.curry(z);return g.state_updaters=R.append(D,g.state_updaters),B}}angular.module("clickApp.services").factory("modelPlace",a),a.$inject=["point"]}(),function(){function a(){var a=R.lensPath(["state","rml"]);return function(){function b(b){return R.view(a,b)}function c(b,c){return R.set(a,b,c)}var d={rulerMaxLength:b,setRulerMaxLength:c};return d}}angular.module("clickApp.services").factory("modelRuler",a),a.$inject=[]}(),function(){function a(){var a=R.lensPath(["state","dsp"]),b=R.lensPath(["state","u"]);return function(c){function d(b){return!!R.find(R.equals("u"),R.viewOr([],a,b))}function e(a){return R.viewOr(0,b,a)}function f(a,c){return a===R.view(b,c)}function g(a,c){return R.set(b,a,c)}function h(b,c){var d=b?R.compose(R.uniq,R.append("u")):R.reject(R.equals("u"));return R.over(a,d,c)}function i(b){var d=c.isUnitDisplayed(b)?R.reject(R.equals("u")):R.append("u");return R.over(a,d,b)}function j(a,b){var d=a.base,e=a.cx,f=a.cy,g=a.radius,h={rotate:-b.r,flip_center:{x:e,y:f},text_center:{x:e-.7*g-5,y:f-.7*g-5}},i=d.renderText(h,"U"+c.unit({state:b}));return i.show=c.isUnitDisplayed({state:b}),i.cx=i.x-10,i.cy=i.y-10,{unit:i}}var k={isUnitDisplayed:d,unit:e,unitIs:f,setUnit:g,setUnitDisplay:h,toggleUnitDisplay:i,renderUnit:j};return k}}angular.module("clickApp.services").factory("modelUnit",a),a.$inject=[]}(),function(){function a(a){var b=R.lensPath(["state","dsp"]);return function(c){function d(a){return!!R.find(R.equals("w"),R.viewOr([],b,a))}function e(b,d){return R.thread(b)(a.getModelInfo$(d.state.info),R.prop("img"),function(a){return R.thread(a)(R.find(R.propEq("type","wreck")),R.defaultTo(R.thread(a)(R.find(R.propEq("type","default")),R.defaultTo({}),R.assoc("link",null))))},function(a){var b=c.isImageDisplayed(d)?a.link:null;return R.assoc("link",b,a)})}function f(a,c){var d=a?R.compose(R.uniq,R.append("w")):R.reject(R.equals("w"));return R.over(b,d,c)}function g(a){var d=c.isWreckDisplayed(a)?R.reject(R.equals("w")):R.append("w");return R.over(b,d,a)}var h={isWreckDisplayed:d,getWreckImage:e,setWreckDisplay:f,toggleWreckDisplay:g};return h}}angular.module("clickApp.services").factory("modelWreck",a),a.$inject=["gameFactions"]}(),function(){function a(a){function b(a){r[a.name]=a}function c(){var a={register:r};return Mousetrap.reset(),m("Default",a)}function d(a){return o(a)}function e(a){return R.propOr("Unknown","name",l(a))}function f(a){return R.propOr({},"actions",l(a))}function g(a){return R.propOr({},"bindings",l(a))}function h(a){return R.propOr({},"buttons",l(a))}function i(a){return R.thread(a)(s.currentModeBindings,R.toPairsIn,R.sortBy(R.head))}function j(a,b,c){var d=s.currentModeName(c);return R.thread(c)(l,R.path(["actions",a]),R.ifElse(R.exists,function(a){return a.apply(null,b)},function(){return R.rejectP('Unknown action "'+a+'" in "'+d+'" mode')}))}function k(b,c){var d=l(c);return R.thread(c)(R.path(["register",b]),R.ifElse(R.isNil,function(){return a.emit("Game.error","Mode "+b+" does not exist"),c},function(){return R.thread(c)(n,t(b),R.spy("Modes: switch mode from "+d.name+" to "+b))}))}function l(){var a=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return R.pathOr({},["register",R.propOr("##","current",a)],a)}function m(a,b){return R.thread(b)(R.path(["register",a]),R.when(function(a){return R.exists(a.onEnter)},function(a){return a.onEnter()}),function(){return R.assoc("current",a,b)},p)}function n(a){return R.thread(a)(l,R.when(function(a){return R.exists(a.onLeave)},function(a){return a.onLeave()}),function(){return o(a)},R.assoc("current",null))}function o(a){return Mousetrap.reset(),a}function p(a){return q(l(a)),a}function q(b){function c(a){Mousetrap.bind(b.bindings[a],d(a))}function d(b){return function(c,d){return a.reduce("Modes.current.action",b,[c]),!1}}var e=R.keys(b.bindings),f=R.keysIn(b.bindings),g=R.difference(f,e);R.forEach(c,g),R.forEach(c,e)}var r={},s={registerMode:b,init:c,exit:d,currentModeName:e,currentModeActions:f,currentModeBindings:g,currentModeButtons:h,currentModeBindingsPairs:i,currentModeActionP:j,switchToMode:k},t=R.curry(m);return R.curryService(s),s}angular.module("clickApp.services").factory("modes",a).factory("allModes",["defaultMode","rulerMode","losMode","createModelMode","modelsMode","modelMode","modelChargeMode","modelPlaceMode","createTemplateMode","aoeTemplateMode","sprayTemplateMode","wallTemplateMode","createTerrainMode","terrainMode",function(){return{}}]),a.$inject=["appState"]}(),function(){function a(a,b){function c(){b.chainReduce("Modes.switchTo","Default")}function d(){b.chainReduce("Game.command.undoLast")}function e(){b.chainReduce("Game.command.replayNext")}function f(){b.emit("Game.view.scrollLeft")}function g(){b.emit("Game.view.scrollRight")}function h(){b.emit("Game.view.scrollUp")}function i(){b.emit("Game.view.scrollDown")}function j(){b.emit("Game.view.zoomIn")}function k(){b.emit("Game.view.zoomOut")}function l(){b.emit("Game.view.zoomReset")}function m(){b.chainReduce("Game.uiState.flip")}function n(){b.emit("Game.toggleMenu")}var o={DragEpsilon:3,ScrollStep:30,ZoomFactor:2},p=R.clone(o),q={modeBackToDefault:c,commandUndoLast:d,commandReplayNext:e,viewScrollLeft:f,viewScrollRight:g,viewScrollUp:h,viewScrollDown:i,viewZoomIn:j,viewZoomOut:k,viewZoomReset:l,flipMap:m,toggleMenu:n},r={modeBackToDefault:"esc",commandUndoLast:"ctrl+z",commandReplayNext:"ctrl+y",viewScrollLeft:"alt+left",viewScrollRight:"alt+right",viewScrollUp:"alt+up",viewScrollDown:"alt+down",viewZoomIn:"alt++",viewZoomOut:"alt+-",viewZoomReset:"alt+z",flipMap:"ctrl+shift+f",toggleMenu:"ctrl+shift+m"},s={name:"Common",actions:q,buttons:[],bindings:R.clone(r),settings:function(){return p}};return a.register("Misc",s.name,o,function(a){R.extend(p,a)}),a.register("Bindings",s.name,r,function(a){R.extend(s.bindings,a)}),s}angular.module("clickApp.services").factory("commonMode",a),a.$inject=["settings","appState"]}(),function(){function a(a,b){var c=R.lensProp("create");return function(d){function e(){a.emit("Game.moveMap.enable")}function f(){a.emit("Game.moveMap.disable")}function g(a){return b.actions.modeBackToDefault(),R.set(c,{},a)}function h(a,b){return R.over(c,p(b),a)}function i(b,e){var f=R.path(["ui_state","flip_map"],b),g=R.thread(b)(R.view(c),p(e["click#"]),R.assoc("factions",b.factions));return a.chainReduce("Game.command.execute","create"+s.capitalize(d),[g,f]),R.set(c,{},b)}function j(a,b){return R.over(R.lensProp("base"),R.pipe(R.assoc("x",a.x),R.assoc("y",a.y)),b)}var k=Object.create(b.actions);k.modeBackToDefault=g,k.moveMap=h,k.create=i;var l={create:"clickMap"},m=R.extend(Object.create(b.bindings),l),n=[],o={onEnter:e,onLeave:f,name:"Create"+s.capitalize(d),actions:k,buttons:n,bindings:m},p=R.curry(j);return o}}angular.module("clickApp.services").factory("createElementMode",a),a.$inject=["appState","commonMode"]}(),function(){function a(a,b,c){var d=a("model");return b.registerMode(d),c.register("Bindings",d.name,d.bindings,function(a){R.extend(d.bindings,a)}),d}angular.module("clickApp.services").factory("createModelMode",a),a.$inject=["createElementMode","modes","settings"]}(),function(){function a(a,b,c){var d=a("template");return b.registerMode(d),c.register("Bindings",d.name,d.bindings,function(a){R.extend(d.bindings,a)}),d}angular.module("clickApp.services").factory("createTemplateMode",a),a.$inject=["createElementMode","modes","settings"]}(),function(){function a(a,b,c){var d=a("terrain");return b.registerMode(d),c.register("Bindings",d.name,d.bindings,function(a){R.extend(d.bindings,a)}),d}angular.module("clickApp.services").factory("createTerrainMode",a),a.$inject=["createElementMode","modes","settings"]}(),function(){function a(a,e,f,g,h,i,j,k){function l(b,c){var d=c["click#"].target.state.stamp;return a.chainReduce("Game.command.execute","setModelSelection",["set",[d]]),R.thread(b)(w,x)}function m(c,d){var e=d["click#"].target.state.stamp,f=i["in"]("local",e,R.view(b,c));return f?a.chainReduce("Game.command.execute","setModelSelection",["removeFrom",[e]]):a.chainReduce("Game.command.execute","setModelSelection",["addTo",[e]]),R.threadP(c)(w,x)}function n(b,c){return a.emit("Game.selectionDetail.open","model",c["click#"].target),l(b,c)}function o(a,b){return R.thread(a)(x,R.over(d,j.set$("local",[b["click#"].target.state.stamp])))}function p(b,c){return a.emit("Game.selectionDetail.open","template",c["click#"].target),o(b,c)}function q(a,b){return R.thread(a)(w,R.over(c,k.set$("local",[b["click#"].target.state.stamp])))}function r(b){return a.chainReduce("Modes.switchTo","Ruler")}function s(b){return a.chainReduce("Modes.switchTo","Los")}function t(b,c){a.emit("Game.dragBox.enable",c.start,c.now)}function u(b,c){a.emit("Game.dragBox.enable",c.start,c.now)}function v(b,c){a.emit("Game.dragBox.disable");var d={x:Math.min(c.now.x,c.start.x),y:Math.min(c.now.y,c.start.y)},e={x:Math.max(c.now.x,c.start.x),y:Math.max(c.now.y,c.start.y)};R.thread(b.game)(R.prop("models"),function(a){return h.findStampsBetweenPoints(d,e,a)},function(b){R.isEmpty(b)||a.chainReduce("Game.command.execute","setModelSelection",["set",b])})}function w(a){return R.over(d,R.unless(j.isEmpty$("local"),j.clear$("local")),a)}function x(a){return R.over(c,R.unless(k.isEmpty$("local"),k.clear$("local")),a)}var y=Object.create(g.actions);y.setModelSelection=l,y.toggleModelSelection=m,y.modelSelectionDetail=n,y.selectTemplate=o,y.templateSelectionDetail=p,y.selectTerrain=q,y.enterRulerMode=r,y.enterLosMode=s,y.dragStartMap=t,y.dragMap=u,y.dragEndMap=v;var z={enterRulerMode:"ctrl+r",enterLosMode:"ctrl+l",setModelSelection:"clickModel",toggleModelSelection:"ctrl+clickModel",modelSelectionDetail:"rightClickModel",selectTemplate:"clickTemplate",templateSelectionDetail:"rightClickTemplate",selectTerrain:"clickTerrain"},A=R.extend(Object.create(g.bindings),z),B=[],C={name:"Default",actions:y,buttons:B,bindings:A};return e.registerMode(C),f.register("Bindings",C.name,z,function(a){R.extend(C.bindings,a)}),C}angular.module("clickApp.services").factory("defaultMode",a),a.$inject=["appState","modes","settings","commonMode","gameModels","gameModelSelection","gameTemplateSelection","gameTerrainSelection"];var b=R.lensPath(["game","model_selection"]),c=R.lensPath(["game","terrain_selection"]),d=R.lensPath(["game","template_selection"])}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b){return function(c,d,e,f){function g(a){return R.over(q,f.clear$("local"),a)}function h(b){var d=R.thread(b)(R.view(q),f.get$("local"));return R.thread(b)(R.view(p),e.copyStamps$(d),R.assoc("create",R.__,b),R.tap(function(){a.chainReduce("Modes.switchTo","Create"+s.capitalize(c))}))}function i(b){var d=R.thread(b)(R.view(q),f.get$("local"));a.chainReduce("Game.command.execute","delete"+s.capitalize(c),[d])}function j(b){var g=R.thread(b)(R.view(q),f.get$("local"));return R.thread(b)(R.view(p),e.findStamp$(g[0]),R.when(R.exists,function(b){var e=d.isLocked(b);a.chainReduce("Game.command.execute","lock"+s.capitalize(c)+"s",[!e,g])}))}function k(b){var d=_slicedToArray(b,1),e=d[0];r[e]=function(b){var d=R.thread(b)(R.view(q),f.get$("local"));a.chainReduce("Game.command.execute","on"+s.capitalize(c)+"s",[e+"P",[!1],d])},r[e+"Small"]=function(b){var d=R.thread(b)(R.view(q),f.get$("local"));a.chainReduce("Game.command.execute","on"+s.capitalize(c)+"s",[e+"P",[!0],d])}}function l(b){var d=_slicedToArray(b,3),e=d[0],g=(d[1],d[2]);r[e]=function(b){var d=R.thread(b)(R.view(q),f.get$("local")),h=R.path(["ui_state","flip_map"],b)?g:e;a.chainReduce("Game.command.execute","on"+s.capitalize(c)+"s",[h+"P",[!1],d])},r[e+"Small"]=function(b){var d=R.thread(b)(R.view(q),f.get$("local")),h=R.path(["ui_state","flip_map"],b)?g:e;a.chainReduce("Game.command.execute","on"+s.capitalize(c)+"s",[h+"P",[!0],d])}}function m(){function e(a,b){var e=b.target;return d.isLocked(e)?R.rejectP(s.capitalize(c)+" is locked"):(j=R.clone(b.target.state),i(b,b.target.state),R.over(q,f.set$("local",[b.target.state.stamp]),a))}function g(b,e){return R.threadP(e.target)(R.rejectIfP(d.isLocked,s.capitalize(c)+" is locked"),function(){i(e,e.target.state),a.emit("Game."+c+".change."+e.target.state.stamp)})}function h(b,e){return R.threadP(e.target)(R.rejectIfP(d.isLocked,s.capitalize(c)+" is locked"),function(){e.target.state=R.clone(j);var b=R.clone(j);i(e,b),a.chainReduce("Game.command.execute","on"+s.capitalize(c)+"s",["setPositionP",[b],[e.target.state.stamp]])})}function i(a,b){var c=a.now.x-a.start.x,d=a.now.y-a.start.y;b.x=j.x+c,b.y=j.y+d}r["dragStart"+s.capitalize(c)]=e,b.actions["dragStart"+s.capitalize(c)]=e,r["drag"+s.capitalize(c)]=g,r["dragEnd"+s.capitalize(c)]=h;var j=void 0}function n(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];v[c]=d,v[c+"Small"]="shift+"+d}function o(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];v[c]=d,v[c+"Small"]="shift+"+d}var p=R.lensPath(["game",c+"s"]),q=R.lensPath(["game",c+"_selection"]),r=Object.create(b.actions);r.modeBackToDefault=g,r.clickMap=g,r.rightClickMap=g,r.copySelection=h,r["delete"]=i,r.toggleLock=j;var t=[["moveFront","up"],["moveBack","down"],["rotateLeft","left"],["rotateRight","right"]];R.forEach(k,t);var u=[["shiftUp","ctrl+up","shiftDown"],["shiftDown","ctrl+down","shiftUp"],["shiftLeft","ctrl+left","shiftRight"],["shiftRight","ctrl+right","shiftLeft"]];R.forEach(l,u),m();var v={clickMap:"clickMap",rightClickMap:"rightClickMap",copySelection:"ctrl+c","delete":"del",toggleLock:"l"};R.forEach(n,t),R.forEach(o,u);var w=R.extend(Object.create(b.bindings),v),x=[["Delete","delete"],["Lock/Unlock","toggleLock"]],y={onEnter:function(){},onLeave:function(){},name:s.capitalize(c),actions:r,buttons:x,bindings:w};return y}}angular.module("clickApp.services").factory("elementMode",a),a.$inject=["appState","defaultMode"]}(),function(){function a(a,b,c){function d(b,c){return a.chainReduce("Game.command.execute","setLos",["setOrigin",[c["click#"].target]])}function e(b,c){return a.chainReduce("Game.command.execute","setLos",["setTarget",[c["click#"].target]])}function f(b,c){return a.chainReduce("Game.command.execute","setLos",["toggleIgnoreModel",[c["click#"].target]])}var g={exitLosMode:"ctrl+l",toggleIgnoreModel:"clickModel",setOriginModel:"ctrl+clickModel",setTargetModel:"shift+clickModel"},h=b("los",c,g);return h.actions.setOriginModel=d,h.actions.setTargetModel=e,h.actions.toggleIgnoreModel=f,h}angular.module("clickApp.services").factory("losMode",a),a.$inject=["appState","segmentMode","gameLos"]}(),function(){function a(a,b,c,d,e,f){function g(b){var c=f.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","onModels",["startChargeP",[],c]),a.chainReduce("Modes.switchTo","ModelCharge")}function h(b){var c=f.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","onModels",["startPlaceP",[],c]),a.chainReduce("Modes.switchTo","ModelPlace")}var i=Object.create(e.actions);i.startCharge=g,i.startPlace=h;var j={startCharge:"c",startPlace:"p"},k=R.extend(Object.create(e.bindings),j),l=d.buildButtons({single:!0,start_charge:!0,start_place:!0}),m={onEnter:function(){},onLeave:function(){},name:"Model",actions:i,buttons:l,bindings:k};return b.registerMode(m),c.register("Bindings",m.name,j,function(a){R.extend(m.bindings,a)}),m}angular.module("clickApp.services").factory("modelMode",a),a.$inject=["appState","modes","settings","modelsMode","modelBaseMode","gameModelSelection"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g,h){function i(){a.chainReduce("Game.command.execute","setModelSelection",["clear",null])}function j(b){var c=g.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","deleteModel",[c])}function k(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.copyStamps$(c),function(b){a.chainReduce("Game.model.copy",b)})}function l(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,R.pipe(e.isLocked,function(b){a.chainReduce("Game.command.execute","lockModels",[!b,c])})))}function m(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),e.isImageDisplayed,function(b){a.chainReduce("Game.command.execute","onModels",["setImageDisplay",[!b],c])})}function n(b){var c=g.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","onModels",["setNextImage",[b.factions],c])}function o(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),e.isWreckDisplayed,function(b){a.chainReduce("Game.command.execute","onModels",["setWreckDisplay",[!b],c])})}function p(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,R.pipe(e.isUnitDisplayed,function(b){a.chainReduce("Game.command.execute","onModels",["setUnitDisplay",[!b],c])})))}function q(b){var c=g.get("local",b.game.model_selection);return R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,function(b){return R.threadP(b)(e.unit,R.defaultTo(0),function(a){return h.promptP("prompt","Set unit number :",a)["catch"](R.always(null))},function(b){a.chainReduce("Game.command.execute","onModels",["setUnit",[b],c])})}))}function r(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,R.pipe(e.isMeleeDisplayed$("mm"),function(b){a.chainReduce("Game.command.execute","onModels",["setMeleeDisplay",["mm",!b],c])})))}function s(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,R.pipe(e.isMeleeDisplayed$("mr"),function(b){a.chainReduce("Game.command.execute","onModels",["setMeleeDisplay",["mr",!b],c])})))}function t(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,R.pipe(e.isMeleeDisplayed$("ms"),function(b){a.chainReduce("Game.command.execute","onModels",["setMeleeDisplay",["ms",!b],c])})))}function u(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),e.isCounterDisplayed$("c"),function(b){a.chainReduce("Game.command.execute","onModels",["setCounterDisplay",["c",!b],c])})}function v(b){var c=g.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","onModels",["incrementCounter",["c"],c])}function w(b){var c=g.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","onModels",["decrementCounter",["c"],c])}function x(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),e.isCounterDisplayed$("s"),function(b){a.chainReduce("Game.command.execute","onModels",["setCounterDisplay",["s",!b],c])})}function y(b){var c=g.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","onModels",["incrementCounter",["s"],c])}function z(b){var c=g.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","onModels",["decrementCounter",["s"],c])}function A(b){var c=g.get("local",b.game.model_selection);return R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,function(b){return R.threadP(b)(e.rulerMaxLength,R.defaultTo(0),function(a){return h.promptP("prompt","Set ruler max length :",a)["catch"](R.always(null))},function(a){return 0===a?null:a},function(b){a.chainReduce("Game.command.execute","onModels",["setRulerMaxLength",[b],c])})}))}function B(b){var c=g.get("local",b.game.model_selection);return R.threadP(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,function(d){return R.threadP(d)(e.chargeMaxLength,function(a){return h.promptP("prompt","Set charge max length :",a)["catch"](R.always(null))},function(a){return 0===a?null:a},function(d){a.chainReduce("Game.command.execute","onModels",["setChargeMaxLength",[b.factions,d],c])})}))}function C(b){var c=g.get("local",b.game.model_selection);return R.threadP(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,function(d){return R.threadP(d)(e.placeMaxLength,R.defaultTo(0),function(a){return h.promptP("prompt","Set place max length :",a)["catch"](R.always(null))},function(a){return 0===a?null:a},function(d){a.chainReduce("Game.command.execute","onModels",["setPlaceMaxLengthP",[b.factions,d],c])})}))}function D(b){var c=g.get("local",b.game.model_selection);return R.threadP(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,R.pipe(e.placeWithin,function(d){a.chainReduce("Game.command.execute","onModels",["setPlaceWithinP",[b.factions,!d],c])})))}function E(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,R.pipe(e.isLeaderDisplayed,function(b){a.chainReduce("Game.command.execute","onModels",["setLeaderDisplay",[!b],c])})))}function F(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),e.isIncorporealDisplayed,function(b){a.chainReduce("Game.command.execute","onModels",["setIncorporealDisplay",[!b],c])})}function G(b){function c(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,R.pipe(e.isEffectDisplayed$(i),function(b){a.chainReduce("Game.command.execute","onModels",["setEffectDisplay",[i,!b],c])})))}var d=_slicedToArray(b,2),h=d[0],i=d[1];Y["toggle"+h+"EffectDisplay"]=c}function H(b){function c(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,R.pipe(e.auraDisplay,function(b){a.chainReduce("Game.command.execute","onModels",["setAuraDisplay",[b===i?null:i],c])})))}var d=_slicedToArray(b,2),h=d[0],i=d[1];Y["toggle"+h+"AuraDisplay"]=c}function I(b){var c=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(c[0]),R.unless(R.isNil,R.pipe(e.isCtrlAreaDisplayed$(b.factions),function(b){a.chainReduce("Game.command.execute","onModels",["setCtrlAreaDisplay",[!b],c])})))}function J(b){function c(b){return function(c){var d=g.get("local",c.game.model_selection);return R.thread(c.game)(R.prop("models"),f.findStamp$(d[0]),R.unless(R.isNil,R.pipe(e.areaDisplay,function(c){a.chainReduce("Game.command.execute","onModels",["setAreaDisplay",[c===b?null:b],d])})))}}var d=0===b?10:b;Y["toggle"+d+"InchesAreaDisplay"]=c(d);var h=d+10;Y["toggle"+h+"InchesAreaDisplay"]=c(h)}function K(b){function c(b){return function(c){var d=g.get("local",c.game.model_selection);a.chainReduce("Game.command.execute","onModels",[e+"P",[c.factions,b],d])}}var d=_slicedToArray(b,2),e=d[0];d[1];Y[e]=c(!1),Y[e+"Small"]=c(!0)}function L(b){function c(b){return function(c){var d=g.get("local",c.game.model_selection),h=R.path(["ui_state","flip_map"],c)?f:e;a.chainReduce("Game.command.execute","onModels",[h+"P",[c.factions,b],d])}}var d=_slicedToArray(b,3),e=d[0],f=(d[1],d[2]);Y[e]=c(!1),Y[e+"Small"]=c(!0)}function M(b){var c=g.get("local",b.game.model_selection),d=b.ui_state.flip_map?180:0;a.chainReduce("Game.command.execute","onModels",["setOrientationP",[b.factions,d],c])}function N(b){var c=g.get("local",b.game.model_selection),d=b.ui_state.flip_map?0:180;a.chainReduce("Game.command.execute","onModels",["setOrientationP",[b.factions,d],c])}function O(b,c){var d=g.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","onModels",["orientToP",[b.factions,c["click#"].target],d])}function P(b){var c=g.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","onModels",["clearLabel",[],c])}function Q(){function b(b,d){function h(){return R.thread(b.game)(R.prop("model_selection"),R.ifElse(g.in$("local",m),g.get$("local"),function(){return a.chainReduce("Game.command.execute","setModelSelection",["set",[m]]),[m]}))}function l(a){i=null,1===R.length(a)&&R.thread(a)(R.head,e.chargeTarget,R.unless(R.isNil,R.pipe(f.findStamp$(R.__,b.game.models),function(a){i=a})))}var m=d.target.state.stamp;return R.thread(b.game)(h,f.findAnyStamps$(R.__,b.game.models),R.reject(R.isNil),R.tap(l),R.tap(function(a){k=a}),R.map(e.saveState),R.tap(function(a){j=a}),function(){return c(b,d)})}function c(b,c){function d(a,d){var f={x:j[d].x+c.now.x-c.start.x,y:j[d].y+c.now.y-c.start.y};return e.setPositionP_(b.factions,i,f,a)["catch"](function(){return null})}function f(b){a.emit("Game.model.change."+b.state.stamp)}return R.threadP(k)(R.addIndex(R.map)(d),R.allP,R.reject(R.isNil),R.forEach(f))}function h(b,c){function d(a,c){return e.setPositionP_(b.factions,i,j[c],a)["catch"](function(){return null})}function f(d){var e={x:c.now.x-c.start.x,y:c.now.y-c.start.y};a.chainReduce("Game.command.execute","onModels",["shiftPositionP",[b.factions,i,e],d])}return R.threadP(k)(R.addIndex(R.map)(d),R.allP,R.reject(R.isNil),R.map(R.path(["state","stamp"])),f)}var i=void 0,j=void 0,k=void 0;Y.dragStartModel=b,d.actions.dragStartModel=b,Y.dragModel=c,d.actions.dragModel=c,Y.dragEndModel=h,d.actions.dragEndModel=h}function S(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];ca[c]=d,ca[c+"Small"]="shift+"+d}function T(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];ca[c]=d,ca[c+"Small"]="shift+"+d}function U(a){var b=0===a?10:a;ca["toggle"+b+"InchesAreaDisplay"]="alt+"+a,b+=10,ca["toggle"+b+"InchesAreaDisplay"]="alt+shift+"+a}function V(a,b){var c=_slicedToArray(a,1),d=c[0];ca["toggle"+d+"AuraDisplay"]="ctrl+"+(b+1)}function W(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];ca["toggle"+c+"EffectDisplay"]="alt+"+d}function X(){var a=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],b=a.single,c=a.start_charge,d=a.end_charge,e=a.start_place,f=a.end_place,g=[["Delete","deleteSelection"],["Copy","copySelection"],["Lock","toggleLock"],["Clear Label","clearLabel"],["Image","toggle","image"],["Show/Hide","toggleImageDisplay","image"],["Next","setNextImage","image"],["Wreck","toggleWreckDisplay","image"],["Orient.","toggle","orientation"],["Face Up","setOrientationUp","orientation"],["Face Down","setOrientationDown","orientation"],["Counter","toggle","counter"],["Show/Hide","toggleCounterDisplay","counter"],["Inc.","incrementCounter","counter"],["Dec.","decrementCounter","counter"],["Souls","toggle","souls"],["Show/Hide","toggleSoulsDisplay","souls"],["Inc.","incrementSouls","souls"],["Dec.","decrementSouls","souls"],["Melee","toggle","melee"],['0.5"',"toggleMeleeDisplay","melee"],["Reach","toggleReachDisplay","melee"],["Strike","toggleStrikeDisplay","melee"]];return b&&(g=R.concat(g,[["Templates","toggle","templates"],["AoE","createAoEOnModel","templates"],["Spray","createSprayOnModel","templates"]])),g=R.append(["Areas","toggle","areas"],g),g=R.append(["CtrlArea","toggleCtrlAreaDisplay","areas"],g),g=R.concat(g,R.map(function(a){var b=a+1;return[b+'"',"toggle"+b+"InchesAreaDisplay","areas"];
},_)),g=R.concat(g,R.map(function(a){var b=a+11;return[b+'"',"toggle"+b+"InchesAreaDisplay","areas"]},_)),g=R.append(["Auras","toggle","auras"],g),g=R.concat(g,R.map(function(a){var b=_slicedToArray(a,1),c=b[0];return[c,"toggle"+c+"AuraDisplay","auras"]},$)),g=R.append(["Effects","toggle","effects"],g),g=R.concat(g,R.map(function(a){var b=_slicedToArray(a,1),c=b[0];return[c,"toggle"+c+"EffectDisplay","effects"]},Z)),g=R.append(["Incorp.","toggleIncorporealDisplay","effects"],g),g=R.append(["Charge","toggle","charge"],g),c&&(g=R.append(["Start","startCharge","charge"],g)),d&&(g=R.append(["End","endCharge","charge"],g)),g=R.append(["Max Len.","setChargeMaxLength","charge"],g),g=R.append(["Place","toggle","place"],g),e&&(g=R.append(["Start","startPlace","place"],g)),f&&(g=R.append(["End","endPlace","place"],g)),g=R.append(["Max Len.","setPlaceMaxLength","place"],g),g=R.append(["Within","togglePlaceWithin","place"],g),g=R.concat(g,[["Unit","toggle","unit"],["Show/Hide","toggleUnitDisplay","unit"],["Set #","setUnit","unit"],["Leader","toggleLeaderDisplay","unit"]]),b&&(g=R.append(["Select All","selectAllUnit","unit"],g),g=R.append(["Select Friends","selectAllFriendly"],g)),g}var Y=Object.create(d.actions);Y.clickMap=i,Y.rightClickMap=i,Y.modeBackToDefault=i,Y.deleteSelection=j,Y.copySelection=k,Y.toggleLock=l,Y.toggleImageDisplay=m,Y.setNextImage=n,Y.toggleWreckDisplay=o,Y.toggleUnitDisplay=p,Y.setUnit=q,Y.toggleMeleeDisplay=r,Y.toggleReachDisplay=s,Y.toggleStrikeDisplay=t,Y.toggleCounterDisplay=u,Y.incrementCounter=v,Y.decrementCounter=w,Y.toggleSoulsDisplay=x,Y.incrementSouls=y,Y.decrementSouls=z,Y.setRulerMaxLength=A,Y.setChargeMaxLength=B,Y.setPlaceMaxLength=C,Y.togglePlaceWithin=D,Y.toggleLeaderDisplay=E,Y.toggleIncorporealDisplay=F,Y.setOrientationUp=M,Y.setOrientationDown=N,Y.setTargetModel=O,Y.clearLabel=P;var Z=[["Blind","b"],["Corrosion","c"],["Disrupt","d"],["Fire","f"],["Fleeing","e"],["KD","k"],["Stationary","t"]];R.forEach(G,Z);var $=[["Red","#F00"],["Green","#0F0"],["Blue","#00F"],["Yellow","#FF0"],["Purple","#F0F"],["Cyan","#0FF"]];R.forEach(H,$),Y.toggleCtrlAreaDisplay=I;var _=R.range(0,10);R.forEach(J,_);var aa=[["moveFront","up"],["moveBack","down"],["rotateLeft","left"],["rotateRight","right"]];R.forEach(K,aa);var ba=[["shiftUp","ctrl+up","shiftDown"],["shiftDown","ctrl+down","shiftUp"],["shiftLeft","ctrl+left","shiftRight"],["shiftRight","ctrl+right","shiftLeft"]];R.forEach(L,ba),Q();var ca={clickMap:"clickMap",rightClickMap:"rightClickMap",deleteSelection:"del",copySelection:"ctrl+c",toggleLock:"l",toggleImageDisplay:"alt+i",setNextImage:"shift+i",toggleWreckDisplay:"alt+w",setOrientationUp:"pageup",setOrientationDown:"pagedown",setTargetModel:"shift+clickModel",toggleCounterDisplay:"alt+n",incrementCounter:"+",decrementCounter:"-",toggleSoulsDisplay:"alt+o",incrementSouls:"ctrl++",decrementSouls:"ctrl+-",toggleCtrlAreaDisplay:"alt+a",setRulerMaxLength:"shift+r",setChargeMaxLength:"shift+c",setPlaceMaxLength:"shift+p",togglePlaceWithin:"alt+p",toggleMeleeDisplay:"alt+m",toggleReachDisplay:"alt+r",toggleStrikeDisplay:"alt+s",toggleUnitDisplay:"alt+u",setUnit:"shift+u",toggleLeaderDisplay:"alt+l",toggleIncorporealDisplay:"alt+g",clearLabel:"ctrl+shift+l"};R.forEach(S,aa),R.forEach(T,ba),R.forEach(U,_),R.addIndex(R.forEach)(V,$),R.forEach(W,Z);var da=R.extend(Object.create(d.bindings),ca),ea=X(),fa={onEnter:function(){},onLeave:function(){},name:"Models",actions:Y,buttons:ea,buildButtons:X,bindings:da,areas:_,auras:$,effects:Z};return b.registerMode(fa),c.register("Bindings",fa.name,ca,function(a){R.extend(fa.bindings,a)}),fa}angular.module("clickApp.services").factory("modelsMode",a),a.$inject=["appState","modes","settings","defaultMode","model","gameModels","gameModelSelection","prompt"]}(),function(){function a(a,b,c,d,e,f){function g(b){var c=f.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),e.findStamp$(c[0]),R.unless(R.isNil,R.pipe(function(a){return R.pick(["x","y"],a.state)},R.assoc("type","aoe"),function(a){return{base:{x:0,y:0,r:0},templates:[R.assoc("r",0,a)]}},function(c){var d=R.path(["ui_state","flip_map"],b);a.chainReduce("Game.command.execute","createTemplate",[c,d])})))}function h(b){var c=f.get("local",b.game.model_selection);return R.thread(b.game)(R.prop("models"),e.findStamp$(c[0]),R.unless(R.isNil,R.pipe(function(c){return R.thread(c)(d.baseEdgeInDirection$(b.factions,c.state.r),R.assoc("o",c.state.stamp),R.assoc("r",c.state.r),R.assoc("type","spray"),function(a){return{base:{x:0,y:0,r:0},templates:[a]}},function(c){var d=R.path(["ui_state","flip_map"],b);a.chainReduce("Game.command.execute","createTemplate",[c,d])})})))}function i(b){var c=f.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),e.findStamp$(c[0]),R.unless(R.isNil,R.pipe(d.user,function(a){return R.thread(b.game)(R.prop("models"),e.all,R.filter(d.userIs$(a)),R.map(d.stamp))},function(b){a.chainReduce("Game.command.execute","setModelSelection",["set",b])})))}function j(b){var c=f.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),e.findStamp$(c[0]),R.unless(R.isNil,R.pipe(function(c){return R.thread(c)(d.unit,R.unless(R.equals(0),R.pipe(function(a){return R.thread(b.game)(R.prop("models"),e.all,R.filter(d.userIs$(d.user(c))),R.filter(d.unitIs$(a)),R.map(d.stamp))},function(b){a.chainReduce("Game.command.execute","setModelSelection",["set",b])})))})))}function k(b,c){var d=f.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),e.findStamp$(d[0]),R.unless(R.isNil,function(e){e.state.stamp!==c["click#"].target.state.stamp&&a.chainReduce("Game.command.execute","onModels",["setB2BP",[b.factions,c["click#"].target],d])}))}function l(b){var c=f.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),e.findStamp$(c[0]),function(b){a.emit("Game.editLabel.open","onModels",b)})}function m(b){var c=f.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),e.findStamp$(c[0]),R.unless(R.isNil,function(b){a.emit("Game.editDamage.toggle",b)}))}var n=Object.create(c.actions);n.createAoEOnModel=g,n.createSprayOnModel=h,n.selectAllFriendly=i,n.selectAllUnit=j,n.setB2B=k,n.openEditLabel=l,n.openEditDamage=m;var o={createAoEOnModel:"ctrl+a",createSprayOnModel:"ctrl+s",selectAllUnit:"ctrl+u",selectAllFriendly:"ctrl+f",setB2B:"ctrl+shift+clickModel",openEditLabel:"shift+l",openEditDamage:"shift+d"},p=R.extend(Object.create(c.bindings),o),q={onEnter:function(){},onLeave:function(){},name:"ModelBase",actions:n,buttons:[],bindings:p};return b.register("Bindings",q.name,o,function(a){R.extend(q.bindings,a)}),q}angular.module("clickApp.services").factory("modelBaseMode",a),a.$inject=["appState","settings","modelsMode","model","gameModels","gameModelSelection"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g,h){function i(b){var c=h.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","onModels",["endCharge",[],c]),a.chainReduce("Modes.switchTo","Model")}function j(b,c){var d=h.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),g.findStamp$(d[0]),R.unless(R.isNil,R.pipe(function(e){return R.threadP(e)(f.chargeTarget,function(a){return a===c["click#"].target.state.stamp?null:c["click#"].target},function(c){R.exists(c)&&e.state.stamp===c.state.stamp||a.chainReduce("Game.command.execute","onModels",["setChargeTargetP",[b.factions,c],d])})})))}function k(b,c,d,e){var i=h.get("local",e.game.model_selection),j=R.path(["ui_state","flip_map"],e)?c:b;R.thread(e.game)(R.prop("models"),g.findStamp$(i[0]),R.unless(R.isNil,R.pipe(f.chargeTarget,function(a){return R.exists(a)?g.findStamp(a,e.game.models):null},function(b){a.chainReduce("Game.command.execute","onModels",[j+"ChargeP",[e.factions,b,d],i])})))}function l(a){var b=_slicedToArray(a,3),c=b[0],d=(b[1],b[2]);m[c]=o(c,d,!1),m[c+"Small"]=o(c,d,!0)}var m=Object.create(e.actions);m.endCharge=i,m.setTargetModel=j;var n=[["moveFront","up","moveFront"],["moveBack","down","moveBack"],["rotateLeft","left","rotateLeft"],["rotateRight","right","rotateRight"],["shiftUp","ctrl+up","shiftDown"],["shiftDown","ctrl+down","shiftUp"],["shiftLeft","ctrl+left","shiftRight"],["shiftRight","ctrl+right","shiftLeft"]],o=R.curry(k);R.forEach(l,n);var p={endCharge:"c",setTargetModel:"shift+clickModel"},q=R.extend(Object.create(e.bindings),p),r=d.buildButtons({single:!0,end_charge:!0}),s={onEnter:function(){},onLeave:function(){},name:"ModelCharge",actions:m,buttons:r,bindings:q};return b.registerMode(s),c.register("Bindings",s.name,p,function(a){R.extend(s.bindings,a)}),s}angular.module("clickApp.services").factory("modelChargeMode",a),a.$inject=["appState","modes","settings","modelsMode","modelBaseMode","model","gameModels","gameModelSelection"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g){function h(b){var c=g.get("local",b.game.model_selection);a.chainReduce("Game.command.execute","onModels",["endPlace",[],c]),a.chainReduce("Modes.switchTo","Model")}function i(b,c){var d=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(d[0]),R.unless(R.isNil,function(e){e.state.stamp!==c["click#"].target.state.stamp&&a.chainReduce("Game.command.execute","onModels",["setPlaceTargetP",[b.factions,c["click#"].target],d])}))}function j(b,c){var d=g.get("local",b.game.model_selection);R.thread(b.game)(R.prop("models"),f.findStamp$(d[0]),R.unless(R.isNil,function(e){e.state.stamp!==c["click#"].target.state.stamp&&a.chainReduce("Game.command.execute","onModels",["setPlaceOriginP",[b.factions,c["click#"].target],d])}))}function k(b,c,d,e){var f=g.get("local",e.game.model_selection),h=R.path(["ui_state","flip_map"],e)?c:b;a.chainReduce("Game.command.execute","onModels",[h+"PlaceP",[e.factions,d],f])}function l(a){var b=_slicedToArray(a,3),c=b[0],d=(b[1],b[2]);m[c]=o(c,d,!1),m[c+"Small"]=o(c,d,!0)}var m=Object.create(e.actions);m.endPlace=h,m.setTargetModel=i,m.setOriginModel=j;var n=[["moveFront","up","moveFront"],["moveBack","down","moveBack"],["rotateLeft","left","rotateLeft"],["rotateRight","right","rotateRight"],["shiftUp","ctrl+up","shiftDown"],["shiftDown","ctrl+down","shiftUp"],["shiftLeft","ctrl+left","shiftRight"],["shiftRight","ctrl+right","shiftLeft"]],o=R.curry(k);R.forEach(l,n);var p={endPlace:"p",setTargetModel:"shift+clickModel",setOriginModel:"ctrl+clickModel"},q=R.extend(Object.create(e.bindings),p),r=d.buildButtons({single:!0,end_place:!0}),s={onEnter:function(){},onLeave:function(){},name:"ModelPlace",actions:m,buttons:r,bindings:q};return b.registerMode(s),c.register("Bindings",s.name,p,function(a){R.extend(s.bindings,a)}),s}angular.module("clickApp.services").factory("modelPlaceMode",a),a.$inject=["appState","modes","settings","modelsMode","modelBaseMode","gameModels","gameModelSelection"]}(),function(){function a(a,b,c,d){function e(b,c){a.chainReduce("Game.command.execute","setRuler",["setOrigin",[c["click#"].target,b]])}function f(b,c){a.chainReduce("Game.command.execute","setRuler",["setTarget",[c["click#"].target,b]])}function g(b){return R.threadP()(function(){return d.promptP("prompt","Set ruler max length :",c.maxLength(b.game.ruler))["catch"](R.always(null))},function(a){return 0===a?null:a},function(d){return R.threadP()(function(){a.chainReduce("Game.command.execute","setRuler",["setMaxLength",[d,b]])},function(){var e=c.origin(b.game.ruler);R.isNil(e)||a.chainReduce("Game.command.execute","onModels",["setRulerMaxLength",[d],[e]])})})}function h(b){R.thread(b.game.ruler)(c.targetAoEPosition$(b.game.models),function(a){return{base:{x:0,y:0,r:0},templates:[R.assoc("type","aoe",a)]}},function(b){a.chainReduce("Game.command.execute","createTemplate",[b,!1])})}function i(){var b=a.current();return R.threadP()(function(){return m(b)},function(){return j(b)})}function j(b){var d=c.maxLength(b.game.ruler);l.buttons[0][0]="Set Max Len. ("+d+")",a.emit("Modes.buttons.update")}var k={exitRulerMode:"ctrl+r",setMaxLength:"shift+r",setOriginModel:"ctrl+clickModel",setTargetModel:"shift+clickModel",createAoEOnTarget:"ctrl+a"},l=b("ruler",c,k);l.actions.setOriginModel=e,l.actions.setTargetModel=f,l.actions.setMaxLength=g,l.actions.createAoEOnTarget=h,l.buttons=R.concat(l.buttons,[["Set Max Len.","setMaxLength"],["AoE on Target","createAoEOnTarget"]]);var m=l.onEnter;return l.onEnter=i,l}angular.module("clickApp.services").factory("rulerMode",a),a.$inject=["appState","segmentMode","gameRuler","prompt"]}(),function(){function a(a,b,c,d,e,f){return function(g,h,i){function j(a,b){return R.over(o,h.setLocal$(b.start,b.now),a)}function k(a,b){return R.over(o,h.setLocal$(b.start,b.now),a)}function l(b,c){a.chainReduce("Game.command.execute","set"+s.capitalize(g),["setRemote",[c.start,c.now,b]])}function m(b){R.thread(b)(R.path(["game","model_selection"]),f.get$("local"),function(a){return 1!==R.length(a)?null:e.findStamp(a[0],b.game.models)},function(c){R.isNil(c)||a.chainReduce("Game.command.execute","set"+s.capitalize(g),["setOriginResetTarget",[c,b]])})}function n(){a.emit("Game."+g+".remote.change")}var o=R.lensPath(["game",g]),p=Object.create(d.actions);p["exit"+s.capitalize(g)+"Mode"]=d.actions.modeBackToDefault,p.dragStartMap=j,p.dragMap=k,p.dragEndMap=l,p.dragStartTemplate=p.dragStartMap,p.dragTemplate=p.dragMap,p.dragEndTemplate=p.dragEndMap,p.dragStartModel=p.dragStartMap,p.dragModel=p.dragMap,p.dragEndModel=p.dragEndMap;var q=R.extend(Object.create(d.bindings),i),r=[],t={onEnter:m,onLeave:n,name:s.capitalize(g),actions:p,buttons:r,bindings:q};return b.registerMode(t),c.register("Bindings",t.name,i,function(a){R.extend(t.bindings,a)}),t}}angular.module("clickApp.services").factory("segmentMode",a),a.$inject=["appState","modes","settings","commonMode","gameModels","gameModelSelection"]}(),function(){function a(a,b,c,d,e,f){function g(a){var b=f.get("local",a.game.template_selection);return R.threadP(a.game)(R.prop("templates"),e.findStampP$(b[0]),function(b){a.queueChangeEventP("Game.editLabel.open","onTemplates",b)})}var h=a("template",d,e,f);return h.actions.openEditLabel=g,h.bindings.openEditLabel="shift+l",b.registerMode(h),c.register("Bindings",h.name,h.bindings,function(a){R.extend(h.bindings,a)}),h}angular.module("clickApp.services").factory("templateMode",a),a.$inject=["elementMode","modes","settings","template","gameTemplates","gameTemplateSelection"]}(),function(){function a(a,b,c,d,e,f,g,h){function i(b){var c=f.get("local",b.game.template_selection);a.chainReduce("Game.command.execute","onTemplates",["setSizeP",[3],c])}function j(b){var c=f.get("local",b.game.template_selection);a.chainReduce("Game.command.execute","onTemplates",["setSizeP",[4],c])}function k(b){var c=f.get("local",b.game.template_selection);a.chainReduce("Game.command.execute","onTemplates",["setSizeP",[5],c])}function l(b,c){var d=f.get("local",b.game.template_selection);a.chainReduce("Game.command.execute","onTemplates",["setTargetP",[b.factions,null,c["click#"].target],d])}function m(b){function c(a){var b=a[0];return h.promptP("prompt","Set AoE max deviation :",b)["catch"](R.spyAndDiscardError())}var d=f.get("local",b.game.template_selection);return R.threadP(b.game)(R.prop("templates"),e.fromStampsP$("maxDeviation",[],d),c,function(a){return 0===a?null:a},function(b){var c=a.current(),f=R.prop("game",c);return e.onStampsP$("setMaxDeviation",[b],d,f.templates)},function(b){var c=a.current(),d=R.prop("game",c);a.reduce("Game.set",R.assoc("templates",b,d))})}function n(b){var c=f.get("local",b.game.template_selection);a.chainReduce("Game.command.execute","rollDeviation",[c])}function o(b){if(g.isDisplayed(b.game.ruler)){var c=f.get("local",b.game.template_selection);R.thread(b.game)(R.prop("ruler"),g.targetAoEPosition$(b.game.models),function(b){a.chainReduce("Game.command.execute","onTemplates",["setToRulerP",[b],c])})}}var p=Object.create(d.actions);p.aoeSize3=i,p.aoeSize4=j,p.aoeSize5=k,p.setTargetModel=l,p.setMaxDeviation=m,p.deviate=n,p.setToRulerTarget=o;var q={setTargetModel:"shift+clickModel",aoeSize3:"3",aoeSize4:"4",aoeSize5:"5",deviate:"d",setMaxDeviation:"shift+d",setToRulerTarget:"shift+r"},r=R.extend(Object.create(d.bindings),q),s=R.concat([["Size","toggle","size"],["Aoe3","aoeSize3","size"],["Aoe4","aoeSize4","size"],["Aoe5","aoeSize5","size"],["Deviate","deviate"],["Set to Ruler","setToRulerTarget"]],d.buttons),t={onEnter:function(){},onLeave:function(){},name:"aoe"+d.name,actions:p,buttons:s,bindings:r};return b.registerMode(t),c.register("Bindings",t.name,q,function(a){R.extend(t.bindings,a)}),t}angular.module("clickApp.services").factory("aoeTemplateMode",a),a.$inject=["appState","modes","settings","templateMode","gameTemplates","gameTemplateSelection","gameRuler","prompt"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g,h){function i(b){var c=g.get("local",b.game.template_selection);a.chainReduce("Game.command.execute","onTemplates",["setSizeP",[6],c])}function j(b){var c=g.get("local",b.game.template_selection);a.chainReduce("Game.command.execute","onTemplates",["setSizeP",[8],c])}function k(b){var c=g.get("local",b.game.template_selection);a.chainReduce("Game.command.execute","onTemplates",["setSizeP",[10],c])}function l(b,c){var d=g.get("local",b.game.template_selection);a.chainReduce("Game.command.execute","onTemplates",["setOriginP",[b.factions,c["click#"].target],d])}function m(b,c){var d=g.get("local",b.game.template_selection);R.thread(b.game)(R.prop("templates"),f.findStamp$(d[0]),R.unless(R.isNil,R.pipe(e.origin,w(b),function(e){R.isNil(e)||a.chainReduce("Game.command.execute","onTemplates",["setTargetP",[b.factions,e,c["click#"].target],d])})))}function n(b,c,d){var h=g.get("local",d.game.template_selection);return R.thread(d.game)(R.prop("templates"),f.findStamp$(h[0]),e.origin,w(d),function(e){a.chainReduce("Game.command.execute","onTemplates",[b+"P",[d.factions,e,c],h])})}function o(a,b){return R.isNil(b)?null:h.findStamp(b,a.game.models)}var p=Object.create(d.actions);p.spraySize6=i,p.spraySize8=j,p.spraySize10=k,p.setOriginModel=l,p.setTargetModel=m;var q=[["rotateLeft","left"],["rotateRight","right"]],r=R.curry(n);R.forEach(function(a){var b=_slicedToArray(a,1),c=b[0];p[c]=r(c,!1),p[c+"Small"]=r(c,!0)},q);var s={setOriginModel:"ctrl+clickModel",setTargetModel:"shift+clickModel",spraySize6:"6",spraySize8:"8",spraySize10:"0"},t=R.extend(Object.create(d.bindings),s),u=R.concat([["Size","toggle","size"],["Spray6","spraySize6","size"],["Spray8","spraySize8","size"],["Spray10","spraySize10","size"]],d.buttons),v={onEnter:function(){},onLeave:function(){},name:"spray"+d.name,actions:p,buttons:u,bindings:t};b.registerMode(v),c.register("Bindings",v.name,s,function(a){R.extend(v.bindings,a)});var w=R.curry(o);return v}angular.module("clickApp.services").factory("sprayTemplateMode",a),a.$inject=["appState","modes","settings","templateMode","sprayTemplate","gameTemplates","gameTemplateSelection","gameModels"]}(),function(){function a(a,b){var c=Object.create(b.actions),d={},e=R.extend(Object.create(b.bindings),d),f=R.concat([],b.buttons),g={onEnter:function(){},onLeave:function(){},name:"wall"+b.name,actions:c,buttons:f,bindings:e};return a.registerMode(g),g}angular.module("clickApp.services").factory("wallTemplateMode",a),a.$inject=["modes","templateMode"]}(),function(){function a(a,b,c,d,e,f){var g=a("terrain",d,e,f);return b.registerMode(g),c.register("Bindings",g.name,g.bindings,function(a){R.extend(g.bindings,a)}),g}angular.module("clickApp.services").factory("terrainMode",a),a.$inject=["elementMode","modes","settings","terrain","gameTerrains","gameTerrainSelection"]}(),function(){function a(a){function b(a,b,c,d){i[a]=R.defaultTo({},i[a]),j[a]=R.defaultTo({},j[a]),i[a][b]=c,j[a][b]=d}function c(){return R.threadP(h)(function(b){return a.loadP(b)["catch"](R.spy("settings: failed to load data"))},R.defaultTo({}),R.spyWarn("Settings load"))}function d(){return R.threadP()(k.loadP,k.bind,k.update)}function e(a){function b(b,c){function d(a,b){var d=Object.create(i[c][b]);return R.extend(d,R.propOr({},b,e)),a[b]=d,a}var e=R.propOr({},c,a);return b[c]=R.thread(i[c])(R.keys,R.reduce(d,{})),b}return a=R.defaultTo({},a),R.thread(i)(R.keys,R.reduce(b,{}),function(a){return{"default":i,current:a}})}function f(a){function b(b){R.thread(a.current[b])(R.keys,R.filter(function(a){return R.exists(j[b][a])}),R.forEach(function(c){j[b][c](a.current[b][c])}))}return R.thread(a.current)(R.keys,R.forEach(b)),a}function g(b){return R.thread(b.current)(R.spyWarn("Settings store"),a.save$(h))}var h="clickApp.settings",i={},j={},k={register:b,loadP:c,initP:d,bind:e,update:f,store:g};return R.curryService(k),k}angular.module("clickApp.services").factory("settings",a),a.$inject=["localStorage"]}(),function(){function a(){function a(a){c=R.append(a,c)}function b(){return R.reduce(function(a,b){return b.create(a)},{},c)}var c=[],d={register:a,create:b};return R.curryService(d),d}angular.module("clickApp.services").factory("state",a),a.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g,h,i){function j(a){h.addReducer("Boards.set",D.onBoardsSet).addReducer("Terrains.set",D.onTerrainsSet).addReducer("Factions.set",D.onFactionsSet).addReducer("Scenarios.set",D.onScenariosSet).addReducer("Settings.set",D.onSettingsSet).addReducer("Settings.loadFile",D.onSettingsLoadFile).addReducer("Settings.reset",D.onSettingsReset).addReducer("Factions.loadDescFile",D.onFactionsLoadDescFile).addReducer("Factions.updateDesc",D.onFactionsUpdateDesc).addReducer("Factions.clearDesc",D.onFactionsClearDesc).addReducer("Factions.clearAllDesc",D.onFactionsClearAllDesc).addListener("Factions.desc.change",D.factionsStoreDesc).addListener("Settings.current.change",D.settingsStoreCurrent);var b=d.initP().then(function(a){return h.reduce("Boards.set",a)}),i=f.initP().then(function(a){return h.reduce("Factions.set",a)}),j=e.initP().then(function(a){return h.reduce("Terrains.set",a)}),k=g.initP().then(function(a){return h.reduce("Scenarios.set",a)}),l=c.initP().then(function(a){return h.reduce("Settings.set",a)});h.onChange("AppState.change","Factions.desc.change",R.compose(R.prop("desc"),R.view(z))),h.onChange("AppState.change","Settings.current.change",R.compose(R.prop("current"),R.view(B)));var m=h.cell("Settings.current.change",D.settingsUpdateExport,{});return R.thread(a)(R.set(y,[]),R.set(z,{}),R.set(A,{}),R.set(B,{}),R.set(C,{}),R.assocPath(["exports","settings"],m),R.assoc("data_ready",R.allP([b,j,i,k,l])))}function k(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.set(y,e,a)}function l(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.set(z,e,a)}function m(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.set(A,e,a)}function n(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.set(B,e,a)}function o(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.set(C,e,a)}function p(a,d,e){var f=_slicedToArray(e,1),g=f[0];return R.threadP(g)(b.readP$("json"),c.bind,c.update,function(a){h.reduce("Settings.set",a),h.emit("Settings.loadFile","Settings loaded")})["catch"](function(a){h.emit("Settings.loadFile",a)})}function q(a,b,d){var e=_slicedToArray(d,1),f=e[0];return R.thread(f)(c.bind,c.update,function(b){return R.set(B,b,a)})}function r(a,c,d){var e=_slicedToArray(d,2),f=e[0],g=e[1];return R.threadP(g)(b.readP$("json"),function(a){h.reduce("Factions.updateDesc",f,a),h.emit("Factions.loadDescFile","File loaded")})["catch"](function(a){h.emit("Factions.loadDescFile",a)})}function s(a,b,c){var d=_slicedToArray(c,2),e=d[0],g=d[1];return R.over(z,function(a){return R.thread(a)(R.assocPath(["desc",e],g),f.updateDesc)},a)}function t(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.over(z,function(a){return R.thread(a)(R.dissocPath(["desc",e]),f.updateDesc)},a)}function u(a){return R.over(z,function(a){return R.thread(a)(R.assoc("desc",{}),f.updateDesc)},a)}function v(){var a=R.view(B,h.current());return c.store(a)}function w(a){var b=R.view(z,h.current());return f.storeDesc(b)}function x(b,c){return a.cleanup(b.url),{name:"clicknfeat_settings.json",url:a.generate("json",c)}}var y=R.lensProp("boards"),z=R.lensProp("factions"),A=R.lensProp("scenarios"),B=R.lensProp("settings"),C=R.lensProp("terrains"),D={create:j,onBoardsSet:k,onFactionsSet:l,onScenariosSet:m,onSettingsSet:n,onTerrainsSet:o,onSettingsLoadFile:p,onSettingsReset:q,settingsStoreCurrent:v,settingsUpdateExport:x,onFactionsLoadDescFile:r,onFactionsClearDesc:t,onFactionsClearAllDesc:u,onFactionsUpdateDesc:s,factionsStoreDesc:w};return R.curryService(D),i.register(D),D}angular.module("clickApp.services").factory("stateData",a),a.$inject=["fileExport","fileImport","settings","gameBoard","gameTerrainInfo","gameFactions","gameScenario","appState","state"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p){function q(a){c.addReducer("Game.update",fa.onUpdate).addReducer("Game.set",fa.onSet).addReducer("Game.load",fa.onLoad).addReducer("Game.load.dataReady",fa.onLoadDataReady).addReducer("Game.load.dataLoaded",fa.onLoadDataLoaded).addReducer("Game.load.gameLoaded",fa.onLoadGameLoaded).addReducer("Game.connection.close",fa.onConnectionClose).addReducer("Game.command.execute",fa.onCommandExecute).addReducer("Game.command.undo",fa.onCommandUndo).addReducer("Game.command.replay",fa.onCommandReplay).addReducer("Game.command.replayBatch",fa.onCommandReplayBatch).addReducer("Game.command.undoLast",fa.onCommandUndoLast).addReducer("Game.command.replayNext",fa.onCommandReplayNext).addReducer("Game.invitePlayer",fa.onInvitePlayer).addReducer("Game.setCmds",fa.onSetCmds).addReducer("Game.setPlayers",fa.onSetPlayers).addReducer("Game.newChatMsg",fa.onNewChatMsg).addReducer("Game.uiState.flip",fa.onUiStateFlip).addReducer("Game.board.set",fa.onBoardSet).addReducer("Game.board.setRandom",fa.onBoardSetRandom).addReducer("Game.scenario.set",fa.onScenarioSet).addReducer("Game.scenario.setRandom",fa.onScenarioSetRandom).addReducer("Game.scenario.generateObjectives",fa.onScenarioGenerateObjectives).addReducer("Game.model.create",fa.onModelCreate).addReducer("Game.model.copy",fa.onModelCopy).addReducer("Game.model.importList",fa.onModelImportList).addReducer("Game.model.importFile",fa.onModelImportFile).addReducer("Game.model.importFileData",fa.onModelImportFileData).addReducer("Game.template.create",fa.onTemplateCreate).addReducer("Game.terrain.create",fa.onTerrainCreate).addReducer("Game.terrain.reset",fa.onTerrainReset).addReducer("Game.board.importFile",fa.onBoardImportFile).addListener("Game.change",fa.saveCurrent).addListener("Modes.change",fa.closeOsd).addListener("Game.template_selection.local.change",fa.checkMode).addListener("Game.terrain_selection.local.change",fa.checkMode).addListener("Game.model_selection.local.change",fa.checkMode),c.onChange("AppState.change","Game.change",R.view(da));var b=c.cell("Game.change",fa.updateExport,{}),d=c.cell(["Game.board.change","Game.terrains.change"],fa.updateBoardExport,{}),e=c.cell(["Game.models.change","Game.model_selection.local.change"],fa.updateModelsExport,{});return c.onChange("Game.change","Game.layers.change",R.pipe(R.defaultTo({}),R.prop("layers"))),c.onChange("AppState.change","Modes.change",R.path(["modes","current","name"])),c.onChange("Game.change","Game.command.change",[R.prop("commands"),R.prop("commands_log"),R.prop("undo"),R.prop("undo_log")]),c.onChange("AppState.change","Game.view.flipMap",R.pipe(R.view(ea),R.prop("flipped"))),c.onChange("Game.change","Game.dice.change",R.prop("dice")),c.onChange("Game.change","Game.board.change",R.prop("board")),c.onChange("Game.change","Game.scenario.change",R.prop("scenario")),c.onChange("AppState.change","Create.base.change",R.path(["create","base"])),c.onChange("Game.change","Game.models.change",R.prop(["models"])),c.onChange("Game.change","Game.model_selection.change",R.prop("model_selection")),c.onChange("Game.model_selection.change","Game.model_selection.local.change",R.prop("local")),c.onChange("Game.change","Game.templates.change",R.prop(["templates"])),c.onChange("Game.change","Game.template_selection.change",R.prop("template_selection")),c.onChange("Game.template_selection.change","Game.template_selection.local.change",R.prop("local")),c.onChange("Game.change","Game.terrains.change",R.prop(["terrains"])),c.onChange("Game.change","Game.terrain_selection.change",R.prop("terrain_selection")),c.onChange("Game.terrain_selection.change","Game.terrain_selection.local.change",R.prop("local")),c.onChange("Game.change","Game.ruler.remote.change",R.path(["ruler","remote"])),c.onChange("Game.change","Game.ruler.local.change",R.path(["ruler","local"])),c.onChange("Game.change","Game.los.remote.change",R.path(["los","remote"])),c.onChange("Game.change","Game.los.local.change",R.path(["los","local"])),R.thread(a)(R.set(ea,{flipped:!1}),R.set(da,{}),R.assocPath(["exports","game"],b),R.assocPath(["exports","board"],d),R.assocPath(["exports","models"],e))}function r(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.over(da,e,a)}function t(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.set(da,e,a)}function u(a,b,d){function e(){return R.allP([a.data_ready,a.user_ready,a.games_ready])}var f=_slicedToArray(d,3),g=f[0],h=f[1],i=f[2];return e().then(function(){return c.reduce("Game.load.dataReady",g,h,i)})}function v(a,b,d){var e=_slicedToArray(d,3),g=e[0],h=e[1],i=e[2];return R.threadP()(R.ifElse(function(){return g},function(){return f.loadOnlineGameP(h,i)},function(){return f.loadLocalGameP(i,a.local_games)}),function(a){return c.reduce("Game.load.dataLoaded",a)})}function w(a,b,d){var f=_slicedToArray(d,1),h=f[0];return c.emit("Game.loading"),R.threadP(h)(g.loadP,function(a){return c.reduce("Game.load.gameLoaded",a)}),R.assoc("modes",e.init(),a)}function x(a,b,d){var e=_slicedToArray(d,1),f=e[0];c.emit("Game.loaded");var h=R.path(["user","state","name"],a);return R.threadP(f)(R.when(g.isOnline,i.openP$(h)),function(a){return c.reduce("Game.set",a)})}function y(a,b){return R.over(da,i.cleanup,a);
}function z(a,b,d){var e=_slicedToArray(d,2),f=e[0],h=e[1];return R.threadP(a.game)(g.executeCommandP$(f,h),function(a){return c.reduce("Game.set",a)})["catch"](function(a){return c.emit("Game.error",a)})}function A(a,b,d){var e=_slicedToArray(d,1),f=e[0];return R.threadP(a.game)(g.undoCommandP$(f),function(a){return c.reduce("Game.set",a)})["catch"](function(a){return c.emit("Game.error",a)})}function B(a,b){return R.threadP(a.game)(g.undoLastCommandP,function(a){return c.reduce("Game.set",a)})["catch"](function(a){return c.emit("Game.error",a)})}function C(a,b,d){var e=_slicedToArray(d,1),f=e[0];return R.threadP(a.game)(g.replayCommandP$(f),function(a){return c.reduce("Game.set",a)})["catch"](function(a){return c.emit("Game.error",a)})}function D(a,b,d){var e=_slicedToArray(d,1),f=e[0];return R.threadP(a.game)(g.replayCommandsBatchP$(f),function(a){return c.reduce("Game.set",a)})["catch"](function(a){return c.emit("Game.error",a)})}function E(a,b){return R.threadP(a.game)(g.replayNextCommandP,function(a){return c.reduce("Game.set",a)})["catch"](function(a){return c.emit("Game.error",a)})}function F(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.over(da,R.assoc(e.where,e.cmds),a)}function G(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.over(da,R.assoc("players",e),a)}function H(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.over(da,R.over(R.lensProp("chat"),R.compose(R.append(e.chat),R.defaultTo([]))),a)}function I(a){return R.over(ea,R.over(R.lensProp("flipped"),R.not),a)}function J(a,b,d){var e=[s.capitalize(R.pathOr("Unknown",["user","state","name"],a)),"has invited you to join a game"].join(" "),f=self.window.location.hash;c.chainReduce("User.sendChatMsg",{to:[d],msg:e,link:f})}function K(a,b,d){var e=_slicedToArray(d,2),f=e[0],g=e[1];return c.chainReduce("Modes.switchTo","CreateModel"),R.assoc("create",{base:{x:240,y:240,r:0},models:R.times(function(a){return{info:f,x:20*a,y:0,r:0}},R.defaultTo(1,g))},a)}function L(a,b,d){var e=_slicedToArray(d,1),f=e[0];return c.chainReduce("Modes.switchTo","CreateModel"),R.assoc("create",f,a)}function M(a,b,d){var e=_slicedToArray(d,1),f=e[0],g=R.pathOr("Unknown",["user","state","name"],a);return c.chainReduce("Modes.switchTo","CreateModel"),R.assoc("create",j.buildModelsList(f,g,a.factions.references),a)}function N(a,d,e){var f=_slicedToArray(e,1),g=f[0];return R.threadP(g)(b.readP$("json"),function(a){c.reduce("Game.model.importFileData",a)})["catch"](function(a){return c.emit("Game.error",a)})}function O(a,b,d){var e=_slicedToArray(d,1),f=e[0];return c.chainReduce("Modes.switchTo","CreateModel"),R.assoc("create",f,a)}function P(a,b,d){var e=_slicedToArray(d,1),f=e[0];return c.chainReduce("Modes.switchTo","CreateTemplate"),R.assoc("create",{base:{x:240,y:240,r:0},templates:[{type:f,x:0,y:0,r:0}]},a)}function Q(a,b,d){var e=_slicedToArray(d,1),f=e[0];return c.chainReduce("Modes.switchTo","CreateTerrain"),R.assoc("create",{base:{x:240,y:240,r:0},terrains:[{info:f,x:0,y:0,r:0}]},a)}function S(a){return R.threadP(a)(R.view(da),R.prop("terrains"),n.all,R.pluck("state"),R.pluck("stamp"),function(a){c.reduce("Game.command.execute","deleteTerrain",[a])})["catch"](function(a){return c.emit("Game.error",a)})}function T(a,b,d){var e=_slicedToArray(d,1),f=e[0],g=h.forName(f,a.boards);self.window.requestAnimationFrame(function(){c.reduce("Game.command.execute","setBoard",[g])})}function U(a,b){for(var d=void 0,e=h.name(a.game.board);e===h.name(a.game.board);)d=a.boards[R.randomRange(0,a.boards.length-1)],e=h.name(d);self.window.requestAnimationFrame(function(){c.reduce("Game.command.execute","setBoard",[d])})}function V(a,d,e){var f=_slicedToArray(e,1),g=f[0];R.threadP(g)(b.readP$("json"),R.spyWarn("import"),R.tap(R.pipe(R.prop("board"),R.rejectIfP(R.isNil,"No board"),R.spyWarn("import"),function(a){c.chainReduce("Game.command.execute","setBoard",[a])})),R.tap(function(a){return R.thread(a)(R.path(["terrain","terrains"]),R.rejectIfP(R.isEmpty,"No terrain"),R.spyWarn("import",a),function(){c.chainReduce("Game.terrain.reset"),c.chainReduce("Game.command.execute","createTerrain",[a.terrain,!1])})}))["catch"](R.spyAndDiscardError("Import board file"))}function W(a,b,d){var e=_slicedToArray(d,2),f=e[0],g=e[1],h=m.forName(f,g);self.window.requestAnimationFrame(function(){c.reduce("Game.command.execute","setScenario",[h])})}function X(a,b){for(var d=m.group("SR15",a.scenarios),e=void 0,f=m.name(a.game.scenario);f===m.name(a.game.scenario);)e=d[1][R.randomRange(0,d[1].length-1)],f=m.name(e);self.window.requestAnimationFrame(function(){c.reduce("Game.command.execute","setScenario",[e])})}function Y(a,b){function d(a){return R.threadP(a)(R.prop("models"),k.all,R.filter(R.pipe(R.path(["state","info"]),R.head,R.equals("scenario"))),R.map(R.path(["state","stamp"])),R.unless(R.isEmpty,function(a){c.chainReduce("Game.command.execute","deleteModel",[a])}))}R.thread(a.game)(d,function(){return m.createObjectives(a.game.scenario)},function(b){var d=R.path(["ui_state","flip_map"],a);return c.chainReduce("Game.command.execute","createModel",[b,d])})["catch"](g.actionError$(a))}function Z(b,c){return a.cleanup(b.url),{name:"clicknfeat_game.json",url:a.generate("json",c)}}function $(a,b){var d=_slicedToArray(b,1),e=d[0];R.isNil(R.prop("local_stamp",R.defaultTo({},e)))||self.window.requestAnimationFrame(function(){c.reduce("Games.local.update",e)})}function _(b){a.cleanup(b.url);var d=c.current(),e=R.thread(d)(R.path(["game","model_selection"]),l.get$("local"),k.copyStamps$(R.__,R.path(["game","models"],d)));return{name:"clicknfeat_models.json",url:a.generate("json",e)}}function aa(b){a.cleanup(b.url);var d=c.current(),e=R.thread(d)(R.prop("game"),function(a){return{board:a.board,terrain:{base:{x:0,y:0,r:0},terrains:R.thread(a.terrains)(n.all,R.pluck("state"),R.map(R.pick(["x","y","r","info","lk"])))}}});return{name:"clicknfeat_board.json",url:a.generate("json",e)}}function ba(){var a=c.current(),b=R.propOr({},"game",a),d=e.currentModeName(a.modes),f=R.thread()(function(){return p.checkMode(R.propOr({},"terrain_selection",b))},R.unless(R.exists,function(){return o.checkMode(R.propOr({},"template_selection",b))}),R.unless(R.exists,function(){return l.checkMode(b.models,R.propOr({},"model_selection",b))}),R.defaultTo("Default"));R.exists(f)&&f!==d&&c.chainReduce("Modes.switchTo",f)}function ca(){c.emit("Game.selectionDetail.close"),c.emit("Game.editDamage.close"),c.emit("Game.editLabel.close")}var da=R.lensProp("game"),ea=R.lensProp("ui_state"),fa={create:q,onUpdate:r,onSet:t,onLoad:u,onLoadDataReady:v,onLoadDataLoaded:w,onLoadGameLoaded:x,onConnectionClose:y,onCommandExecute:z,onCommandUndo:A,onCommandUndoLast:B,onCommandReplay:C,onCommandReplayNext:E,onCommandReplayBatch:D,onSetCmds:F,onSetPlayers:G,onNewChatMsg:H,onUiStateFlip:I,onInvitePlayer:J,onModelCreate:K,onModelCopy:L,onModelImportList:M,onModelImportFile:N,onModelImportFileData:O,onTemplateCreate:P,onTerrainCreate:Q,onTerrainReset:S,onBoardSet:T,onBoardSetRandom:U,onBoardImportFile:V,onScenarioSet:W,onScenarioSetRandom:X,onScenarioGenerateObjectives:Y,updateExport:Z,updateBoardExport:aa,updateModelsExport:_,saveCurrent:$,checkMode:ba,closeOsd:ca};return R.curryService(fa),d.register(fa),fa}angular.module("clickApp.services").factory("stateGame",a),a.$inject=["fileExport","fileImport","appState","state","modes","games","game","gameBoard","gameConnection","gameFactions","gameModels","gameModelSelection","gameScenario","gameTerrains","gameTemplateSelection","gameTerrainSelection","allCommands"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e){function f(a){e.addReducer("Games.local.set",s.onLocalSet).addReducer("Games.local.update",s.onLocalUpdate).addReducer("Games.local.create",s.onLocalCreate).addReducer("Games.local.loadFile",s.onLocalLoadFile).addReducer("Games.local.loadNew",s.onLocalLoadNew).addReducer("Games.local.load",s.onLocalLoad).addReducer("Games.local.delete",s.onLocalDelete).addReducer("Games.online.create",s.onOnlineCreate).addReducer("Games.online.load",s.onOnlineLoad).addReducer("Games.online.loadFile",s.onOnlineLoadFile),e.onChange("AppState.change","Games.local.change",R.view(r));var c=R.threadP()(b.loadLocalGamesP,function(a){return e.reduce("Games.local.set",a)});return R.thread(a)(R.set(r,[]),R.assoc("local_games_ready",c))}function g(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.set(r,e,a)}function h(a,c,d){var e=_slicedToArray(d,1),f=e[0];return R.over(r,b.updateLocalGame$(f),a)}function i(b,c){return R.thread(b.user.state)(a.create,function(a){return s.onLocalLoadNew(b,c,[a])})}function j(a,b,d){var f=_slicedToArray(d,1),g=f[0];return R.threadP(g)(c.readP$("json"),function(a){return e.reduce("Games.local.loadNew",a)})}function k(a,c,d){var e=_slicedToArray(d,1),f=e[0];return R.thread(a)(R.over(r,b.newLocalGame$(f)),R.tap(function(a){return R.thread(a)(R.view(r),R.last,R.prop("local_stamp"),function(b){return s.onLocalLoad(a,c,[b])})}))}function l(a,b,c){var d=_slicedToArray(c,1),f=d[0];e.emit("Games.local.load",f)}function m(a,c,d){var e=_slicedToArray(d,1),f=e[0];return R.over(r,b.removeLocalGame$(f),a)}function n(b){return R.thread(b)(R.pathOr({},["user","state"]),a.create,s.loadNewOnlineGameP)}function o(a,b,d){var e=_slicedToArray(d,1),f=e[0];return R.threadP(f)(c.readP$("json"),s.loadNewOnlineGameP)["catch"](R.spyAndDiscardError("Failed to open online game file"))}function p(a){return R.threadP(a)(b.newOnlineGameP,R.prop("private_stamp"),function(a){return e.emit("Games.online.load","private",a)})}function q(a,b,c){var d=_slicedToArray(c,1),f=d[0];e.emit("Games.online.load","public",f)}var r=R.lensProp("local_games"),s={create:f,onLocalSet:g,onLocalUpdate:h,onLocalCreate:i,onLocalLoadFile:j,onLocalLoadNew:k,onLocalLoad:l,onLocalDelete:m,onOnlineCreate:n,onOnlineLoadFile:o,loadNewOnlineGameP:p,onOnlineLoad:q};return R.curryService(s),d.register(s),s}angular.module("clickApp.services").factory("stateGames",a),a.$inject=["game","games","fileImport","state","appState"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c){function d(a){return b.addReducer("Modes.switchTo",j.onModesSwitchTo).addReducer("Modes.current.action",j.onModesCurrentAction).addReducer("Modes.reset",j.onModesReset).addReducer("Modes.exit",j.onModesExit),b.onChange("AppState.change","Modes.change",R.pathOr({},["modes","current"])),R.thread(a)(R.assoc("modes",{}))}function e(b,c,d){var e=_slicedToArray(d,1),f=e[0];return R.over(i,a.switchToMode$(f),b)}function f(c,d,e){var f=_slicedToArray(e,2),g=f[0],h=f[1],i=R.last(h);return R.exists(R.prop("preventDefault",i))&&i.preventDefault(),R.thread(c.modes)(a.currentModeActionP$(g,[c].concat(_toConsumableArray(h))),R.when(function(a){return"Promise"===R.type(a)},function(a){return R.resolveP(a)["catch"](function(a){return b.emit("Game.error",a)})}))}function g(b){return R.set(i,a.init(),b)}function h(b,c){return R.over(i,a.exit,b)}var i=R.lensProp("modes"),j={create:d,onModesSwitchTo:e,onModesCurrentAction:f,onModesReset:g,onModesExit:h};return R.curryService(j),c.register(j),j}angular.module("clickApp.services").factory("stateModes",a),a.$inject=["modes","appState","state","allModes"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,c,d,e,f,g){function h(b){f.addReducer("User.set",y.onUserSet).addReducer("User.update",y.onUserUpdate).addReducer("User.toggleOnline",y.onUserToggleOnline).addReducer("User.sendChatMsg",y.onUserSendChatMsg).addReducer("User.connection.close",y.onUserConnectionClose).addReducer("User.setOnlineUsers",y.onUserSetOnlineUsers).addReducer("User.setOnlineGames",y.onUserSetOnlineGames).addReducer("User.newChatMsg",y.onUserNewChatMsg).addListener("User.state.change",y.onUserStateChange).addListener("User.isValid",y.onUserIsValid),f.onChange("AppState.change","User.state.change",R.compose(R.prop("state"),R.view(x))),f.onChange("AppState.change","User.connection.change",R.compose(R.prop("connection"),R.view(x))),f.onChange("AppState.change","User.isValid",R.compose(a.isValid,R.view(x))),f.onChange("AppState.change","User.isOnline",R.compose(a.online,R.view(x))),f.onChange("User.connection.change","Games.online.change",R.pipe(R.defaultTo({}),R.prop("games"))),f.onChange("AppState.change","User.chat.new",R.pipe(R.view(x),R.pathOr([],["connection","chat"]),R.last)),f.filterEvent("User.chat.new","User.chat.receive",y.filterChatReceived),f.cell("User.isOnline",y.updateOnlineKeepAlive,null);var c=R.threadP()(a.initP,function(a){return f.reduce("User.set",a)});return R.thread(b)(R.set(x,{init:!1}),R.assoc("user_ready",c))}function i(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.set(x,e,a)}function j(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.over(x,R.assoc("state",e),a)}function k(b){R.threadP(b)(R.view(x),a.toggleOnlineP,function(a){return f.reduce("User.set",a)})}function l(a,b,d){var e=_slicedToArray(d,1),f=e[0];R.threadP(a)(R.view(x),c.sendChatP$(f))}function m(b){return R.threadP(b)(R.view(x),R.rejectIfP(R.complement(a.online),"User not online when connection close"),function(){return e.promptP("alert","Server connection lost.")["catch"](R.always(null))},function(){var b=f.current();return a.toggleOnlineP(R.view(x,b))},function(a){return f.reduce("User.set",a)})}function n(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.over(x,R.assocPath(["connection","users"],e),a)}function o(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.over(x,R.assocPath(["connection","games"],e),a)}function p(a,b,c){var d=_slicedToArray(c,1),e=d[0];return R.over(x,R.over(R.lensPath(["connection","chat"]),R.pipe(R.defaultTo([]),R.append(e))),a)}function q(){var b=R.view(x,f.current());a.save(b)}function r(a,b){var c=_slicedToArray(b,1),d=c[0];d?f.emit("User.becomesValid"):f.emit("User.becomesInvalid")}function s(a,b){if(b){var c=R.view(x,f.current());return t(a,c)}return u(a)}function t(a,c){return R.exists(a)?a:self.window.setInterval(v(c),1e3*b)}function u(a){return R.isNil(a)?null:(self.window.clearInterval(a),null)}function v(a){return function(){d.getP("/api/users/"+a.state.stamp).then(R.spyInfo("** keepAlive"))}}function w(a){var b=R.view(x,f.current());return R.exists(a)&&R.exists(a.from)&&a.from!==b.state.stamp}var x=R.lensProp("user"),y={create:h,onUserSet:i,onUserUpdate:j,onUserToggleOnline:k,onUserSendChatMsg:l,onUserConnectionClose:m,onUserSetOnlineUsers:n,onUserSetOnlineGames:o,onUserNewChatMsg:p,onUserStateChange:q,onUserIsValid:r,updateOnlineKeepAlive:s,filterChatReceived:w};return R.curryService(y),g.register(y),y}angular.module("clickApp.services").factory("stateUser",a);var b=60;a.$inject=["user","userConnection","http","prompt","appState","state"]}(),function(){function a(a,b,c){function d(a,b){var d=c.getInfo(b.info,a);return{stamp:b.stamp,img_link:d.img.link,width:d.img.width,height:d.img.height,x:b.x-d.img.width/2,y:b.y-d.img.height/2,transform:["translate(",b.x-d.img.width/2,",",b.y-d.img.height/2,") rotate(",b.r,",",d.img.width/2,",",d.img.height/2,")"].join("")}}var e={Move:10,MoveSmall:1,Rotate:15,RotateSmall:5,Shift:10,ShiftSmall:1},f=R.clone(e);a.register("Misc","Terrain",e,function(a){R.extend(f,a)});var g=b("terrain",f),h=Object.create(g);return R.deepExtend(h,{render:d}),R.curryService(h),h}angular.module("clickApp.services").factory("terrain",a),a.$inject=["settings","element","gameTerrainInfo"]}(),function(){function a(a,b){function c(a,b){h[a]=b}function d(a){return R.thread(a.type)(R.unless(function(a){return R.exists(h[a])},function(){return null}),R.ifElse(R.exists,function(a){return R.thread(k.createDefault())(R.assocPath(["state","type"],a),h[a]._create)},function(){return k.createDefault()}))}function e(a,b){return R.exists(h[b.state.type])&&R.exists(h[b.state.type][a])}function f(a,b,c){return R.threadP(c)(R.rejectIfP(R.complement(l.respondTo$(a)),"Unknown call "+a+" on "+c.state.type+" template"),function(){return h[c.state.type][a].apply(h[c.state.type],[].concat(_toConsumableArray(b),[c]))})}function g(a,b){var c={stamp:b.stamp,type:b.type,x:0,y:0,transform:""},d=h[b.type].render(b,c);return d.flipped=a,c.label=k.renderLabel(d,b),c}var h={},i={Move:10,MoveSmall:1,Rotate:60,RotateSmall:6,Shift:10,ShiftSmall:1},j=R.clone(i);a.register("Misc","Template",i,function(a){R.extend(j,a)});var k=b("template",j),l=Object.create(k);return R.deepExtend(l,{registerTemplate:c,createDefault:d,respondTo:e,callP:f,render:g}),R.curryService(l),l}angular.module("clickApp.services").factory("template",a).factory("allTemplates",["aoeTemplate","sprayTemplate","wallTemplate",function(){return{}}]),a.$inject=["settings","element"]}(),function(){function a(a,b){function c(a){return R.assocPath(["state","s"],15,a)}function d(a,b){return R.threadP(a)(function(a){return R.find(R.equals(a),[3,4,5])},R.rejectIfP(R.isNil,"Invalid size for an AoE"),function(){return R.assocPath(["state","s"],5*a,b)})}function e(a){return R.path(["state","s"],a)}function f(c,d,e){return R.threadP(e)(R.rejectIfP(a.isLocked,"Template is locked"),function(e){c=e.state.r+60*(c-1);var f=R.defaultTo(d,R.path(["state","m"],e));return d=Math.min(d,f),R.thread(e)(R.over(R.lensProp("state"),b.translateInDirection$(10*d,c)),R.assocPath(["state","r"],c),a.checkState)})}function g(a){return R.pathOr(0,["state","m"],a)}function h(a,b){return R.assocPath(["state","m"],a,b)}function i(b,c){return R.threadP(c)(R.rejectIfP(a.isLocked,"Template is locked"),function(c){var d=R.thread(c.state)(R.assoc("x",b.x),R.assoc("y",b.y),R.assoc("r",b.r),R.assoc("m",b.m));return R.thread(c)(R.assoc("state",d),a.checkState)})}function j(b,c,d,e){return a.setPositionP(d.state,e)}function k(a,b){return R.deepExtend(b,{x:a.x,y:a.y,radius:a.s||15,dx:a.x,dy:a.y-(a.s||15),dtransform:"rotate("+a.r+","+a.x+","+a.y+")"}),{text_center:{x:a.x,y:a.y+a.s+5},flip_center:a,rotate_with_model:!1}}var l=Object.create(a);return R.deepExtend(l,{_create:c,setSizeP:d,size:e,deviate:f,maxDeviation:g,setMaxDeviation:h,setToRulerP:i,setTargetP:j,render:k}),a.registerTemplate("aoe",l),R.curryService(l),l}angular.module("clickApp.models").factory("aoeTemplate",a),a.$inject=["template","point"]}(),function(){function a(a,c,d){function e(a){return R.assocPath(["state","s"],6,a)}function f(a,b){return R.threadP(a)(function(a){return R.find(R.equals(a),[6,8,10])},R.rejectIfP(R.isNil,"Invalid size for a Spray"),function(){return R.assocPath(["state","s"],a,b)})}function g(a){return R.path(["state","s"],a)}function h(a){return R.path(["state","o"],a)}function i(b,d,e){return R.threadP(e)(R.rejectIfP(a.isLocked,"Template is locked"),function(){return c.baseEdgeInDirection$(b,e.state.r,d)},function(b){return R.thread(e)(R.assocPath(["state","o"],d.state.stamp),function(c){return a.setPositionP(b,c)})})}function j(b,e,f,g){return R.threadP(g)(R.rejectIfP(a.isLocked,"Template is locked"),function(){return d.directionTo(f.state,e.state)},function(d){return R.threadP(e)(c.baseEdgeInDirection$(b,d),function(b){return R.thread(g)(R.assocPath(["state","r"],d),function(c){return a.setPositionP(b,c)})})})}function k(b){function c(c,d){return R.threadP(d)(R.rejectIfP(a.isLocked,"Template is locked"),R.assocPath(["state","o"],null),function(d){return a[b](c,d)})}o[b]=c}function l(b,d,e,f){function g(e){return R.isNil(d)?e:R.threadP(d)(c.baseEdgeInDirection$(b,e.state.r),function(b){return a.setPositionP(b,e)})}return R.threadP(f)(function(b){return a.rotateLeftP(e,b)},g)}function m(b,d,e,f){function g(e){return R.isNil(d)?e:R.threadP(d)(c.baseEdgeInDirection$(b,e.state.r),function(b){return a.setPositionP(b,e)})}return R.threadP(f)(function(b){return a.rotateRightP(e,b)},g)}function n(a,c){return R.deepExtend(c,{points:b[a.s||6],transform:["rotate("+a.r+","+a.x+","+a.y+")","translate("+(a.x-10)+","+a.y+")"].join(" ")}),{text_center:{x:a.x,y:a.y+5},flip_center:a,rotate_with_model:!1}}var o=Object.create(a);R.deepExtend(o,{_create:e,setSizeP:f,size:g,origin:h,setOriginP:i,setTargetP:j,rotateLeftP:l,rotateRightP:m,render:n});var p=["moveFrontP","moveBackP","shiftLeftP","shiftRightP","shiftUpP","shiftDownP","setPositionP"];return R.forEach(k,p),a.registerTemplate("spray",o),R.curryService(o),o}angular.module("clickApp.models").factory("sprayTemplate",a),a.$inject=["template","model","point"];var b={6:"8.75,0 5.125,-59 10,-60 14.875,-59 11.25,0",8:"8.75,0 3.5,-78.672 10,-80 16.5,-78.672 11.25,0",10:"8.75,0 1.875,-98.34 10,-100 18.125,-98.34 11.25,0"}}(),function(){function a(a){function b(a){return a}function c(a,b){return R.deepExtend(b,{x:a.x-20,y:a.y-3.75,transform:"rotate("+a.r+","+a.x+","+a.y+")"}),{text_center:{x:a.x,y:a.y+2},flip_center:a,rotate_with_model:!0}}var d=Object.create(a);return R.deepExtend(d,{_create:b,render:c}),a.registerTemplate("wall",d),R.curryService(d),d}angular.module("clickApp.models").factory("wallTemplate",a),a.$inject=["template"]}(),function(){function a(a,b,c){function d(a){return R.thread(a)(R.pathOr("",["state","name"]),s.trim,R.length,R.lt(0))}function e(a){return R.threadP(a)(R.when(u.isOnline,p),R.prop("state"),R.spyWarn("User save"),b.save$(t),R.always(a))}function f(){return R.threadP(t)(b.loadP,R.defaultTo({}),R.spyInfo("User load"),function(a){return{state:a}},c.init)}function g(){return R.threadP()(f,u.checkOnlineP)}function h(a){return R.thread(a)(R.prop("state"),R.ifElse(R.compose(R.equals("Object"),R.type),u.stateDescription,R.always("")))}function i(){var a=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],b=a.name,c=a.language,d=a.chat,e=a.faction,f=a.game_size,g=a.ck_position,h="";R.exists(b)&&(h+=s(b).trim().capitalize().value());var i=[];return R.exists(c)&&i.push(s(c).trim().value()),R.exists(d)&&i.push(s(d).trim().value()),R.isEmpty(i)||(h+=" ["+i.join(" ")+"]"),R.exists(e)&&!R.isEmpty(e)&&(h+=" - "+R.map(s.capitalize,e).join(",")),R.exists(f)&&(h+="["+s.trim(f)+"pts]"),R.exists(g)&&!R.isEmpty(g)&&(h+=" - likes "+g.join(",")),h}function j(a){return R.path(["state","online"],a)}function k(a){return u.isOnline(a)?n(a):m(a)}function l(a){return R.threadP(a)(R.rejectIfP(R.complement(u.isOnline),"No online flag"),function(a){return p(a)["catch"](function(){return o(a)})},q)["catch"](function(b){return r(a)})}function m(a){return R.threadP(a)(R.assocPath(["state","online"],!0),u.checkOnlineP)}function n(a){return r(a)}function o(b){return R.threadP(b)(R.prop("state"),a.postP$("/api/users"),function(a){return R.assoc("state",a,b)})}function p(b){return R.threadP(b)(R.rejectIfP(R.compose(R.isNil,R.path(["state","stamp"])),"No valid stamp"),R.prop("state"),a.putP$("/api/users/"+b.state.stamp),function(a){return R.assoc("state",a,b)})}function q(a){return R.threadP(a)(c.openP,R.assocPath(["state","online"],!0))}function r(a){return R.thread(a)(R.assocPath(["state","online"],!1),c.close)}var t="clickApp.user",u={isValid:d,saveP:e,loadP:f,initP:g,description:h,stateDescription:i,isOnline:j,toggleOnlineP:k,checkOnlineP:l};return R.curryService(u),u}angular.module("clickApp.models").factory("user",a),a.$inject=["http","localStorage","userConnection"]}(),function(){function a(a){function b(a){var b={state:{socket:null}};return R.assoc("connection",b,a)}function c(b){if(m.active(b))return R.resolveP(b);var c={close:"User.connection.close",users:"User.connection.users",games:"User.connection.games",chat:"User.connection.chat"};return b=R.assocPath(["connection","state","socket"],null,b),R.threadP()(function(){return a.createP("/api/users/"+b.state.stamp,c)},R.assocPath(["connection","state","socket"],R.__,b))}function d(b){return m.active(b)&&a.close(b.connection.state.socket),R.over(R.lensProp("connection"),j,b)}function e(a){return R.thread(a)(R.path(["connection","state","socket"]),R.exists)}function f(b,c){return R.threadP(c)(R.rejectIfP(R.complement(m.active),"Not active"),function(a){return R.thread(b)(R.assoc("type","chat"),R.assoc("from",a.state.stamp))},function(b){return a.send(b,c.connection.state.socket)})}function g(a,b){return R.thread(b)(R.prop("connection"),n(a),R.defaultTo({name:"Unknown"}),R.prop("name"),i)}function h(a,b){return R.thread(b)(R.defaultTo({}),R.propOr({},"connection"),o(R.defaultTo([],a)),R.pluck("name"),R.when(R.isEmpty,function(){return["Unknown"]}),R.map(i))}function i(a){return s(a).trim().capitalize().value()}function j(a){return R.thread(a)(R.assocPath(["state","socket"],null),R.assoc("users",[]))}function k(a,b){return R.thread(b)(R.prop("users"),R.find(R.propEq("stamp",a)))}function l(a,b){return R.thread(a)(R.map(n(R.__,b)),R.reject(R.isNil))}var m={init:b,openP:c,close:d,active:e,sendChatP:f,userNameForStamp:g,usersNamesForStamps:h},n=R.curry(k),o=R.curry(l);return R.curryService(m),m}angular.module("clickApp.models").factory("userConnection",a),a.$inject=["websocket"]}(),function(){function a(a,b){function c(){return g}function d(a,b){return"Function"!==R.type(b)?i:(R.exists(R.prop(a,g)),g=R.assoc(a,b,g),i)}function e(){for(var b=arguments.length,c=Array(b),d=0;b>d;d++)c[d]=arguments[d];h.send(c),a.$digest()}function f(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];self.window.requestAnimationFrame(function(){e.apply(null,b)})}var g={},h=b.signalModel.create(),i={action:h,handlers:c,register:d,"do":e,defer:f};return R.curryService(i),i}angular.module("clickApp.services").factory("appAction",a),a.$inject=["$rootScope","behaviours"]}(),function(){function a(a){function b(b){a.emit("error",b,g)}function c(b){g=a.addListener("error",b,g)}function d(b){g=a.removeListener("error",b,g)}function e(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c]}var f={emit:b,addListener:c,removeListener:d};R.curryService(f);var g=R.thread()(function(){return a.create()},a.addListener$("error",e));return f}angular.module("clickApp.services").factory("appError",a),a.$inject=["pubSub"]}(),function(){function a(a,b,c){function d(){c.register("State.Init",f)}function e(a,d){var e=_toArray(d),f=e[0],g=e.slice(1),h=null,i=R.prop(f,c.handlers());if(R.isNil(i))return b.emit('Unknown action "'+f+'"'),h;try{h=i.apply(null,[a].concat(_toConsumableArray(g)))}catch(j){b.emit('Action "'+f+'" handler error',j)}return"Promise"===R.type(h)||R.isNil(h)?a:h}function f(){var a={};return a}var g=c.action.snapshot(e,function(){return j}),h=a.signalModel.create();self.window.stateSet=h;var i=h.orElse(g).hold({}),j=i.delay();self.window.state=i;var k={state:i,set:h};return R.curryService(k),d(),k}angular.module("clickApp.services").factory("appState",a),a.$inject=["behaviours","appError","appAction"]}(),function(){function a(a){function b(){l=a.create(),m=!1,n=0}function c(){return n}function d(a){var b=m;m=!0;var c=a();return b?c:(m=!1,i(),j(),c)}function e(b){l=a.addListener("tick",b,l)}function f(b){l=a.removeListener("tick",b,l)}function g(b){l=a.addListener("tickEnd",b,l)}function h(b){l=a.removeListener("tickEnd",b,l)}function i(){n++,a.emit("tick",[n],l)}function j(){a.emit("tickEnd",[n],l)}var k={now:c,inTransaction:d,addTickListener:e,removeTickListener:f,addEndListener:g,removeEndListener:h};R.curryService(k);var l=void 0,m=void 0,n=void 0;return b(),k}angular.module("clickApp.services").factory("appTick",a),a.$inject=["pubSub"]}(),function(){function a(a,b,c,d,e,f,g){function h(){d.register("User.connection.chat",p).register("User.connection.close",m).register("User.connection.games",o).register("User.connection.users",n).register("User.sendChat",l).register("User.set",i).register("User.toggleOnline",k).register("User.updateState",j),f.initP().then(function(a){return d.action.send(["User.set",a])})}function i(a,b){return R.set(q,b,a)}function j(a,b){return R.over(q,R.assoc("state",b),a)}function k(a){return R.threadP(a)(R.view(q),f.toggleOnlineP,function(a){d["do"]("User.set",a)})}function l(a,b){return R.threadP(a)(R.view(q),g.sendChatP$(b))}function m(b){return R.threadP(b)(R.view(q),R.when(f.isOnline,function(){return R.threadP()(function(){return a.promptP("alert","Server connection lost.")["catch"](R.always(null))},function(){d["do"]("User.toggleOnline")})}))}function n(a,b){return R.thread(b)(R.propOr([],"users"),R.sortBy(R.compose(R.toLower,R.prop("name"))),R.set(r,R.__,a))}function o(a,b){return R.thread(b)(R.propOr([],"games"),R.set(s,R.__,a))}function p(a,b){return R.over(t,R.pipe(R.defaultTo([]),R.append(b)),a)}var q=R.lensProp("user"),r=R.lensPath(["user","connection","users"]),s=R.lensPath(["user","connection","games"]),t=R.lensPath(["user","connection","chat"]),u=e.state.map(R.view(q));u.changes().listen(f.saveP);var v=u.map(f.isValid),w={user:u,valid:v,set:i,updateState:j,toggleOnline:k,sendChat:l,connectionChat:p,connectionClose:m,connectionGames:o,connectionUsers:n};return R.curryService(w),h(),w}angular.module("clickApp.services").factory("appUser",a),a.$inject=["prompt","behaviours","appError","appAction","appState","user","userConnection"]}(),function(){function a(a){function b(a,b){return R.thread(b)(d[a].stringify,function(a){return new self.Blob([a],{type:"text/plain"})},self.URL.createObjectURL)}function c(a){R.isNil(a)||self.URL.revokeObjectURL(a)}self.URL=self.URL||self.webkitURL;var d={json:a},e={generate:b,cleanup:c};return R.curryService(e),e}angular.module("clickApp.services").factory("fileExport",a),a.$inject=["jsonStringifier"]}(),function(){function a(a){function b(a,b){return new self.Promise(function(d,e){var f=new self.FileReader;f.onload=function(b){c[a].parseP(b.target.result).then(d)["catch"](e)},f.onerror=function(){e(["Error reading file"])},f.onabort=function(){e(["Abort reading file"])},f.readAsText(b)})}var c={json:a},d={readP:b};return R.curryService(d),d}angular.module("clickApp.services").factory("fileImport",a),a.$inject=["jsonParser"]}(),function(){function a(a,b,c){function d(a){return a.classList.contains("flipped")}function e(a){var b=a.getBoundingClientRect();return b.width/480}function f(a,b){var c=i.isFlipped(a),d=a.getBoundingClientRect(),e=480*(b.clientX-d.left)/d.width,f=480*(b.clientY-d.top)/d.height;return e=c?480-e:e,f=c?480-f:f,{x:e,y:f}}function g(a,b){var c=i.isFlipped(a),d=a.getBoundingClientRect(),e=b.x*d.width/480,f=b.y*d.height/480;return c&&(e=d.width-e,f=d.height-f),e+=d.left,f+=d.top,{x:e,y:f}}function h(d,e){function f(a){return e.target.classList.contains(a)&&e.target.hasAttribute("data-stamp")}function g(a,b){var c=e.target.getAttribute("data-stamp");return R.thread(d)(R.prop(b+"s"),a.findStamp$(c),R.ifElse(R.exists,function(a){return{type:s.capitalize(b),target:a}},function(){return h}))}var h={type:"Map",target:null};return f("template")?g(b,"template"):f("model-base")?g(a,"model"):f("terrain-image")?g(c,"terrain"):h}var i={isFlipped:d,zoomFactor:e,eventToMapCoordinates:f,mapToScreenCoordinates:g,findEventTarget:h};return R.curryService(i),i}angular.module("clickApp.services").factory("gameMap",a),a.$inject=["gameModels","gameTemplates","gameTerrains"]}(),function(){function a(){function a(a){return e("GET",a)}function b(a,b){return e("POST",a,b);
}function c(a,b){return e("PUT",a,b)}function d(a){return e("DELETE",a)}function e(a,b,c){return new self.Promise(function(d,e){var f=new self.XMLHttpRequest;f.open(a,b),f.responseType="json",R.exists(c)?f.send(JSON.stringify(c)):f.send(),f.onload=function(){f.status>=200&&f.status<300?d(f.response):e(f.statusText)},f.onerror=function(){e(f.statusText)}})}var f={getP:a,postP:b,putP:c,deleteP:d};return R.curryService(f),f}angular.module("clickApp.services").factory("http",a),a.$inject=[]}(),function(){function a(){function a(a){return self.Promise.resolve(a).then(function(a){return JSON.parse(a)})["catch"](function(a){return R.rejectP(a.message)})}var b={parseP:a};return R.curryService(b),b}angular.module("clickApp.services").factory("jsonParser",a),a.$inject=[]}(),function(){function a(){function a(a){return JSON.stringify(a,b)}function b(a,b){return s.startsWith(a,"$$")?void 0:b}var c={stringify:a};return R.curryService(c),c}angular.module("clickApp.services").factory("jsonStringifier",a),a.$inject=[]}(),function(){function a(a,b){function c(){return R.thread(self.localStorage.length)(R.range(0),R.map(function(a){return self.localStorage.key(a)}))}function d(a){return self.localStorage.getItem(a)}function e(b){return R.threadP(b)(i.getItem,a.parseP)}function f(a,b){return self.localStorage.setItem(a,b),b}function g(a,c){return R.thread(c)(b.stringify,i.setItem$(a)),c}function h(a){return self.localStorage.removeItem(a)}var i={keys:c,getItem:d,loadP:e,setItem:f,save:g,removeItem:h};return R.curryService(i),i}angular.module("clickApp.services").factory("localStorage",a),a.$inject=["jsonParser","jsonStringifier"]}(),function(){function a(){function a(){return{listeners:{},reducers:{}}}function b(a,b,c){function d(a){return function(){return R.thread(c)(R.pathOr([],["listeners",a]),h(a),R.forEach(e))}}function e(c){try{c.apply(null,[a,b])}catch(d){}}return R.thread()(d(a),d(f))}function c(a){return function(b,c,d){return R.over(R.lensPath([a,b]),R.pipe(R.defaultTo([]),R.append(c)),d)}}function d(a){return function(b,c,d){return R.over(R.lensPath([a,b]),R.pipe(R.defaultTo([]),R.reject(R.equals(c))),d)}}function e(a,b){return R.when(function(b){return R.isEmpty(b)&&a!==f},R.spyWarn("...> "+a+" with no watchers"),b)}var f="#ALL#",g={create:a,emit:b,addListener:c("listeners"),removeListener:d("listeners")},h=R.curry(e);return R.curryService(g),g}angular.module("clickApp.services").factory("pubSub",a),a.$inject=[]}(),function(){function a(a,b,c,d){function e(d,e,f){return new self.Promise(function(g,h){function i(a){g(o),p=!0}function j(b){a["do"](f.error,b)}function k(){return p?void a["do"](f.close):(h("Connection error"),void(p=!0))}function l(d){R.threadP(d.data)(c.parseP,R.ifElse(function(a){return R.exists(f[a.type])},function(b){a["do"](f[b.type],b)},function(a){b.emit("Websocket: unknown msg type "+a.type,a)}))}e=R.defaultTo(d,e),f=R.thread(f)(R.over(R.lensProp("error"),R.defaultTo("Websocket.error")),R.over(R.lensProp("close"),R.defaultTo("Websocket.close")));var m="ws://",n=m+self.document.location.host+d,o=new self.WebSocket(n),p=!1;o.onopen=i,o.onerror=j,o.onclose=k,o.onmessage=l})}function f(a,b){return R.thread(a)(d.stringify,function(a){return b.send(a)},R.always(b))}function g(a){return a.close(),a}var h={createP:e,send:f,close:g};return R.curryService(h),h}angular.module("clickApp.services").factory("websocket",a),a.$inject=["appAction","appError","jsonParser","jsonStringifier"]}(),function(){function a(){function a(){return R.thread([null])(R.ap([b("requestAnimationFrame"),b("Promise"),b("FileReader"),function(){return R.exists(self.URL)||R.exists(self.webkitURL)?null:"URL"},b("Blob"),b("localStorage"),b("WebSocket"),b("XMLHttpRequest"),b("crypto")]),R.reject(R.isNil))}function b(a){return function(){return R.exists(self[a])?null:a}}var c={check:a};return R.curryService(c),c}function b(a){function b(b){var c=a.check();b.compat_error=R.isEmpty(c)?null:c}return{restrict:"E",templateUrl:"app/components/compat_check/compat_check.html",link:b}}angular.module("clickApp.directives").factory("compatCheck",a).directive("clickCompatCheck",b),a.$inject=[],b.$inject=["compatCheck"]}(),function(){function a(){function a(a,b){function c(){this.value=null}function d(){var b=e.files;a.clickFile({file:b}),e.blur()}var e=b[0];e.setAttribute("multiple",""),e.onclick=c,e.onchange=d}return{restrict:"A",scope:{clickFile:"&"},link:a}}angular.module("clickApp.directives").directive("clickFile",a),a.$inject=[]}(),function(){function a(){function a(a,b){function c(b,c){R.exists(h)&&self.clearTimeout(h),f.innerHTML=a.game.currentModeName(),g.innerHTML=c,e.style.display="initial",h=self.setTimeout(d,1e3)}function d(){e.style.display="none",h=null}var e=b[0];e.style.display="none";var f=e.querySelector(".game-error-mode-name"),g=e.querySelector(".game-error-reason");a.onStateChangeEvent("Game.error",c,a);var h=void 0}return{restrict:"A",link:a}}angular.module("clickApp.directives").directive("clickGameError",a),a.$inject=[]}(),function(){function a(){function a(a,b){function c(){var b=R.last(R.pathOr([],["state","game","dice"],a));if("rollDeviation"!==b.type){var c=R.propOr([],"d",b);if(!(R.length(c)<2)){var e=R.reduce(R.add,0,c)/R.length(c);e>=2||(d.currentTime=0,d.play())}}}var d=b[0].querySelector("audio");a.onStateChangeEvent("Game.dice.roll",c,a)}return{restrict:"E",templateUrl:"app/components/game/bad_dice_notification/bad_dice_notification.html",link:a}}angular.module("clickApp.directives").directive("clickBadDiceNotification",a),a.$inject=[]}(),function(){function a(a,b){function c(){f.msg="",a.onStateChangeEvent("Game.chat",d,a),a.onStateChangeEvent("Game.loaded",d,a),self.window.requestAnimationFrame(d)}function d(){f.chat=R.clone(R.path(["game","chat"],a.state)),a.$digest()}function e(){var c=s.trim(f.msg);R.isEmpty(c)||R.threadP(a.state.game)(b.sendChatP$(R.path(["user","state","name"],a.state),c),function(){f.msg="",a.$digest()})}var f=this;f.doSendChatMessage=e,c()}function b(){return{restrict:"E",templateUrl:"app/components/game/chat_box/game_chat_box.html",scope:!0,controller:"gameChatBoxCtrl",controllerAs:"game_chat",link:function(){}}}angular.module("clickApp.directives").controller("gameChatBoxCtrl",a).directive("clickGameChatBox",b),a.$inject=["$scope","game"],b.$inject=[]}(),function(){function a(a){function b(b,c){function d(c,d){if(!R.isNil(d)&&!R.isNil(d.from)&&d.from!==a.state.user.state.stamp&&d.from!==a.state.user.state.name){var e=!a.stateIs(b.state);e?f.classList.add("go-to-hint"):f.classList.remove("go-to-hint")}}function e(a,c){c.name===b.state&&f.classList.remove("go-to-hint")}var f=c[0];a.onStateChangeEvent(s.capitalize(b.type)+".chat",d,b),a.$on("$stateChangeSuccess",e)}return{restrict:"A",scope:{type:"@clickChatHint",state:"@hintState"},link:b}}angular.module("clickApp.directives").directive("clickChatHint",a),a.$inject=["$rootScope"]}(),function(){function a(a,b,c){function d(b){function c(){e(b),b.$digest()}e(b),a.onStateChangeEvent("Create.base.change",c,b)}function e(d){var e=a.state,f=e.create;if(!R.isNil(f.base)){var g=d.model,h=document.getElementById("map"),i=b.isFlipped(h),j=i?-1:1;d.pos=c.render({is_flipped:i},e.factions,R.thread(g)(R.assoc("x",e.create.base.x+j*g.x),R.assoc("y",e.create.base.y+j*g.y)))}}return{restrict:"A",link:d}}angular.module("clickApp.directives").directive("clickGameCreateModel",a),a.$inject=["$rootScope","gameMap","model"]}(),function(){function a(a,b,c){function d(c,d){d=d[0];var h=a.state,i=b.render(h.terrains,c.terrain);e(i,d),g(R.path(["create","base"],h),i,c),a.onStateChangeEvent("Create.base.change",f(c),c)}function e(a,b){var c=b.querySelector("rect");c.setAttribute("width",a.width),c.setAttribute("height",a.height)}function f(c){return function(){var d=a.state,e=R.path(["create","base"],d);if(!R.isNil(e)){var f=b.render(d.terrains,c.terrain);g(e,f,c),c.$digest()}}}function g(a,b,d){var e=document.getElementById("map"),f=c.isFlipped(e),g=f?-1:1;d.pos={x:a.x+g*b.x,y:a.y+g*b.y}}return{restrict:"A",link:d}}angular.module("clickApp.directives").directive("clickGameCreateTerrain",a),a.$inject=["$rootScope","terrain","gameMap"]}(),function(){function a(a){function b(a){function b(){var b=a.state;R.isNil(R.path(["create","templates"],b))||(c(a),a.$digest())}a.onStateChangeEvent("Create.base.change",b,a),c(a)}function c(b){var c=b.state,d=R.pathOr({x:0,y:0},["create","base"],c),e=b.template;b.pos=a.render(!1,R.thread(e)(R.assoc("x",d.x),R.assoc("y",d.y)))}var d={restrict:"A",link:b};return d}angular.module("clickApp.directives").directive("clickGameCreateTemplate",a),a.$inject=["template"]}(),function(){function a(a){function b(){d.dice=R.clone(R.path(["state","game","dice"],a)),a.$digest()}function c(b,c){a.stateEvent("Game.command.execute","rollDice",[b,c])}var d=this;d.doRollDice=c,a.onStateChangeEvent("Game.dice.change",b,a),self.requestAnimationFrame(b)}function b(){return{restrict:"E",controller:"gameDiceBoxCtrl",controllerAs:"dice_box",templateUrl:"app/components/game/dice_box/dice_box.html",scope:!0,link:function(){}}}angular.module("clickApp.directives").controller("gameDiceBoxCtrl",a).directive("clickGameDiceBox",b),a.$inject=["$scope"],b.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(){function a(a,b){function c(){e.style.visibility="hidden"}function d(a,b){var c=_slicedToArray(b,2),d=c[0],f=c[1],g=Math.min(d.x,f.x),h=Math.min(d.y,f.y),i=Math.abs(d.x-f.x),j=Math.abs(d.y-f.y);e.style.visibility="visible",e.setAttribute("x",g+""),e.setAttribute("y",h+""),e.setAttribute("width",i+""),e.setAttribute("height",j+"")}var e=b[0];c(),a.onStateChangeEvent("Game.dragBox.enable",d,a),a.onStateChangeEvent("Game.dragBox.disable",c,a)}return{restrict:"A",link:a}}angular.module("clickApp.directives").directive("clickGameDragbox",a),a.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){function b(){var b=s.trim(c.new_label);0!==R.length(b)&&(a.stateEvent("Game.command.execute",c.cmd,["addLabel",[b],[c.selection.state.stamp]]),c.new_label="",c.doClose())}var c=this;c.new_label="",c.doAddLabel=b}function b(a){function b(b,c){function d(a){27===a.keyCode&&(e(),a.preventDefault())}function e(){b.edit_label.selection={},m.style.display="none",m.style.visibility="hidden",m.style.left="0px",m.style.top="0px"}function f(a,c){var d=_slicedToArray(c,2),e=d[0],f=d[1];b.edit_label.cmd=e,b.edit_label.selection=f,b.edit_label.new_label="",b.$digest(),self.window.requestAnimationFrame(g)}function g(){m.style.display="initial",m.style.visibility="hidden",k(),self.window.requestAnimationFrame(h)}function h(){j(),m.style.visibility="visible",self.window.requestAnimationFrame(function(){n.focus()})}function i(){k(),self.window.requestAnimationFrame(j)}function j(){var c=n.getBoundingClientRect(),d=a.mapToScreenCoordinates(l,b.edit_label.selection.state);m.style.left=d.x-c.width/2+"px",m.style.top=d.y-c.height/2+"px"}function k(){n.style.width=R.length(b.edit_label.new_label)+"em"}var l=document.getElementById("map"),m=c[0],n=m.querySelector("input");e(),b.onStateChangeEvent("Game.editLabel.open",f,b),b.onStateChangeEvent("Game.editLabel.close",e,b),n.addEventListener("keydown",d),b.edit_label.doRefresh=i,b.edit_label.doClose=e}return{restrict:"A",templateUrl:"app/components/game/edit_label/edit_label.html",scope:!0,controller:"clickGameEditLabelCtrl",controllerAs:"edit_label",link:b}}angular.module("clickApp.directives").controller("clickGameEditLabelCtrl",a).directive("clickGameEditLabel",b),a.$inject=["$scope"],b.$inject=["gameMap"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(){}function b(a,b){function c(c,d){function e(a,b){o?f():g(a,b)}function f(){o=!1,c.selection={},n.style.display="none",n.style.visibility="hidden",n.style.left="0px",n.style.top="0px"}function g(b,d){var e=_slicedToArray(d,1),f=e[0];o=!0,c.selection=f;var g=a.getModelInfo(c.selection.state.info,m.factions);c.info=g,c.$digest(),self.window.requestAnimationFrame(h)}function h(){n.style.display="initial",n.style.visibility="hidden",self.window.requestAnimationFrame(i)}function i(){j(),n.style.visibility="visible"}function j(){var a=n.getBoundingClientRect(),d=b.mapToScreenCoordinates(l,c.selection.state),e=k.getBoundingClientRect(),f=e.height-a.height,g=e.width-a.width,h=Math.max(0,Math.min(f,d.y-a.height/2)),i=Math.max(0,Math.min(g,d.x-a.width/2));n.style.top=h+"px",n.style.left=i+"px"}var k=document.getElementById("viewport"),l=document.getElementById("map"),m=c.state,n=d[0],o=!1;f(),c.onStateChangeEvent("Game.editDamage.toggle",e,c),c.onStateChangeEvent("Game.editDamage.open",g,c),c.onStateChangeEvent("Game.editDamage.close",f,c),c.doClose=f}return{restrict:"A",templateUrl:"app/components/game/edit_damage/edit_damage.html",scope:!0,controller:"clickGameEditDamageCtrl",controllerAs:"edit_damage",link:c}}angular.module("clickApp.directives").controller("clickGameEditDamageCtrl",a).directive("clickGameEditDamage",b),a.$inject=["$scope"],b.$inject=["gameFactions","gameMap"]}(),function(){function a(){function a(){}return{restrict:"A",templateUrl:"app/components/game/label/element_label.html",scope:{label:"=clickGameElementLabel"},link:a}}angular.module("clickApp.directives").directive("clickGameElementLabel",a),a.$inject=[]}(),function(){function a(){return{restrict:"A",link:b}}function b(a,b){a.onStateChangeEvent("Game.loading",function(){b[0].style.display="block"},a),a.onStateChangeEvent("Game.loaded",function(){b[0].style.display="none"},a)}angular.module("clickApp.directives").directive("clickGameLoading",a),a.$inject=[]}(),function(){function a(){function a(a,b){var c=b[0],d=c.getAttribute("click-log-replay-list");a.$watch(d,function(){self.requestAnimationFrame(function(){c.scrollTop=1e6})})}return{restrict:"A",link:a}}angular.module("clickApp.directives").directive("clickLogReplayList",a),a.$inject=[]}(),function(){function a(a,b){function c(c){function d(){var d=c.state,e=d.game.los,f="Los"===a.currentModeName(d.modes);c.render=b.render({in_los_mode:f,factions:d.factions,models:d.game.models},e),c.$digest()}c.onStateChangeEvent("Game.los.local.change",d,c),c.onStateChangeEvent("Game.los.remote.change",d,c)}return{restrict:"A",scope:!0,link:c}}function b(a){function b(b){function c(){var c=b.state,d=c.game.los;b.render=a.renderEnveloppe(c,d);var e=document.querySelector("#los-clip polygon");e.setAttribute("points",b.render.enveloppe),b.$digest()}b.onStateChangeEvent("Game.los.remote.change",c,b)}return{restrict:"A",scope:!0,link:b}}angular.module("clickApp.directives").directive("clickGameLos",a).directive("clickGameLosEnveloppe",b),a.$inject=["modes","gameLos","gameModels","gameFactions"],b.$inject=["gameLos"]}(),function(){function a(){function a(a,c){c=c[0];var d=b(c);c.querySelector("#menu-toggle").addEventListener("click",d),a.onStateChangeEvent("Game.toggleMenu",d,a);var e=c.querySelector("#gameview"),f=e.getBoundingClientRect();e.style.width=f.height+"px"}function b(a){var b=void 0;return function(){var c=a.querySelector("#gameview"),d=a.querySelector("#menu"),e=a.querySelector("#tool-osd"),f=a.querySelector("#chat-osd"),g=d.classList.contains("hidden");if(g)c.style.width=b+"px";else{var h=c.getBoundingClientRect();b=h.width,c.style.width=self.window.innerWidth+"px"}c.classList.toggle("resizable"),d.classList.toggle("hidden"),e.classList.toggle("show"),f.classList.toggle("show")}}return{restrict:"A",link:a}}angular.module("clickApp.directives").directive("clickGamePage",a),a.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,c,d,e){function f(f,h){function i(){function h(b){if(g("mouseDownMap",b,r.getBoundingClientRect()),n(),b.preventDefault(),1===b.which){var d=a.current(),e=c.eventToMapCoordinates(r,b),f=c.findEventTarget(d.game,b);p(e,f),r.addEventListener("mousemove",i)}}function i(a){if(g("dragMap",a),a.preventDefault(),1===a.which&&(t.now=c.eventToMapCoordinates(r,a),t.active||!s())){var b=t.active?"drag":"dragStart";t.active=!0,"Terrain"===t.target.type&&d.isLocked(t.target.target)&&(t.target={type:"Map",target:null}),f.stateEvent("Modes.current.action",b+t.target.type,[{target:t.target.target,start:t.start,now:t.now},a])}}function j(a){g("mouseLeaveMap",a),a.preventDefault(),r.removeEventListener("mousemove",i),t.active&&q(a)}function k(b){if(g("clickMap",b),b.preventDefault(),1===b.which){r.removeEventListener("mousemove",i);var d=a.current(),e=c.eventToMapCoordinates(r,b);if(t.active)t.now=e,q(b);else{var f=c.findEventTarget(d.game,b);o("click",b,e,f)}}}function l(b){g("rightClickMap",b),b.preventDefault();var d=a.current(),e=c.eventToMapCoordinates(r,b),f=c.findEventTarget(d.game,b);o("rightClick",b,e,f)}function m(a){g("moveMap",a),a.preventDefault();var b=c.eventToMapCoordinates(r,a);f.stateEvent("Modes.current.action","moveMap",[b,a])}function n(){var a=[].concat(_toConsumableArray(document.querySelectorAll("input")),_toConsumableArray(document.querySelectorAll("select")),_toConsumableArray(document.querySelectorAll("textarea")));R.forEach(function(a){a.blur()},a)}function o(a,c,d,e){var f=R.thread(c)(b,R.append(a+e.type),R.join("+"));c["click#"]={target:e.target,x:d.x,y:d.y},Mousetrap.trigger(f,void 0,c)}function p(a,b){t={active:!1,start:a,target:b,now:null}}function q(a){f.stateEvent("Modes.current.action","dragEnd"+t.target.type,[{target:t.target.target,start:t.start,now:t.now},a]),t={active:!1,start:null,target:null,now:null}}function s(){var a=e.settings().DragEpsilon;return Math.abs(t.now.x-t.start.x)<a&&Math.abs(t.now.y-t.start.y)<a}var t={active:!1,start:null,target:null,now:null};return{down:h,leave:j,click:k,rightClick:l,move:m}}function j(){function a(){c||(r.addEventListener("mousemove",s.move),c=!0)}function b(){c&&(r.removeEventListener("mousemove",s.move),c=!1)}var c=!1;return{enable:a,disable:b}}function k(){function a(){r.classList.remove("flipped")}function b(a,b){var d=_slicedToArray(b,1),e=d[0];c=document.querySelector("#deploiement-labels"),e?(r.classList.add("flipped"),c.setAttribute("transform","rotate(180,240,240)")):(r.classList.remove("flipped"),c.setAttribute("transform",""))}var c=void 0;return a(),b}function l(){function a(){var a=q.getBoundingClientRect(),b=Math.min(a.width,a.height);n(b-15)}function b(){var a=e.settings().ZoomFactor,b=o(),c=_slicedToArray(b,2),d=_slicedToArray(c[0],2),f=d[0],g=d[1],h=_slicedToArray(c[1],2),i=h[0],j=h[1],k=r.getBoundingClientRect();f=i>k.width?k.width/a:f,g=j>k.height?k.height/a:g,n(k.width*a),p(f*a,g*a,i,j)}function c(){var a=e.settings().ZoomFactor,b=o(),c=_slicedToArray(b,2),d=_slicedToArray(c[0],2),f=d[0],g=d[1],h=_slicedToArray(c[1],2),i=h[0],j=h[1],k=Math.min(i,j),l=r.getBoundingClientRect();n(Math.max(k-15,l.width/a)),p(f/a,g/a,i,j)}return{"in":b,out:c,reset:a}}function m(){function a(){var a=e.settings().ScrollStep,b=q.scrollLeft;self.window.requestAnimationFrame(function(){q.scrollLeft=b-a})}function b(){var a=e.settings().ScrollStep,b=q.scrollLeft;self.window.requestAnimationFrame(function(){q.scrollLeft=b+a})}function c(){var a=e.settings().ScrollStep,b=q.scrollTop;self.window.requestAnimationFrame(function(){q.scrollTop=b-a})}function d(){var a=e.settings().ScrollStep,b=q.scrollTop;self.window.requestAnimationFrame(function(){q.scrollTop=b+a})}return{left:a,right:b,up:c,down:d}}function n(a){r.style.width=a+"px",r.style.height=a+"px"}function o(){var a=q.getBoundingClientRect(),b=a.width,c=a.height,d=q.scrollLeft+b/2,e=q.scrollTop+c/2;return[[d,e],[b,c]]}function p(a,b,c,d){q.scrollLeft=a-c/2,q.scrollTop=b-d/2}var q=document.querySelector("#viewport"),r=h[0],s=i(),t=j(),u=k(),v=l(),w=m();r.addEventListener("mouseup",s.click),r.addEventListener("mousedown",s.down),r.addEventListener("mouseleave",s.leave),r.addEventListener("dragstart",function(a){a.preventDefault()}),r.addEventListener("contextmenu",s.rightClick),f.onStateChangeEvent("Game.view.flipMap",u,f),f.onStateChangeEvent("Game.moveMap.enable",t.enable,f),f.onStateChangeEvent("Game.moveMap.disable",t.disable,f),f.onStateChangeEvent("Game.view.zoomIn",v["in"],f),f.onStateChangeEvent("Game.view.zoomOut",v.out,f),f.onStateChangeEvent("Game.view.zoomReset",v.reset,f),f.onStateChangeEvent("Game.view.scrollLeft",w.left,f),f.onStateChangeEvent("Game.view.scrollRight",w.right,f),f.onStateChangeEvent("Game.view.scrollUp",w.up,f),f.onStateChangeEvent("Game.view.scrollDown",w.down,f),self.window.requestAnimationFrame(v.reset)}var g=R.bind(console.log,console);return{restrict:"A",link:f}}function b(a){var b=[];return a.shiftKey&&b.push("shift"),a.altKey&&b.push("alt"),a.ctrlKey&&b.push("ctrl"),a.metaKey&&b.push("meta"),b.sort()}angular.module("clickApp.directives").directive("clickGameMap",a),a.$inject=["appState","gameMap","terrain","commonMode"]}(),function(){function a(a,b,c,d,e,f){function g(d,e){function f(){var c=document.getElementById("map"),e=b.isFlipped(c),f=a.current(),h=R.path(["game","model_selection"],f),i=d.model;(k!==i||l!==h||m!==e)&&(k=i,l=h,m=e,g())}function g(){h(d),d.$digest()}var i=d.state,j=d.model;R.thread(i.factions)(c.getModelInfo$(j.state.info),R.defaultTo({base_radius:5.905}));d.onStateChangeEvent("Game.view.flipMap",f,d),d.onStateChangeEvent("Game.models.change",f,d),d.onStateChangeEvent("Game.model_selection.change",f,d),d.onStateChangeEvent("Game.model.change."+j.state.stamp,g,d),h(d);var k=void 0,l=void 0,m=void 0}function h(g){var h=document.getElementById("map"),i=b.isFlipped(h),j=g.model,k=j.state.stamp,l=a.current(),m=R.path(["game","model_selection"],l),n=f["in"]("local",k,m),o=f["in"]("remote",k,m),p=f.inSingle("local",k,m),q=f.inSingle("remote",k,m);j.selection={local:n,remote:o,single_local:p,single_remote:q};var r=void 0;if(p){var s=R.path(["state","cha","t"],j);R.exists(s)&&(r=e.findStamp(s,l.game.models),r.info=c.getModelInfo(r.state.info,l.factions))}j.render=d.render({is_flipped:i,charge_target:r},l.factions,j.state),a.emit("Game.model.change."+k+".render")}var i={restrict:"A",link:g};return i}function b(){function a(a,b){a.type=b[0].getAttribute("click-game-models-list"),a.digestOnStateChangeEvent("Game.models.change",a)}return{restrict:"A",templateUrl:"app/components/game/model/models_list.html",scope:!0,link:a}}function c(){function a(a,b){var c=a.model.state.stamp;a.digestOnStateChangeEvent("Game.view.flipMap",a),a.digestOnStateChangeEvent("Game.model.change."+c+".render",a)}var b={restrict:"A",link:a};return b}function d(){function a(a){a.digestOnStateChangeEvent("Game.models.change",a)}return{restrict:"A",templateUrl:"app/components/game/model/under_models_list.html",scope:!0,link:a}}function e(){function a(a,b){var c=a.model.state.stamp;a.digestOnStateChangeEvent("Game.view.flipMap",a),a.digestOnStateChangeEvent("Game.model.change."+c+".render",a)}var b={restrict:"A",link:a};return b}function f(){function a(a){a.digestOnStateChangeEvent("Game.models.change",a)}return{restrict:"A",templateUrl:"app/components/game/model/over_models_list.html",scope:!0,link:a}}angular.module("clickApp.directives").directive("clickGameModel",a).directive("clickGameModelsList",b).directive("clickGameUnderModel",c).directive("clickGameUnderModelsList",d).directive("clickGameOverModel",e).directive("clickGameOverModelsList",f),a.$inject=["appState","gameMap","gameFactions","model","gameModels","gameModelSelection"],b.$inject=[],c.$inject=[],d.$inject=[],e.$inject=[],f.$inject=[]}(),function(){function a(a,b,c){function d(){a.onStateChangeEvent("Game.models.change",n,b)}function e(a){return R.range(0,a)}function f(a){return R.isNil(o.state)||R.isNil(o.state.dmg)?"":o.state&&o.state.dmg.n>a?"mark":""}function g(a,b){return R.isNil(o.state)||R.isNil(o.state.dmg)?"":o.state&&o.state.dmg.f>b*o.info.field/2+a?"mark":""}function h(a,b){return R.isNil(o.state)||R.isNil(o.state.dmg)?"":o.info[a][b]?o.state&&1===o.state.dmg[a][b]?"mark":"":"none"}function i(){R.isNil(o.state)||a.stateEvent("Game.command.execute","onModels",["resetDamage",[],[o.state.stamp]])}function j(b){R.isNil(o.state)||a.stateEvent("Game.command.execute","onModels",["setWarriorDamage",[p.factions,b],[o.state.stamp]])}function k(b){R.isNil(o.state)||a.stateEvent("Game.command.execute","onModels",["setFieldDamage",[p.factions,b],[o.state.stamp]])}function l(b,c){R.isNil(o.state)||R.isNil(o.info[c][b])||a.stateEvent("Game.command.execute","onModels",["setGridDamage",[p.factions,b,c],[o.state.stamp]])}function m(b){R.isNil(o.state)||a.stateEvent("Game.command.execute","onModels",["setGridColDamage",[p.factions,b],[o.state.stamp]])}function n(){R.isNil(o.state)||R.thread(a.state)(R.path(["game","models"]),c.findStamp$(o.state.stamp),R.ifElse(R.exists,function(a){o.state=a.state,b.$digest()},function(){o.state={},b.$digest()}))}var o=this,p=a.state;o.range=e,o.warriorBoxClass=f,o.fieldBoxClass=g,o.gridBoxClass=h,o.doResetDamage=i,o.doWarriorDamage=j,o.doFieldDamage=k,o.doGridDamage=l,o.doGridColDamage=m,d()}function b(){function a(a){}return{restrict:"E",scope:{},controller:"clickGameModelDamageCtrl",controllerAs:"damage",bindToController:{info:"=",state:"="},templateUrl:"app/components/game/model/damage/model_damage.html",link:a}}angular.module("clickApp.directives").controller("clickGameModelDamageCtrl",a).directive("clickGameModelDamage",b),a.$inject=["$rootScope","$scope","gameModels"],b.$inject=[]}(),function(){function a(a,b,c,d,e){function f(b){function c(){var c=document.getElementById("map"),d=a.isFlipped(c),f=b.state,j=f.game.ruler,k={x:(j.remote.end.x-j.remote.start.x)/2+j.remote.start.x,y:(j.remote.end.y-j.remote.start.y)/2+j.remote.start.y};b.render={local:{show:j.local.display,x1:j.local.start.x,y1:j.local.start.y,x2:j.local.end.x,y2:j.local.end.y},remote:{show:j.remote.display,x1:j.remote.start.x,y1:j.remote.start.y,x2:j.remote.end.x,y2:j.remote.end.y},label:g({flipped:d,flip_center:k,text_center:k},j.remote.length)},b.render.label.show=j.remote.display;var l="Ruler"===e.currentModeName(f.modes);b.render.origin=h(f.factions,f.game.models,l,j.remote),b.render.target=i(f.factions,f.game.models,l,j.remote),b.$digest()}b.onStateChangeEvent("Game.ruler.local.change",c,b),b.onStateChangeEvent("Game.ruler.remote.change",c,b),b.onStateChangeEvent("Game.map.flipped",c,b)}function g(a,b){var c=a.rotate,d=void 0===c?0:c,e=a.flipped,f=void 0===e?!1:e,g=a.flip_center,h=void 0===g?{x:240,y:240}:g,i=a.text_center,j=void 0===i?{x:240,y:240}:i;b+="",d+=f?180:0;var k="rotate("+d+","+h.x+","+h.y+")",l=j.x,m=j.y,n=5*R.length(b),o=j.x-n/2,p=j.y-5;return{text:b,x:l,y:m,transform:k,bkg_x:o,bkg_y:p,bkg_width:n}}function h(a,b,e,f){if(R.isNil(f.origin)||!f.display&&!e)return null;var g=c.findStamp(f.origin,b);if(R.isNil(g))return null;var h=d.getModelInfo(g.state.info,a);return R.isNil(h)?null:{cx:g.state.x,cy:g.state.y,radius:h.base_radius}}function i(a,e,f,g){if(R.isNil(g.target)||!g.display&&!f)return null;var h=c.findStamp(g.target,e);if(R.isNil(h))return null;var i=d.getModelInfo(h.state.info,a);if(R.isNil(i))return null;var j=b.targetReached({remote:g});return{cx:h.state.x,cy:h.state.y,radius:i.base_radius,reached:j}}return{restrict:"A",scope:!0,link:f}}angular.module("clickApp.directives").directive("clickGameRuler",a),a.$inject=["gameMap","gameRuler","gameModels","gameFactions","modes"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d){function e(){a.onStateChangeEvent("Game.templates.change",g,a),a.onStateChangeEvent("Game.models.change",g,a)}function f(){n.show.info=!1,g()}function g(){R.isNil(n.type)||(o[n.type](),a.$digest())}function h(){return R.thread(a.state.game)(R.prop("templates"),d.findStamp$(n.element.stamp),function(a){n.element=a.state,n.edit.max_deviation=R.propOr(0,"m",n.element)})}function i(){return R.thread(a.state.game)(R.prop("models"),c.findStamp$(n.element.stamp),function(a){n.element=a.state},function(){return b.getModelInfo(n.element.info,a.state.factions)},function(a){n.info=a})}function j(a){return s.truncate(a,12)}function k(){var b=n.edit.max_deviation>0?n.edit.max_deviation:null;a.stateEvent("Game.command.execute","onTemplates",["setMaxDeviation",[b],[n.element.stamp]])}function l(){var b="template"===n.type?"onTemplates":"onModels",c=s.trim(n.edit.label);0!==R.length(c)&&(a.stateEvent("Game.command.execute",b,["addLabel",[c],[n.element.stamp]]),n.edit.label="")}function m(b){var c="template"===n.type?"onTemplates":"onModels";a.stateEvent("Game.command.execute",c,["removeLabel",[b],[n.element.stamp]])}var n=this;n.edit={label:"",max_deviation:0},n.show={info:!1},n.onOpen=f,n.updateElement=g,n.labelDisplay=j,n.doSetMaxDeviation=k,n.doAddLabel=l,n.doRemoveLabel=m,e();var o={template:h,model:i}}function b(a){function b(b,c){function d(a,b){var c=_slicedToArray(b,2),d=c[0],e=c[1];q.type=d,q.element=e.state,q.edit={label:"",max_deviation:0},q.onOpen(),self.window.requestAnimationFrame(f)}function e(){q.type=null,q.element={},c.style.display="none",c.style.visibility="hidden",c.style.left="0px",c.style.top="0px"}function f(){c.style.display="initial",c.style.visibility="hidden",self.window.requestAnimationFrame(g)}function g(){h(),c.style.visibility="visible"}function h(){var b=c.getBoundingClientRect(),d=a.mapToScreenCoordinates(p,q.element),e=o.getBoundingClientRect();i(e,b,d)?c.style.left=j(b,d):c.style.left=k(b,d),l(e,b,d)?c.style.top=m(b,d):c.style.top=n(b,d)}function i(a,b,c){return c.x+b.width<=a.right}function j(a,b){return b.x+"px"}function k(a,b){return Math.max(0,b.x-a.width)+"px"}function l(a,b,c){return c.y+b.height<=a.bottom}function m(a,b){return b.y+"px"}function n(a,b){return Math.max(0,b.y-a.height)+"px"}c=c[0];var o=document.getElementById("viewport"),p=document.getElementById("map"),q=b.selection;q.type="model",e(),b.onStateChangeEvent("Game.selectionDetail.open",d,b),b.onStateChangeEvent("Game.selectionDetail.close",e,b),q.doClose=e}var c={restrict:"A",scope:!0,controller:"clickGameSelectionDetailCtrl",controllerAs:"selection",link:b};return c}angular.module("clickApp.directives").controller("clickGameSelectionDetailCtrl",a).directive("clickGameSelectionDetail",b),a.$inject=["$scope","gameFactions","gameModels","gameTemplates"],
b.$inject=["gameMap"]}(),function(){function a(a,b,c){function d(a,b){return b=b[0],e(a,b)}function e(c,d){var e=a.state,j=b.render(e.terrains,c.terrain.state);f(j,d),c.pos=j,i(e.game.terrain_selection,c.terrain,c);var k=g(c);c.onStateChangeEvent("Game.terrains.change",k,c),c.onStateChangeEvent("Game.terrain.change."+c.terrain.state.stamp,h(c),c),c.onStateChangeEvent("Game.terrain_selection.change",k,c)}function f(a,b){var c=b.querySelector("image");c.setAttribute("data-stamp",a.stamp),c.setAttribute("width",a.width+""),c.setAttribute("height",a.height+""),c.setAttributeNS("http://www.w3.org/1999/xlink","href",a.img_link);var d=b.querySelector("rect");d.setAttribute("width",a.width+""),d.setAttribute("height",a.height+"")}function g(b){var c=h(b),d=b.terrain,e=R.path(["game","terrain_selection"],a.state);return function(){var f=R.path(["game","terrain_selection"],a.state);(b.terrain!==d||f!==e)&&(d=b.terrain,e=f,c())}}function h(c){return function(){var d=a.state,e=b.render(d.terrains,c.terrain.state);c.pos=e,i(d.game.terrain_selection,c.terrain,c),c.$digest()}}function i(a,b,d){var e=b.state.stamp;d.selection={local:c["in"]("local",e,a),remote:c["in"]("remote",e,a)}}return{restrict:"A",link:d}}function b(){function a(a,b,c){a.type=c.clickGameTerrainsList,a.digestOnStateChangeEvent("Game.terrains.change",a)}return{restrict:"A",templateUrl:"app/components/game/terrain/terrains_list.html",scope:!0,link:a}}angular.module("clickApp.directives").directive("clickGameTerrain",a).directive("clickGameTerrainsList",b),a.$inject=["$rootScope","terrain","gameTerrainSelection"],b.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f){function g(c){function d(){var d=document.getElementById("map"),f=b.isFlipped(d),h=a.current(),k=R.path(["game","template_selection"],h),l=c.template;(g!==l||i!==k||j!==f)&&(g=l,i=k,j=f,e())}function e(){h(c),c.$digest()}var f=c.template;c.onStateChangeEvent("Game.view.flipMap",d,c),c.onStateChangeEvent("Game.templates.change",d,c),c.onStateChangeEvent("Game.template_selection.change",d,c),c.onStateChangeEvent("Game.template.change."+f.state.stamp,e,c),h(c);var g=void 0,i=void 0,j=void 0}function h(g){var h=document.getElementById("map"),i=b.isFlipped(h),j=g.template;g.render=c.render(i,j.state);var k=a.current(),l=R.path(["game","template_selection"],k),m=j.state.stamp,n=d["in"]("local",m,l),o=d["in"]("remote",m,l),p=n||o;g.selection={local:n,remote:o,selected:p},n&&R.exists(j.state.o)&&R.thread(k.game.models)(e.findStamp$(j.state.o),R.unless(R.isNil,R.pipe(function(a){return[a,f.getModelInfo(a.state.info,k.factions)]},function(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];g.render.origin={cx:c.state.x,cy:c.state.y,radius:d.base_radius}})))}var i={restrict:"A",scope:!0,link:g};return i}function b(){function a(a,b){a.type=b[0].getAttribute("click-game-templates-list"),a.digestOnStateChangeEvent("Game.templates.change",a)}var b={restrict:"A",templateUrl:"app/components/game/template/templates_list.html",scope:!0,link:a};return b}angular.module("clickApp.directives").directive("clickGameTemplate",a).directive("clickGameTemplatesList",b),a.$inject=["appState","gameMap","template","gameTemplateSelection","gameModels","gameFactions"],b.$inject=[]}(),function(){function a(a){function b(){a.digestOnStateChangeEvent("Game.ruler.remote.change",a),a.digestOnStateChangeEvent("Game.los.remote.change",a)}function c(){a.game.currentModeIs("Ruler")?a.game.doModeAction("modeBackToDefault"):a.game.doModeAction("enterRulerMode")}function d(){a.stateEvent("Game.command.execute","setRuler",["toggleDisplay",[]])}function e(){a.game.currentModeIs("Los")?a.game.doModeAction("modeBackToDefault"):a.game.doModeAction("enterLosMode")}function f(){a.stateEvent("Game.command.execute","setLos",["toggleDisplay",[]])}function g(b){a.stateEvent("Game.template.create",b)}var h=this;h.doUseRuler=c,h.doToggleShowRuler=d,h.doUseLos=e,h.doToggleShowLos=f,h.doCreateTemplate=g,b()}function b(){return{restrict:"E",controller:"gameToolBoxCtrl",controllerAs:"tool_box",templateUrl:"app/components/game/tool_box/game_tool_box.html",scope:!0,link:function(){}}}angular.module("clickApp.directives").controller("gameToolBoxCtrl",a).directive("clickGameToolBox",b),a.$inject=["$scope"],b.$inject=[]}(),function(){function a(){return{restrict:"E",templateUrl:"app/components/games_list/games_list.html",scope:{},link:function(){},controller:"gamesListCtrl",controllerAs:"vm",bindToController:{games:"=",selection:"=",current:"="}}}function b(a){function b(){a.$watch("vm.games",function(){e()})}function c(a){return R.exists(R.find(R.equals(a),f.selection.list))}function d(a){R.exists(f.current)&&f.games[a].public_stamp===f.current||e(a)}function e(a){R.thread(a)(R.defaultTo(R.head(f.selection.list)),R.defaultTo(0),R.min(R.length(f.games)-1),R.max(0),function(a){f.selection.list=[a]})}var f=this;f.selection.list=[],f.isInSelection=c,f.doSetSelection=d,b()}angular.module("clickApp.directives").controller("gamesListCtrl",b).directive("clickGamesList",a),b.$inject=["$scope"]}(),function(){function a(a){function b(b,c){function d(){e.currentTime=0,e.play()}var e=c[0].querySelector("audio");a.onStateChangeEvent(s.capitalize(b.type)+".chat.receive",d,b)}return{restrict:"E",scope:{type:"@"},templateUrl:"app/components/mail_notification/mail_notification.html",link:b}}angular.module("clickApp.directives").directive("clickMailNotification",a),a.$inject=["$rootScope"]}(),function(){function a(){function a(a){return i=a,i.doValidate=g,i.doCancel=h,f(),i}function b(a,b,e){function f(c){c.open({prompt_type:a,message:"String"===R.type(b)?[b]:b,input_type:"Number"===R.type(e)?"number":"text",input_value:e})}return R.threadP()(d,f,c)}function c(){return new self.Promise(function(a,b){k={resolve:a,reject:b}})}function d(){return R.exists(i)?i:e()}function e(){return new self.Promise(function(a){j.push(a)})}function f(){R.forEach(function(a){a(i)},j),j.length=0}function g(){var a=i.close();k.resolve(a),k=null}function h(){i.close(),k.reject("canceled"),k=null}var i=void 0,j=[],k=void 0,l={register:a,promptP:b};return R.curryService(l),l}function b(a){function b(b,c){function d(){var a=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],b=a.message,d=a.input_type,e=a.prompt_type,f=a.input_value;self.window.requestAnimationFrame(function(){g.innerHTML=R.defaultTo([],b).join("<br />"),h.setAttribute("type",R.defaultTo("text",d)),h.style.display="prompt"===e?"initial":"none",i.style.display="alert"!==e?"initial":"none",c.style.display="initial",h.focus(),h.value=R.defaultTo(null,f)})}function e(){var a=h.value;return"number"===h.getAttribute("type")&&(a=0===R.length(a)?null:parseFloat(a)),c.style.display="none",a}c=c[0];var f=c.querySelector("form"),g=c.querySelector("p"),h=c.querySelector("input"),i=c.querySelector("button.btn-default");c.style.display="none";var j=a.register({open:d,close:e});f.addEventListener("submit",j.doValidate),i.addEventListener("click",j.doCancel)}var c={restrict:"E",templateUrl:"app/components/prompt/prompt.html",scope:!0,link:b};return c}angular.module("clickApp.directives").factory("prompt",a).directive("prompt",b),a.$inject=[],b.$inject=["prompt"]}(),function(){function a(){return{restrict:"E",templateUrl:"app/components/user_chat/user_chat.html",scope:!0,controller:"userChatCtrl",controllerAs:"user_chat",link:function(){}}}function b(a){function b(){m.chat={msg:"",to:[]},a.onStateChangeEvent("User.state.change",c,a),a.onStateChangeEvent("User.connection.change",c,a),self.window.requestAnimationFrame(c)}function c(){m.user=R.clone(a.state.user),a.$digest()}function d(a){m.chat.to=R.reject(R.equals(m.user.state.stamp),a)}function e(a){return R.find(R.equals(a),m.chat.to)}function f(a){d(m.userIsInRecipients(a)?R.reject(R.equals(a),m.chat.to):R.append(a,m.chat.to))}function g(){d(R.pluck("stamp",m.user.connection.users))}function h(a){d(R.thread(a)(R.prop("to"),R.append(R.prop("from",a)),R.uniq))}function i(){return R.length(s.strip(m.chat.msg))>0}function j(){return!R.isEmpty(m.chat.to)&&i()}function k(){m.canSendChatMsg()&&(a.stateEvent("User.sendChatMsg",R.clone(m.chat)),m.chat.msg="")}function l(){d(R.pluck("stamp",m.user.connection.users)),m.doSendChatMsg()}var m=this;m.userIsInRecipients=e,m.doToggleRecipient=f,m.doSetAllRecipients=g,m.doSetRecipientsFromChat=h,m.canSendChatMsg=j,m.doSendChatMsg=k,m.doBroadcastChatMsg=l,b()}angular.module("clickApp.directives").controller("userChatCtrl",b).directive("clickUserChat",a),a.$inject=[],b.$inject=["$scope"]}();

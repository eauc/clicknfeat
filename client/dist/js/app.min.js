...
angular.module('clickApp.services').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/views/game/game.html',
    ...
    "                                  for u in state.user.connection.users\" ng-model=game.invite_player required></select></div></div></form></p><ul class=\"nav nav-tabs\"><li class=\"{{app.stateIs('game.main') ? 'active' : ''}}\" ng-click=\"app.goToState('^.main')\"><a class=\"{{ game.hints.go_to_main ? 'go-to-hint' : ''}}\">Main</a></li><li class=\"{{app.stateIs('game.model') ? 'active' : ''}}\" ng-click=\"app.goToState('^.model')\"><a>Model</a></li><li class=\"{{app.stateIs('game.setup') ? 'active' : ''}}\" ng-click=\"app.goToState('^.setup')\"><a>Setup</a></li><li class=\"{{app.stateIs('game.log') ? 'active' : ''}}\" ng-click=\"app.goToState('^.log')\"><a>Log</a></li><li class=\"{{app.stateIs('game.save') ? 'active' : ''}}\" ng-click=\"app.goToState('^.save')\"><a>Save</a></li><li class=\"{{app.stateIs('game.help') ? 'active' : ''}}\" ng-click=\"app.goToState('^.help')\"><a>Help</a></li><li ng-show=\"state.user | user:'online'\" class=\"{{app.stateIs('game.online') ? 'active' : ''}}\" ng-click=\"app.goToState('^.online')\"><a class=\"{{ game.hints.go_to_online ? 'go-to-hint' : ''}}\">Online</a></li><li ng-click=\"app.goToState('lounge')\"><a>Lounge</a></li></ul><div ui-view id=menu-view class=\"{{game.menuDisabled() ? 'disabled' : ''}}\"></div></div></div><click-mail-notification type=game></click-mail-notification><click-bad-dice-notification></click-bad-dice-notification></div>"
  );

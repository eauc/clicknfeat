...
angular.module('clickApp.services').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('partials/game/main.html',
    "<div><div ng-show=\"game | gameConnection:'active'\" class=\"panel panel-info\"><div class=panel-heading>Chat</div><div class=panel-content><click-game-chat-box></click-game-chat-box></div></div><div class=\"panel panel-info\"><div class=panel-heading>Tools</div><div class=panel-content><button class=\"btn {{ currentModeIs('Ruler') ? 'btn-primary' : 'btn-default' }}\" title=\"{{action_bindings['enterRulerMode'] || ''}}\" ng-click=doUseRuler()>Use<br>Ruler</button> <button class=\"btn {{ (game.ruler | gameRuler:'isDisplayed') ? 'btn-primary' : 'btn-default' }}\" ng-click=doToggleShowRuler()>Show<br>Ruler</button> <button class=\"btn {{ currentModeIs('LoS') ? 'btn-primary' : 'btn-default' }}\" title=\"{{action_bindings['enterLosMode'] || ''}}\" ng-click=doUseLos()>Use<br>LoS</button> <button class=\"btn {{ (game.los | gameLos:'isDisplayed') ? 'btn-primary' : 'btn-default' }}\" ng-click=doToggleShowLos()>Show<br>LoS</button> <button class=\"btn btn-default\" ng-click=\"doCreateTemplate('aoe')\">New<br>AoE</button> <button class=\"btn btn-default\" ng-click=\"doCreateTemplate('spray')\">New<br>Spray</button> <button class=\"btn btn-default\" ng-click=\"doCreateTemplate('wall')\">New<br>Wall</button></div></div><div class=\"panel panel-info\"><div class=panel-heading>Dice</div><div class=panel-content><click-game-dice-box></click-game-dice-box></div></div></div>"
  );
  ...
  $templateCache.put('partials/game/scenario.html',
    "<g><circle ng-repeat=\"(i,c) in game.scenario.circle track by i\" ng-attr-cx={{::c.x}} ng-attr-cy={{::c.y}} ng-attr-r={{::c.r}} class=zone></circle><rect ng-repeat=\"(i,r) in game.scenario.rect track by i\" ng-attr-x={{::r.x-r.width/2}} ng-attr-y={{::r.y-r.height/2}} ng-attr-width={{::r.width}} ng-attr-height={{::r.height}} class=zone></rect><circle ng-repeat=\"(i,o) in game.scenario.objectives track by i\" ng-attr-cx={{::o.x}} ng-attr-cy={{::o.y}} r=9.842 class=objective></circle><circle ng-repeat=\"(i,f) in game.scenario.flags track by i\" ng-attr-cx={{::f.x}} ng-attr-cy={{::f.y}} r=7.874 class=objective></circle><g ng-show=\"stateIs('game.setup')\"><rect ng-show=game.scenario.killbox x=140 y=140 width=200 height=200 class=area></rect><circle ng-repeat=\"(i,o) in game.scenario.objectives track by i\" ng-attr-cx={{::o.x}} ng-attr-cy={{::o.y}} r=49.842 class=area></circle><circle ng-repeat=\"(i,f) in game.scenario.flags track by i\" ng-attr-cx={{::f.x}} ng-attr-cy={{::f.y}} r=47.874 class=area></circle></g></g>"
  );

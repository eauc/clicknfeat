...
angular.module('clickApp.services').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/components/game/tool_box/game_tool_box.html',
    "<div class=panel-content><div class=btn-group><div class=btn-group><button class=\"btn btn-default\" ng-click=\"tool_box.doCreateTemplate('aoe')\">New<br>AoE</button> <button class=\"btn btn-default\" ng-click=\"tool_box.doCreateTemplate('spray')\">New<br>Spray</button> <button class=\"btn btn-default\" ng-click=\"tool_box.doCreateTemplate('wall')\">New<br>Wall</button></div></div></div>"
  );

...
y.$current.navigable==b&&j(a,c)||y.transitionTo(b,a,{inherit:!0,location:!1})}]),p(c),b}function r(a){return a.indexOf("*")>-1}function s(a){for(var b=a.split("."),c=y.$current.name.split("."),d=0,e=b.length;e>d;d++)"*"===b[d]&&(c[d]="*");return"**"===b[0]&&(c=c.slice(h(c,b[1])),c.unshift("**")),"**"===b[b.length-1]&&(c.splice(h(c,b[b.length-2])+1,Number.MAX_VALUE),c.push("**")),b.length!=c.length?!1:c.join("")===b.join("")}function t(a,b){return J(a)&&!H(b)?C[a]:I(b)&&J(a)?(C[a]&&!C.$delegates[a]&&(C.$delegates[a]=C[a]),C[a]=b,this):this}function u(a,b){return K(a)?b=a:b.name=a,q(b),this}function v(a,e,f,h,l,n,p,q,t){function u(b,c,d,f){var g=a.$broadcast("$stateNotFound",b,c,d);if(g.defaultPrevented)return p.update(),D;if(!g.retry)return null;if(f.$retry)return p.update(),E;var h=y.transition=e.when(g.retry);return h.then(function(){return h!==y.transition?A:(b.options.$retry=!0,y.transitionTo(b.to,b.toParams,b.options))},function(){return D}),p.update(),h}function v(a,c,d,g,i,j){function m(){var c=[];return M(a.views,function(d,e){var g=d.resolve&&d.resolve!==a.resolve?d.resolve:{};g.$template=[function(){return f.load(e,{view:d,locals:i.globals,params:n,notify:j.notify})||""}],c.push(l.resolve(g,i.globals,i.resolve,a).then(function(c){if(I(d.controllerProvider)||L(d.controllerProvider)){var f=b.extend({},g,i.globals);c.$$controller=h.invoke(d.controllerProvider,null,f)}else c.$$controller=d.controller;c.$$state=a,c.$$controllerAs=d.controllerAs,i[e]=c}))}),e.all(c).then(function(){return i.globals})}var n=d?c:k(a.params.$$keys(),c),o={$stateParams:n};i.resolve=l.resolve(a.resolve,o,i.resolve,a);var p=[i.resolve.then(function(a){i.globals=a})];return g&&p.push(g),e.all(p).then(m).then(function(a){return i})}var A=e.reject(new Error("transition superseded")),C=e.reject(new Error("transition prevented")),D=e.reject(new Error("transition aborted")),E=e.reject(new Error("transition failed"));return x.locals={resolve:null,globals:{$stateParams:{}}},y={params:{},current:x.self,$current:x,transition:null},y.reload=function(a){return y.transitionTo(y.current,n,{reload:a||!0,inherit:!1,notify:!0})},y.go=function(a,b,c){return y.transitionTo(a,b,N({inherit:!0,relative:y.$current},c))},y.transitionTo=function(b,c,f){c=c||{},f=N({location:!0,inherit:!1,relative:null,notify:!0,reload:!1,$retry:!1},f||{});var g,j=y.$current,l=y.params,o=j.path,q=m(b,f.relative),r=c["#"];if(!H(q)){var s={to:b,toParams:c,options:f},t=u(s,j.self,l,f);if(t)return t;if(b=s.to,c=s.toParams,f=s.options,q=m(b,f.relative),!H(q)){if(!f.relative)throw new Error("No such state '"+b+"'");throw new Error("Could not resolve '"+b+"' from state '"+f.relative+"'")}}if(q[B])throw new Error("Cannot transition to abstract state '"+b+"'");if(f.inherit&&(c=i(n,c||{},y.$current,q)),!q.params.$$validates(c))return E;c=q.params.$$values(c),b=q;var z=b.path,D=0,F=z[D],G=x.locals,I=[];if(f.reload){if(J(f.reload)||K(f.reload)){if(K(f.reload)&&!f.reload.name)throw new Error("Invalid reload state object");var L=f.reload===!0?o[0]:m(f.reload);if(f.reload&&!L)throw new Error("No such reload state '"+(J(f.reload)?f.reload:f.reload.name)+"'");for(;F&&F===o[D]&&F!==L;)G=I[D]=F.locals,D++,F=z[D]}}else for(;F&&F===o[D]&&F.ownParams.$$equals(c,l);)G=I[D]=F.locals,D++,F=z[D];if(w(b,c,j,l,G,f))return r&&(c["#"]=r),y.params=c,O(y.params,n),f.location&&b.navigable&&b.navigable.url&&(p.push(b.navigable.url,c,{$$avoidResync:!0,replace:"replace"===f.location}),p.update(!0)),y.transition=null,e.when(y.current);if(c=k(b.params.$$keys(),c||{}),f.notify&&a.$broadcast("$stateChangeStart",b.self,c,j.self,l).defaultPrevented)return a.$broadcast("$stateChangeCancel",b.self,c,j.self,l),p.update(),C;for(var M=e.when(G),P=D;P<z.length;P++,F=z[P])G=I[P]=d(G),M=v(F,c,F===b,M,G,f);var Q=y.transition=M.then(function(){var d,e,g;if(y.transition!==Q)return A;for(d=o.length-1;d>=D;d--)g=o[d],g.self.onExit&&h.invoke(g.self.onExit,g.self,g.locals.globals),g.locals=null;for(d=D;d<z.length;d++)e=z[d],e.locals=I[d],e.self.onEnter&&h.invoke(e.self.onEnter,e.self,e.locals.globals);return r&&(c["#"]=r),y.transition!==Q?A:(y.$current=b,y.current=b.self,y.params=c,O(y.params,n),y.transition=null,f.location&&b.navigable&&p.push(b.navigable.url,b.navigable.locals.globals.$stateParams,{$$avoidResync:!0,replace:"replace"===f.location}),f.notify&&a.$broadcast("$stateChangeSuccess",b.self,c,j.self,l),p.update(!0),y.current)},function(d){return y.transition!==Q?A:(y.transition=null,g=a.$broadcast("$stateChangeError",b.self,c,j.self,l,d),g.defaultPrevented||p.update(),e.reject(d))});return Q},y.is=function(a,b,d){d=N({relative:y.$current},d||{});var e=m(a,d.relative);return H(e)?y.$current!==e?!1:b?j(e.params.$$values(b),n):!0:c},y.includes=function(a,b,d){if(d=N({relative:y.$current},d||{}),J(a)&&r(a)){if(!s(a))return!1;a=y.$current.name}var e=m(a,d.relative);return H(e)?H(y.$current.includes[e.name])?b?j(e.params.$$values(b),n,g(b)):!0:!1:c},y.href=function(a,b,d){d=N({lossy:!0,inherit:!0,absolute:!1,relative:y.$current},d||{});var e=m(a,d.relative);if(!H(e))return null;d.inherit&&(b=i(n,b||{},y.$current,e));var f=e&&d.lossy?e.navigable:e;return f&&f.url!==c&&null!==f.url?p.href(f.url,k(e.params.$$keys().concat("#"),b||{}),{absolute:d.absolute}):null},y.get=function(a,b){if(0===arguments.length)return o(g(z),function(a){return z[a].self});var c=m(a,b||y.$current);return c&&c.self?c.self:null},y}function w(a,b,c,d,e,f){function g(a,b,c){function d(b){return"search"!=a.params[b].location}var e=a.params.$$keys().filter(d),f=l.apply({},[a.params].concat(e)),g=new P.ParamSet(f);return g.$$equals(b,c)}return!f.reload&&a===c&&(e===c.locals||a.self.reloadOnSearch===!1&&g(c,d,b))?!0:void 0}var x,y,z={},A={},B="abstract",C={parent:function(a){if(H(a.parent)&&a.parent)return m(a.parent);var b=/^(.+)\.[^.]+$/.exec(a.name);return b?m(b[1]):x},data:function(a){return a.parent&&a.parent.data&&(a.data=a.self.data=N({},a.parent.data,a.data)),a.data},url:function(a){var b=a.url,c={params:a.params||{}};if(J(b))return"^"==b.charAt(0)?e.compile(b.substring(1),c):(a.parent.navigable||x).url.concat(b,c);if(!b||e.isMatcher(b))return b;throw new Error("Invalid url '"+b+"' in state '"+a+"'")},navigable:function(a){return a.url?a:a.parent?a.parent.navigable:null},ownParams:function(a){var b=a.url&&a.url.params||new P.ParamSet;return M(a.params||{},function(a,c){b[c]||(b[c]=new P.Param(c,null,a,"config"))}),b},params:function(a){return a.parent&&a.parent.params?N(a.parent.params.$$new(),a.ownParams):new P.ParamSet},views:function(a){var b={};return M(H(a.views)?a.views:{"":a},function(c,d){d.indexOf("@")<0&&(d+="@"+a.parent.name),b[d]=c}),b},path:function(a){return a.parent?a.parent.path.concat(a):[]},includes:function(a){var b=a.parent?N({},a.parent.includes):{};return b[a.name]=!0,b},$delegates:{}};x=q({name:"",url:"^",views:null,"abstract":!0}),x.navigable=null,this.decorator=t,this.state=u,this.$get=v,v.$inject=["$rootScope","$q","$view","$injector","$resolve","$stateParams","$urlRouter","$location","$urlMatcherFactory"]}function w(){function a(a,b){return{load:function(c,d){var e,f={template:null,controller:null,view:null,locals:null,notify:!0,async:!0,params:{}};return d=N(f,d),d.view&&(e=b.fromConfig(d.view,d.params,d.locals)),e&&d.notify&&a.$broadcast("$viewContentLoading",d),e}}}this.$get=a,a.$inject=["$rootScope","$templateFactory"]}function x(){var a=!1;this.useAnchorScroll=function(){a=!0},this.$get=["$anchorScroll","$timeout",function(b,c){return a?b:function(a){return c(function(){a[0].scrollIntoView()},0,!1)}}]}function y(a,c,d,e){function f(){return c.has?function(a){return c.has(a)?c.get(a):null}:function(a){try{return c.get(a)}catch(b){return null}}}function g(a,b){var c=function(){return{enter:function(a,b,c){b.after(a),c()},leave:function(a,b){a.remove(),b()}}};if(j)return{enter:function(a,b,c){var d=j.enter(a,null,b,c);d&&d.then&&d.then(c)},leave:function(a,b){var c=j.leave(a,b);c&&c.then&&c.then(b)}};if(i){var d=i&&i(b,a);return{enter:function(a,b,c){d.enter(a,null,b),c()},leave:function(a,b){d.leave(a),b()}}}return c()}var h=f(),i=h("$animator"),j=h("$animate"),k={restrict:"ECA",terminal:!0,priority:400,transclude:"element",compile:function(c,f,h){return function(c,f,i){function j(){l&&(l.remove(),l=null),n&&(n.$destroy(),n=null),m&&(r.leave(m,function(){l=null}),l=m,m=null)}function k(g){var k,l=A(c,i,f,e),s=l&&a.$current&&a.$current.locals[l];if(g||s!==o){k=c.$new(),o=a.$current.locals[l];var t=h(k,function(a){r.enter(a,f,function(){n&&n.$emit("$viewContentAnimationEnded"),(b.isDefined(q)&&!q||c.$eval(q))&&d(a)}),j()});m=t,n=k,n.$emit("$viewContentLoaded"),n.$eval(p)}}var l,m,n,o,p=i.onload||"",q=i.autoscroll,r=g(i,c);c.$on("$stateChangeSuccess",function(){k(!1)}),c.$on("$viewContentLoading",function(){k(!1)}),k(!0)}}};return k}function z(a,b,c,d){return{restrict:"ECA",priority:-400,compile:function(e){var f=e.html();return function(e,g,h){var i=c.$current,j=A(e,h,g,d),k=i&&i.locals[j];if(k){g.data("$uiView",{name:j,state:k.$$state}),g.html(k.$template?k.$template:f);var l=a(g.contents());if(k.$$controller){k.$scope=e,k.$element=g;var m=b(k.$$controller,k);k.$$controllerAs&&(e[k.$$controllerAs]=m),g.data("$ngControllerController",m),g.children().data("$ngControllerController",m)}l(e)}}}}}function A(a,b,c,d){var e=d(b.uiView||b.name||"")(a),f=c.inheritedData("$uiView");return e.indexOf("@")>=0?e:e+"@"+(f?f.state.name:"")}function B(a,b){var c,d=a.match(/^\s*({[^}]*})\s*$/);if(d&&(a=b+"("+d[1]+")"),c=a.replace(/\n/g," ").match(/^([^(]+?)\s*(\((.*)\))?$/),!c||4!==c.length)throw new Error("Invalid state ref '"+a+"'");return{state:c[1],paramExpr:c[3]||null}}function C(a){var b=a.parent().inheritedData("$uiView");return b&&b.state&&b.state.name?b.state:void 0}function D(a,c){var d=["location","inherit","reload","absolute"];return{restrict:"A",require:["?^uiSrefActive","?^uiSrefActiveEq"],link:function(e,f,g,h){var i=B(g.uiSref,a.current.name),j=null,k=C(f)||a.$current,l="[object SVGAnimatedString]"===Object.prototype.toString.call(f.prop("href"))?"xlink:href":"href",m=null,n="A"===f.prop("tagName").toUpperCase(),o="FORM"===f[0].nodeName,p=o?"action":l,q=!0,r={relative:k,inherit:!0},s=e.$eval(g.uiSrefOpts)||{};b.forEach(d,function(a){a in s&&(r[a]=s[a])});var t=function(c){if(c&&(j=b.copy(c)),q){m=a.href(i.state,j,r);var d=h[1]||h[0];return d&&d.$$addStateInfo(i.state,j),null===m?(q=!1,!1):void g.$set(p,m)}};i.paramExpr&&(e.$watch(i.paramExpr,function(a,b){a!==j&&t(a)},!0),j=b.copy(e.$eval(i.paramExpr))),t(),o||f.bind("click",function(b){var d=b.which||b.button;if(!(d>1||b.ctrlKey||b.metaKey||b.shiftKey||f.attr("target"))){var e=c(function(){a.go(i.state,j,r)});b.preventDefault();var g=n&&!m?1:0;b.preventDefault=function(){g--<=0&&c.cancel(e)}}})}}}function E(a,b,c){return{restrict:"A",controller:["$scope","$element","$attrs",function(b,d,e){function f(){g()?d.addClass(i):d.removeClass(i)}function g(){for(var a=0;a<j.length;a++)if(h(j[a].state,j[a].params))return!0;return!1}function h(b,c){return"undefined"!=typeof e.uiSrefActiveEq?a.is(b.name,c):a.includes(b.name,c)}var i,j=[];i=c(e.uiSrefActiveEq||e.uiSrefActive||"",!1)(b),this.$$addStateInfo=function(b,c){var e=a.get(b,C(d));j.push({state:e||{name:b},params:c}),f()},b.$on("$stateChangeSuccess",f)}]}}function F(a){var b=function(b){return a.is(b)};return b.$stateful=!0,b}function G(a){var b=function(b){return a.includes(b)};return b.$stateful=!0,b}var H=b.isDefined,I=b.isFunction,J=b.isString,K=b.isObject,L=b.isArray,M=b.forEach,N=b.extend,O=b.copy;b.module("ui.router.util",["ng"]),b.module("ui.router.router",["ui.router.util"]),b.module("ui.router.state",["ui.router.router","ui.router.util"]),b.module("ui.router",["ui.router.state"]),b.module("ui.router.compat",["ui.router"]),p.$inject=["$q","$injector"],b.module("ui.router.util").service("$resolve",p),q.$inject=["$http","$templateCache","$injector"],b.module("ui.router.util").service("$templateFactory",q);var P;r.prototype.concat=function(a,b){var c={caseInsensitive:P.caseInsensitive(),strict:P.strictMode(),squash:P.defaultSquashPolicy()};return new r(this.sourcePath+a+this.sourceSearch,N(c,b),this)},r.prototype.toString=function(){return this.source},r.prototype.exec=function(a,b){function c(a){function b(a){return a.split("").reverse().join("")}function c(a){return a.replace(/\\-/g,"-")}var d=b(a).split(/-(?!\\)/),e=o(d,b);return o(e,c).reverse()}var d=this.regexp.exec(a);if(!d)return null;b=b||{};var e,f,g,h=this.parameters(),i=h.length,j=this.segments.length-1,k={};if(j!==d.length-1)throw new Error("Unbalanced capture group in route '"+this.source+"'");for(e=0;j>e;e++){g=h[e];var l=this.params[g],m=d[e+1];for(f=0;f<l.replace;f++)l.replace[f].from===m&&(m=l.replace[f].to);m&&l.array===!0&&(m=c(m)),k[g]=l.value(m)}for(;i>e;e++)g=h[e],k[g]=this.params[g].value(b[g]);return k},r.prototype.parameters=function(a){return H(a)?this.params[a]||null:this.$$paramNames},r.prototype.validates=function(a){return this.params.$$validates(a)},r.prototype.format=function(a){function b(a){return encodeURIComponent(a).replace(/-/g,function(a){return"%5C%"+a.charCodeAt(0).toString(16).toUpperCase()})}a=a||{};var c=this.segments,d=this.parameters(),e=this.params;if(!this.validates(a))return null;var f,g=!1,h=c.length-1,i=d.length,j=c[0];for(f=0;i>f;f++){var k=h>f,l=d[f],m=e[l],n=m.value(a[l]),p=m.isOptional&&m.type.equals(m.value(),n),q=p?m.squash:!1,r=m.type.encode(n);if(k){var s=c[f+1];if(q===!1)null!=r&&(j+=L(r)?o(r,b).join("-"):encodeURIComponent(r)),j+=s;else if(q===!0){var t=j.match(/\/$/)?/\/?(.*)/:/(.*)/;j+=s.match(t)[1]}else J(q)&&(j+=q+s)}else{if(null==r||p&&q!==!1)continue;L(r)||(r=[r]),r=o(r,encodeURIComponent).join("&"+l+"="),j+=(g?"&":"?")+(l+"="+r),g=!0}}return j},s.prototype.is=function(a,b){return!0},s.prototype.encode=function(a,b){return a},s.prototype.decode=function(a,b){return a},s.prototype.equals=function(a,b){return a==b},s.prototype.$subPattern=function(){var a=this.pattern.toString();return a.substr(1,a.length-2)},s.prototype.pattern=/.*/,s.prototype.toString=function(){return"{Type:"+this.name+"}"},s.prototype.$normalize=function(a){return this.is(a)?a:this.decode(a)},s.prototype.$asArray=function(a,b){function d(a,b){function d(a,b){return function(){return a[b].apply(a,arguments)}}function e(a){return L(a)?a:H(a)?[a]:[]}function f(a){switch(a.length){case 0:return c;case 1:return"auto"===b?a[0]:a;default:return a}}function g(a){return!a}function h(a,b){return function(c){c=e(c);var d=o(c,a);return b===!0?0===n(d,g).length:f(d)}}function i(a){return function(b,c){var d=e(b),f=e(c);if(d.length!==f.length)return!1;for(var g=0;g<d.length;g++)if(!a(d[g],f[g]))return!1;return!0}}this.encode=h(d(a,"encode")),this.decode=h(d(a,"decode")),this.is=h(d(a,"is"),!0),this.equals=i(d(a,"equals")),this.pattern=a.pattern,this.$normalize=h(d(a,"$normalize")),this.name=a.name,this.$arrayMode=b}if(!a)return this;if("auto"===a&&!b)throw new Error("'auto' array mode is for query parameters only");return new d(this,a)},b.module("ui.router.util").provider("$urlMatcherFactory",t),b.module("ui.router.util").run(["$urlMatcherFactory",function(a){}]),u.$inject=["$locationProvider","$urlMatcherFactoryProvider"],b.module("ui.router.router").provider("$urlRouter",u),v.$inject=["$urlRouterProvider","$urlMatcherFactoryProvider"],b.module("ui.router.state").value("$stateParams",{}).provider("$state",v),w.$inject=[],b.module("ui.router.state").provider("$view",w),b.module("ui.router.state").provider("$uiViewScroll",x),y.$inject=["$state","$injector","$uiViewScroll","$interpolate"],z.$inject=["$compile","$controller","$state","$interpolate"],b.module("ui.router.state").directive("uiView",y),b.module("ui.router.state").directive("uiView",z),D.$inject=["$state","$timeout"],E.$inject=["$state","$stateParams","$interpolate"],b.module("ui.router.state").directive("uiSref",D).directive("uiSrefActive",E).directive("uiSrefActiveEq",E),F.$inject=["$state"],G.$inject=["$state"],b.module("ui.router.state").filter("isState",F).filter("includedByState",G)}(window,window.angular),function(a,b,c){function d(a,b,c){return a.addEventListener?void a.addEventListener(b,c,!1):void a.attachEvent("on"+b,c)}function e(a){if("keypress"==a.type){var b=String.fromCharCode(a.which);return a.shiftKey||(b=b.toLowerCase()),b}return r[a.which]?r[a.which]:s[a.which]?s[a.which]:String.fromCharCode(a.which).toLowerCase()}function f(a,b){return a.sort().join(",")===b.sort().join(",")}function g(a){var b=[];return a.shiftKey&&b.push("shift"),a.altKey&&b.push("alt"),a.ctrlKey&&b.push("ctrl"),a.metaKey&&b.push("meta"),b}function h(a){return a.preventDefault?void a.preventDefault():void(a.returnValue=!1)}function i(a){return a.stopPropagation?void a.stopPropagation():void(a.cancelBubble=!0)}function j(a){return"shift"==a||"ctrl"==a||"alt"==a||"meta"==a}function k(){if(!q){q={};for(var a in r)a>95&&112>a||r.hasOwnProperty(a)&&(q[r[a]]=a)}return q}function l(a,b,c){return c||(c=k()[a]?"keydown":"keypress"),"keypress"==c&&b.length&&(c="keydown"),c}function m(a){return"+"===a?["+"]:(a=a.replace(/\+{2}/g,"+plus"),a.split("+"))}function n(a,b){var c,d,e,f=[];for(c=m(a),e=0;e<c.length;++e)d=c[e],u[d]&&(d=u[d]),b&&"keypress"!=b&&t[d]&&(d=t[d],f.push("shift")),j(d)&&f.push(d);return b=l(d,f,b),{key:d,modifiers:f,action:b}}function o(a,c){return null===a||a===b?!1:a===c?!0:o(a.parentNode,c)}function p(a){function c(a){a=a||{};var b,c=!1;for(b in u)a[b]?c=!0:u[b]=0;c||(x=!1)}function k(a,b,c,d,e,g){var h,i,k=[],l=c.type;if(!s._callbacks[a])return[];for("keyup"==l&&j(a)&&(b=[a]),h=0;h<s._callbacks[a].length;++h)if(i=s._callbacks[a][h],(d||!i.seq||u[i.seq]==i.level)&&l==i.action&&("keypress"==l&&!c.metaKey&&!c.ctrlKey||f(b,i.modifiers))){var m=!d&&i.combo==e,n=d&&i.seq==d&&i.level==g;(m||n)&&s._callbacks[a].splice(h,1),k.push(i)}return k}function l(a,b,c,d){s.stopCallback(b,b.target||b.srcElement,c,d)||a(b,c)===!1&&(h(b),i(b))}function m(a){"number"!=typeof a.which&&(a.which=a.keyCode);var b=e(a);if(b)return"keyup"==a.type&&v===b?void(v=!1):void s.handleKey(b,g(a),a)}function o(){clearTimeout(t),t=setTimeout(c,1e3)}function q(a,b,d,f){function g(b){return function(){x=b,++u[a],o()}}function h(b){l(d,b,a),"keyup"!==f&&(v=e(b)),setTimeout(c,10)}u[a]=0;for(var i=0;i<b.length;++i){var j=i+1===b.length,k=j?h:g(f||n(b[i+1]).action);r(b[i],k,f,a,i)}}function r(a,b,c,d,e){s._directMap[a+":"+c]=b,a=a.replace(/\s+/g," ");var f,g=a.split(" ");return g.length>1?void q(a,g,b,c):(f=n(a,c),s._callbacks[f.key]=s._callbacks[f.key]||[],k(f.key,f.modifiers,{type:f.action},d,a,e),void s._callbacks[f.key][d?"unshift":"push"]({callback:b,modifiers:f.modifiers,action:f.action,seq:d,level:e,combo:a}))}var s=this;if(a=a||b,!(s instanceof p))return new p(a);s.target=a,s._callbacks={},s._directMap={};var t,u={},v=!1,w=!1,x=!1;s._handleKey=function(a,b,d){var e,f=k(a,b,d),g={},h=0,i=!1;for(e=0;e<f.length;++e)f[e].seq&&(h=Math.max(h,f[e].level));for(e=0;e<f.length;++e)if(f[e].seq){if(f[e].level!=h)continue;i=!0,g[f[e].seq]=1,l(f[e].callback,d,f[e].combo,f[e].seq)}else i||l(f[e].callback,d,f[e].combo);var m="keypress"==d.type&&w;d.type!=x||j(a)||m||c(g),w=i&&"keydown"==d.type},s._bindMultiple=function(a,b,c){for(var d=0;d<a.length;++d)r(a[d],b,c)},d(a,"keypress",m),d(a,"keydown",m),d(a,"keyup",m)}for(var q,r={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"ins",46:"del",91:"meta",93:"meta",224:"meta"},s={106:"*",107:"+",109:"-",110:".",111:"/",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'"},t={"~":"`","!":"1","@":"2","#":"3",$:"4","%":"5","^":"6","&":"7","*":"8","(":"9",")":"0",_:"-","+":"=",":":";",'"':"'","<":",",">":".","?":"/","|":"\\"},u={option:"alt",command:"meta","return":"enter",escape:"esc",plus:"+",mod:/Mac|iPod|iPhone|iPad/.test(navigator.platform)?"meta":"ctrl"},v=1;20>v;++v)r[111+v]="f"+v;for(v=0;9>=v;++v)r[v+96]=v;p.prototype.bind=function(a,b,c){var d=this;return a=a instanceof Array?a:[a],d._bindMultiple.call(d,a,b,c),d},p.prototype.unbind=function(a,b){var c=this;return c.bind.call(c,a,function(){},b)},p.prototype.trigger=function(a,b,c){var d=this;return d._directMap[a+":"+b]&&d._directMap[a+":"+b](c||{},a),d},p.prototype.reset=function(){var a=this;return a._callbacks={},a._directMap={},a},p.prototype.stopCallback=function(a,b){var c=this;return(" "+b.className+" ").indexOf(" mousetrap ")>-1?!1:o(b,c.target)?!1:"INPUT"==b.tagName||"SELECT"==b.tagName||"TEXTAREA"==b.tagName||b.isContentEditable},p.prototype.handleKey=function(){var a=this;return a._handleKey.apply(a,arguments)},p.init=function(){var a=p(b);for(var c in a)"_"!==c.charAt(0)&&(p[c]=function(b){return function(){return a[b].apply(a,arguments)}}(c))},p.init(),a.Mousetrap=p,"undefined"!=typeof module&&module.exports&&(module.exports=p),"function"==typeof define&&define.amd&&define(function(){return p})}(window,document),function(a){function b(a){return a.preventDefault?void a.preventDefault():void(a.returnValue=!1)}function c(a,c,f){var g=this;if(!g.recording)return void o.apply(g,arguments);if(b(f),"keydown"==f.type){for(1===a.length&&m&&e(),i=0;i<c.length;++i)d(c[i]);d(a)}else"keyup"==f.type&&l.length>0&&e()}function d(a){var b;for(b=0;b<l.length;++b)if(l[b]===a)return;l.push(a),1===a.length&&(m=!0)}function e(){j.push(l),l=[],m=!1,h()}function f(a){var b;for(b=0;b<a.length;++b)a[b].sort(function(a,b){return a.length>1&&1===b.length?-1:1===a.length&&b.length>1?1:a>b?1:-1}),a[b]=a[b].join("+")}function g(){k&&(f(j),k(j)),j=[],k=null,l=[]}function h(){clearTimeout(n),n=setTimeout(g,1e3)}var j=[],k=null,l=[],m=!1,n=null,o=a.prototype.handleKey;a.prototype.record=function(a){var b=this;b.recording=!0,k=function(){b.recording=!1,a.apply(b,arguments)}},a.prototype.handleKey=function(){var a=this;c.apply(a,arguments)},a.init()}(Mousetrap),R.countWatchers=function(){var a=angular.element(document.getElementsByTagName("body")),b=[],c=function e(a){angular.forEach(["$scope","$isolateScope"],function(c){a.data()&&a.data().hasOwnProperty(c)&&angular.forEach(a.data()[c].$$watchers,function(a){b.push(a)})}),angular.forEach(a.children(),function(a){e(angular.element(a))})};c(a);var d=[];angular.forEach(b,function(a){d.indexOf(a)<0&&d.push(a)})},R.curryService=function(){return function(a){R.pipe(R.keys,R.filter(R.compose(R.equals("Function"),R.type,R.flip(R.prop)(a))),R.reject(R.compose(R.not,R.isEmpty,R.match(/\$$/))),R.forEach(function(b){a[b+"$"]=R.curry(a[b])}))(a)}}(),function(){R.extend=function(a){for(var b=arguments.length,c=Array(b>1?b-1:0),d=1;b>d;d++)c[d-1]=arguments[d];return R.forEach(function(b){for(var c in b)a[c]=b[c]},c),a},R.deepExtend=function(a){for(var b=/#{\s*?_\s*?}/,c=arguments.length,d=Array(c>1?c-1:0),e=1;c>e;e++)d[e-1]=arguments[e];return R.forEach(function(c){for(var d in c)if(R.isNil(a[d])||"Function"===R.type(a[d])||"Date"===R.type(c[d]))a[d]=c[d];else if("String"===R.type(c[d])&&b.test(c[d]))"String"===R.type(a[d])&&(a[d]=c[d].replace(b,a[d]));else if("Array"===R.type(a[d])||"Array"===R.type(c[d])){if("Array"!==R.type(a[d])||"Array"!==R.type(c[d]))throw new Error("Trying to combine an array with a non-array ("+d+")");a[d]=R.deepExtend(a[d],c[d])}else if("Object"===R.type(a[d])||"Object"===R.type(c[d])){if("Object"!==R.type(a[d])||"Object"!==R.type(c[d]))throw new Error("Trying to combine an object with a non-object ("+d+")");a[d]=R.deepExtend(a[d],c[d])}else a[d]=c[d]},d),a}}(),R.exists=function(a){return!R.isNil(a)},function(){R.promiseAll=R.bind(self.Promise.all,self.Promise),R.resolveP=R.bind(self.Promise.resolve,self.Promise),R.rejectP=R.bind(self.Promise.reject,self.Promise),R.rejectIf=R.curry(function(a,b,c){return a(c)?self.Promise.reject(b):c}),R.condErrorP=R.curry(function(a,b){return b["catch"](R.cond(R.append([R.T,R.rejectP],a)))})}(),function(){function a(b,c){var d=0,e=c-b,f=R.exists(Math.log2)?Math.ceil(Math.log2(e)):30;if(f>53)throw new self.Exception("We cannot generate numbers larger than 53 bits.");var g=Math.ceil(f/8),h=Math.pow(2,f)-1,i=new Uint8Array(g);self.crypto.getRandomValues(i);for(var j=8*(g-1),k=0;g>k;k++)d+=i[k]*Math.pow(2,j),j-=8;return d&=h,d>=e?a(b,c):b+d}R.random=function(){return a(0,1e9)/1e9},R.randomRange=function(a,b){return a+R.random()*(b-a+1)|0},R.guid=function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(a){var b=16*R.random()|0,c="x"==a?b:3&b|8;return c.toString(16)})}}(),function(){R.spy=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return function(a){return a}},R.spyDebug=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return function(a){return a}},R.spyInfo=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return function(a){return a}},R.spyWarn=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return function(a){return a}},R.spyError=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return function(a){return a}},R.spyAndDiscardError=function(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return R.pipe(R.spyError.apply(R,b),R.always(null))}}(),function(){R.thread=function(a){return function(){for(var b=arguments.length,c=Array(b),d=0;b>d;d++)c[d]=arguments[d];return R.pipe.apply(R,c)(a)}},R.threadP=function(a){return function(){for(var b=arguments.length,c=Array(b),d=0;b>d;d++)c[d]=arguments[d];return R.pipeP.apply(R,[R.always(self.Promise.resolve(a))].concat(c))()}}}(),function(){angular.module("clickApp.controllers",[]),angular.module("clickApp.directives",[]),angular.module("clickApp.filters",[]),angular.module("clickApp.models",[]),angular.module("clickApp.services",[]),angular.module("clickApp",["ui.router","clickApp.controllers","clickApp.directives","clickApp.filters","clickApp.models","clickApp.services"])}(),function(){function a(a){a.otherwise("/lounge")}function b(a){a.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|blob):/)}angular.module("clickApp").config(a).config(b),a.$inject=["$urlRouterProvider"],b.$inject=["$compileProvider"]}(),function(){function a(a,b,c,d){function e(){for(var b=arguments.length,d=Array(b),e=0;b>e;e++)d[e]=arguments[e];return c.queueEventP(d,a.state)}function f(){for(var b=arguments.length,d=Array(b),e=0;b>e;e++)d[e]=arguments[e];return c.queueChangeEventP(d,a.state)}function g(b,d,e){var f=c.onChangeEvent(b,d,a.state);e.$on("$destroy",function(){f()})}function h(a,b){g(a,function(){b.$digest()},b)}function i(){d.isValid(a.state.user)||b.go("user"),a.$digest()}function j(){return R.path(["current","data","hide_nav"],b)}function k(a){return b.is(a)}function l(a){return 0<=b.current.name.indexOf(a)}function m(){for(var a=arguments.length,c=Array(a),d=0;a>d;d++)c[d]=arguments[d];self.setTimeout(function(){b.go.apply(b,c)},100)}function n(){a.stateEvent("State.init"),a.state.user_ready.then(o),a.onStateChangeEvent("User.change",i,a)}function o(){d.isValid(a.state.user)||b.transitionTo("user")}var p=this;p.isNavHidden=j,p.stateIs=k,p.stateMatches=l,p.goToState=m,a.state=c.create(),a.stateIs=k,a.stateEvent=e,a.stateChangeEvent=f,a.onStateChangeEvent=g,a.digestOnStateChangeEvent=h,a.goToState=m,n()}angular.module("clickApp.controllers").controller("appCtrl",a),a.$inject=["$rootScope","$state","state","user"]}(),function(){function a(){return function(a){return s.capitalize(a)}}function b(a){return function(b,c){if(R.isNil(a[c]))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function c(a){return function(b,c){if(R.isNil(a[c]))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function d(a){return function(b,c){if(R.isNil(a[c]))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function e(a){return function(b,c){if(R.isNil(a[c]))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function f(a){return function(b,c){if(R.isNil(a[c]))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function g(a){return function(b,c){if(R.isNil(a[c]))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}function h(a){return function(b,c){if(R.isNil(a[c]))return null;for(var d=arguments.length,e=Array(d>2?d-2:0),f=2;d>f;f++)e[f-2]=arguments[f];return a[c].apply(null,R.append(b,e))}}angular.module("clickApp.filters").filter("capitalize",a).filter("game",b).filter("gameConnection",c).filter("gameLayers",d).filter("gameLos",e).filter("gameRuler",f).filter("user",g).filter("userConnection",h),a.$inject=[],b.$inject=["game"],c.$inject=["gameConnection"],d.$inject=["gameLayers"],e.$inject=["gameLos"],f.$inject=["gameRuler"],g.$inject=["user"],h.$inject=["userConnection"]}(),function(){function a(a){a.state("debug",{url:"/debug",templateUrl:"app/views/debug/debug.html",controller:"debugCtrl",controllerAs:"debug"})}angular.module("clickApp").config(a),a.$inject=["$stateProvider"]}(),function(){function a(a){function b(b,c){e.result=c,a.$digest()}function c(b,c){a.app.goToState("game.main",{online:"offline","private":"private",id:c})}function d(b){a.stateEvent("State.loadDumpFile",b[0])}var e=this;a.onStateChangeEvent("State.loadDumpFile",b,a),a.onStateChangeEvent("Games.local.load",c,a),e.doLoadDumpFile=d}angular.module("clickApp.controllers").controller("debugCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){a.state("game",{"abstract":!0,url:"/game/:online/:private/:id",templateUrl:"app/views/game/game.html",controller:"gameCtrl",controllerAs:"game"}).state("game.main",{url:"/main",templateUrl:"app/views/game/main/game_main.html",controller:"gameMainCtrl",controllerAs:"game_main",data:{hide_nav:!0}}).state("game.model",{url:"/model",templateUrl:"app/views/game/model/game_model.html",controller:"gameModelCtrl",controllerAs:"game_model",data:{hide_nav:!0}}).state("game.setup",{url:"/setup",templateUrl:"app/views/game/setup/game_setup.html",controller:"gameSetupCtrl",controllerAs:"game_setup",data:{hide_nav:!0}}).state("game.save",{url:"/save",templateUrl:"app/views/game/save/game_save.html",controller:"gameSaveCtrl",controllerAs:"game_save",data:{hide_nav:!0}}).state("game.help",{url:"/help",templateUrl:"app/views/game/help/game_help.html",controller:"gameHelpCtrl",controllerAs:"game_help",data:{hide_nav:!0}}).state("game.log",{url:"/log",templateUrl:"app/views/game/log/game_log.html",controller:"gameLogCtrl",controllerAs:"log",data:{hide_nav:!0}}).state("game.online",{url:"/online",templateUrl:"app/views/game/online/game_online.html",controller:"gameOnlineCtrl",controllerAs:"game_online",data:{hide_nav:!0}})}angular.module("clickApp").config(a),a.$inject=["$stateProvider"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c){function d(){l.show_action_group=null,l.invite_player=null,a.stateEvent("Game.load",m,n,o),a.digestOnStateChangeEvent("Game.load.success",a),a.onStateChangeEvent("Game.load.error",e,a),a.digestOnStateChangeEvent("Game.layers.change",a),a.digestOnStateChangeEvent("Game.board.change",a),a.digestOnStateChangeEvent("Game.scenario.change",a),a.digestOnStateChangeEvent("Game.model.create.enable",a),a.digestOnStateChangeEvent("Game.template.create.enable",a),a.digestOnStateChangeEvent("Game.terrain.create.enable",a),
a.digestOnStateChangeEvent("Game.players.change",a),a.digestOnStateChangeEvent("User.change",a),a.onStateChangeEvent("Modes.change",f,a),a.onStateChangeEvent("Modes.buttons.update",f,a),a.$on("$destroy",function(){a.stateEvent("Modes.exit")})}function e(){a.goToState("lounge")}function f(){l.action_bindings=R.thread(a)(R.path(["state","modes"]),c.currentModeBindings,R.clone),l.action_buttons=R.thread(a)(R.path(["state","modes"]),c.currentModeButtons,R.clone),a.$digest()}function g(){return R.thread(a)(R.pathOr({},["state","modes"]),c.currentModeName)}function h(a){return g()===a}function i(b){for(var c=arguments.length,d=Array(c>1?c-1:0),e=1;c>e;e++)d[e-1]=arguments[e];a.stateEvent("Modes.current.action",b,[].concat(d,[{}]))}function j(b){var c=_slicedToArray(b,3),d=(c[0],c[1]),e=c[2];return"toggle"===d?void(l.show_action_group=l.show_action_group===e?null:e):void a.stateEvent("Modes.current.action",d,[{}])}function k(){R.isNil(l.invite_player)||a.stateEvent("Game.invitePlayer",l.invite_player)}var l=this,m=R.propEq("online","online",b),n=R.propEq("private","private",b),o=R.prop("id",b);l.currentModeName=g,l.currentModeIs=h,l.doModeAction=i,l.doActionButton=j,l.doInvitePlayer=k,d()}angular.module("clickApp.controllers").controller("gameCtrl",a),a.$inject=["$scope","$stateParams","modes"]}(),function(){function a(a,b){function c(){e.exports=R.clone(R.path(["state","exports"],a)),a.$digest()}function d(){e.bindings_pairs=R.thread(a)(R.path(["state","modes"]),b.currentModeBindingsPairs,R.sortBy(R.head)),a.$digest()}var e=this;a.onStateChangeEvent("Exports.dump",c,a),self.requestAnimationFrame(c),a.onStateChangeEvent("Modes.change",d,a),self.requestAnimationFrame(d)}angular.module("clickApp.controllers").controller("gameHelpCtrl",a),a.$inject=["$scope","modes"]}(),function(){function a(a){function b(){a.onStateChangeEvent("Game.command.execute",c,a),a.onStateChangeEvent("Game.command.replay",c,a),a.onStateChangeEvent("Game.command.undo",c,a),a.onStateChangeEvent("Game.loaded",c,a),self.requestAnimationFrame(c)}function c(){d.undo=R.path(["state","game","undo"],a),d.undo_log=R.path(["state","game","undo_log"],a),d.commands_log=R.path(["state","game","commands_log"],a),d.commands=R.path(["state","game","commands"],a),a.$digest()}var d=this;b()}angular.module("clickApp.controllers").controller("gameLogCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){function b(){a.digestOnStateChangeEvent("Game.ruler.remote.change",a),a.digestOnStateChangeEvent("Game.los.remote.change",a)}function c(){a.game.currentModeIs("Ruler")?a.game.doModeAction("modeBackToDefault"):a.game.doModeAction("enterRulerMode")}function d(){a.stateEvent("Game.command.execute","setRuler",["toggleDisplay",[]])}function e(){a.game.currentModeIs("Los")?a.game.doModeAction("modeBackToDefault"):a.game.doModeAction("enterLosMode")}function f(){a.stateEvent("Game.command.execute","setLos",["toggleDisplay",[]])}function g(b){a.stateEvent("Game.template.create",b)}var h=this;h.doUseRuler=c,h.doToggleShowRuler=d,h.doUseLos=e,h.doToggleShowLos=f,h.doCreateTemplate=g,b()}angular.module("clickApp.controllers").controller("gameMainCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){function b(){o.import_list=null,a.state.data_ready.then(c)}function c(){o.factions=R.path(["state","factions","current"],a),o.faction=R.head(R.keys(o.factions)),o.onFactionChange(),a.$digest()}function d(){o.section=R.head(R.keys(o.factions[o.faction].models)),o.onSectionChange()}function e(){o.entry=R.head(R.keys(o.factions[o.faction].models[o.section])),o.onEntryChange()}function f(){var b=o.getEntries();return R.isNil(b)?(o.model=a.entry,void o.onModelChange()):(o.type=R.head(R.keys(b)),void o.onTypeChange())}function g(){var a=o.getEntries();o.model=R.thread(a)(R.defaultTo({}),R.prop(o.type),R.defaultTo({}),R.keys(),R.head()),o.onModelChange()}function h(){o.repeat=1}function i(){return R.path([o.faction,"models",o.section,o.entry,"entries"],o.factions)}function j(){var a=o.getEntries();return R.isNil(a)?R.path([o.faction,"models",o.section,o.entry],o.factions):R.path([o.type,o.model],a)}function k(){var a=o.getEntries();return R.isNil(a)?[o.faction,"models",o.section,o.entry]:[o.faction,"models",o.section,o.entry,"entries",o.type,o.model]}function l(){var b=k();a.stateEvent("Game.model.create",b,o.repeat)}function m(){a.stateEvent("Game.model.importList",o.import_list)}function n(b){a.stateEvent("Game.model.importFile",b[0])}var o=this;o.onFactionChange=d,o.onSectionChange=e,o.onEntryChange=f,o.onTypeChange=g,o.onModelChange=h,o.getEntries=i,o.getModel=j,o.doCreateModel=l,o.doImportList=m,o.doImportModelsFile=n,b()}angular.module("clickApp.controllers").controller("gameModelCtrl",a),a.$inject=["$scope"]}(),function(){function a(a,b){function c(){g.games_selection={},a.onStateChangeEvent("Games.online.load",f,a),a.state.user_ready.then(d)}function d(){b.online(a.state.user)||a.goToState("^.main")}function e(){R.thread(a.state)(R.pathOr([],["user","connection","games"]),R.nth(g.games_selection.list[0]),R.defaultTo({}),R.propOr("null","public_stamp"),function(b){a.stateEvent("Games.online.load",b)})}function f(b,c,d){a.goToState("game.main",{online:"online","private":c,id:d}),a.$digest()}var g=this;g.doLoadOnlineGame=e,c()}angular.module("clickApp.controllers").controller("gameOnlineCtrl",a),a.$inject=["$scope","user"]}(),function(){function a(a){function b(){a.onStateChangeEvent("Exports.game",c,a),a.onStateChangeEvent("Exports.board",c,a),a.onStateChangeEvent("Exports.models",c,a),self.requestAnimationFrame(c)}function c(){d.exports=R.path(["state","exports"],a),a.$digest()}var d=this;b()}angular.module("clickApp.controllers").controller("gameSaveCtrl",a),a.$inject=["$scope"]}(),function(){function a(a,b){function c(){a.state.data_ready.then(d),a.onStateChangeEvent("Game.board.change",e,a),self.requestAnimationFrame(e),a.onStateChangeEvent("Game.scenario.change",h,a),self.requestAnimationFrame(h),a.onStateChangeEvent("Game.layers.change",l,a),a.onStateChangeEvent("Game.load.success",l,a),self.requestAnimationFrame(l),a.$on("$destroy",function(){a.stateEvent("Game.scenario.refresh")}),a.stateEvent("Game.scenario.refresh")}function d(){v.boards=a.state.boards,v.terrains=a.state.terrains,v.ambiance=R.head(R.keys(v.terrains)),v.onAmbianceChange(),v.scenarios=a.state.scenarios,a.$digest()}function e(){v.board_name=R.path(["game","board","name"],a.state),a.$digest()}function f(){a.stateEvent("Game.board.set",v.board_name)}function g(){a.stateEvent("Game.board.setRandom")}function h(){v.scenario_name=R.path(["state","game","scenario","name"],a),v.scenario_group=b.groupForName(v.scenario_name,v.scenarios),a.$digest()}function i(){R.isNil(v.scenario_name)||a.stateEvent("Game.scenario.set",v.scenario_name,v.scenario_group)}function j(){a.stateEvent("Game.scenario.setRandom")}function k(){a.stateEvent("Game.scenario.generateObjectives")}function l(){v.layers=R.path(["state","game","layers"],a),a.$digest()}function m(b){a.stateEvent("Game.command.execute","setLayers",["toggle",b])}function n(){v.category=R.head(R.keys(v.terrains[v.ambiance])),v.onCategoryChange()}function o(){v.entry=R.head(R.keys(v.terrains[v.ambiance][v.category])),v.onEntryChange()}function p(){}function q(){return[v.ambiance,v.category,v.entry]}function r(){return R.path([v.ambiance,v.category,v.entry],v.terrains)}function s(){var b=q();a.stateEvent("Game.terrain.create",b)}function t(){a.stateEvent("Game.terrain.reset")}function u(b){a.stateEvent("Game.board.importFile",b[0])}var v=this;v.doSetBoard=f,v.doSetRandomBoard=g,v.doSetScenario=i,v.doSetRandomScenario=j,v.doGenerateObjectives=k,v.doToggleLayer=m,v.onAmbianceChange=n,v.onCategoryChange=o,v.onEntryChange=p,v.getTerrain=r,v.doCreateTerrain=s,v.doResetTerrain=t,v.doImportBoardFile=u,c()}angular.module("clickApp.controllers").controller("gameSetupCtrl",a),a.$inject=["$scope","gameScenario"]}(),function(){function a(a){a.state("info",{url:"/info",templateUrl:"app/views/info/info.html",controller:"infoCtrl",controllerAs:"info",data:{}})}function b(a){a.aHrefSanitizationWhitelist(/^\s*(https?|ftp|mailto|blob):/)}angular.module("clickApp").config(a),a.$inject=["$stateProvider"],b.$inject=["$compileProvider"]}(),function(){function a(){}angular.module("clickApp.controllers").controller("infoCtrl",a),a.$inject=[]}(),function(){function a(a){a.state("lounge",{url:"/lounge",templateUrl:"app/views/lounge/lounge.html",controller:"loungeCtrl",controllerAs:"lounge",data:{}})}angular.module("clickApp").config(a),a.$inject=["$stateProvider"]}(),function(){function a(a){function b(){n.local_games_selection={},n.online_games_selection={},a.digestOnStateChangeEvent("Games.local.change",a),a.onStateChangeEvent("Games.local.load",h,a),a.onStateChangeEvent("Games.online.load",m,a)}function c(){var b=R.isEmpty(a.state.local_games)||R.isEmpty(n.local_games_selection.list);return b}function d(){a.stateEvent("Games.local.create")}function e(){var b=R.thread(a.state.local_games)(R.nth(n.local_games_selection.list[0]),R.prop("local_stamp"));a.stateEvent("Games.local.load",b)}function f(b){a.stateEvent("Games.local.loadFile",b[0])}function g(){var b=R.thread(a.state.local_games)(R.nth(n.local_games_selection.list[0]),R.prop("local_stamp"));a.stateEvent("Games.local.delete",b)}function h(b,c){a.goToState("game.main",{online:"offline","private":"private",id:c}),a.$digest()}function i(){a.stateEvent("User.toggleOnline")}function j(){a.stateEvent("Games.online.create")}function k(){R.thread(a.state)(R.pathOr([],["user","connection","games"]),R.nth(n.online_games_selection.list[0]),R.defaultTo({}),R.propOr("null","public_stamp"),function(b){a.stateEvent("Games.online.load",b)})}function l(b){a.stateEvent("Games.online.loadFile",b[0])}function m(b,c,d){a.goToState("game.main",{online:"online","private":c,id:d}),a.$digest()}var n=this;n.localGamesIsEmpty=c,n.doCreateLocalGame=d,n.doLoadLocalGame=e,n.doOpenLocalGameFile=f,n.doDeleteLocalGame=g,n.doUserToggleOnline=i,n.doCreateOnlineGame=j,n.doLoadOnlineGame=k,n.doOpenOnlineGameFile=l,b()}angular.module("clickApp.controllers").controller("loungeCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){a.state("settings",{"abstract":!0,url:"/settings",templateUrl:"app/views/settings/settings.html",controller:"settingsCtrl",controllerAs:"settings",data:{}}).state("settings.Main",{url:"/main",templateUrl:"app/views/settings/main/settings_main.html",controller:"settingsMainCtrl",controllerAs:"settings_main"}).state("settings.Models",{url:"/models",templateUrl:"app/views/settings/models/settings_models.html",controller:"settingsModelsCtrl",controllerAs:"settings_models"}).state("settings.Bindings",{url:"/bindings",templateUrl:"app/views/settings/bindings/settings_bindings.html",controller:"settingsBindingsCtrl",controllerAs:"settings_bindings"}).state("settings.Misc",{url:"/misc",templateUrl:"app/views/settings/misc/settings_misc.html",controller:"settingsMiscCtrl",controllerAs:"settings_misc"})}angular.module("clickApp").config(a),a.$inject=["$stateProvider"]}(),function(){function a(a){function b(){a.state.data_ready.then(c),a.onStateChangeEvent("Settings.change",c,a)}function c(){e.edit=R.thread(a.state)(R.path(["settings","current"]),JSON.stringify,JSON.parse),e.menu=R.thread(a.state)(R.path(["settings","default"]),R.keys,R.concat(["Main","Models"])),a.$digest()}function d(){a.stateEvent("Settings.reset",e.edit)}var e=this;e.doUpdateSettings=d,b()}angular.module("clickApp.controllers").controller("settingsCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){function b(){a.state.data_ready.then(d),a.$on("$destroy",a.settings.doUpdateSettings)}function c(){return R.thread(a.state)(R.path(["settings","default","Bindings",f.mode]),R.keys,R.sortBy(R.identity))}function d(){f.modes=R.thread(a.state)(R.path(["settings","default","Bindings"]),R.keys,R.sortBy(R.identity)),f.mode=R.defaultTo(R.head(f.modes),f.mode),a.$digest()}function e(b){function c(a){Mousetrap.record(function(b){a(b)})}function d(c){R.isNil(c)||R.isEmpty(c)||(a.settings.edit.Bindings[f.mode][b]=c.join(" "))}function e(){f.recording=null,a.$digest()}return f.recording?null:(f.recording=b,R.threadP(new self.Promise(c))(d,e))}var f=this;f.getBindingsKeysForMode=c,f.doRecordBinding=e,b()}angular.module("clickApp.controllers").controller("settingsBindingsCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){function b(){a.digestOnStateChangeEvent("Exports.settings",a),a.onStateChangeEvent("Settings.loadFile",c,a)}function c(b,c){f.load_settings_result=c,a.$digest()}function d(b){a.stateEvent("Settings.loadFile",b[0])}function e(){a.stateEvent("Settings.reset",{})}var f=this;f.doLoadSettingsFile=d,f.doResetSettings=e,b()}angular.module("clickApp.controllers").controller("settingsMainCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){function b(){a.state.data_ready.then(c),a.$on("$destroy",a.settings.doUpdateSettings)}function c(){d.modes=R.thread(a.state)(R.path(["settings","default","Misc"]),R.keys,R.sortBy(R.identity)),d.mode=R.defaultTo(R.head(d.modes),d.mode),a.$digest()}var d=this;b()}angular.module("clickApp.controllers").controller("settingsMiscCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){function b(){self.requestAnimationFrame(c),a.onStateChangeEvent("Factions.change",c,a),a.onStateChangeEvent("Factions.loadDescFile",d,a)}function c(){i.factions=R.path(["factions","base"],a.state),a.$digest()}function d(b,c){a.result=c,a.$digest()}function e(b){return R.thread(a.state)(R.path(["factions","desc",b]),R.type,R.equals("Object"))}function f(b,c){a.stateEvent("Factions.loadDescFile",b,c[0])}function g(b){a.stateEvent("Factions.clearDesc",b)}function h(){a.stateEvent("Factions.clearAllDesc")}var i=this;i.hasDesc=e,i.doOpenFactionFile=f,i.doClearFactionDesc=g,i.doClearAllDesc=h,b()}angular.module("clickApp.controllers").controller("settingsModelsCtrl",a),a.$inject=["$scope"]}(),function(){function a(a){a.state("user",{url:"/user",templateUrl:"app/views/user/user.html",controller:"userCtrl",controllerAs:"user",data:{}})}function b(a,b,c){a.$on("$stateChangeStart",function(d,e){a.state.user_ready.fulfilled&&"user"!==e.name&&(c.isValid(a.state.user)||(b.transitionTo("user"),d.preventDefault()))})}angular.module("clickApp").config(a).run(b),a.$inject=["$stateProvider"],b.$inject=["$rootScope","$state","user"]}(),function(){function a(a){function b(){a.stateEvent("User.set",d.edit).then(function(){a.goToState("lounge")})}function c(){a.state.user_ready.then(function(){d.edit=R.clone(a.state.user.state),a.$digest()})}var d=this;d.doSave=b,c()}angular.module("clickApp.controllers").controller("userCtrl",a),a.$inject=["$scope"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(){function a(a,b){h[a]=b}function b(a,b,c,d){function e(b){var c=_slicedToArray(b,2),d=c[0],e=c[1];return[R.assoc("type",a,d),e]}return R.threadP(a)(f,function(a){return a.executeP.apply(null,[].concat(_toConsumableArray(b),[c,d]))},e)}function c(a,b,c){return R.threadP(a)(e,function(d){return d.undoP(a,b,c)})}function d(a,b,c){return R.threadP(a)(e,function(d){return d.replayP(a,b,c)})}function e(a){return R.threadP(a)(R.prop("type"),f)}function f(a){return R.threadP(h)(R.prop(a),R.rejectIf(R.isNil,'Game: unknown command "'+a+'"'))}function g(a,b,c){function d(c){return i.replayP(a[0],b,c)["catch"](R.always(c))}function e(c){return g(R.tail(a),b,c)}return R.isEmpty(a)?self.Promise.resolve(c):R.threadP(c)(d,e)}var h={},i={registerCommand:a,executeP:b,undoP:c,replayP:d,replayBatchP:g};return R.curryService(i),i}angular.module("clickApp.services").factory("commands",a).factory("allCommands",["createModelCommand","deleteModelCommand","setModelSelectionCommand","lockModelsCommand","onModelsCommand","createTemplateCommand","deleteTemplateCommand","lockTemplatesCommand","onTemplatesCommand","createTerrainCommand","deleteTerrainCommand","lockTerrainsCommand","onTerrainsCommand","rollDiceCommand","rollDeviationCommand","setBoardCommand","setLayersCommand","setLosCommand","setRulerCommand","setScenarioCommand",function(){return{}}]),a.$inject=[]}(),function(){function a(a){return function(b,c,d,e,f){function g(d,e,g,h){function i(a){return R.thread(a)(k(d.base),R.omit(["stamp"]),f(g))}function j(a){var d,e=(d={},_defineProperty(d,b+"s",R.map(c.saveState,a)),_defineProperty(d,"desc",R.thread(a)(R.head,R.pathOr([],["state","info"]),R.join("."))),d);return R.thread(a)(q("local",g,h),function(a){return[e,a]})}var k=a.addToWithFlip$(e);return R.threadP(d)(R.prop(b+"s"),R.map(i),R.promiseAll,R.reject(R.isNil),R.rejectIf(R.isEmpty,"No valid "+b+" definition"),j)}function h(a,c,d){return R.threadP(a)(R.prop(b+"s"),R.map(f(c)),R.promiseAll,R.reject(R.isNil),R.rejectIf(R.isEmpty,"No valid "+b+" definition"),q("remote",c,d))}function i(a,c,f){var g=R.pluck("stamp",R.prop(b+"s",a));return R.thread(f)(R.over(R.lensProp(b+"s"),d.removeStamps$(g)),R.over(R.lensProp(b+"_selection"),e.removeFrom$("local",g,c)),R.over(R.lensProp(b+"_selection"),e.removeFrom$("remote",g,c)),function(a){return R.forEach(p(c),g),a},o(c))}function j(a,b){return c.createP(b)["catch"](R.always(null))}function k(a,c,f,g){function h(a){return R.thread(a)(R.prop(b+"s"),d.add$(g),function(c){return R.assoc(b+"s",c,a)})}function i(d){var f=R.map(R.path(["state","stamp"]),g);return R.thread(d)(R.prop(b+"_selection"),e.set$(a,f,c),function(a){return R.assoc(b+"_selection",a,d)})}return R.thread(f)(h,i,o(c))}function l(a,c){return a.queueChangeEventP("Game."+b+".create"),c}function m(a,b){a.queueChangeEventP("Game.model.delete."+b)}var n={executeP:g,replayP:h,undoP:i},o=R.curry(l),p=R.curry(m),q=R.curry(k);return f=R.thread(f)(R.defaultTo(j),R.curry),n}}angular.module("clickApp.services").factory("createElementCommand",a),a.$inject=["point"]}(),function(){function a(a,b,c,d,e){function f(a,b){return c.createP(a.factions,b)["catch"](R.always(null))}var g=a("model",c,d,e,f);return b.registerCommand("createModel",g),g}angular.module("clickApp.services").factory("createModelCommand",a),a.$inject=["createElementCommand","commands","model","gameModels","gameModelSelection"]}(),function(){function a(a,b,c,d,e){var f=a("template",c,d,e);return b.registerCommand("createTemplate",f),f}angular.module("clickApp.services").factory("createTemplateCommand",a),a.$inject=["createElementCommand","commands","template","gameTemplates","gameTemplateSelection"]}(),function(){function a(a,b,c,d,e){var f=a("terrain",c,d,e);return b.registerCommand("createTerrain",f),f}angular.module("clickApp.services").factory("createTerrainCommand",a),a.$inject=["createElementCommand","commands","terrain","gameTerrains","gameTerrainSelection"]}(),function(){function a(){return function(a,b,c,d,e){function f(d,e,f){function g(b){var c,d=(c={},_defineProperty(c,a+"s",b),_defineProperty(c,"desc",""),c);return R.thread(b)(n(e,f),function(a){return[d,a]})}return R.threadP(f)(R.prop(a+"s"),c.findAnyStampsP$(d),R.reject(R.isNil),R.map(b.saveState),g)}function g(b,c,d){return i(c,d,b[a+"s"])}function h(b,f,g){function h(b){function e(d){return R.thread(d)(R.prop(a+"s"),c.add$(b),function(b){return R.assoc(a+"s",b,d)})}function h(b){return R.thread(b)(R.prop(a+"_selection"),d.set$("remote",i,f),function(c){return R.assoc(a+"_selection",c,b)})}var i=R.map(R.path(["state","stamp"]),b);return R.thread(g)(e,h,o(f))}return R.threadP(b)(R.prop(a+"s"),R.map(e(f)),R.promiseAll,R.reject(R.isNil),R.rejectIf(R.isEmpty,"No valid "+a+" definition"),h)}function i(b,e,f){function g(b){return R.thread(b)(R.prop(a+"s"),c.removeStamps$(i),function(c){return R.assoc(a+"s",c,b)})}function h(c){return R.thread(c)(R.prop(a+"_selection"),d.removeFrom$("local",i,b),d.removeFrom$("remote",i,b),function(b){return R.assoc(a+"_selection",b,c)})}var i=R.pluck("stamp",f);return R.thread(e)(g,h,function(a){return R.forEach(p(b),i),a},o(b))}function j(a,c){return b.createP(c)["catch"](R.always(null))}function k(b,c){b.queueChangeEventP("Game."+a+".delete."+c)}function l(b,c){return b.queueChangeEventP("Game."+a+".create"),c}var m={executeP:f,replayP:g,undoP:h},n=R.curry(i),o=R.curry(l),p=R.curry(k);return e=R.thread(e)(R.defaultTo(j),R.curry),m}}angular.module("clickApp.models").factory("deleteElementCommand",a),a.$inject=[]}(),function(){function a(a,b,c,d,e){function f(a,b){return c.createP(a.factions,b)["catch"](R.always(null))}var g=a("model",c,d,e,f);return b.registerCommand("deleteModel",g),g}angular.module("clickApp.services").factory("deleteModelCommand",a),a.$inject=["deleteElementCommand","commands","model","gameModels","gameModelSelection"]}(),function(){function a(a,b,c,d,e){var f=a("template",c,d,e);return b.registerCommand("deleteTemplate",f),f}angular.module("clickApp.models").factory("deleteTemplateCommand",a),a.$inject=["deleteElementCommand","commands","template","gameTemplates","gameTemplateSelection"]}(),function(){function a(a,b,c,d,e){var f=a("terrain",c,d,e);return b.registerCommand("deleteTerrain",f),f}angular.module("clickApp.models").factory("deleteTerrainCommand",a),a.$inject=["deleteElementCommand","commands","terrain","gameTerrains","gameTerrainSelection"]}(),function(){function a(){return function(a,b){function c(a,b,c,d){var e={desc:a,stamps:b};return R.threadP(d)(i(a,b),j(b,c),function(a){return[e,a]})}function d(a,b,c){return R.threadP(c)(i(a.desc,a.stamps),j(a.stamps,b))}function e(a,b,c){return R.threadP(c)(i(!a.desc,a.stamps),j(a.stamps,b))}function f(c,d,e){return R.threadP(e)(R.prop(a+"s"),b.lockStampsP$(c,d),function(b){return R.assoc(a+"s",b,e)})}function g(b,c,d){return R.forEach(function(b){c.queueChangeEventP("Game."+a+".change."+b)},b),c.queueChangeEventP("Game."+a+".create"),d}var h={executeP:c,replayP:d,undoP:e},i=R.curry(f),j=R.curry(g);return h}}angular.module("clickApp.services").factory("lockElementsCommand",a),a.$inject=[]}(),function(){function a(a,b,c){var d=a("model",c);return b.registerCommand("lockModels",d),d}angular.module("clickApp.services").factory("lockModelsCommand",a),a.$inject=["lockElementsCommand","commands","gameModels"]}(),function(){function a(a,b,c){var d=a("template",c);return b.registerCommand("lockTemplates",d),d}angular.module("clickApp.models").factory("lockTemplatesCommand",a),a.$inject=["lockElementsCommand","commands","gameTemplates"]}(),function(){function a(a,b,c){var d=a("terrain",c);return b.registerCommand("lockTerrains",d),d}angular.module("clickApp.services").factory("lockTerrainsCommand",a),a.$inject=["lockElementsCommand","commands","gameTerrains"]}(),function(){function a(){return function(a,b,c,d){function e(c,d,e,f,g){function h(){return o?R.threadP(b)(R.prop(c),R.type,R.rejectIf(R.complement(R.equals("Function")),'Unknown method "'+c+'" on '+a)):!0}return R.threadP(b)(h,function(){var a={before:[],after:[],desc:c};return R.threadP(g)(s(a,"before",e),q(c,d,e),s(a,"after",e),u(e,f),function(b){return[a,b]})})}function f(a,b,c){var d=R.pluck("stamp",a.after);return R.threadP(c)(r(a.after,d),t(d,b),u(d,b))}function g(a,b,c){var d=R.pluck("stamp",a.before);return R.threadP(c)(r(a.before,d),t(d,b),u(d,b))}function h(b,d,e,f){return R.threadP(f)(R.prop(a+"s"),c.onStampsP$(b,d,e),function(b){return R.assoc(a+"s",b,f)})}function i(b,d,e){return R.threadP(e)(R.prop(a+"s"),c.setStateStampsP$(b,d),function(b){return R.assoc(a+"s",b,e)})}function j(b,d,e,f){return R.threadP(f)(R.prop(a+"s"),c.fromStampsP$("saveState",[],e),function(a){return b[d]=a,f})}function k(b,c,e){return R.thread(e)(R.prop(a+"_selection"),d.set$("remote",b,c),function(b){return R.assoc(a+"_selection",b,e)})}function l(b,c,d){return R.forEach(function(b){c.queueChangeEventP("Game."+a+".change."+b)},b),d}var m=arguments.length<=4||void 0===arguments[4]?{}:arguments[4],n=m.checkIfModelRespondToMethod,o=void 0===n?!0:n,p={executeP:e,replayP:f,undoP:g},q=R.curry(h),r=R.curry(i),s=R.curry(j),t=R.curry(k),u=R.curry(l);return p}}angular.module("clickApp.services").factory("onElementsCommand",a),a.$inject=[]}(),function(){function a(a,b,c,d,e){var f=a("model",c,d,e,{checkIfModelRespondToMethod:!0});return b.registerCommand("onModels",f),f}angular.module("clickApp.services").factory("onModelsCommand",a),a.$inject=["onElementsCommand","commands","model","gameModels","gameModelSelection"]}(),function(){function a(a,b,c,d,e){var f=a("template",c,d,e,{checkIfModelRespondToMethod:!1});return b.registerCommand("onTemplates",f),f}angular.module("clickApp.services").factory("onTemplatesCommand",a),a.$inject=["onElementsCommand","commands","template","gameTemplates","gameTemplateSelection"]}(),function(){function a(a,b,c,d,e){var f=a("terrain",c,d,e);return b.registerCommand("onTerrains",f),f}angular.module("clickApp.services").factory("onTerrainsCommand",a),a.$inject=["onElementsCommand","commands","terrain","gameTerrains","gameTerrainSelection"]}(),function(){function a(a){function b(a,b){var c=R.randomRange(1,6),d=R.randomRange(1,6),e={desc:"AoE deviation : direction "+c+", distance "+d+'"',r:c,d:d};return a.queueChangeEventP("Game.dice.roll"),[e,b]}function c(a,b,c){var d=R.propOr([],"dice",c);return c=R.assoc("dice",R.append(a,d),c),b.queueChangeEventP("Game.dice.roll"),c}function d(a,b,c){var d=R.propOr([],"dice",c);return c=R.assoc("dice",R.reject(R.propEq("stamp",a.stamp),d),c),b.queueChangeEventP("Game.dice.roll"),c}var e={executeP:b,replayP:c,undoP:d};return a.registerCommand("rollDeviation",e),e}angular.module("clickApp.services").factory("rollDeviationCommand",a),a.$inject=["commands"]}(),function(){function a(a){function b(a,b,c,d){var e=R.times(function(){return R.randomRange(1,a)},b),f=R.reduce(R.add,0,e),g={desc:"d"+a+"["+e.join(",")+"] = "+f,s:a,n:b,d:e};return c.queueChangeEventP("Game.dice.roll"),[g,d]}function c(a,b,c){return c=R.over(R.lensProp("dice"),R.append(a),c),b.queueChangeEventP("Game.dice.roll"),c}function d(a,b,c){return c=R.over(R.lensProp("dice"),R.reject(R.propEq("stamp",a.stamp)),c),b.queueChangeEventP("Game.dice.roll"),c}var e={executeP:b,replayP:c,undoP:d};return a.registerCommand("rollDice",e),e}angular.module("clickApp.services").factory("rollDiceCommand",a),a.$inject=["commands"]}(),function(){function a(a){function b(a,b,c){var d={before:c.board,after:a,desc:a.name};return c=R.assoc("board",a,c),b.queueChangeEventP("Game.board.change"),[d,c]}function c(a,b,c){return c=R.assoc("board",a.after,c),b.queueChangeEventP("Game.board.change"),c}function d(a,b,c){return c=R.assoc("board",a.before,c),b.queueChangeEventP("Game.board.change"),c}var e={executeP:b,replayP:c,undoP:d};return a.registerCommand("setBoard",e),e}angular.module("clickApp.services").factory("setBoardCommand",a),a.$inject=["commands"]}(),function(){function a(a,b){function c(a,c,d,e){if("Function"!==R.type(b[a]))return R.rejectP('Layers unknown method "'+a+'"');var f={before:e.layers,desc:a+"("+c+")"};return e=R.over(R.lensProp("layers"),b[a+"$"](c),e),f.after=e.layers,d.queueChangeEventP("Game.layers.change"),[f,e]}function d(a,b,c){return c=R.assoc("layers",a.after,c),b.queueChangeEventP("Game.layers.change"),c}function e(a,b,c){return c=R.assoc("layers",a.before,c),b.queueChangeEventP("Game.layers.change"),c}var f={executeP:c,replayP:d,undoP:e};return a.registerCommand("setLayers",f),f}angular.module("clickApp.services").factory("setLayersCommand",a),a.$inject=["commands","gameLayers"]}(),function(){function a(a,b,c){var d=a("los",c),e=Object.create(d);return b.registerCommand("setLos",e),e}angular.module("clickApp.services").factory("setLosCommand",a),a.$inject=["setSegmentCommand","commands","gameLos"]}(),function(){function a(a,b){function c(a,c,d,e){return R.threadP(b)(R.prop(a),R.type,R.rejectIf(R.complement(R.equals("Function")),"SetModelSelection unknown method "+a),function(){var f=R.isNil(c)?["local",d,e.model_selection]:["local",c,d,e.model_selection];return b[a].apply(b,f)},function(a){return R.assoc("model_selection",a,e)},function(a){var c={after:b.get("local",a.model_selection),desc:"",do_not_log:!0};return[c,a]})}function d(a,c,d){var e=b.set("remote",a.after,c,d.model_selection);return d=R.assoc("model_selection",e,d)}function e(){return R.rejectP("!!! ERROR : WE SHOULD NOT BE HERE !!!")}var f={executeP:c,replayP:d,undoP:e};return a.registerCommand("setModelSelection",f),f}angular.module("clickApp.services").factory("setModelSelectionCommand",a),a.$inject=["commands","gameModelSelection"]}(),function(){function a(a,b,c){var d=a("ruler",c),e=Object.create(d);return b.registerCommand("setRuler",e),e}angular.module("clickApp.services").factory("setRulerCommand",a),a.$inject=["setSegmentCommand","commands","gameRuler"]}(),function(){function a(a){function b(a,b,c){var d={before:c.scenario,after:a,desc:a.name};return c=R.assoc("scenario",a,c),b.queueChangeEventP("Game.scenario.change"),[d,c]}function c(a,b,c){return c=R.assoc("scenario",a.after,c),b.queueChangeEventP("Game.scenario.change"),c}function d(a,b,c){return c=R.assoc("scenario",a.before,c),b.queueChangeEventP("Game.scenario.change"),c}var e={executeP:b,replayP:c,undoP:d};return a.registerCommand("setScenario",e),e}angular.module("clickApp.services").factory("setScenarioCommand",a),a.$inject=["commands"]}(),function(){function a(){return function(a,b){function c(c,d,e,f){function g(b){return R.threadP(b)(R.prop(c),R.type,R.rejectIf(R.complement(R.equals("Function")),s.capitalize(a)+' unknown method "'+c+'"'))}function h(c){return function(d){return i[c]=b.saveRemoteState(R.prop(a,d)),d}}var i={before:[],after:[],desc:c};return R.threadP(b)(g,R.always(f),h("before"),function(){return b[c].apply(null,[].concat(_toConsumableArray(d),[e,f,R.prop(a,f)]))},function(b){return R.assoc(a,b,f)},h("after"),function(b){return e.queueChangeEventP("Game."+a+".remote.change"),[i,b]})}function d(c,d,e){return R.over(R.lensProp(a),R.pipe(b.resetRemote$(c.after,d,e),function(b){return d.queueChangeEventP("Game."+a+".remote.change"),b}),e)}function e(c,d,e){return R.over(R.lensProp(a),R.pipe(b.resetRemote$(c.before,d,e),function(b){return d.queueChangeEventP("Game."+a+".remote.change"),b}),e)}var f={executeP:c,replayP:d,undoP:e};return f}}angular.module("clickApp.services").factory("setSegmentCommand",a),a.$inject=[]}(),function(){function a(a){return function(b,c){function d(){return R.resolveP({state:{x:0,y:0,r:0,l:[],lk:!1,stamp:R.guid()}})}function e(a){return R.threadP(a)(this.createDefaultP,function(b){return R.deepExtend(b.state,a),b},this.checkState)}function f(a){return R.path(["state","stamp"],a)}function g(a){return R.path(["state","stamp"],a)}function h(a){return R.prop("state",a)}function i(a){return R.clone(R.prop("state",a))}function j(a,b){return R.assoc("state",R.clone(a),b)}function k(a){return R.thread(a)(R.over(R.lensPath(["state","x"]),R.compose(R.max(0),R.min(480))),R.over(R.lensPath(["state","y"]),R.compose(R.max(0),R.min(480))))}function l(a){return R.path(["state","lk"],a)}function m(a,b){return R.assocPath(["state","lk"],a,b)}function n(a){return function(){for(var c=arguments.length,d=Array(c),e=0;c>e;e++)d[e]=arguments[e];var f=R.last(d),g=R.init(d);return R.threadP(f)(R.rejectIf(this.isLocked,s.capitalize(b)+" is locked"),function(b){return a.apply(null,[].concat(_toConsumableArray(g),[b]))},this.checkState)}}function o(a,b){return R.thread(b)(R.assocPath(["state","x"],a.x),R.assocPath(["state","y"],a.y))}function p(a,b){return R.thread(b)(R.assocPath(["state","x"],b.state.x+a.x),R.assocPath(["state","y"],b.state.y+a.y))}function q(a,b){return R.thread(b)(R.assocPath(["state","r"],a))}function r(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.moveFront$(e)))}function t(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.moveBack$(e)));
}function u(b,d){var e=c[b?"RotateSmall":"Rotate"];return R.thread(d)(R.over(R.lensProp("state"),a.rotateLeft$(e)))}function v(b,d){var e=c[b?"RotateSmall":"Rotate"];return R.thread(d)(R.over(R.lensProp("state"),a.rotateRight$(e)))}function w(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.shiftLeft$(e)))}function x(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.shiftRight$(e)))}function y(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.shiftUp$(e)))}function z(b,d){var e=c[b?"MoveSmall":"Move"];return R.thread(d)(R.over(R.lensProp("state"),a.shiftDown$(e)))}function A(a,b){return R.over(R.lensPath(["state","l"]),R.compose(R.uniq,R.append(a)),b)}function B(a,b){return R.over(R.lensPath(["state","l"]),R.reject(R.equals(a)),b)}function C(a){return R.assocPath(["state","l"],[],a)}function D(a){return R.pathOr([],["state","l"],a).join(" ")}var E={createDefaultP:d,createP:e,stamp:f,eventName:g,state:h,saveState:i,setState:j,checkState:k,isLocked:l,setLock:m,addLabel:A,removeLabel:B,fullLabel:D,clearLabel:C,setPositionP:n(o),shiftPositionP:n(p),setOrientationP:n(q),moveFrontP:n(r),moveBackP:n(t),rotateLeftP:n(u),rotateRightP:n(v),shiftLeftP:n(w),shiftRightP:n(x),shiftUpP:n(y),shiftDownP:n(z)};return R.curryService(E),E}}angular.module("clickApp.services").factory("element",a),a.$inject=["point"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g,h,i,j,k,l){function m(a){var b={players:{p1:{name:R.propOr("player1","name",a)},p2:{name:null}}};return b}function n(a,b){function d(a){return R.deepExtend(a,o(),b)}return R.threadP(Object.create(F))(d,c.create,G(a))}function o(){return{players:{p1:{name:null},p2:{name:null}},board:{},scenario:{},chat:[],commands:[],commands_log:[],undo:[],undo_log:[],dice:[],ruler:h.create(),los:e.create(),models:f.create(),model_selection:g.create(),templates:i.create(),template_selection:j.create(),terrains:k.create(),terrain_selection:l.create(),layers:d.create()}}function p(a){return R.pick(["players","commands","undo","chat","local_stamp","private_stamp","public_stamp"],a)}function q(b){return R.thread(b)(p,a.stringify)}function r(a,b){return R.pathOr("John Doe",["players",a,"name"],b)}function t(a){return[s.capitalize(r("p1",a)),"vs",s.capitalize(r("p2",a))].join(" ")}function u(a,d,e,f){function g(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];return[R.thread(c)(R.assoc("user",R.pathOr("Unknown",["user","state","name"],e)),R.assoc("stamp",R.guid())),d]}function h(a){var b=_slicedToArray(a,2),d=b[0],e=b[1];return R.threadP(e)(c.sendReplayCommandP$(d),function(a){return[d,a]})}function i(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];return[c,R.unless(function(){return c.do_not_log},R.over(R.lensProp("commands"),R.append(c)),d)]}return R.threadP(b.executeP(a,d,e,f))(g,R.ifElse(function(a){var b=_slicedToArray(a,2),d=(b[0],b[1]);return c.active(d)},h,i),function(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];return R.when(function(){return"rollDice"===c.type||"rollDeviation"===c.type},R.over(R.lensProp("dice"),R.append(c)),d)},R.tap(function(){e.queueChangeEventP("Game.command.execute")}))}function v(a,c,d){function e(b){return R.thread(b)(R.propOr([],"undo_log"),R.find(R.propEq("stamp",a.stamp)))}function f(b){return R.over(R.lensProp("undo_log"),R.compose(R.reject(R.propEq("stamp",a.stamp)),R.defaultTo([])),b)}function g(b){return R.thread(b)(R.over(R.lensProp("commands"),R.reject(R.propEq("stamp",a.stamp))),R.over(R.lensProp("undo"),R.append(a)))}return R.threadP(d)(R.ifElse(e,f,b.undoP$(a,c)),g,R.tap(function(){c.queueChangeEventP("Game.command.undo")}))}function w(a,d){function e(a){return R.threadP(a)(R.propOr([],"commands"),R.last,R.rejectIf(R.isNil,"Command history empty"))}function f(c){return R.threadP(d)(b.undoP$(c,a),function(a){return[c,a]})}function g(a){var b=_slicedToArray(a,2),d=b[0],e=b[1];return R.threadP(e)(R.over(R.lensProp("commands"),R.init),R.ifElse(c.active,c.sendUndoCommandP$(d),R.over(R.lensProp("undo"),R.append(d))))}return R.threadP(d)(e,f,g,R.tap(function(){a.queueChangeEventP("Game.command.undo")}))}function x(a,c,d){function e(b){return R.thread(b)(R.propOr([],"commands_log"),R.find(R.propEq("stamp",a.stamp)))}function f(b){return R.over(R.lensProp("commands_log"),R.reject(R.propEq("stamp",a.stamp)),b)}function g(b){return R.thread(b)(R.over(R.lensProp("undo"),R.reject(R.propEq("stamp",a.stamp))),R.unless(function(){return a.do_not_log},R.over(R.lensProp("commands"),R.append(a))))}return R.threadP(d)(R.ifElse(e,f,b.replayP$(a,c)),g,R.tap(function(){c.queueChangeEventP("Game.command.replay")}))}function y(a,c,d){return R.threadP(d)(b.replayBatchP$(a,c),R.over(R.lensProp("commands"),R.flip(R.concat)(a)))}function z(a,d){function e(a){return R.threadP(a)(R.propOr([],"undo"),R.last,R.rejectIf(R.isNil,"Undo history empty"))}function f(c){return R.threadP(d)(b.replayP$(c,a),function(a){return[c,a]})}function g(a){var b=_slicedToArray(a,2),d=b[0],e=b[1];return R.threadP(e)(R.over(R.lensProp("undo"),R.init),R.ifElse(c.active,c.sendReplayCommandP$(d),R.over(R.lensProp("commands"),R.append(d))))}return R.threadP(d)(e,f,g,R.tap(function(){a.queueChangeEventP("Game.command.replay")}))}function A(a,b,d){return c.sendEventP({type:"chat",chat:{from:a,msg:b}},d)}function B(a,c,d){function e(b){return new self.Promise(function(d){self.requestAnimationFrame(function(){d(B(R.tail(a),c,b))})})}return R.isEmpty(a)?self.Promise.resolve(d):R.threadP(d)(b.replayBatchP$(a[0],c),e)}function C(a,b){return new self.Promise(function(c){R.isEmpty(b.commands)&&c(b);var d=R.splitEvery(b.commands.length,b.commands);self.requestAnimationFrame(function(){c(B(d,a,b))})})}function D(a,b){return a.queueChangeEventP("Game.action.error",b),null}var E={create:m,loadP:n,pickForJson:p,toJson:q,description:t,executeCommandP:u,undoCommandP:v,undoLastCommandP:w,replayCommandP:x,replayCommandsBatchP:y,replayNextCommandP:z,sendChatP:A,actionError:D},F={toJSON:function(){return p(this)}},G=R.curry(C);return R.curryService(E),E}angular.module("clickApp.services").factory("game",a),a.$inject=["jsonStringifier","commands","gameConnection","gameLayers","gameLos","gameModels","gameModelSelection","gameRuler","gameTemplates","gameTemplateSelection","gameTerrains","gameTerrainSelection"]}(),function(){function a(a){function b(){return R.thread("/data/boards.json")(a.getP,R.condErrorP([[R.T,R.pipe(R.spyError("Error getting boards.json"),R.always([]))]]))}function c(a){return R.prop("name",a)}function d(a,b){return R.find(R.propEq("name",a),b)}var e={initP:b,name:c,forName:d};return R.curryService(e),e}angular.module("clickApp.services").factory("gameBoard",a),a.$inject=["http"]}(),function(){function a(a){function b(a){var b={state:{socket:null}};return R.assoc("connection",b,a)}function c(b,c,d){if(q.active(d))return R.resolveP(d);b=s.trim(b);var e={close:j(c),chat:v(c),replayCmd:r(c),undoCmd:t(c),cmdBatch:u(c),setCmds:w(c),players:x(c)};d=R.assocPath(["connection","state","socket"],null,d);var f=["/api/games",R.prop("private_stamp",d)?"private":"public",R.prop("private_stamp",d)?R.prop("private_stamp",d):R.prop("public_stamp",d)].join("/");return f+="?name="+b,R.threadP()(function(){return a.createP(f,"game",e)},function(a){return R.assocPath(["connection","state","socket"],a,d)})}function d(b){return q.active(b)&&a.close(b.connection.state.socket),q.cleanup(b)}function e(a){return R.assocPath(["connection","state","socket"],null,a)}function f(a){return R.thread(a)(R.path(["connection","state","socket"]),R.exists)}function g(a,b){return R.threadP(b)(q.sendEventP$({type:"replayCmd",cmd:a}),R.over(R.lensProp("commands_log"),R.compose(R.append(a),R.defaultTo([]))))}function h(a,b){return R.threadP(b)(q.sendEventP$({type:"undoCmd",cmd:a}),R.over(R.lensProp("undo_log"),R.compose(R.append(a),R.defaultTo([]))))}function i(b,c){return R.threadP(c)(R.rejectIf(R.complement(q.active),"Not active"),function(){return a.send(b,c.connection.state.socket)},R.always(c))}function j(a){return function(){a.queueEventP("Game.connection.close")}}function k(a,b){a.queueEventP("Game.command.replay",b.cmd)}function l(a,b){a.queueEventP("Game.command.undo",b.cmd)}function m(a,b){a.queueEventP("Game.command.replayBatch",b.cmds)}function n(a,b){a.queueEventP("Game.newChatMsg",b)}function o(a,b){a.queueEventP("Game.setCmds",b)}function p(a,b){a.queueEventP("Game.setPlayers",b.players)}var q={create:b,openP:c,close:d,cleanup:e,active:f,sendReplayCommandP:g,sendUndoCommandP:h,sendEventP:i},r=R.curry(k),t=R.curry(l),u=R.curry(m),v=R.curry(n),w=R.curry(o),x=R.curry(p);return R.curryService(q),q}angular.module("clickApp.services").factory("gameConnection",a),a.$inject=["websocket"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){return function(b,c){function d(){return{active:[],locked:[]}}function e(a){return R.concat(a.active,a.locked)}function f(a,c){return new self.Promise(function(d,e){var f=R.thread(c)(q.all,R.find(R.pathEq(["state","stamp"],a)));R.isNil(f)?e(s.capitalize(b)+' "'+a+'" not found'):d(f)})}function g(a,c){function d(a){return q.findStampP(a,c)["catch"](R.always(null))}return R.threadP(a)(R.map(d),R.promiseAll,R.rejectIf(R.compose(R.isEmpty,R.reject(R.isNil)),"No "+b+" found"))}function h(a,b,c,d){return o(function(){return R.always(null)},a,b,c,d)}function i(a,b,c,d){return R.threadP(d)(r(R.always,a,b,c),t(d))}function j(a,b,d){function e(b,d){return R.isNil(b)?null:c.setState(a[d],b)}return R.threadP(d)(q.findAnyStampsP$(b),R.addIndex(R.map)(e),R.reject(R.isNil),t(d))}function k(a,b,d){return R.threadP(d)(q.findAnyStampsP$(b),R.reject(R.isNil),R.map(c.setLock$(a)),t(d))}function l(a,b){var c=R.map(R.path(["state","stamp"]),a);return R.thread(b)(q.removeStamps$(c),R.flip(t)(a))}function m(a,b){function c(b){return R.find(R.equals(R.path(["state","stamp"],b)),a)}return R.thread(b)(R.over(R.lensProp("active"),R.reject(c)),R.over(R.lensProp("locked"),R.reject(c)))}function n(d,e){function f(d){var e=R.pick(["x","y","r"],d[0].state);return _defineProperty({base:e},b+"s",R.map(R.compose(a.differenceFrom$(e),c.saveState),d))}return R.threadP(e)(q.findAnyStampsP$(d),R.reject(R.isNil),f)}function o(a,d,e,f,g){function h(){return R.threadP(c)(R.prop(d),R.type,R.rejectIf(R.complement(R.equals("Function")),'Unknown method "'+d+'" on '+b+"s"))}function i(b){return self.Promise.resolve(c[d].apply(c,[].concat(_toConsumableArray(e),[b])))["catch"](a(b))}return R.threadP()(h,R.always(g),q.findAnyStampsP$(f),R.reject(R.isNil),R.map(i),R.promiseAll)}function p(a,b){return R.thread(a)(q.all,R.concat(b),R.uniqBy(R.path(["state","stamp"])),R.partition(c.isLocked),function(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];return{active:d,locked:c}})}var q={create:d,all:e,findStampP:f,findAnyStampsP:g,fromStampsP:h,onStampsP:i,setStateStampsP:j,lockStampsP:k,add:l,removeStamps:m,copyStampsP:n},r=R.curry(o),t=R.curry(p);return R.curryService(q),q}}angular.module("clickApp.services").factory("gameElements",a),a.$inject=["point"]}(),function(){function a(){return function(a){function b(){return{local:[],remote:[]}}function c(a,b,c){var d=R.prop(a,c);return R.find(R.equals(b),d)}function d(a,b){return R.propOr([],a,b)}function e(b,c){return R.threadP(c)(l.get$("local"),R.head,R.rejectIf(R.isNil,"No "+a+" selection"),function(){b.queueEventP("Modes.switchTo",s.capitalize(a))})}function f(a,b,c,d){var e=l.get(a,d),f=R.assoc(a,b,d);return j(a,c),R.forEach(m(c),b),R.forEach(m(c),e),f}function g(a,b,c,d){var e=l.get(a,d),f=R.uniq(R.concat(e,b)),g=R.assoc(a,f,d);return j(a,c),R.forEach(m(c),f),g}function h(a,b,c,d){var e=R.prop(a,d),f=R.difference(e,b),g=R.assoc(a,f,d);return j(a,c),R.forEach(m(c),R.uniq(R.concat(e,b))),g}function i(a,b,c){var d=R.prop(a,c);return l.removeFrom(a,d,b,c)}function j(b,c){"local"===b&&(c.queueEventP("Modes.switchTo","Default"),c.queueChangeEventP("Game."+a+".selection.local.change"))}function k(b,c){b.queueChangeEventP("Game."+a+".change."+c)}var l={create:b,"in":c,get:d,checkModeP:e,set:f,addTo:g,removeFrom:h,clear:i},m=R.curry(k);return R.curryService(l),l}}angular.module("clickApp.services").factory("gameElementSelection",a),a.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b){function c(){return R.threadP()(S.loadDefaultP,function(a){return R.threadP()(S.loadDescP,function(b){return{base:a,desc:b}})},S.updateDesc,R.spyWarn("Factions"))}function d(){return R.threadP("/data/model/factions.json")(b.getP,function(a){return R.thread(a)(R.keys,R.map(function(c){return b.getP(a[c]).then(function(a){return[c,a]})}))},R.promiseAll,R.reduce(function(a,b){var c=_slicedToArray(b,2),d=c[0],e=c[1];return R.assoc(d,e,a)},{}))}function e(a){return R.thread(a)(S.applyDesc,S.updateInfo,S.buildReferences)}function f(){return R.threadP()(function(){return a.loadP(Q)["catch"](R.spyError("Factions: no stored desc"))},R.defaultTo({}),R.spyWarn("Factions Desc load"))}function g(a){var b=a.base,c=a.desc;return{base:b,desc:c,current:R.deepExtend(b,c)}}function h(a){var b=a.base,c=a.desc,d=a.current;return{base:b,desc:c,current:R.pipe(R.toPairs,R.sortBy(R.compose(R.prop("name"),R.nth(1))),R.reduce(function(a,b){var c=_slicedToArray(b,2),d=c[0],e=c[1];return R.assoc(d,t(e),a)},{}))(d)}}function i(b){return R.thread(b)(R.prop("desc"),R.spyWarn("Factions Desc store"),a.save$(Q))}function j(a){var b=a.base,c=a.desc,d=a.current;return{base:b,desc:c,current:d,references:R.reduce(T(d),{},R.keys(d))}}function k(a,b){return new self.Promise(function(c,d){var e=R.path(["current"].concat(_toConsumableArray(a)),b);R.isNil(e)?d("Model info "+a.join(".")+" not found"):c(e)})}function l(a,b){function c(a){return R.thread(b)(R.values,R.find(d(a)),e(a))}var d=R.curry(m),e=R.curry(n);return R.thread(a)(s.lines,R.map(c),R.reject(R.isNil))}function m(a,b){return XRegExp.exec(a,b.regexp)}function n(a,b){if(R.isNil(b))return b;var c=XRegExp.exec(a,b.regexp);return[R.prop("entries",b),o(c.nb_grunts),p(c.nb_repeat)]}function o(a){return R.thread(a)(R.defaultTo("0"),function(a){return parseFloat(a)+1})}function p(a){return R.thread(a)(R.defaultTo("0"),function(a){return parseFloat(a)})}function q(a,b,c){function d(a){var b=_slicedToArray(a,3),c=b[0],d=b[1],g=b[2],i=e(c,d),j=f(c,g),k=[].concat(_toConsumableArray(i),_toConsumableArray(j));return h(c,R.length(i),k),k}function e(a,b){var c=[],d=R.propOr([],"grunt",a),e=_slicedToArray(d,1),f=e[0];if(R.exists(f)&&R.exists(f.fk_grunts)&&(b=f.fk_grunts),b>0){var h=R.propOr([],"leader",a),i=_slicedToArray(h,1),j=i[0];R.exists(j)&&(c=R.concat(c,g(1,j)),b--),R.exists(f)&&R.times(function(){c=R.concat(c,g(1,f))},b),R.isEmpty(c)||(c[0].dsp=["l","i"])}return c}function f(a,b){return R.thread(a)(R.omit(["grunt","leader"]),R.values,R.flatten,R.chain(function(a){return g(b,a)}))}function g(a,c){function d(){e.push({user:b,info:c.path,x:l+c.base_radius,y:m+c.base_radius,r:0}),l+=2*c.base_radius,n=Math.max(n,2*c.base_radius),l>k&&(l=0,m+=n,n=0)}var e=[];return R.thread(c)(R.propOr(1,"fk_repeat"),R.max(a),R.times(d)),e}function h(a,b,c){var d=i(a);(R.isNil(d)||d!==o.name||b>0)&&o.number++,o.name=d,R.forEach(function(a){a.u=o.number},c)}function i(a){return R.thread(a)(R.values,R.find(function(a){return R.find(function(a){return R.exists(a.unit_name)},a)}),R.defaultTo([{}]),R.head,R.prop("unit_name"))}var j=S.getListInfo(a,c),k=240,l=0,m=0,n=0,o={name:null,number:0};return{base:{x:240,y:240,r:0},models:R.chain(d,j)}}function r(a){var b="^\\**\\s*"+a;return XRegExp(b,"i")}function t(a){return R.thread(a)(R.assoc("wreck",C(a.wreck)),function(a){return R.assoc("models",u(a,a.models),a)})}function u(a,b){return R.reduce(function(c,d){return R.assoc(d,v(a,b[d]),c)},{},R.keys(b))}function v(a,b){return R.thread(b)(R.keys,R.sortBy(function(a){return b[a].name}),R.reduce(function(c,d){return R.assoc(d,w(a,b[d]),c)},{}))}function w(a,b){return R.exists(b.entries)?x(a,b):A(a,null,b)}function x(a,b){return R.assoc("entries",y(a,b,b.entries),b)}function y(a,b,c){return R.reduce(function(d,e){return R.assoc(e,z(a,b,c[e]),d)},{},R.keys(c))}function z(a,b,c){return R.reduce(function(d,e){return R.assoc(e,A(a,b,c[e]),d)},{},R.keys(c))}function A(a,b,c){var d=c.name;return R.exists(b)&&(d=R.exists(b.fk_name)?b.fk_name:b.name+".*(?<nb_grunts>\\d+)\\s+grunt"),b=R.defaultTo({},b),R.thread(c)(R.assoc("fk_name",R.defaultTo(d,c.fk_name)),R.assoc("unit_name",b.name),R.assoc("img",B(c.img)),R.assoc("damage",E(c.damage)),R.assoc("base_color",a.color),R.assoc("base_radius",P[c.base]),function(b){return"jack"===b.type&&R.exists(a.wreck)&&R.exists(a.wreck[b.base])?R.assoc("img",R.append(a.wreck[b.base],b.img),b):b})}function B(a){return R.thread(a)(R.defaultTo([]),function(a){return R.isEmpty(a)?R.append({},a):a},R.map(D))}function C(a){return R.thread(a)(R.defaultTo({}),function(a){return R.thread(a)(R.keys,R.reduce(function(b,c){return R.assoc(c,D(R.assoc("type","wreck",a[c])),b)},{}))})}function D(a){return R.thread(a)(R.assoc("type",R.defaultTo("default",a.type)),R.assoc("width",R.defaultTo(60,a.width)),R.assoc("height",R.defaultTo(60,a.height)))}function E(a){return R.thread(a)(R.defaultTo({type:"warrior",n:1}),function(a){return R.assoc("type",R.defaultTo("warrior",a.type),a)},function(a){return R.assoc("total",F(a),a)},function(a){return R.assoc("depth",G(a),a)})}function F(a){return"warrior"===a.type?a.n:R.thread(a)(R.keys,R.reject(R.equals("type")),R.reject(R.equals("total")),R.reject(R.equals("field")),R.reduce(function(b,c){return b+R.thread(a[c])(R.reject(R.isNil),R.length)},0))}function G(a){return"warrior"===a.type?a.n:R.thread(a)(R.keys,R.reject(R.equals("type")),R.reject(R.equals("total")),R.reject(R.equals("field")),R.map(function(b){return R.length(a[b])}),R.reduce(R.max,0))}function H(a,b,c){var d=a[c].models;return R.reduce(U(c,d),b,R.keys(d))}function I(a,b,c,d){var e=b[d];return R.reduce(V(a,d,e),c,R.keys(e))}function J(a,b,c,d,e){var f=c[e].entries;return R.isNil(f)?K(a,b,c,e,d):R.reduce(W(a,b,e,f),d,R.keys(f))}function K(a,b,c,d,e){return d=R.assoc("path",[a,"models",b,d],c[d]),N("default",d,e),e}function L(a,b,c,d,e,f){var g=d[f];return R.reduce(X(a,b,c,f,g),e,R.keys(g))}function M(a,b,c,d,e,f,g){var h=R.assoc("path",[a,"models",b,c,"entries",d,g],e[g]);return N(g,h,f),f}function N(a,b,c){var d=O(b.fk_name,c),e=R.defaultTo([],d.entries[a]);e.push(b),d.entries[a]=e,c[b.fk_name]=d}function O(a,b){var c=S.buildReferenceRegexp(a);return R.defaultTo({regexp:c,entries:{}},b[a])}var P={huge:24.605,large:9.842,medium:7.874,small:5.905},Q="clickApp.factions_desc",S={initP:c,loadDefaultP:d,updateDesc:e,loadDescP:f,applyDesc:g,updateInfo:h,storeDesc:i,buildReferences:j,getModelInfoP:k,getListInfo:l,buildModelsList:q,buildReferenceRegexp:r},T=R.curry(H),U=R.curry(I),V=R.curry(J),W=R.curry(L),X=R.curry(M);return R.curryService(S),S}angular.module("clickApp.services").factory("gameFactions",a),a.$inject=["localStorage","http"]}(),function(){function a(){function a(){return["b","d","s","m","t"]}function b(a){var b=arguments.length<=1||void 0===arguments[1]?[]:arguments[1];return R.find(R.equals(a),b)}function c(a){var b=arguments.length<=1||void 0===arguments[1]?[]:arguments[1];return R.uniq(R.append(a,b))}function d(a){var b=arguments.length<=1||void 0===arguments[1]?[]:arguments[1];return R.reject(R.equals(a),b)}function e(a,b){return f.isDisplayed(a,b)?f.unset(a,b):f.set(a,b)}var f={create:a,isDisplayed:b,set:c,unset:d,toggle:e};return R.curryService(f),f}angular.module("clickApp.services").factory("gameLayers",a),a.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d){function e(){return R.deepExtend(w.create(),{computed:{}})}function f(a,b,c){return R.thread(c)(w.toggleDisplay$(a,b),y({},a,b))}function g(a,b,c,d,e){return R.thread(e)(w.setRemote$(a,b,c,d),y({},c,d))}function h(a,b,c,d){return R.thread(d)(w.resetRemote$(a,b,c),y({},b,c))}function i(a){return R.path(["remote","origin"],a)}function j(a,b,c){return r({origin:null,ignore:null,display:!1},a,b,c)}function k(a,b,c,d){var e=a.state.stamp,f=x.target(d);f=f===e?null:f;var g=f&&e;return r({origin:e,target:f,ignore:null,display:g},b,c,d)}function l(a,b,c,d){var e=a.state.stamp;return r({origin:e,target:null,ignore:null,display:!0},b,c,d)}function m(a){return R.path(["remote","target"],a)}function n(a,b,c){return r({target:null,ignore:null,display:!1},a,b,c)}function o(a,b,c,d){var e=x.origin(d),f=a.state.stamp;e=e===f?null:e;var g=f&&e;return r({origin:e,target:f,ignore:null,display:g},b,c,d)}function p(a,b,c,d){var e=R.pathOr([],["remote","ignore"],d),f=R.find(R.equals(a.state.stamp),e);return e=f?R.reject(R.equals(a.state.stamp),e):R.append(a.state.stamp,e),r({ignore:e},b,c,d)}function q(a,b,c){return r({},a,b,c)}function r(a,c,d,e){function f(){R.threadP()(function(){return s(c,d,e.remote.origin,e.remote.target)},function(a){var f=_slicedToArray(a,4),g=f[0],i=f[1],k=f[2],l=f[3],m={x:g.x,y:g.y,radius:i.base_radius},n={x:k.x,y:k.y,radius:l.base_radius},o=b.envelopeTo(n,m);return e.computed.envelope=o,R.threadP()(function(){return t(c,d,e.remote.ignore,j,n,h,o)},function(a){return[m,a]})},function(a){var b=_slicedToArray(a,2),d=b[0],f=b[1],g=u(d,f);e.computed.darkness=g;var h=v(d,f);e.computed.shadow=h,c.queueChangeEventP("Game.los.remote.change")})}var g=a.origin,h=void 0===g?R.path(["remote","origin"],e):g,i=a.target,j=void 0===i?R.path(["remote","target"],e):i,k=a.ignore,l=void 0===k?R.pathOr([],["remote","ignore"],e):k,m=a.display,n=void 0===m?R.path(["remote","display"],e):m;return e=R.thread(e)(R.assocPath(["remote","origin"],h),R.assocPath(["remote","target"],j),R.assocPath(["remote","display"],n),R.assocPath(["remote","ignore"],R.defaultTo([],l)),R.assoc("computed",{envelope:null,darkness:[],shadow:[]})),e.remote.origin&&e.remote.target&&f(),c.queueChangeEventP("Game.los.remote.change"),e}function s(a,b,e,f){return R.threadP()(function(){return[d.findStampP(e,b.models),d.findStampP(f,b.models)]},R.promiseAll,function(b){var d=_slicedToArray(b,2),e=d[0].state,f=d[1].state;return R.threadP()(function(){return[c.getModelInfoP(e.info,a.factions),c.getModelInfoP(f.info,a.factions)]},R.promiseAll,function(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];return[e,c,f,d]})})}function t(a,e,f,g,h,i,j){function k(b){return R.threadP()(function(){return c.getModelInfoP(b.state.info,a.factions)},function(a){return R.assoc("radius",a.base_radius,b.state)})}function l(a){return g===a.stamp||i===a.stamp||h.radius>a.radius||R.find(R.equals(a.stamp),f)}return R.threadP(e.models)(d.all,R.map(k),R.promiseAll,R.reject(l),R.filter(b.isInEnvelope$(j)))}function u(a,c){return R.map(function(c){return b.outsideEnvelopeTo(c,[],a)},c)}function v(a,c){return R.map(function(d){return b.outsideEnvelopeTo(d,c,a)},c)}var w=a("los"),x=Object.create(w);R.deepExtend(x,{create:e,toggleDisplay:f,setRemote:g,resetRemote:h,origin:i,clearOrigin:j,setOrigin:k,target:m,setOriginResetTarget:l,clearTarget:n,setTarget:o,toggleIgnoreModel:p,updateOriginTarget:q});var y=R.curry(r);return R.curryService(x),x}angular.module("clickApp.services").factory("gameLos",a),a.$inject=["gameSegment","circle","gameFactions","gameModels"]}(),function(){function a(a,b){function c(a,c,d){return new self.Promise(function(e,g){var h=R.thread(d)(f.all,R.filter(b.isBetweenPoints$(a,c)),R.map(R.path(["state","stamp"])));R.isEmpty(h)?g("No model found between points"):e(h)})}function d(a,c){return R.threadP(c)(f.findStampP$(a),b.modeFor$)}var e=a("model",b),f=Object.create(e);return R.deepExtend(f,{findStampsBetweenPointsP:c,modeForStampP:d}),R.curryService(f),f}angular.module("clickApp.services").factory("gameModels",a),a.$inject=["gameElements","model"]}(),function(){function a(a,b){function c(a,b,c){var d=R.prop(a,c);return 1===R.length(d)&&d[0]===b}function d(a,c){var d=g.get("local",c);return R.isEmpty(d)?self.Promise.reject("No model selection"):1===R.length(d)?b.modeForStampP(d[0],a):"Models"}function e(a,b){return R.threadP(b)(g.modeForP$(a.game.models),function(b){a.queueEventP("Modes.switchTo",b)})}var f=a("model"),g=Object.create(f);return R.deepExtend(g,{inSingle:c,modeForP:d,checkModeP:e}),R.curryService(g),g}angular.module("clickApp.services").factory("gameModelSelection",a),a.$inject=["gameElementSelection","gameModels"]}(),function(){function a(a,b,c,d){function e(){return R.deepExtend(w.create(),{local:{length:null},remote:{length:null}})}function f(a){return R.pathOr(0,["remote","max"],a)}function g(a,b,c,d){return R.thread(d)(R.assocPath(["local","max"],a),R.assocPath(["remote","max"],a),z(b))}function h(a){return R.path(["remote","origin"],a)}function i(a,b,c){return u({origin:null},a,c)}function j(a,b,d,e){var f=a.state.stamp,g=x.target(e);g=g===f?null:g;var h=R.defaultTo(R.path(["remote","max"],e),c.rulerMaxLength(a));return u({origin:f,target:g,max_length:h},b,e)}function k(a,b,d,e){var f=a.state.stamp,g=R.defaultTo(R.path(["remote","max"],e),c.rulerMaxLength(a));return u({origin:f,target:null,max_length:g},b,e)}function l(a){return R.path(["remote","target"],a)}function m(a){return R.path(["remote","reached"],a)}function n(a,b,c){return u({target:null},a,c)}function o(a,b,c,d){var e=x.origin(d),f=a.state.stamp;return e=e===f?null:e,u({origin:e,target:f},b,d)}function p(a,b,c){return v(a,c)}function q(a,b,c,d,e){return R.over(R.lensProp("local"),R.pipe(R.assoc("start",R.clone(a)),y(b),R.assoc("length",null),R.assoc("display",!0),function(a){return c.queueChangeEventP("Game.ruler.local.change"),a}),e)}function r(a,b,c,d,e){return R.thread(e)(R.over(R.lensProp("local"),R.pipe(R.assoc("display",!1),function(a){return c.queueChangeEventP("Game.ruler.local.change"),a})),R.over(R.lensProp("remote"),R.pipe(R.assoc("origin",null),R.assoc("target",null),R.assoc("start",R.clone(a)),R.assoc("end",R.clone(b)),R.assoc("display",!0))),z(c))}function s(a,c){var e=b.directionTo(c.remote.end,c.remote.start),f=c.remote.length/2,g=c.remote.end,h=x.target(c);return R.threadP(g)(function(b){return R.exists(h)&&x.targetReached(c)?R.threadP(a)(d.findStampP$(h),R.prop("state")):b},R.pick(["x","y"]),R.assoc("r",e),R.assoc("m",f))}function t(a,c){var d=b.distanceTo(a,c.start),e=b.directionTo(a,c.start),f=10*R.defaultTo(d/10,c.max);return d=Math.min(d,f),a=b.translateInDirection(d,e,c.start),R.assoc("end",a,c)}function u(a,b,c){var d=a.origin,e=void 0===d?x.origin(c):d,f=a.target,g=void 0===f?x.target(c):f,h=a.max_length,i=void 0===h?R.path(["remote","max"],c):h,j=R.exists(e)&&R.exists(g);return R.thread(c)(R.over(R.lensProp("remote"),R.pipe(R.assoc("origin",e),R.assoc("target",g),R.assoc("display",j),R.assoc("max",i))),z(b))}function v(a,e){function f(b){var c=R.path(["remote","origin"],b);return R.exists(c)?d.findStampP(c,a.game.models)["catch"](R.always(null)):null}function g(b){var c=R.path(["remote","target"],b);return R.exists(c)?d.findStampP(c,a.game.models)["catch"](R.always(null)):null}function h(b,d){return R.exists(b)&&R.exists(d)?c.shortestLineToP(a.factions,d,b):R.exists(b)?{start:R.pick(["x","y"],b.state),end:R.pick(["x","y"],b.state)}:R.exists(d)?{start:R.pick(["x","y"],d.state),end:R.pick(["x","y"],d.state)}:R.pick(["start","end"],R.prop("remote",e))}return R.threadP(e)(f,function(a){return R.threadP(e)(g,function(b){return h(a,b)})},function(c){var d=c.start,f=c.end,g=b.distanceTo(f,d);return R.over(R.lensProp("remote"),R.pipe(R.assoc("start",d),y(f),function(c){var d=b.distanceTo(c.end,c.start);return a.queueChangeEventP("Game.ruler.remote.change"),R.thread(c)(R.assoc("reached",d>=g-.1),R.assoc("length",Math.round(10*d)/100))}),e)})}var w=a("ruler"),x=Object.create(w);R.deepExtend(x,{create:e,maxLength:f,setMaxLength:g,setLocal:q,setRemote:r,origin:h,clearOrigin:i,setOrigin:j,setOriginResetTarget:k,target:l,targetReached:m,clearTarget:n,setTarget:o,updateOriginTarget:p,targetAoEPositionP:s});var y=R.curry(t),z=R.curry(v);return R.curryService(x),x}angular.module("clickApp.services").factory("gameRuler",a),a.$inject=["gameSegment","point","model","gameModels"]}(),function(){function a(a,b,c,d){function e(){return a.getP("/data/scenarios.json")["catch"](function(a){return[]})}function f(a){return R.prop("name",a)}function g(a,b){return R.find(R.compose(R.equals(a),R.head),b)}function h(a,b){return R.find(R.propEq("name",a),b[1])}function i(a,b){return R.isNil(a)?void 0:R.find(R.compose(R.find(R.propEq("name",a)),R.last),b)}function j(a){return new self.Promise(function(c,d){var e=R.concat(R.propOr([],"objectives",a),R.propOr([],"flags",a));R.isEmpty(e)&&d("No objectives");var f=R.assoc("r",0,R.head(e));c({base:R.pick(["x","y","r"],f),models:R.map(function(a){return R.thread(a)(R.assoc("r",0),R.assoc("info",R.concat(["scenario","models"],R.prop("info",a))),b.differenceFrom$(f))},e)})})}function k(a,b){return R.exists(R.find(function(b){return m(a,b)},R.propOr([],"circle",b))||R.find(function(b){return o(a,b)},R.propOr([],"rect",b))||R.find(function(b){return n(a,b)},R.propOr([],"flags",b)))}function l(a,b){return R.exists(b.killbox)&&p(a,b.killbox)}function m(a,b){var d={start:a,end:b},e=c.length(d);return e<=a.radius+b.r}function n(a,b){var d={start:a,end:b},e=c.length(d);return e<=a.radius+40+7.874}function o(a,b){var c={low:{x:b.x-b.width/2,y:b.y-b.height/2},high:{x:b.x+b.width/2,y:b.y+b.height/2}};return d.isInBox(c,a)}function p(a,b){var c={low:{x:b,y:b},high:{x:480-b,y:480-b}};return!d.isInBox(c,a)}var q={initP:e,name:f,group:g,forName:h,groupForName:i,createObjectivesP:j,isContesting:k,isKillboxing:l};return R.curryService(q),q}angular.module("clickApp.services").factory("gameScenario",a),a.$inject=["http","point","line","circle"]}(),function(){function a(){return function(a){function b(){return{local:{display:!1,start:{x:0,y:0},end:{x:0,y:0}},remote:{display:!1,start:{x:0,y:0},end:{x:0,y:0}}}}function c(a){return R.path(["remote","display"],a)}function d(b,c,d){return R.thread(d)(R.over(R.lensPath(["remote","display"]),R.not),function(c){return b.queueChangeEventP("Game."+a+".remote.change"),c})}function e(b,c,d,e,f){return R.over(R.lensProp("local"),R.pipe(R.assoc("start",R.clone(b)),R.assoc("end",R.clone(c)),R.assoc("display",!0),function(b){return d.queueChangeEventP("Game."+a+".local.change"),b}),f)}function f(b,c,d,e,f){return R.thread(f)(R.assocPath(["local","display"],!1),R.assocPath(["remote","start"],R.clone(b)),R.assocPath(["remote","end"],R.clone(c)),R.assocPath(["remote","display"],!0),function(b){return d.queueChangeEventP("Game."+a+".local.change"),
d.queueChangeEventP("Game."+a+".remote.change"),b})}function g(a){return R.clone(R.prop("remote",a))}function h(b,c,d,e){return R.thread(e)(R.assoc("remote",R.clone(b)),function(b){return c.queueChangeEventP("Game."+a+".remote.change"),b})}var i={create:b,isDisplayed:c,toggleDisplay:d,setLocal:e,setRemote:f,saveRemoteState:g,resetRemote:h};return R.curryService(i),i}}angular.module("clickApp.services").factory("gameSegment",a),a.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b){function c(a,b){return R.threadP(b)(i.findStampP$(a),R.path(["state","type"]),R.defaultTo("aoe"),function(a){return a+"Template"})}function d(a,b,c,d){return j(R.compose(R.always,R.always(null)),a,b,c,d)}function e(a,b,c,d){return R.threadP(d)(j(R.always,a,b,c),k(d))}function f(b,c,d,e,f){function g(e){return self.Promise.resolve(a.callP(c,d,e))["catch"](b(e))}return R.threadP(f)(i.findAnyStampsP$(e),R.reject(R.isNil),R.map(g),R.promiseAll)}function g(b,c){return R.thread(b)(i.all,R.concat(c),R.uniqBy(R.path(["state","stamp"])),R.partition(a.isLocked),function(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];return{active:d,locked:c}})}var h=b("template",a),i=Object.create(h);R.deepExtend(i,{modeForStampP:c,fromStampsP:d,onStampsP:e});var j=R.curry(f),k=R.curry(g);return R.curryService(i),i}angular.module("clickApp.services").factory("gameTemplates",a),a.$inject=["template","gameElements"]}(),function(){function a(a,b){function c(a,c){return R.threadP(c)(e.get$("local"),R.head,R.rejectIf(R.isNil,"No template selection"),function(c){return b.findStampP(c,a.game.templates)},function(b){a.queueEventP("Modes.switchTo",b.state.type+"Template")})}var d=a("template"),e=Object.create(d);return R.deepExtend(e,{checkModeP:c}),R.curryService(e),e}angular.module("clickApp.models").factory("gameTemplateSelection",a),a.$inject=["gameElementSelection","gameTemplates"]}(),function(){function a(a){function b(){return R.thread("/data/terrains.json")(a.getP,R.condErrorP([[R.T,function(a){return[]}]]),d)}function c(a,b){return new self.Promise(function(c,d){var e=R.path(a,b);R.isNil(e)?d('Terrain info "'+a.join(".")+'" not found'):c(e)})}function d(a){return R.threadP(a)(e)}function e(a){return R.thread(a)(R.keys,R.sortBy(R.identity),R.reduce(function(b,c){return b[c]=f(a[c]),b},{}))}function f(a){return R.thread(a)(R.keys,R.sortBy(R.identity),R.reduce(function(b,c){return b[c]=g(a[c]),b},{}))}function g(a){return R.thread(a)(R.keys,R.sortBy(R.identity),R.reduce(function(b,c){return b[c]=h(a[c]),b},{}))}function h(a){return R.thread(a)(R.over(R.lensPath(["img","width"]),R.divide(R.__,3)),R.over(R.lensPath(["img","height"]),R.divide(R.__,3)))}var i={initP:b,getInfoP:c};return R.curryService(i),i}angular.module("clickApp.services").factory("gameTerrainInfo",a),a.$inject=["http"]}(),function(){function a(a,b){return b("terrain",a)}angular.module("clickApp.services").factory("gameTerrains",a),a.$inject=["terrain","gameElements"]}(),function(){function a(a){return a("terrain")}angular.module("clickApp.services").factory("gameTerrainSelection",a),a.$inject=["gameElementSelection"]}(),function(){function a(a,b,c){function d(){return R.threadP(a.keys())(R.filter(function(a){return a.startsWith(l)}),R.map(function(b){return a.loadP(b)["catch"](R.spyAndDiscardError("GamesModel: Failed to load local game",b))}),R.promiseAll,R.reject(R.isNil),R.defaultTo([]),R.spyWarn("Games local load"))}function e(b){var c=l+b.local_stamp;return a.save(c,b)}function f(b){var c=l+b;return a.loadP(c)}function g(a,b){return R.thread(a)(R.assoc("local_stamp",R.guid()),m.saveLocalGame,R.flip(R.append)(b))}function h(b,c){return R.thread(l+b)(a.removeItem,R.always(c),R.reject(R.propEq("local_stamp",b)))}function i(a,b){var c=R.findIndex(R.propEq("local_stamp",a.local_stamp),b);return R.thread(a)(m.saveLocalGame,R.always(b),R.update(c,a))}function j(a){return R.threadP(a)(c.pickForJson,R.spyWarn("upload game"),b.postP$("/api/games"),R.spyWarn("upload game response"))}function k(a,c){var d=["/api/games",a?"private":"public",c].join("/");return R.threadP(d)(b.getP,R.spyError("Games: load online game"))}var l="clickApp.game.",m={loadLocalGamesP:d,saveLocalGame:e,loadLocalGameP:f,newLocalGame:g,removeLocalGame:h,updateLocalGame:i,newOnlineGameP:j,loadOnlineGameP:k};return R.curryService(m),m}angular.module("clickApp.services").factory("games",a),a.$inject=["localStorage","http","game"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b){function c(c,d){var e=a.differenceFrom(c.start,d),f=b.length(c),g=b.vector(c),h=a.vectorProduct(g,e),i=a.scalarProduct(g,e);return[h,i,f]}function d(a,b){var c=p.positionToLine(a,b),d=_slicedToArray(c,3),e=d[0],f=d[1],g=d[2];return e+b.radius>=0&&f+b.radius>=0&&f-b.radius<=g}function e(a,b){var c=p.positionToLine(a,b),d=_slicedToArray(c,3),e=d[0],f=d[1],g=d[2];return e-b.radius<=0&&f+b.radius>=0&&f-b.radius<=g}function f(a,b){return p.isRightOfLine(a.left,b)&&p.isLeftOfLine(a.right,b)}function g(a,b){var c=void 0,d=void 0;return b.x>=a.low.x&&b.x<=a.high.x&&b.y>=a.low.y&&b.y<=a.high.y?!0:b.x>=a.low.x-b.radius&&b.x<a.low.x?(c=a.low.x-b.x,d=Math.sqrt(b.radius*b.radius-c*c),b.y+d>=a.low.y&&b.y-d<=a.high.y):b.x<=a.high.x+b.radius&&b.x>a.high.x?(c=a.high.x-b.x,d=Math.sqrt(b.radius*b.radius-c*c),b.y+d>=a.low.y&&b.y-d<=a.high.y):b.y>=a.low.y-b.radius&&b.y<a.low.y?(d=a.low.y-b.y,c=Math.sqrt(b.radius*b.radius-d*d),b.x+c>=a.low.x&&b.x-c<=a.high.x):b.y<=a.high.y+b.radius&&b.y>a.high.y?(d=a.high.y-b.y,c=Math.sqrt(b.radius*b.radius-d*d),b.x+c>=a.low.x&&b.x-c<=a.high.x):!1}function h(a,b){var c=p.positionToLine(a,b),d=_slicedToArray(c,3),e=d[0],f=d[1],g=d[2];return Math.abs(e)<b.radius&&f+b.radius>=0&&f-b.radius<=g}function i(a,b){return{x:b.x+Math.sin(Math.PI*a/180)*b.radius,y:b.y-Math.cos(Math.PI*a/180)*b.radius}}function j(b,c,d){var e=a.distanceTo(d,b),f=a.directionTo(d,b),g=180*Math.acos(d.radius/e)/Math.PI,h=c?f-180+g:f+180-g;return p.pointOnEdgeInDirection(h,d)}function k(b,c){var d=a.directionTo(b,c),e=a.distanceTo(b,c),f=Math.abs(c.radius-b.radius),g=180*(Math.asin(f/e)*(c.radius>=b.radius?1:-1))/Math.PI;return{right:d-g+90,left:d+g-90}}function l(a,b){var c=p.envelopeDirectionsTo(a,b),d={left:{start:p.pointOnEdgeInDirection(c.left,b),end:p.pointOnEdgeInDirection(c.left,a)},right:{start:p.pointOnEdgeInDirection(c.right,b),end:p.pointOnEdgeInDirection(c.right,a)}};return d}function m(c,d,e){var f=p.envelopeDirectionsTo(c,e),g={left:n(f,c,d,e),right:o(f,c,d,e)};g.left.vector=b.vector(g.left),g.right.vector=b.vector(g.right);var h={left:{start:{x:g.left.end.x,y:g.left.end.y}},right:{start:{x:g.right.end.x,y:g.right.end.y}}},i=800,j=800,k=a.vectorProduct(g.left.vector,g.right.vector);if(k>.001){var l={start:g.left.end,end:g.right.end};l.length=b.length(l),l.vector=b.vector(l);var m=Math.acos(a.scalarProduct(l.vector,g.left.vector)),q=Math.acos(-a.scalarProduct(l.vector,g.right.vector));i=l.length*Math.sin(m)/Math.sin(m+q),j=l.length*Math.sin(q)/Math.sin(m+q)}return i=Math.min(800,i),j=Math.min(800,j),h.left.end=a.translateInVector(i,g.left.vector,h.left.start),h.right.end=a.translateInVector(j,g.right.vector,h.right.start),h}function n(a,c,d,e){for(var f=(a.right-a.left)/180,g={start:null,end:null},h=a.left;h<a.right;h+=f){g.start=p.pointOnEdgeInDirection(h,e),g.end=p.pointOnEdgeTangentTo(g.start,!0,c),g.length=b.length(g),g.vector=b.vector(g);var i=R.find(function(a){return p.intersectLine(g,a)},d);if(R.isNil(i))return g}return g}function o(a,c,d,e){for(var f=(a.right-a.left)/180,g={start:null,end:null},h=a.right;h>a.left;h-=f){g.start=p.pointOnEdgeInDirection(h,e),g.end=p.pointOnEdgeTangentTo(g.start,!1,c),g.length=b.length(g),g.vector=b.vector(g);var i=R.find(function(a){return p.intersectLine(g,a)},d);if(R.isNil(i))return g}return g}var p={positionToLine:c,isLeftOfLine:d,isRightOfLine:e,isInEnvelope:f,isInBox:g,intersectLine:h,pointOnEdgeInDirection:i,pointOnEdgeTangentTo:j,envelopeDirectionsTo:k,envelopeTo:l,outsideEnvelopeTo:m};return R.curryService(p),p}angular.module("clickApp.services").factory("circle",a),a.$inject=["point","line"]}(),function(){function a(a){function b(b){return a.distanceTo(b.end,b.start)}function c(a){var b=d.length(a);return{x:(a.end.x-a.start.x)/b,y:(a.end.y-a.start.y)/b}}var d={length:b,vector:c};return R.curryService(d),d}angular.module("clickApp.services").factory("line",a),a.$inject=["point"]}(),function(){function a(){function a(a,b){var c=b.r*Math.PI/180;return R.pipe(R.assoc("x",b.x+a*Math.sin(c)),R.assoc("y",b.y-a*Math.cos(c)))(b)}function b(a,b){var c=b.r*Math.PI/180;return R.pipe(R.assoc("x",b.x-a*Math.sin(c)),R.assoc("y",b.y+a*Math.cos(c)))(b)}function c(a,b){return R.assoc("r",b.r-a,b)}function d(a,b,c){var d=t.directionTo(c,b),e=t.distanceTo(c,b),f=d-a;return R.pipe(R.assoc("x",b.x+e*Math.sin(f*Math.PI/180)),R.assoc("y",b.y-e*Math.cos(f*Math.PI/180)))(c)}function e(a,b){return R.assoc("r",b.r+a,b)}function f(a,b,c){var d=t.directionTo(c,b),e=t.distanceTo(c,b),f=d+a;return R.pipe(R.assoc("x",b.x+e*Math.sin(f*Math.PI/180)),R.assoc("y",b.y-e*Math.cos(f*Math.PI/180)))(c)}function g(a,b,c){var d=t.distanceTo(c,b);return R.pipe(R.assoc("x",b.x+d*Math.sin(a*Math.PI/180)),R.assoc("y",b.y-d*Math.cos(a*Math.PI/180)))(c)}function h(a,b){return R.assoc("x",b.x-a,b)}function i(a,b){return R.assoc("x",b.x+a,b)}function j(a,b){return R.assoc("y",b.y-a,b)}function k(a,b){return R.assoc("y",b.y+a,b)}function l(a,b){return Math.sqrt(Math.pow(a.x-b.x,2)+Math.pow(a.y-b.y,2))}function m(a,b){return 180*Math.atan2(a.x-b.x,b.y-a.y)/Math.PI}function n(a,b,c){return b=b*Math.PI/180,R.pipe(R.assoc("x",c.x+a*Math.sin(b)),R.assoc("y",c.y-a*Math.cos(b)))(c)}function o(a,b,c){return R.pipe(R.assoc("x",c.x+a*b.x),R.assoc("y",c.y+a*b.y))(c)}function p(a,b,c){var d=a?-1:1,e=a?180:0;return R.pipe(R.assoc("x",b.x+d*c.x),R.assoc("y",b.y+d*c.y),R.assoc("r",b.r+c.r+e))(c)}function q(a,b){return R.pipe(R.assoc("x",b.x-a.x),R.assoc("y",b.y-a.y),R.assoc("r",b.r-a.r))(b)}function r(a,b){return a.y*b.x-a.x*b.y}function s(a,b){return a.x*b.x+a.y*b.y}var t={moveFront:a,moveBack:b,rotateLeft:c,rotateLeftAround:d,rotateRight:e,rotateRightAround:f,rotateAroundTo:g,shiftLeft:h,shiftRight:i,shiftUp:j,shiftDown:k,distanceTo:l,directionTo:m,translateInDirection:n,translateInVector:o,addToWithFlip:p,differenceFrom:q,vectorProduct:r,scalarProduct:s};return R.curryService(t),t}angular.module("clickApp.services").factory("point",a),a.$inject=[]}(),function(){function a(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s){function t(a,b){return R.threadP(a)(c.getModelInfoP$(b.info),function(c){var d={state:{x:0,y:0,r:0,img:0,dsp:["i"],eff:[],l:[],c:0,s:0,u:null,aur:null,are:null,rml:null,cml:null,pml:[null,!1],cha:null,pla:null,dmg:z(c.damage),stamp:R.guid()}};return("wardude"===c.type||"beast"===c.type||"jack"===c.type)&&(d.state.dsp=R.append("c",d.state.dsp)),c.immovable&&(d.state.lk=!0),d.state=R.deepExtend(d.state,b),D.checkStateP(a,null,d)})}function u(a){return R.path(["state","user"],a)}function v(a,b){return R.pathEq(["state","user"],a,b)}function w(a,b,d){return R.threadP(a)(c.getModelInfoP$(d.state.info),function(a){var c=a.base_radius;return R.thread(d.state)(R.assoc("x",Math.max(0+c,Math.min(480-c,d.state.x))),R.assoc("y",Math.max(0+c,Math.min(480-c,d.state.y))),function(c){return R.reduce(function(c,d){return d(a,b,c)},c,D.state_checkers)},function(a){return R.reduce(function(a,b){return b(a)},a,D.state_updaters)})},function(a){return R.assoc("state",a,d)})}function x(a){return D.isCharging(a)?"ModelCharge":D.isPlacing(a)?"ModelPlace":"Model"}function y(a,b){return R.thread(a)(R.props(["unit_name","name"]),R.prepend(D.user(b)),R.reject(R.isNil),R.join("/"))}function z(a){return"warrior"===a.type?{n:0,t:0}:R.thread(a)(R.keys,R.reject(R.equals("type")),R.reject(R.equals("field")),R.reject(R.equals("total")),R.reject(R.equals("depth")),R.reduce(function(b,c){return R.assoc(c,R.map(R.always(0),a[c]),b)},{}),R.assoc("f",0),R.assoc("t",0))}var A={Move:10,MoveSmall:5,Rotate:15,RotateSmall:5,Shift:10,ShiftSmall:1,RotateCharge:10,RotateChargeSmall:2},B=R.clone(A);a.register("Misc","Model",A,function(a){R.extend(B,a)});var C=b("model",B),D=Object.create(C);return R.deepExtend(D,{createP:t,state_checkers:[],state_updaters:[],checkStateP:w,descriptionFromInfo:y,user:u,userIs:v,modeFor:x},d(D),e(D),f(B,D),g(D),h(D),i(D),j(D),k(D),l(D),m(D),n(D),o(B,D),p(B,D),s(D),q(D),r(D)),R.curryService(D),D}angular.module("clickApp.services").factory("model",a),a.$inject=["settings","element","gameFactions","modelArea","modelAura","modelCharge","modelCounter","modelDamage","modelEffect","modelGeom","modelImage","modelIncorporeal","modelLeader","modelMelee","modelMove","modelPlace","modelRuler","modelUnit","modelWreck"]}(),function(){function a(a){return function(){function b(b,c){return R.threadP(b)(a.getModelInfoP$(c.state.info),function(a){return"wardude"===a.type&&("Number"===R.type(a.focus)||"Number"===R.type(a.fury))&&!!R.find(R.equals("a"),c.state.dsp)})}function c(a,b){return a?R.over(R.lensPath(["state","dsp"]),R.compose(R.uniq,R.append("a")),b):R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("a")),b)}function d(a){return R.find(R.equals("a"),a.state.dsp)?R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("a")),a):R.over(R.lensPath(["state","dsp"]),R.append("a"),a)}function e(a){return R.exists(a.state.are)}function f(a){return a.state.are}function g(a,b){return R.assocPath(["state","are"],a,b)}function h(a,b){return R.over(R.lensPath(["state","are"]),function(b){return a===b?null:a},b)}var i={isCtrlAreaDisplayedP:b,setCtrlAreaDisplay:c,toggleCtrlAreaDisplay:d,isAreaDisplayed:e,areaDisplay:f,setAreaDisplay:g,toggleAreaDisplay:h};return i}}angular.module("clickApp.services").factory("modelArea",a),a.$inject=["gameFactions"]}(),function(){function a(){return function(){function a(a){return R.exists(a.state.aur)}function b(a){return a.state.aur}function c(a,b){return R.assocPath(["state","aur"],a,b)}function d(a,b){return R.over(R.lensPath(["state","aur"]),function(b){return a===b?null:a},b)}var e={isAuraDisplayed:a,auraDisplay:b,setAuraDisplay:c,toggleAuraDisplay:d};return e}}angular.module("clickApp.services").factory("modelAura",a),a.$inject=[]}(),function(){function a(a){var b=.1;return function(c,d){function e(a){return R.threadP(a)(R.rejectIf(d.isLocked,"Model is locked"),R.assocPath(["state","cha"],{s:R.pick(["x","y","r"],a.state),t:null}))}function f(a){return R.exists(a.state.cha)}function g(a){return new self.Promise(function(b,c){return d.isCharging(a)?void b(R.path(["state","cha","t"],a)):void c("Model is not charging")})}function h(a){return R.assocPath(["state","cha"],null,a)}function i(b,c,e){return R.threadP(e)(R.rejectIf(d.isLocked,"Model is locked"),function(b){return R.exists(c)?R.thread(b)(R.over(R.lensPath(["state","cha"]),R.assoc("t",c.state.stamp)),R.over(R.lensProp("state"),R.assoc("r",a.directionTo(c.state,b.state)))):R.assocPath(["state","cha","t"],null,b)},d.checkStateP$(b,c))}function j(a){return R.path(["state","cml"],a)}function k(a,b,c){return c=R.assocPath(["state","cml"],b,c),d.checkStateP(a,null,c)}function l(b,e,f,g){return R.threadP(g)(R.rejectIf(d.isLocked,"Model is locked"),function(b){var d=c[f?"MoveSmall":"Move"],e=b.state.cha.s.r;return R.over(R.lensProp("state"),a.translateInDirection$(d,e),b)},d.checkStateP$(b,e))}function m(b,e,f,g){return R.threadP(g)(R.rejectIf(d.isLocked,"Model is locked"),function(b){var d=c[f?"MoveSmall":"Move"],e=b.state.cha.s.r+180,g=a.distanceTo(b.state,b.state.cha.s);return d>g&&(d=g),R.over(R.lensProp("state"),a.translateInDirection$(d,e),b)},d.checkStateP$(b,e))}function n(b,e,f,g){return R.threadP(g)(R.rejectIf(d.isLocked,"Model is locked"),function(b){var d=c[f?"RotateChargeSmall":"RotateCharge"];return R.thread(b)(R.over(R.lensProp("state"),a.rotateLeftAround$(d,b.state.cha.s)),R.over(R.lensPath(["state","cha","s","r"]),R.subtract(R.__,d)))},d.checkStateP$(b,e))}function o(b,e,f,g){return R.threadP(g)(R.rejectIf(d.isLocked,"Model is locked"),function(b){var d=c[f?"RotateChargeSmall":"RotateCharge"];return R.thread(b)(R.over(R.lensProp("state"),a.rotateRightAround$(d,b.state.cha.s)),R.over(R.lensPath(["state","cha","s","r"]),R.add(d)))},d.checkStateP$(b,e))}function p(b,e,f,g){return R.threadP(g)(R.rejectIf(d.isLocked,"Model is locked"),function(b){var d=c[f?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftLeft$(d),b)},d.checkStateP$(b,e))}function q(b,e,f,g){return R.threadP(g)(R.rejectIf(d.isLocked,"Model is locked"),function(b){var d=c[f?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftRight$(d),b)},d.checkStateP$(b,e))}function r(b,e,f,g){return R.threadP(g)(R.rejectIf(d.isLocked,"Model is locked"),function(b){var d=c[f?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftUp$(d),b)},d.checkStateP$(b,e))}function s(b,e,f,g){return R.threadP(g)(R.rejectIf(d.isLocked,"Model is locked"),function(b){var d=c[f?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftDown$(d),b)},d.checkStateP$(b,e))}function t(b,c,d){if(R.exists(d.cha)&&R.exists(d.cml)&&d.cml>0){var e=a.distanceTo(d,d.cha.s);if(e>10*d.cml){var f=a.directionTo(d,d.cha.s),g=a.translateInDirection(10*d.cml,f,d.cha.s);return R.thread(d)(R.assoc("x",g.x),R.assoc("y",g.y))}}return d}function u(c,d,e){if(R.exists(e.cha)){if(R.exists(d))return R.assoc("r",a.directionTo(d.state,e),e);var f=a.distanceTo(e,e.cha.s),g=b>f?e.r:a.directionTo(e,e.cha.s);return R.assoc("r",g,e)}return e}function v(c){if(R.exists(c.cha)){var d=a.distanceTo(c,c.cha.s);if(d>b){var e=a.directionTo(c,c.cha.s);return R.assocPath(["cha","s","r"],e,c)}}return c}var w={startChargeP:e,isCharging:f,chargeTargetP:g,endCharge:h,setChargeTargetP:i,chargeMaxLength:j,setChargeMaxLengthP:k,moveFrontChargeP:l,moveBackChargeP:m,rotateLeftChargeP:n,rotateRightChargeP:o,shiftLeftChargeP:p,shiftRightChargeP:q,shiftUpChargeP:r,shiftDownChargeP:s},x=R.curry(t);d.state_checkers=R.append(x,d.state_checkers);var y=R.curry(u);d.state_checkers=R.append(y,d.state_checkers);var z=R.curry(v);return d.state_updaters=R.append(z,d.state_updaters),w}}angular.module("clickApp.services").factory("modelCharge",a),a.$inject=["point"]}(),function(){function a(){return function(a){function b(a,b){return!!R.find(R.equals(a),b.state.dsp)}function c(a,b){var c=R.defaultTo(0,b.state[a])+1;return R.assocPath(["state",a],c,b)}function d(a,b){var c=Math.max(0,R.defaultTo(0,b.state[a])-1);return R.assocPath(["state",a],c,b)}function e(a,b,c){return b?R.over(R.lensPath(["state","dsp"]),R.compose(R.uniq,R.append(a)),c):R.over(R.lensPath(["state","dsp"]),R.reject(R.equals(a)),c)}function f(b,c){return a.isCounterDisplayed(b,c)?R.over(R.lensPath(["state","dsp"]),R.reject(R.equals(b)),c):R.over(R.lensPath(["state","dsp"]),R.append(b),c)}var g={isCounterDisplayed:b,incrementCounter:c,decrementCounter:d,setCounterDisplay:e,toggleCounterDisplay:f};return g}}angular.module("clickApp.services").factory("modelCounter",a),a.$inject=[]}(),function(){function a(a){return function(){function b(a){function b(b,c){var d=a.state.dmg[c];return d="Array"===R.type(d)?R.map(R.always(0),d):0,R.assoc(c,d,b)}return R.over(R.lensPath(["state","dmg"]),R.pipe(R.keys,R.reduce(b,{})),a)}function c(b,c,d){return R.threadP(b)(a.getModelInfoP$(d.state.info),function(a){var b=R.defaultTo(0,d.state.dmg.n);return b=b===c?0:c,b=Math.min(b,a.damage.n),R.over(R.lensPath(["state","dmg"]),R.pipe(R.assoc("n",b),R.assoc("t",b)),d)})}function d(b,c,d){return R.threadP(b)(a.getModelInfoP$(d.state.info),function(a){var b=R.defaultTo(0,d.state.dmg.f);return b=b===c?0:c,b=Math.min(b,a.damage.field),R.assocPath(["state","dmg","f"],b,d)})}function e(b,c,d,e){return R.threadP(b)(a.getModelInfoP$(e.state.info),function(a){var b=e.state.dmg[d][c];return b=0===b?1:0,b=R.exists(a.damage[d][c])?b:0,R.over(R.lensPath(["state","dmg"]),R.pipe(R.over(R.lensProp(d),R.update(c,b)),function(a){return R.assoc("t",g(a),a)}),e)})}function f(b,c,d){return R.threadP(b)(a.getModelInfoP$(d.state.info),function(a){var b=R.thread(d.state.dmg[c])(R.addIndex(R.filter)(function(b,d){return R.exists(a.damage[c][d])}),R.reject(R.equals(1)),R.isEmpty),e=b?0:1;return R.over(R.lensPath(["state","dmg"]),R.pipe(R.over(R.lensProp(c),R.addIndex(R.map)(function(b,d){return R.exists(a.damage[c][d])?e:0})),function(a){return R.assoc("t",g(a),a)}),d)})}function g(a){return R.thread(a)(R.keys,R.reject(R.equals("t")),R.reject(R.equals("f")),R.reject(R.equals("n")),R.reduce(function(b,c){return b+R.reduce(R.add,0,a[c])},0))}var h={resetDamage:b,setWarriorDamageP:c,setFieldDamageP:d,setGridDamageP:e,setGridColDamageP:f};return h}}angular.module("clickApp.services").factory("modelDamage",a),a.$inject=["gameFactions"]}(),function(){function a(){return function(a){function b(a,b){return!!R.find(R.equals(a),R.pathOr([],["state","eff"],b))}function c(a,b,c){return b?R.over(R.lensPath(["state","eff"]),R.compose(R.uniq,R.append(a),R.defaultTo([])),c):R.over(R.lensPath(["state","eff"]),R.compose(R.reject(R.equals(a)),R.defaultTo([])),c)}function d(b,c){return a.isEffectDisplayed(b,c)?R.over(R.lensPath(["state","eff"]),R.compose(R.reject(R.equals(b)),R.defaultTo([])),c):R.over(R.lensPath(["state","eff"]),R.compose(R.append(b),R.defaultTo([])),c)}var e={isEffectDisplayed:b,setEffectDisplay:c,toggleEffectDisplay:d};return e}}angular.module("clickApp.services").factory("modelEffect",a),a.$inject=[]}(),function(){function a(a,b){return function(c){function d(a,b,c){var d=R.path(["state","x"],c),e=R.path(["state","y"],c);return a.x<=d&&d<=b.x&&a.y<=e&&e<=b.y}function e(c,d,e){var f=a.directionTo(d.state,e.state);return R.threadP(c)(b.getModelInfoP$(e.state.info),function(g){var h=a.translateInDirection(g.base_radius,f,e.state);return R.threadP(c)(b.getModelInfoP$(d.state.info),function(b){var c=a.translateInDirection(b.base_radius,f+180,d.state);return{start:R.pick(["x","y"],h),end:R.pick(["x","y"],c)}})})}function f(c,d,e){return R.threadP(c)(b.getModelInfoP$(e.state.info),function(b){return R.thread(e.state)(a.translateInDirection$(b.base_radius,d),R.pick(["x","y"]))})}function g(c,d,e){return R.threadP(c)(b.getModelInfoP$(e.state.info),function(f){return R.threadP(c)(b.getModelInfoP$(d.state.info),function(b){return a.distanceTo(d.state,e.state)-f.base_radius-b.base_radius})})}function h(c,d,e){return R.threadP(c)(b.getModelInfoP$(e.state.info),function(b){var c=d.state.s;return a.distanceTo(d.state,e.state)-b.base_radius-c})}function i(d,e,f){return R.threadP(f)(R.rejectIf(c.isLocked,"Model is locked"),function(f){var g=a.directionTo(f.state,e.state);return R.threadP(d)(b.getModelInfoP$(f.state.info),function(h){return R.threadP(d)(b.getModelInfoP$(e.state.info),function(b){var c=h.base_radius+b.base_radius,d=a.translateInDirection(c,g,e.state);return R.thread(f)(R.assocPath(["state","x"],d.x),R.assocPath(["state","y"],d.y))},c.checkStateP$(d,null))})})}var j={isBetweenPoints:d,shortestLineToP:e,baseEdgeInDirectionP:f,distanceToP:g,distanceToAoEP:h,setB2BP:i};return j}}angular.module("clickApp.services").factory("modelGeom",a),a.$inject=["point","gameFactions"]}(),function(){function a(a){return function(b){function c(a){return!!R.find(R.equals("i"),a.state.dsp)}function d(c,d){return R.threadP(c)(a.getModelInfoP$(d.state.info),R.prop("img"),function(a){var c=R.thread(a)(R.filter(R.propEq("type","default")),R.prop(d.state.img));b.isLeaderDisplayed(d)&&(c=R.thread(a)(R.filter(R.propEq("type","leader")),R.head,R.defaultTo(c))),b.isIncorporealDisplayed(d)&&(c=R.thread(a)(R.filter(R.propEq("type","incorporeal")),R.head,R.defaultTo(c)));var e=b.isImageDisplayed(d)?c.link:null;return R.assoc("link",e,c)})}function e(b,c){return R.threadP(b)(a.getModelInfoP$(c.state.info),R.prop("img"),R.filter(R.propEq("type","default")),function(a){return c.state.img>=a.length-1?0:c.state.img+1},function(a){return R.assocPath(["state","img"],a,c)})}function f(a,b){return a?R.over(R.lensPath(["state","dsp"]),R.compose(R.uniq,R.append("i")),b):R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("i")),b)}function g(a){return b.isImageDisplayed(a)?R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("i")),a):R.over(R.lensPath(["state","dsp"]),R.append("i"),a)}var h={isImageDisplayed:c,getImageP:d,setNextImageP:e,setImageDisplay:f,toggleImageDisplay:g};return h}}angular.module("clickApp.services").factory("modelImage",a),a.$inject=["gameFactions"]}(),function(){function a(){return function(a){function b(a){return!!R.find(R.equals("in"),a.state.dsp)}function c(a,b){return a?R.over(R.lensPath(["state","dsp"]),R.compose(R.uniq,R.append("in")),b):R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("in")),b)}function d(b){return a.isIncorporealDisplayed(b)?R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("in")),b):R.over(R.lensPath(["state","dsp"]),R.append("in"),b)}var e={isIncorporealDisplayed:b,setIncorporealDisplay:c,toggleIncorporealDisplay:d};return e}}angular.module("clickApp.services").factory("modelIncorporeal",a),a.$inject=[]}(),function(){function a(){return function(){function a(a,b){return R.over(R.lensPath(["state","l"]),R.compose(R.uniq,R.append(a)),b)}function b(a,b){return R.over(R.lensPath(["state","l"]),R.reject(R.equals(a)),b)}function c(a){return R.assocPath(["state","l"],[],a)}function d(a){return R.pathOr([],["state","l"],a).join(" ")}var e={addLabel:a,removeLabel:b,clearLabel:c,fullLabel:d};return e}}angular.module("clickApp.services").factory("modelLabel",a),a.$inject=[]}(),function(){function a(){return function(a){function b(a){return!!R.find(R.equals("l"),a.state.dsp)}function c(a,b){return a?R.over(R.lensPath(["state","dsp"]),R.compose(R.uniq,R.append("l")),b):R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("l")),b)}function d(b){return a.isLeaderDisplayed(b)?R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("l")),b):R.over(R.lensPath(["state","dsp"]),R.append("l"),b)}var e={isLeaderDisplayed:b,setLeaderDisplay:c,toggleLeaderDisplay:d};return e}}angular.module("clickApp.services").factory("modelLeader",a),a.$inject=[]}(),function(){function a(){return function(a){function b(a,b){return!!R.find(R.equals(a),b.state.dsp)}function c(a,b,c){return b?R.over(R.lensPath(["state","dsp"]),R.compose(R.uniq,R.append(a)),c):R.over(R.lensPath(["state","dsp"]),R.reject(R.equals(a)),c)}function d(b,c){return a.isMeleeDisplayed(b,c)?R.over(R.lensPath(["state","dsp"]),R.reject(R.equals(b)),c):R.over(R.lensPath(["state","dsp"]),R.append(b),c)}var e={isMeleeDisplayed:b,setMeleeDisplay:c,toggleMeleeDisplay:d};return e}}angular.module("clickApp.services").factory("modelMelee",a),a.$inject=[]}(),function(){function a(a){return function(b,c){function d(a,b){return function(){for(var d=this,e=arguments.length,f=Array(e),g=0;e>g;g++)f[g]=arguments[g];var h=R.last(f),i=R.head(f),j=b?R.nth(1,f):null;return R.threadP(h)(R.rejectIf(c.isLocked,"Model is locked"),function(){return a.apply(d,f)},c.checkStateP$(i,j))}}function e(a,b,c,d){return R.pipe(R.assocPath(["state","x"],c.x),R.assocPath(["state","y"],c.y))(d)}function f(a,b,d,e){return R.threadP(e)(R.rejectIf(c.isLocked,"Model is locked"),R.assocPath(["state","x"],d.x),R.assocPath(["state","y"],d.y),c.checkStateP$(a,b),function(a){return e.state=a.state,e})}function g(a,b,c,d){return R.pipe(R.over(R.lensPath(["state","x"]),R.add(c.x)),R.over(R.lensPath(["state","y"]),R.add(c.y)))(d)}function h(a,b,c){return R.assocPath(["state","r"],b,c)}function i(b,c,d){return R.assocPath(["state","r"],a.directionTo(c.state,d.state),d)}function j(c,d,e){var f=b[d?"MoveSmall":"Move"];return R.over(R.lensProp("state"),a.moveFront$(f),e)}function k(c,d,e){var f=b[d?"MoveSmall":"Move"];return R.over(R.lensProp("state"),a.moveBack$(f),e)}function l(c,d,e){var f=b[d?"RotateSmall":"Rotate"];return R.over(R.lensProp("state"),a.rotateLeft$(f),e)}function m(c,d,e){var f=b[d?"RotateSmall":"Rotate"];return R.over(R.lensProp("state"),a.rotateRight$(f),e)}function n(c,d,e){var f=b[d?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftLeft$(f),e)}function o(c,d,e){var f=b[d?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftRight$(f),e)}function p(c,d,e){var f=b[d?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftUp$(f),e)}function q(c,d,e){var f=b[d?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftDown$(f),e)}var r={setPositionP:d(e,!0),setPosition_:f,shiftPositionP:d(g,!0),setOrientationP:d(h,!1),orientToP:d(i,!1),moveFrontP:d(j,!1),moveBackP:d(k,!1),rotateLeftP:d(l,!1),rotateRightP:d(m,!1),shiftLeftP:d(n,!1),shiftRightP:d(o,!1),shiftUpP:d(p,!1),shiftDownP:d(q,!1)};return r}}angular.module("clickApp.services").factory("modelMove",a),a.$inject=["point"]}(),function(){function a(a){var b=.1;return function(c,d){function e(a){return R.threadP(a)(R.rejectIf(d.isLocked,"Model is locked"),R.assocPath(["state","pla"],{s:R.pick(["x","y","r"],a.state)}))}function f(a){return R.exists(a.state.pla)}function g(a){return R.assocPath(["state","pla"],null,a)}function h(b,c,e){return R.threadP(e)(R.rejectIf(d.isLocked,"Model is locked"),function(){var b=a.directionTo(e.state.pla.s,c.state);return R.thread(e)(R.over(R.lensProp("state"),a.rotateAroundTo$(b,e.state.pla.s)),R.assocPath(["state","pla","s","r"],b))},d.checkStateP$(b,null))}function i(b,c,e){return R.threadP(e)(R.rejectIf(d.isLocked,"Model is locked"),function(){var b=a.directionTo(c.state,e.state.pla.s);return R.thread(e)(R.over(R.lensProp("state"),a.rotateAroundTo$(b,e.state.pla.s)),R.assocPath(["state","pla","s","r"],b))},d.checkStateP$(b,null))}function j(a){return R.head(R.path(["state","pml"],a))}function k(a,b,c){return c=R.assocPath(["state","pml"],[b,c.state.pml[1]],c),d.checkStateP(a,null,c)}function l(a){return R.nth(1,R.pathOr([],["state","pml"],a))}function m(a,b,c){return c=R.assocPath(["state","pml"],[c.state.pml[0],b],c),d.checkStateP(a,null,c)}function n(b,e,f){return R.threadP(f)(R.rejectIf(d.isLocked,"Model is locked"),function(){var b=c[e?"MoveSmall":"Move"],d=f.state.pla.s.r;return R.over(R.lensProp("state"),a.translateInDirection$(b,d),f)},d.checkStateP$(b,null))}function o(b,e,f){return R.threadP(f)(R.rejectIf(d.isLocked,"Model is locked"),function(){var b=c[e?"MoveSmall":"Move"],d=f.state.pla.s.r+180,g=a.distanceTo(f.state,f.state.pla.s);return b>g&&(b=g),R.over(R.lensProp("state"),a.translateInDirection$(b,d),f)},d.checkStateP$(b,null))}function p(b,e,f){return R.threadP(f)(R.rejectIf(d.isLocked,"Model is locked"),function(){var b=c[e?"RotateChargeSmall":"RotateCharge"];return R.thread(f)(R.over(R.lensProp("state"),a.rotateLeftAround$(b,f.state.pla.s)),R.over(R.lensPath(["state","pla","s","r"]),R.subtract(R.__,b)))},d.checkStateP$(b,null))}function q(b,e,f){return R.threadP(f)(R.rejectIf(d.isLocked,"Model is locked"),function(){var b=c[e?"RotateChargeSmall":"RotateCharge"];return R.thread(f)(R.over(R.lensProp("state"),a.rotateRightAround$(b,f.state.pla.s)),R.over(R.lensPath(["state","pla","s","r"]),R.add(b)))},d.checkStateP$(b,null))}function r(b,e,f){return R.threadP(f)(R.rejectIf(d.isLocked,"Model is locked"),function(){var b=c[e?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftLeft$(b),f)},d.checkStateP$(b,null))}function s(b,e,f){return R.threadP(f)(R.rejectIf(d.isLocked,"Model is locked"),function(){
var b=c[e?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftRight$(b),f)},d.checkStateP$(b,null))}function t(b,e,f){return R.threadP(f)(R.rejectIf(d.isLocked,"Model is locked"),function(){var b=c[e?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftUp$(b),f)},d.checkStateP$(b,null))}function u(b,e,f){return R.threadP(f)(R.rejectIf(d.isLocked,"Model is locked"),function(){var b=c[e?"ShiftSmall":"Shift"];return R.over(R.lensProp("state"),a.shiftDown$(b),f)},d.checkStateP$(b,null))}function v(b,c,d){if(R.exists(d.pla)&&R.exists(d.pml)&&d.pml[0]>0){var e=a.distanceTo(d,d.pla.s),f=10*d.pml[0]+(d.pml[1]?2*b.base_radius:0);if(e>f){var g=a.directionTo(d,d.pla.s),h=a.translateInDirection(f,g,d.pla.s);return R.thread(d)(R.assoc("x",h.x),R.assoc("y",h.y))}}return d}function w(c){if(R.exists(c.pla)){var d=a.distanceTo(c,c.pla.s);if(d>b){var e=a.directionTo(c,c.pla.s);return R.assocPath(["pla","s","r"],e,c)}}return c}var x={startPlaceP:e,isPlacing:f,endPlace:g,setPlaceOriginP:h,setPlaceTargetP:i,placeMaxLength:j,setPlaceMaxLengthP:k,placeWithin:l,setPlaceWithinP:m,moveFrontPlaceP:n,moveBackPlaceP:o,rotateLeftPlaceP:p,rotateRightPlaceP:q,shiftLeftPlaceP:r,shiftRightPlaceP:s,shiftUpPlaceP:t,shiftDownPlaceP:u},y=R.curry(v);d.state_checkers=R.append(y,d.state_checkers);var z=R.curry(w);return d.state_updaters=R.append(z,d.state_updaters),x}}angular.module("clickApp.services").factory("modelPlace",a),a.$inject=["point"]}(),function(){function a(){return function(){function a(a){return R.path(["state","rml"],a)}function b(a,b){return R.assocPath(["state","rml"],a,b)}var c={rulerMaxLength:a,setRulerMaxLength:b};return c}}angular.module("clickApp.services").factory("modelRuler",a),a.$inject=[]}(),function(){function a(){return function(a){function b(a){return!!R.find(R.equals("u"),a.state.dsp)}function c(a){return R.prop("u",a.state)}function d(a,b){return R.propEq("u",a,b.state)}function e(a,b){return R.assocPath(["state","u"],a,b)}function f(a,b){return a?R.over(R.lensPath(["state","dsp"]),R.compose(R.uniq,R.append("u")),b):R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("u")),b)}function g(b){return a.isUnitDisplayed(b)?R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("u")),b):R.over(R.lensPath(["state","dsp"]),R.append("u"),b)}var h={isUnitDisplayed:b,unit:c,unitIs:d,setUnit:e,setUnitDisplay:f,toggleUnitDisplay:g};return h}}angular.module("clickApp.services").factory("modelUnit",a),a.$inject=[]}(),function(){function a(a){return function(b){function c(a){return!!R.find(R.equals("w"),a.state.dsp)}function d(c,d){return R.threadP(c)(a.getModelInfoP$(d.state.info),R.prop("img"),function(a){return R.thread(a)(R.find(R.propEq("type","wreck")),R.defaultTo(R.thread(a)(R.find(R.propEq("type","default")),R.defaultTo({}),R.assoc("link",null))))},function(a){var c=b.isImageDisplayed(d)?a.link:null;return R.assoc("link",c,a)})}function e(a,b){return a?R.over(R.lensPath(["state","dsp"]),R.compose(R.uniq,R.append("w")),b):R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("w")),b)}function f(a){return b.isWreckDisplayed(a)?R.over(R.lensPath(["state","dsp"]),R.reject(R.equals("w")),a):R.over(R.lensPath(["state","dsp"]),R.append("w"),a)}var g={isWreckDisplayed:c,getWreckImageP:d,setWreckDisplay:e,toggleWreckDisplay:f};return g}}angular.module("clickApp.services").factory("modelWreck",a),a.$inject=["gameFactions"]}(),function(){function a(){function a(a){q[a.name]=a}function b(a){var b={register:q};return Mousetrap.reset(),s("Default",a,b)}function c(a,b){return u(a,b)}function d(a){return R.propOr("Unknown","name",k(a))}function e(a){return R.propOr({},"actions",k(a))}function f(a){return R.propOr({},"bindings",k(a))}function g(a){return R.propOr({},"buttons",k(a))}function h(a){return R.thread(a)(r.currentModeBindings,R.toPairsIn,R.sortBy(R.head))}function i(a,b,c){var d=r.currentModeName(c);return R.threadP(c)(k,R.path(["actions",a]),R.rejectIf(R.isNil,'Unknown action "'+a+'" in "'+d+'" mode'),function(a){return a.apply(null,b)})}function j(a,b,c){var d=k(c);return R.threadP(c)(R.path(["register",a]),R.rejectIf(R.isNil,"Mode "+a+" does not exists"),R.always(c),t(b),s(a,b),R.spy("Modes: switch mode from "+d.name+" to "+a))}function k(){var a=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return R.pathOr({},["register",R.propOr("##","current",a)],a)}function l(a,b,c){return R.threadP(c)(R.path(["register",a]),function(a){return R.exists(a.onEnter)?a.onEnter(b):null},R.always(c),R.assoc("current",a),v(b))}function m(a,b){return R.threadP(b)(k,function(b){return R.exists(b.onLeave)?b.onLeave(a):null},R.always(b),u(a),R.assoc("current",null))}function n(a,b){return Mousetrap.reset(),b}function o(a,b){return p(k(b),a),b}function p(a,b){function c(b){Mousetrap.bind(a.bindings[b],d(b))}function d(a){return function(c,d){b.queueEventP("Modes.current.action",a,[c])}}var e=R.keys(a.bindings),f=R.keysIn(a.bindings),g=R.difference(f,e);R.forEach(c,g),R.forEach(c,e)}var q={},r={registerMode:a,initP:b,exit:c,currentModeName:d,currentModeActions:e,currentModeBindings:f,currentModeButtons:g,currentModeBindingsPairs:h,currentModeActionP:i,switchToModeP:j},s=R.curry(l),t=R.curry(m),u=R.curry(n),v=R.curry(o);return R.curryService(r),r}angular.module("clickApp.services").factory("modes",a).factory("allModes",["defaultMode","rulerMode","losMode","createModelMode","modelsMode","modelMode","modelChargeMode","modelPlaceMode","createTemplateMode","aoeTemplateMode","sprayTemplateMode","wallTemplateMode","createTerrainMode","terrainMode",function(){return{}}]),a.$inject=[]}(),function(){function a(a){function b(a){return a.eventP("Modes.switchTo","Default")}function c(a){return a.eventP("Game.command.undoLast")}function d(a){return a.eventP("Game.command.replayNext")}function e(a){a.queueChangeEventP("Game.view.scrollLeft")}function f(a){a.queueChangeEventP("Game.view.scrollRight")}function g(a){a.queueChangeEventP("Game.view.scrollUp")}function h(a){a.queueChangeEventP("Game.view.scrollDown")}function i(a){a.queueChangeEventP("Game.view.zoomIn")}function j(a){a.queueChangeEventP("Game.view.zoomOut")}function k(a){a.queueChangeEventP("Game.view.zoomReset")}function l(a){a.queueChangeEventP("Game.view.flipMap")}function m(a){a.queueChangeEventP("Game.toggleMenu")}var n={DragEpsilon:3,ScrollStep:30,ZoomFactor:2},o=R.clone(n),p={modeBackToDefault:b,commandUndoLast:c,commandReplayNext:d,viewScrollLeft:e,viewScrollRight:f,viewScrollUp:g,viewScrollDown:h,viewZoomIn:i,viewZoomOut:j,viewZoomReset:k,flipMap:l,toggleMenu:m},q={modeBackToDefault:"esc",commandUndoLast:"ctrl+z",commandReplayNext:"ctrl+y",viewScrollLeft:"alt+left",viewScrollRight:"alt+right",viewScrollUp:"alt+up",viewScrollDown:"alt+down",viewZoomIn:"alt++",viewZoomOut:"alt+-",viewZoomReset:"alt+z",flipMap:"ctrl+shift+f",toggleMenu:"ctrl+shift+m"},r={name:"Common",actions:p,buttons:[],bindings:R.clone(q),settings:function(){return o}};return a.register("Misc",r.name,n,function(a){R.extend(o,a)}),a.register("Bindings",r.name,q,function(a){R.extend(r.bindings,a)}),r}angular.module("clickApp.services").factory("commonMode",a),a.$inject=["settings"]}(),function(){function a(a){return function(b){function c(a){a.queueChangeEventP("Game."+b+".create.enable"),a.queueChangeEventP("Game.moveMap.enable")}function d(a){a.create=R.assoc(b+"s",null,a.create),a.queueChangeEventP("Game.moveMap.disable"),a.queueChangeEventP("Game."+b+".create.disable")}function e(a,b){g(b,a),a.queueChangeEventP("Game.create.update")}function f(a,c){var d=R.path(["ui_state","flip_map"],a);return g(c["click#"],a),a.eventP("Game.command.execute","create"+s.capitalize(b),[a.create,d])}function g(a,b){b.create=R.over(R.lensProp("base"),R.pipe(R.assoc("x",a.x),R.assoc("y",a.y)),b.create)}var h=Object.create(a.actions);h.moveMap=e,h.create=f;var i={create:"clickMap"},j=R.extend(Object.create(a.bindings),i),k=[],l={onEnter:c,onLeave:d,name:"Create"+s.capitalize(b),actions:h,buttons:k,bindings:j};return l}}angular.module("clickApp.services").factory("createElementMode",a),a.$inject=["commonMode"]}(),function(){function a(a,b,c){var d=a("model");return b.registerMode(d),c.register("Bindings",d.name,d.bindings,function(a){R.extend(d.bindings,a)}),d}angular.module("clickApp.services").factory("createModelMode",a),a.$inject=["createElementMode","modes","settings"]}(),function(){function a(a,b,c){var d=a("template");return b.registerMode(d),c.register("Bindings",d.name,d.bindings,function(a){R.extend(d.bindings,a)}),d}angular.module("clickApp.services").factory("createTemplateMode",a),a.$inject=["createElementMode","modes","settings"]}(),function(){function a(a,b,c){var d=a("terrain");return b.registerMode(d),c.register("Bindings",d.name,d.bindings,function(a){R.extend(d.bindings,a)}),d}angular.module("clickApp.services").factory("createTerrainMode",a),a.$inject=["createElementMode","modes","settings"]}(),function(){function a(a,b,c,d,e,f,g){function h(a,b){return R.threadP()(t(a),u(a),function(){return b["click#"].target.state.stamp},function(b){return a.eventP("Game.command.execute","setModelSelection",["set",[b]])})}function i(a,b){return R.threadP()(t(a),u(a),function(){return b["click#"].target.state.stamp},function(b){return f["in"]("local",b,a.game.model_selection)?a.eventP("Game.command.execute","setModelSelection",["removeFrom",[b]]):a.eventP("Game.command.execute","setModelSelection",["addTo",[b]])})}function j(a,b){return R.threadP()(t(a),u(a),function(){return b["click#"].target.state.stamp},function(c){return a.queueChangeEventP("Game.selectionDetail.open","model",b["click#"].target),a.eventP("Game.command.execute","setModelSelection",["set",[c]])})}function k(a,b){return R.threadP()(u(a),function(){return a.eventP("Game.update",R.lensProp("template_selection"),d.set$("local",[b["click#"].target.state.stamp],a))})}function l(a,b){return R.threadP()(u(a),function(){return a.eventP("Game.update",R.lensProp("template_selection"),d.set$("local",[b["click#"].target.state.stamp],a))},function(){a.queueChangeEventP("Game.selectionDetail.open","template",b["click#"].target)})}function m(a,b){return R.threadP()(t(a),function(){return a.eventP("Game.update",R.lensProp("terrain_selection"),g.set$("local",[b["click#"].target.state.stamp],a))})}function n(a){return a.eventP("Modes.switchTo","Ruler")}function o(a){return a.eventP("Modes.switchTo","Los")}function p(a,b){a.queueChangeEventP("Game.dragBox.enable",b.start,b.now)}function q(a,b){a.queueChangeEventP("Game.dragBox.enable",b.start,b.now)}function r(a,b){a.queueChangeEventP("Game.dragBox.disable");var c={x:Math.min(b.now.x,b.start.x),y:Math.min(b.now.y,b.start.y)},d={x:Math.max(b.now.x,b.start.x),y:Math.max(b.now.y,b.start.y)};return R.threadP(a.game)(R.prop("models"),function(a){return e.findStampsBetweenPointsP(c,d,a)["catch"](R.always([]))},function(b){return R.isEmpty(b)?null:a.eventP("Game.command.execute","setModelSelection",["set",b])})}function s(a){return R.thread()(function(){return d.checkModeP(a,a.game.template_selection)},R.condErrorP([[R.T,function(){return g.checkModeP(a,a.game.terrain_selection)}]]),R.condErrorP([[R.T,function(){return f.checkModeP(a,a.game.model_selection)}]]),R.condErrorP([[R.T,R.always(null)]]))}function t(a){return function(){return a.eventP("Game.update",R.lensProp("template_selection"),d.clear$("local",a))}}function u(a){return function(){return a.eventP("Game.update",R.lensProp("terrain_selection"),g.clear$("local",a))}}var v=Object.create(c.actions);v.setModelSelection=h,v.toggleModelSelection=i,v.modelSelectionDetail=j,v.selectTemplate=k,v.templateSelectionDetail=l,v.selectTerrain=m,v.enterRulerMode=n,v.enterLosMode=o,v.dragStartMap=p,v.dragMap=q,v.dragEndMap=r;var w={enterRulerMode:"ctrl+r",enterLosMode:"ctrl+l",setModelSelection:"clickModel",toggleModelSelection:"ctrl+clickModel",modelSelectionDetail:"rightClickModel",selectTemplate:"clickTemplate",templateSelectionDetail:"rightClickTemplate",selectTerrain:"clickTerrain"},x=R.extend(Object.create(c.bindings),w),y=[],z={name:"Default",onEnter:s,actions:v,buttons:y,bindings:x};return a.registerMode(z),b.register("Bindings",z.name,w,function(a){R.extend(z.bindings,a)}),z}angular.module("clickApp.services").factory("defaultMode",a),a.$inject=["modes","settings","commonMode","gameTemplateSelection","gameModels","gameModelSelection","gameTerrainSelection"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){return function(b,c,d,e){function f(a){return a.queueChangeEventP("Game.selectionDetail.close"),a.queueChangeEventP("Game.editDamage.close"),a.queueChangeEventP("Game.editLabel.close"),a.eventP("Game.update",R.lensProp(b+"_selection"),e.clear$("local",a))}function g(a){var c=e.get("local",a.game[b+"_selection"]);return R.threadP(a.game)(R.prop(b+"s"),d.copyStampsP$(c),function(c){return a.create=c,a.eventP("Modes.switchTo","Create"+s.capitalize(b))})}function h(a){var c=e.get("local",a.game[b+"_selection"]);return a.eventP("Game.command.execute","delete"+s.capitalize(b),[c])}function i(a){var f=e.get("local",a.game[b+"_selection"]);return R.threadP(a.game)(R.prop(b+"s"),d.findStampP$(f[0]),function(d){var e=c.isLocked(d);return a.eventP("Game.command.execute","lock"+s.capitalize(b)+"s",[!e,f])})}function j(a){var c=_slicedToArray(a,1),d=c[0];o[d]=function(a){var c=e.get("local",a.game[b+"_selection"]);return a.eventP("Game.command.execute","on"+s.capitalize(b)+"s",[d+"P",[!1],c])},o[d+"Small"]=function(a){var c=e.get("local",a.game[b+"_selection"]);return a.eventP("Game.command.execute","on"+s.capitalize(b)+"s",[d+"P",[!0],c])}}function k(a){var c=_slicedToArray(a,3),d=c[0],f=(c[1],c[2]);o[d]=function(a){var c=e.get("local",a.game[b+"_selection"]),g=R.path(["ui_state","flip_map"],a)?f:d;return a.eventP("Game.command.execute","on"+s.capitalize(b)+"s",[g+"P",[!1],c])},o[d+"Small"]=function(a){var c=e.get("local",a.game[b+"_selection"]),g=R.path(["ui_state","flip_map"],a)?f:d;return a.eventP("Game.command.execute","on"+s.capitalize(b)+"s",[g+"P",[!0],c])}}function l(){function d(a,d){return R.threadP(d.target)(R.rejectIf(c.isLocked,s.capitalize(b)+" is locked"),function(){return i=R.clone(d.target.state),f(a,d)},function(){return a.eventP("Game.update",R.lensProp(b+"_selection"),e.set$("local",[d.target.state.stamp],a))})}function f(a,d){return R.threadP(d.target)(R.rejectIf(c.isLocked,s.capitalize(b)+" is locked"),function(){h(d,d.target.state),a.queueChangeEventP("Game."+b+".change."+d.target.state.stamp)})}function g(a,d){return R.threadP(d.target)(R.rejectIf(c.isLocked,s.capitalize(b)+" is locked"),function(){d.target.state=R.clone(i);var c=R.clone(i);return h(d,c),a.eventP("Game.command.execute","on"+s.capitalize(b)+"s",["setPositionP",[c],[d.target.state.stamp]])})}function h(a,b){var c=a.now.x-a.start.x,d=a.now.y-a.start.y;b.x=i.x+c,b.y=i.y+d}o["dragStart"+s.capitalize(b)]=d,a.actions["dragStart"+s.capitalize(b)]=d,o["drag"+s.capitalize(b)]=f,o["dragEnd"+s.capitalize(b)]=g;var i=void 0}function m(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];r[c]=d,r[c+"Small"]="shift+"+d}function n(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];r[c]=d,r[c+"Small"]="shift+"+d}var o=Object.create(a.actions);o.modeBackToDefault=f,o.clickMap=f,o.rightClickMap=f,o.copySelection=g,o["delete"]=h,o.toggleLock=i;var p=[["moveFront","up"],["moveBack","down"],["rotateLeft","left"],["rotateRight","right"]];R.forEach(j,p);var q=[["shiftUp","ctrl+up","shiftDown"],["shiftDown","ctrl+down","shiftUp"],["shiftLeft","ctrl+left","shiftRight"],["shiftRight","ctrl+right","shiftLeft"]];R.forEach(k,q),l();var r={clickMap:"clickMap",rightClickMap:"rightClickMap",copySelection:"ctrl+c","delete":"del",toggleLock:"l"};R.forEach(m,p),R.forEach(n,q);var t=R.extend(Object.create(a.bindings),r),u=[["Delete","delete"],["Lock/Unlock","toggleLock"]],v={onEnter:function(){},onLeave:function(){},name:s.capitalize(b),actions:o,buttons:u,bindings:t};return v}}angular.module("clickApp.services").factory("elementMode",a),a.$inject=["defaultMode"]}(),function(){function a(a,b){function c(a,b){return a.eventP("Game.command.execute","setLos",["setOrigin",[b["click#"].target]])}function d(a,b){return a.eventP("Game.command.execute","setLos",["setTarget",[b["click#"].target]])}function e(a,b){return a.eventP("Game.command.execute","setLos",["toggleIgnoreModel",[b["click#"].target]])}var f={exitLosMode:"ctrl+l",toggleIgnoreModel:"clickModel",setOriginModel:"ctrl+clickModel",setTargetModel:"shift+clickModel"},g=a("los",b,f);return g.actions.setOriginModel=c,g.actions.setTargetModel=d,g.actions.toggleIgnoreModel=e,g}angular.module("clickApp.services").factory("losMode",a),a.$inject=["segmentMode","gameLos"]}(),function(){function a(a,b,c,d,e){function f(a){var b=e.get("local",a.game.model_selection);return R.threadP()(function(){return a.eventP("Game.command.execute","onModels",["startChargeP",[],b])},function(){return a.eventP("Modes.switchTo","ModelCharge")})}function g(a){var b=e.get("local",a.game.model_selection);return R.threadP()(function(){return a.eventP("Game.command.execute","onModels",["startPlaceP",[],b])},function(){return a.eventP("Modes.switchTo","ModelPlace")})}var h=Object.create(d.actions);h.startCharge=f,h.startPlace=g;var i={startCharge:"c",startPlace:"p"},j=R.extend(Object.create(d.bindings),i),k=c.buildButtons({single:!0,start_charge:!0,start_place:!0}),l={onEnter:function(){},onLeave:function(){},name:"Model",actions:h,buttons:k,bindings:j};return a.registerMode(l),b.register("Bindings",l.name,i,function(a){R.extend(l.bindings,a)}),l}angular.module("clickApp.services").factory("modelMode",a),a.$inject=["modes","settings","modelsMode","modelBaseMode","gameModelSelection"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g){function h(a){return a.queueChangeEventP("Game.selectionDetail.close"),a.queueChangeEventP("Game.editDamage.close"),a.queueChangeEventP("Game.editLabel.close"),a.eventP("Game.command.execute","setModelSelection",["clear",null])}function i(a){var b=f.get("local",a.game.model_selection);return a.eventP("Game.command.execute","deleteModel",[b])}function j(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isLocked,function(c){return a.eventP("Game.command.execute","lockModels",[!c,b])})}function k(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isImageDisplayed,function(c){return a.eventP("Game.command.execute","onModels",["setImageDisplay",[!c],b])})}function l(a){var b=f.get("local",a.game.model_selection);return a.eventP("Game.command.execute","onModels",["setNextImageP",[a.factions],b])}function m(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isWreckDisplayed,function(c){return a.eventP("Game.command.execute","onModels",["setWreckDisplay",[!c],b])})}function n(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isUnitDisplayed,function(c){return a.eventP("Game.command.execute","onModels",["setUnitDisplay",[!c],b])})}function o(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),function(a){return R.defaultTo(0,d.unit(a))},function(a){return g.promptP("prompt","Set unit number :",a)["catch"](R.always(null))},function(c){return a.eventP("Game.command.execute","onModels",["setUnit",[c],b])})}function p(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isMeleeDisplayed$("mm"),function(c){return a.eventP("Game.command.execute","onModels",["setMeleeDisplay",["mm",!c],b])})}function q(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isMeleeDisplayed$("mr"),function(c){return a.eventP("Game.command.execute","onModels",["setMeleeDisplay",["mr",!c],b])})}function r(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isMeleeDisplayed$("ms"),function(c){return a.eventP("Game.command.execute","onModels",["setMeleeDisplay",["ms",!c],b])})}function s(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isCounterDisplayed$("c"),function(c){return a.eventP("Game.command.execute","onModels",["setCounterDisplay",["c",!c],b])})}function t(a){var b=f.get("local",a.game.model_selection);return a.eventP("Game.command.execute","onModels",["incrementCounter",["c"],b])}function u(a){var b=f.get("local",a.game.model_selection);return a.eventP("Game.command.execute","onModels",["decrementCounter",["c"],b])}function v(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isCounterDisplayed$("s"),function(c){return a.eventP("Game.command.execute","onModels",["setCounterDisplay",["s",!c],b])})}function w(a){var b=f.get("local",a.game.model_selection);return a.eventP("Game.command.execute","onModels",["incrementCounter",["s"],b])}function x(a){var b=f.get("local",a.game.model_selection);return a.eventP("Game.command.execute","onModels",["decrementCounter",["s"],b])}function y(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.rulerMaxLength,R.defaultTo(0),function(a){return g.promptP("prompt","Set ruler max length :",a)["catch"](R.always(null))},function(a){return 0===a?null:a},function(c){return a.eventP("Game.command.execute","onModels",["setRulerMaxLength",[c],b])})}function z(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.chargeMaxLength,function(a){return g.promptP("prompt","Set charge max length :",a)["catch"](R.always(null))},function(a){return 0===a?null:a},function(c){return a.eventP("Game.command.execute","onModels",["setChargeMaxLengthP",[a.factions,c],b])})}function A(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.placeMaxLength,R.defaultTo(0),function(a){return g.promptP("prompt","Set place max length :",a)["catch"](R.always(null))},function(a){return 0===a?null:a},function(c){return a.eventP("Game.command.execute","onModels",["setPlaceMaxLengthP",[a.factions,c],b])})}function B(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.placeWithin,function(c){return a.eventP("Game.command.execute","onModels",["setPlaceWithinP",[a.factions,!c],b])})}function C(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isLeaderDisplayed,function(c){return a.eventP("Game.command.execute","onModels",["setLeaderDisplay",[!c],b])})}function D(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isIncorporealDisplayed,function(c){return a.eventP("Game.command.execute","onModels",["setIncorporealDisplay",[!c],b])})}function E(a){function b(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isEffectDisplayed$(h),function(c){return a.eventP("Game.command.execute","onModels",["setEffectDisplay",[h,!c],b])})}var c=_slicedToArray(a,2),g=c[0],h=c[1];X["toggle"+g+"EffectDisplay"]=b}function F(a){function b(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.auraDisplay,function(c){return a.eventP("Game.command.execute","onModels",["setAuraDisplay",[c===h?null:h],b])})}var c=_slicedToArray(a,2),g=c[0],h=c[1];X["toggle"+g+"AuraDisplay"]=b}function G(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.isCtrlAreaDisplayedP$(a.factions),function(c){return a.eventP("Game.command.execute","onModels",["setCtrlAreaDisplay",[!c],b])})}function H(a){function b(a){return function(b){var c=f.get("local",b.game.model_selection);return R.threadP(b.game)(R.prop("models"),e.findStampP$(c[0]),function(a){return d.areaDisplay(a)},function(d){return b.eventP("Game.command.execute","onModels",["setAreaDisplay",[d===a?null:a],c])})}}var c=0===a?10:a;X["toggle"+c+"InchesAreaDisplay"]=b(c);var g=c+10;X["toggle"+g+"InchesAreaDisplay"]=b(g)}function I(a){function b(a){return function(b){var c=f.get("local",b.game.model_selection);return b.eventP("Game.command.execute","onModels",[d+"P",[b.factions,a],c])}}var c=_slicedToArray(a,2),d=c[0];c[1];X[d]=b(!1),X[d+"Small"]=b(!0)}function J(a){function b(a){return function(b){var c=f.get("local",b.game.model_selection),g=R.path(["ui_state","flip_map"],b)?e:d;return b.eventP("Game.command.execute","onModels",[g+"P",[b.factions,a],c])}}var c=_slicedToArray(a,3),d=c[0],e=(c[1],c[2]);X[d]=b(!1),X[d+"Small"]=b(!0)}function K(a){var b=f.get("local",a.game.model_selection),c=a.ui_state.flip_map?180:0;return a.eventP("Game.command.execute","onModels",["setOrientationP",[a.factions,c],b])}function L(a){var b=f.get("local",a.game.model_selection),c=a.ui_state.flip_map?0:180;return a.eventP("Game.command.execute","onModels",["setOrientationP",[a.factions,c],b])}function M(a,b){var c=f.get("local",a.game.model_selection);return a.eventP("Game.command.execute","onModels",["orientToP",[a.factions,b["click#"].target],c])}function N(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.copyStampsP$(b),function(b){return a.eventP("Game.model.copy",b)})}function O(a){var b=f.get("local",a.game.model_selection);return a.eventP("Game.command.execute","onModels",["clearLabel",[],b])}function P(){function a(a,c){function g(b){return b?null:a.eventP("Game.command.execute","setModelSelection",["set",[n]])}function k(b){return h=null,1!==R.length(b)?b:R.threadP(b)(R.head,d.chargeTargetP,function(b){return e.findStampP(b,a.game.models)},function(a){h=a},R.always(b))["catch"](R.always(b))}function l(a){return j=a,a}function m(a){i=a}var n=c.target.state.stamp;return R.threadP(a.game)(R.prop("model_selection"),f.in$("local",n),g,function(){return f.get("local",a.game.model_selection)},function(b){return e.findAnyStampsP(b,a.game.models)},R.reject(R.isNil),k,l,R.map(d.saveState),R.spyWarn(j,i),m,function(){return b(a,c)})}function b(a,b){function c(c,e){var f={x:i[e].x+b.now.x-b.start.x,y:i[e].y+b.now.y-b.start.y};return d.setPosition_(a.factions,h,f,c)}function e(b){a.queueChangeEventP("Game.model.change."+b.state.stamp)}return R.threadP(j)(R.addIndex(R.map)(c),R.promiseAll,R.forEach(e))}function g(a,b){function c(b,c){return d.setPosition_(a.factions,h,i[c],b)}function e(c){var d={x:b.now.x-b.start.x,y:b.now.y-b.start.y};return a.eventP("Game.command.execute","onModels",["shiftPositionP",[a.factions,h,d],c])}return R.threadP(j)(R.addIndex(R.map)(c),R.promiseAll,R.map(R.path(["state","stamp"])),e)}var h=void 0,i=void 0,j=void 0;X.dragStartModel=a,c.actions.dragStartModel=a,X.dragModel=b,X.dragEndModel=g}function Q(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];ba[c]=d,ba[c+"Small"]="shift+"+d}function S(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];ba[c]=d,ba[c+"Small"]="shift+"+d}function T(a){var b=0===a?10:a;ba["toggle"+b+"InchesAreaDisplay"]="alt+"+a,b+=10,ba["toggle"+b+"InchesAreaDisplay"]="alt+shift+"+a}function U(a,b){var c=_slicedToArray(a,1),d=c[0];ba["toggle"+d+"AuraDisplay"]="ctrl+"+(b+1)}function V(a){var b=_slicedToArray(a,2),c=b[0],d=b[1];ba["toggle"+c+"EffectDisplay"]="alt+"+d}function W(){var a=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],b=a.single,c=a.start_charge,d=a.end_charge,e=a.start_place,f=a.end_place,g=[["Delete","deleteSelection"],["Copy","copySelection"],["Lock","toggleLock"],["Ruler Max Len.","setRulerMaxLength"],["Clear Label","clearLabel"],["Image","toggle","image"],["Show/Hide","toggleImageDisplay","image"],["Next","setNextImage","image"],["Wreck","toggleWreckDisplay","image"],["Orient.","toggle","orientation"],["Face Up","setOrientationUp","orientation"],["Face Down","setOrientationDown","orientation"],["Counter","toggle","counter"],["Show/Hide","toggleCounterDisplay","counter"],["Inc.","incrementCounter","counter"],["Dec.","decrementCounter","counter"],["Souls","toggle","souls"],["Show/Hide","toggleSoulsDisplay","souls"],["Inc.","incrementSouls","souls"],["Dec.","decrementSouls","souls"],["Melee","toggle","melee"],['0.5"',"toggleMeleeDisplay","melee"],["Reach","toggleReachDisplay","melee"],["Strike","toggleStrikeDisplay","melee"]];return b&&(g=R.concat(g,[["Templates","toggle","templates"],["AoE","createAoEOnModel","templates"],["Spray","createSprayOnModel","templates"]])),g=R.append(["Areas","toggle","areas"],g),g=R.append(["CtrlArea","toggleCtrlAreaDisplay","areas"],g),g=R.concat(g,R.map(function(a){var b=a+1;return[b+'"',"toggle"+b+"InchesAreaDisplay","areas"]},$)),g=R.concat(g,R.map(function(a){var b=a+11;return[b+'"',"toggle"+b+"InchesAreaDisplay","areas"]},$)),g=R.append(["Auras","toggle","auras"],g),g=R.concat(g,R.map(function(a){var b=_slicedToArray(a,1),c=b[0];return[c,"toggle"+c+"AuraDisplay","auras"]},Z)),g=R.append(["Effects","toggle","effects"],g),g=R.concat(g,R.map(function(a){var b=_slicedToArray(a,1),c=b[0];return[c,"toggle"+c+"EffectDisplay","effects"]},Y)),g=R.append(["Incorp.","toggleIncorporealDisplay","effects"],g),g=R.append(["Charge","toggle","charge"],g),c&&(g=R.append(["Start","startCharge","charge"],g)),d&&(g=R.append(["End","endCharge","charge"],g)),g=R.append(["Max Len.","setChargeMaxLength","charge"],g),g=R.append(["Place","toggle","place"],g),e&&(g=R.append(["Start","startPlace","place"],g)),f&&(g=R.append(["End","endPlace","place"],g)),g=R.append(["Max Len.","setPlaceMaxLength","place"],g),g=R.append(["Within","togglePlaceWithin","place"],g),g=R.concat(g,[["Unit","toggle","unit"],["Show/Hide","toggleUnitDisplay","unit"],["Set #","setUnit","unit"],["Leader","toggleLeaderDisplay","unit"]]),b&&(g=R.append(["Select All","selectAllUnit","unit"],g),g=R.append(["Select Friends","selectAllFriendly"],g)),g}var X=Object.create(c.actions);X.clickMap=h,X.rightClickMap=h,X.modeBackToDefault=h,X.deleteSelection=i,X.toggleLock=j,X.toggleImageDisplay=k,X.setNextImage=l,X.toggleWreckDisplay=m,X.toggleUnitDisplay=n,X.setUnit=o,X.toggleMeleeDisplay=p,X.toggleReachDisplay=q,X.toggleStrikeDisplay=r,X.toggleCounterDisplay=s,X.incrementCounter=t,X.decrementCounter=u,X.toggleSoulsDisplay=v,X.incrementSouls=w,X.decrementSouls=x,X.setRulerMaxLength=y,X.setChargeMaxLength=z,X.setPlaceMaxLength=A,X.togglePlaceWithin=B,X.toggleLeaderDisplay=C,X.toggleIncorporealDisplay=D,X.setOrientationUp=K,X.setOrientationDown=L,X.setTargetModel=M,X.copySelection=N,X.clearLabel=O;var Y=[["Blind","b"],["Corrosion","c"],["Disrupt","d"],["Fire","f"],["Fleeing","e"],["KD","k"],["Stationary","t"]];R.forEach(E,Y);var Z=[["Red","#F00"],["Green","#0F0"],["Blue","#00F"],["Yellow","#FF0"],["Purple","#F0F"],["Cyan","#0FF"]];R.forEach(F,Z),X.toggleCtrlAreaDisplay=G;var $=R.range(0,10);R.forEach(H,$);var _=[["moveFront","up"],["moveBack","down"],["rotateLeft","left"],["rotateRight","right"]];R.forEach(I,_);var aa=[["shiftUp","ctrl+up","shiftDown"],["shiftDown","ctrl+down","shiftUp"],["shiftLeft","ctrl+left","shiftRight"],["shiftRight","ctrl+right","shiftLeft"]];
R.forEach(J,aa),P();var ba={clickMap:"clickMap",rightClickMap:"rightClickMap",deleteSelection:"del",copySelection:"ctrl+c",toggleLock:"l",toggleImageDisplay:"alt+i",setNextImage:"shift+i",toggleWreckDisplay:"alt+w",setOrientationUp:"pageup",setOrientationDown:"pagedown",setTargetModel:"shift+clickModel",toggleCounterDisplay:"alt+n",incrementCounter:"+",decrementCounter:"-",toggleSoulsDisplay:"alt+o",incrementSouls:"ctrl++",decrementSouls:"ctrl+-",toggleCtrlAreaDisplay:"alt+a",setRulerMaxLength:"shift+r",setChargeMaxLength:"shift+c",setPlaceMaxLength:"shift+p",togglePlaceWithin:"alt+p",toggleMeleeDisplay:"alt+m",toggleReachDisplay:"alt+r",toggleStrikeDisplay:"alt+s",toggleUnitDisplay:"alt+u",setUnit:"shift+u",toggleLeaderDisplay:"alt+l",toggleIncorporealDisplay:"alt+g",clearLabel:"ctrl+shift+l"};R.forEach(Q,_),R.forEach(S,aa),R.forEach(T,$),R.addIndex(R.forEach)(U,Z),R.forEach(V,Y);var ca=R.extend(Object.create(c.bindings),ba),da=W(),ea={onEnter:function(){},onLeave:function(){},name:"Models",actions:X,buttons:da,buildButtons:W,bindings:ca,areas:$,auras:Z,effects:Y};return a.registerMode(ea),b.register("Bindings",ea.name,ba,function(a){R.extend(ea.bindings,a)}),ea}angular.module("clickApp.services").factory("modelsMode",a),a.$inject=["modes","settings","defaultMode","model","gameModels","gameModelSelection","prompt"]}(),function(){function a(a,b,c,d,e,f){function g(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),function(a){return R.pick(["x","y"],a.state)},R.assoc("type","aoe"),function(a){return{base:{x:0,y:0,r:0},templates:[R.assoc("r",0,a)]}},function(b){var c=R.path(["ui_state","flip_map"],a);return a.eventP("Game.command.execute","createTemplate",[b,c])})}function h(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),function(b){return R.threadP(b)(R.prop("state"),R.pick(["x","y"]),R.assoc("type","spray"),function(a){return{base:{x:0,y:0,r:0},templates:[R.assoc("r",0,a)]}},function(d){var e=R.path(["ui_state","flip_map"],a);return R.threadP()(function(){return a.eventP("Game.command.execute","createTemplate",[d,e])},function(){return c.actions.setOriginModel(a,{"click#":{target:b}})})})})}function i(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),d.user,function(b){return R.thread(a.game)(R.prop("models"),e.all,R.filter(d.userIs$(b)),R.map(d.stamp))},function(b){return a.eventP("Game.command.execute","setModelSelection",["set",b])})}function j(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),function(b){return R.threadP(b)(d.unit,R.rejectIf(R.isNil,"Model not in unit"),function(c){return R.thread(a.game)(R.prop("models"),e.all,R.filter(d.userIs$(d.user(b))),R.filter(d.unitIs$(c)),R.map(d.stamp))})},function(b){return a.eventP("Game.command.execute","setModelSelection",["set",b])})}function k(a,b){var c=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(c[0]),function(d){return d.state.stamp===b["click#"].target.state.stamp?null:a.eventP("Game.command.execute","onModels",["setB2BP",[a.factions,b["click#"].target],c])})}function l(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),function(b){a.queueChangeEventP("Game.editLabel.open","onModels",b)})}function m(a){var b=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(b[0]),function(b){a.queueChangeEventP("Game.editDamage.toggle",b)})}var n=Object.create(b.actions);n.createAoEOnModel=g,n.createSprayOnModel=h,n.selectAllFriendly=i,n.selectAllUnit=j,n.setB2B=k,n.openEditLabel=l,n.openEditDamage=m;var o={createAoEOnModel:"ctrl+a",createSprayOnModel:"ctrl+s",selectAllUnit:"ctrl+u",selectAllFriendly:"ctrl+f",setB2B:"ctrl+shift+clickModel",openEditLabel:"shift+l",openEditDamage:"shift+d"},p=R.extend(Object.create(b.bindings),o),q={onEnter:function(){},onLeave:function(){},name:"ModelBase",actions:n,buttons:[],bindings:p};return a.register("Bindings",q.name,o,function(a){R.extend(q.bindings,a)}),q}angular.module("clickApp.services").factory("modelBaseMode",a),a.$inject=["settings","modelsMode","sprayTemplateMode","model","gameModels","gameModelSelection"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g){function h(a){var b=g.get("local",a.game.model_selection);return R.threadP()(function(){return a.eventP("Game.command.execute","onModels",["endCharge",[],b])},function(){return a.eventP("Modes.switchTo","Model")})}function i(a,b){var c=g.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),f.findStampP$(c[0]),function(d){return R.threadP()(function(){return e.chargeTargetP(d)["catch"](R.always(null))},function(a){return a===b["click#"].target.state.stamp?null:b["click#"].target},function(b){return R.exists(b)&&d.state.stamp===b.state.stamp?null:a.eventP("Game.command.execute","onModels",["setChargeTargetP",[a.factions,b],c])})})}function j(a,b,c,d){var h=g.get("local",d.game.model_selection),i=R.path(["ui_state","flip_map"],d)?b:a;return R.threadP(d.game)(R.prop("models"),f.findStampP$(h[0]),function(a){return e.chargeTargetP(a)["catch"](R.always(null))},function(a){return R.exists(a)?f.findStampP(a,d.game.models):null},function(a){return d.eventP("Game.command.execute","onModels",[i+"ChargeP",[d.factions,a,c],h])})}function k(a){var b=_slicedToArray(a,3),c=b[0],d=(b[1],b[2]);l[c]=n(c,d,!1),l[c+"Small"]=n(c,d,!0)}var l=Object.create(d.actions);l.endCharge=h,l.setTargetModel=i;var m=[["moveFront","up","moveFront"],["moveBack","down","moveBack"],["rotateLeft","left","rotateLeft"],["rotateRight","right","rotateRight"],["shiftUp","ctrl+up","shiftDown"],["shiftDown","ctrl+down","shiftUp"],["shiftLeft","ctrl+left","shiftRight"],["shiftRight","ctrl+right","shiftLeft"]],n=R.curry(j);R.forEach(k,m);var o={endCharge:"c",setTargetModel:"shift+clickModel"},p=R.extend(Object.create(d.bindings),o),q=c.buildButtons({single:!0,end_charge:!0}),r={onEnter:function(){},onLeave:function(){},name:"ModelCharge",actions:l,buttons:q,bindings:p};return a.registerMode(r),b.register("Bindings",r.name,o,function(a){R.extend(r.bindings,a)}),r}angular.module("clickApp.services").factory("modelChargeMode",a),a.$inject=["modes","settings","modelsMode","modelBaseMode","model","gameModels","gameModelSelection"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f){function g(a){var b=f.get("local",a.game.model_selection);return R.threadP()(function(){return a.eventP("Game.command.execute","onModels",["endPlace",[],b])},function(){return a.eventP("Modes.switchTo","Model")})}function h(a,b){var c=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(c[0]),function(d){return d.state.stamp===b["click#"].target.state.stamp?null:a.eventP("Game.command.execute","onModels",["setPlaceTargetP",[a.factions,b["click#"].target],c])})}function i(a,b){var c=f.get("local",a.game.model_selection);return R.threadP(a.game)(R.prop("models"),e.findStampP$(c[0]),function(d){return d.state.stamp===b["click#"].target.state.stamp?null:a.eventP("Game.command.execute","onModels",["setPlaceOriginP",[a.factions,b["click#"].target],c])})}function j(a,b,c,d){var e=f.get("local",d.game.model_selection),g=R.path(["ui_state","flip_map"],d)?b:a;return d.eventP("Game.command.execute","onModels",[g+"PlaceP",[d.factions,c],e])}function k(a){var b=_slicedToArray(a,3),c=b[0],d=(b[1],b[2]);l[c]=n(c,d,!1),l[c+"Small"]=n(c,d,!0)}var l=Object.create(d.actions);l.endPlace=g,l.setTargetModel=h,l.setOriginModel=i;var m=[["moveFront","up","moveFront"],["moveBack","down","moveBack"],["rotateLeft","left","rotateLeft"],["rotateRight","right","rotateRight"],["shiftUp","ctrl+up","shiftDown"],["shiftDown","ctrl+down","shiftUp"],["shiftLeft","ctrl+left","shiftRight"],["shiftRight","ctrl+right","shiftLeft"]],n=R.curry(j);R.forEach(k,m);var o={endPlace:"p",setTargetModel:"shift+clickModel",setOriginModel:"ctrl+clickModel"},p=R.extend(Object.create(d.bindings),o),q=c.buildButtons({single:!0,end_place:!0}),r={onEnter:function(){},onLeave:function(){},name:"ModelPlace",actions:l,buttons:q,bindings:p};return a.registerMode(r),b.register("Bindings",r.name,o,function(a){R.extend(r.bindings,a)}),r}angular.module("clickApp.services").factory("modelPlaceMode",a),a.$inject=["modes","settings","modelsMode","modelBaseMode","gameModels","gameModelSelection"]}(),function(){function a(a,b,c){function d(a,b){return R.threadP()(function(){return a.eventP("Game.command.execute","setRuler",["setOrigin",[b["click#"].target]])},function(){return i(a)})}function e(a,b){return a.eventP("Game.command.execute","setRuler",["setTarget",[b["click#"].target]])}function f(a){return R.threadP()(function(){return c.promptP("prompt","Set ruler max length :",b.maxLength(a.game.ruler))["catch"](R.always(null))},function(a){return 0===a?null:a},function(c){return R.threadP()(function(){return a.eventP("Game.command.execute","setRuler",["setMaxLength",[c]])},function(){var d=b.origin(a.game.ruler);return R.isNil(d)?null:a.eventP("Game.command.execute","onModels",["setRulerMaxLength",[c],[d]])})},function(){return i(a)})}function g(a){return R.threadP(a.game.ruler)(b.targetAoEPositionP$(a.game.models),function(a){return{base:{x:0,y:0,r:0},templates:[R.assoc("type","aoe",a)]}},function(b){return a.eventP("Game.command.execute","createTemplate",[b,!1])})}function h(a){return R.threadP()(function(){return l(a)},function(){return i(a)})}function i(a){var c=b.maxLength(a.game.ruler);k.buttons[0][0]="Set Max Len. ("+c+")",a.queueChangeEventP("Modes.buttons.update")}var j={exitRulerMode:"ctrl+r",setMaxLength:"shift+r",setOriginModel:"ctrl+clickModel",setTargetModel:"shift+clickModel",createAoEOnTarget:"ctrl+a"},k=a("ruler",b,j);k.actions.setOriginModel=d,k.actions.setTargetModel=e,k.actions.setMaxLength=f,k.actions.createAoEOnTarget=g,k.buttons=R.concat(k.buttons,[["Set Max Len.","setMaxLength"],["AoE on Target","createAoEOnTarget"]]);var l=k.onEnter;return k.onEnter=h,k}angular.module("clickApp.services").factory("rulerMode",a),a.$inject=["segmentMode","gameRuler","prompt"]}(),function(){function a(a,b,c,d,e){return function(f,g,h){function i(a,b){return a.eventP("Game.update",R.lensProp(f),g.setLocal$(b.start,b.now,a,a.game))}function j(a,b){return a.eventP("Game.update",R.lensProp(f),g.setLocal$(b.start,b.now,a,a.game))}function k(a,b){return a.eventP("Game.command.execute","set"+s.capitalize(f),["setRemote",[b.start,b.now]])}function l(a){return R.threadP(a)(R.path(["game","model_selection"]),e.get$("local"),function(b){return 1!==R.length(b)?null:d.findStampP(b[0],a.game.models)["catch"](R.always(null))},function(b){return R.isNil(b)?null:a.eventP("Game.command.execute","set"+s.capitalize(f),["setOriginResetTarget",[b]])})}function m(a){a.queueChangeEventP("Game."+f+".remote.change")}var n=Object.create(c.actions);n["exit"+s.capitalize(f)+"Mode"]=c.actions.modeBackToDefault,n.dragStartMap=i,n.dragMap=j,n.dragEndMap=k,n.dragStartTemplate=n.dragStartMap,n.dragTemplate=n.dragMap,n.dragEndTemplate=n.dragEndMap,n.dragStartModel=n.dragStartMap,n.dragModel=n.dragMap,n.dragEndModel=n.dragEndMap;var o=R.extend(Object.create(c.bindings),h),p=[],q={onEnter:l,onLeave:m,name:s.capitalize(f),actions:n,buttons:p,bindings:o};return a.registerMode(q),b.register("Bindings",q.name,h,function(a){R.extend(q.bindings,a)}),q}}angular.module("clickApp.services").factory("segmentMode",a),a.$inject=["modes","settings","commonMode","gameModels","gameModelSelection"]}(),function(){function a(a,b,c,d,e,f){function g(a){var b=f.get("local",a.game.template_selection);return R.threadP(a.game)(R.prop("templates"),e.findStampP$(b[0]),function(b){a.queueChangeEventP("Game.editLabel.open","onTemplates",b)})}var h=a("template",d,e,f);return h.actions.openEditLabel=g,h.bindings.openEditLabel="shift+l",b.registerMode(h),c.register("Bindings",h.name,h.bindings,function(a){R.extend(h.bindings,a)}),h}angular.module("clickApp.services").factory("templateMode",a),a.$inject=["elementMode","modes","settings","template","gameTemplates","gameTemplateSelection"]}(),function(){function a(a,b,c,d,e,f,g){function h(a){var b=e.get("local",a.game.template_selection);return a.eventP("Game.command.execute","onTemplates",["setSizeP",[3],b])}function i(a){var b=e.get("local",a.game.template_selection);return a.eventP("Game.command.execute","onTemplates",["setSizeP",[4],b])}function j(a){var b=e.get("local",a.game.template_selection);return a.eventP("Game.command.execute","onTemplates",["setSizeP",[5],b])}function k(a,b){var c=e.get("local",a.game.template_selection);return a.eventP("Game.command.execute","onTemplates",["setTargetP",[a.factions,null,b["click#"].target],c])}function l(a){function b(a){var b=a[0];return g.promptP("prompt","Set AoE max deviation :",b)["catch"](R.spyAndDiscardError())}var c=e.get("local",a.game.template_selection);return R.threadP(a.game)(R.prop("templates"),d.fromStampsP$("maxDeviation",[],c),b,function(a){return 0===a?null:a},function(b){return a.eventP("Game.update",R.lensProp("templates"),d.onStampsP$("setMaxDeviation",[b],c))})}function m(a){var b=e.get("local",a.game.template_selection);return R.threadP()(function(){return a.eventP("Game.command.execute","rollDeviation",[])},R.always(a),R.path(["game","dice"]),R.last,function(c){return a.eventP("Game.command.execute","onTemplates",["deviate",[c.r,c.d],b])})}function n(a){if(!f.isDisplayed(a.game.ruler))return null;var b=e.get("local",a.game.template_selection);return R.threadP(a.game)(R.prop("ruler"),f.targetAoEPositionP$(a.game.models),function(c){return a.eventP("Game.command.execute","onTemplates",["setToRulerP",[c],b])})}var o=Object.create(c.actions);o.aoeSize3=h,o.aoeSize4=i,o.aoeSize5=j,o.setTargetModel=k,o.setMaxDeviation=l,o.deviate=m,o.setToRulerTarget=n;var p={setTargetModel:"shift+clickModel",aoeSize3:"3",aoeSize4:"4",aoeSize5:"5",deviate:"d",setMaxDeviation:"shift+d",setToRulerTarget:"shift+r"},q=R.extend(Object.create(c.bindings),p),r=R.concat([["Size","toggle","size"],["Aoe3","aoeSize3","size"],["Aoe4","aoeSize4","size"],["Aoe5","aoeSize5","size"],["Deviate","deviate"],["Set to Ruler","setToRulerTarget"]],c.buttons),s={onEnter:function(){},onLeave:function(){},name:"aoe"+c.name,actions:o,buttons:r,bindings:q};return a.registerMode(s),b.register("Bindings",s.name,p,function(a){R.extend(s.bindings,a)}),s}angular.module("clickApp.services").factory("aoeTemplateMode",a),a.$inject=["modes","settings","templateMode","gameTemplates","gameTemplateSelection","gameRuler","prompt"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g){function h(a){var b=f.get("local",a.game.template_selection);return a.eventP("Game.command.execute","onTemplates",["setSizeP",[6],b])}function i(a){var b=f.get("local",a.game.template_selection);return a.eventP("Game.command.execute","onTemplates",["setSizeP",[8],b])}function j(a){var b=f.get("local",a.game.template_selection);return a.eventP("Game.command.execute","onTemplates",["setSizeP",[10],b])}function k(a,b){var c=f.get("local",a.game.template_selection);return a.eventP("Game.command.execute","onTemplates",["setOriginP",[a.factions,b["click#"].target],c])}function l(a,b){var c=f.get("local",a.game.template_selection);return R.threadP(a.game)(R.prop("templates"),e.findStampP$(c[0]),d.origin,v(a),function(d){return R.isNil(d)?null:a.eventP("Game.command.execute","onTemplates",["setTargetP",[a.factions,d,b["click#"].target],c])})}function m(a,b,c){var g=f.get("local",c.game.template_selection);return R.threadP(c.game)(R.prop("templates"),e.findStampP$(g[0]),d.origin,v(c),function(d){return c.eventP("Game.command.execute","onTemplates",[a+"P",[c.factions,d,b],g])})}function n(a,b){return R.isNil(b)?null:g.findStampP(b,a.game.models)}var o=Object.create(c.actions);o.spraySize6=h,o.spraySize8=i,o.spraySize10=j,o.setOriginModel=k,o.setTargetModel=l;var p=[["rotateLeft","left"],["rotateRight","right"]],q=R.curry(m);R.forEach(function(a){var b=_slicedToArray(a,1),c=b[0];o[c]=q(c,!1),o[c+"Small"]=q(c,!0)},p);var r={setOriginModel:"ctrl+clickModel",setTargetModel:"shift+clickModel",spraySize6:"6",spraySize8:"8",spraySize10:"0"},s=R.extend(Object.create(c.bindings),r),t=R.concat([["Size","toggle","size"],["Spray6","spraySize6","size"],["Spray8","spraySize8","size"],["Spray10","spraySize10","size"]],c.buttons),u={onEnter:function(){},onLeave:function(){},name:"spray"+c.name,actions:o,buttons:t,bindings:s};a.registerMode(u),b.register("Bindings",u.name,r,function(a){R.extend(u.bindings,a)});var v=R.curry(n);return u}angular.module("clickApp.services").factory("sprayTemplateMode",a),a.$inject=["modes","settings","templateMode","sprayTemplate","gameTemplates","gameTemplateSelection","gameModels"]}(),function(){function a(a,b){var c=Object.create(b.actions),d={},e=R.extend(Object.create(b.bindings),d),f=R.concat([],b.buttons),g={onEnter:function(){},onLeave:function(){},name:"wall"+b.name,actions:c,buttons:f,bindings:e};return a.registerMode(g),g}angular.module("clickApp.services").factory("wallTemplateMode",a),a.$inject=["modes","templateMode"]}(),function(){function a(a,b,c,d,e,f){var g=a("terrain",d,e,f);return b.registerMode(g),c.register("Bindings",g.name,g.bindings,function(a){R.extend(g.bindings,a)}),g}angular.module("clickApp.services").factory("terrainMode",a),a.$inject=["elementMode","modes","settings","terrain","gameTerrains","gameTerrainSelection"]}(),function(){function a(a){function b(a,b,c,d){i[a]=R.defaultTo({},i[a]),j[a]=R.defaultTo({},j[a]),i[a][b]=c,j[a][b]=d}function c(){return R.threadP(h)(function(b){return a.loadP(b)["catch"](R.spy("settings: failed to load data"))},R.defaultTo({}),R.spyWarn("Settings load"))}function d(){return R.threadP()(k.loadP,k.bind,k.update)}function e(a){return a=R.defaultTo({},a),R.thread(i)(R.keys,R.reduce(function(b,c){var d=R.propOr({},c,a);return b[c]=R.thread(i[c])(R.keys,R.reduce(function(a,b){var e=Object.create(i[c][b]);return R.extend(e,R.propOr({},b,d)),a[b]=e,a},{})),b},{}),function(a){return{"default":i,current:a}})}function f(a){return R.thread(a.current)(R.keys,R.forEach(function(b){R.thread(a.current[b])(R.keys,R.filter(function(a){return R.exists(j[b][a])}),R.forEach(function(c){j[b][c](a.current[b][c])}))})),a}function g(b){return R.thread(b.current)(R.spyWarn("Settings store"),a.save$(h))}var h="clickApp.settings",i={},j={},k={register:b,loadP:c,initP:d,bind:e,update:f,store:g};return R.curryService(k),k}angular.module("clickApp.services").factory("settings",a),a.$inject=["localStorage"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f,g,h){function i(){function b(){for(var b=arguments.length,c=Array(b),d=0;b>d;d++)c[d]=arguments[d];return a.subscribe.apply(null,[].concat(c,[q]))}function c(){for(var b=arguments.length,c=Array(b),d=0;b>d;d++)c[d]=arguments[d];return a.subscribe.apply(null,[].concat(c,[q.change]))}function i(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return j(b,q)}function k(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return m(b,q)}function l(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return o(b,q)}function n(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];return p(b,q)}var q=a.init({event_queue:[],onEvent:b,change:a.init({},"State.Change"),change_event_queue:[],onChangeEvent:c,eventP:l,queueEventP:i,changeEventP:n,queueChangeEventP:k},"State");return q=R.thread(q)(d.create,e.create,f.create,g.create,h.create),q.onEvent("State.loadDumpFile",t.onLoadDumpFile$(q)),q}function j(a,b){return new self.Promise(function(c){b.event_queue=R.append([c,a],b.event_queue),k(b)})}function k(a){a.processing_event_queue||(a.processing_event_queue=!0,self.Promise.resolve(l(a)).then(function(){a.processing_event_queue=!1}))}function l(a){if(R.isEmpty(a.event_queue))return self.Promise.resolve();var b=R.head(a.event_queue),c=_slicedToArray(b,2),i=c[0],j=c[1];return R.threadP(o(j,a))(function(){return d.save(a)},function(){return e.save(a)},function(){return f.save(a)},function(){return g.save(a)},function(){return h.save(a)},function(){return u(a)},function(){return n(a)})["catch"](R.spyAndDiscardError("processNextEvent")).then(function(){return a.event_queue=R.tail(a.event_queue),i(),l(a)})}function m(a,b){return new self.Promise(function(c){b.change_event_queue=R.append([c,a],b.change_event_queue)})}function n(a){if(R.isEmpty(a.change_event_queue))return self.Promise.resolve();a.change_event_queue=R.uniqBy(R.compose(R.head,R.nth(1)),a.change_event_queue);var b=R.head(a.change_event_queue),c=_slicedToArray(b,2),d=c[0],e=c[1];return R.threadP(p(e,a))(function(){return a.change_event_queue=R.tail(a.change_event_queue),d(),n(a)})}function o(b,c){return a.publishP.apply(null,[].concat(_toConsumableArray(b),[c]))}function p(b,c){return a.publishP.apply(null,[].concat(_toConsumableArray(b),[c.change]))}function q(b,c,d){return a.subscribe(b,c,d.change)}function r(a,c,e){function f(b){return R.threadP()(function(){return d.onSettingsReset(a,c,b.settings)},function(){return g.loadNewLocalGame(a,b.game)})}return R.threadP(e)(b.readP$("json"),f,function(){a.queueChangeEventP("State.loadDumpFile","File loaded")})["catch"](function(b){a.queueChangeEventP("State.loadDumpFile",b)})}function s(a){return{settings:R.pathOr({},["settings","current"],a),game:R.propOr({},"game",a)}}var t={create:i,queueEventP:j,queueChangeEventP:m,onChangeEvent:q,onLoadDumpFile:r},u=c.exportP$("dump",s);return R.curryService(t),t}angular.module("clickApp.services").factory("state",a),a.$inject=["pubSub","fileImport","stateExports","stateData","stateUser","stateGame","stateGames","stateModes"]}(),function(){function a(a,b,c,d,e,f,g){function h(a){return a.data_ready=new self.Promise(function(b){a.onEvent("State.init",t.onStateInit$(a,b))}),a.onEvent("Settings.loadFile",t.onSettingsLoadFile$(a)),a.onEvent("Settings.reset",t.onSettingsReset$(a)),a.onEvent("Factions.loadDescFile",t.onFactionsLoadDescFile$(a)),a.onEvent("Factions.clearDesc",t.onFactionsClearDesc$(a)),a.onEvent("Factions.clearAllDesc",t.onFactionsClearAllDesc$(a)),a}function i(a,b,h){var i=d.initP().then(function(b){a.boards=b}),j=e.initP().then(function(b){a.terrains=b}),k=f.initP().then(function(b){a.factions=b}),l=g.initP().then(function(b){a.scenarios=b}),m=c.initP().then(function(b){a.settings=b});self.Promise.all([i,j,k,l,m]).then(function(){b()})}function j(a){return R.threadP()(function(){return w(a)},function(){return r(a)},function(){return s(a)})}function k(a,d,e){return R.threadP(e)(b.readP$("json"),c.bind,c.update,u(a),function(){a.queueChangeEventP("Settings.loadFile","Settings loaded")})["catch"](function(b){a.queueChangeEventP("Settings.loadFile",b)})}function l(a,b,d){return R.threadP(d)(c.bind,c.update,u(a))}function m(a,c,d,e){return R.threadP(e)(b.readP$("json"),function(b){return R.assocPath(["desc",d],b,a.factions)},f.updateDesc,v(a),function(){return a.queueChangeEventP("Factions.loadDescFile","File loaded")})["catch"](function(b){a.queueChangeEventP("Factions.loadDescFile",b)})}function n(a,b,c){return R.threadP(a.factions)(R.dissocPath(["desc",c]),f.updateDesc,v(a))}function o(a,b){return R.threadP(a.factions)(R.assoc("desc",{}),f.updateDesc,v(a))}function p(a,b){a.settings=b,a.queueChangeEventP("Settings.change")}function q(a,b){a.factions=b,a.queueChangeEventP("Factions.change")}function r(a){return a._settings===a.settings?null:(a._settings=a.settings,c.store(a.settings))}function s(a){return a._factions===a.factions?null:(a._factions=a.factions,f.storeDesc(a.factions))}var t={create:h,save:j,onStateInit:i,onSettingsLoadFile:k,onSettingsReset:l,onFactionsLoadDescFile:m,onFactionsClearDesc:n,onFactionsClearAllDesc:o},u=R.curry(p),v=R.curry(q),w=a.exportP$("settings",R.path(["settings","current"]));return R.curryService(t),t}angular.module("clickApp.services").factory("stateData",a),a.$inject=["stateExports","fileImport","settings","gameBoard","gameTerrainInfo","gameFactions","gameScenario"]}(),function(){function a(a){function b(a){return a.exports={},a}function c(b,c,d){function e(b){return R.threadP(b)(c,R.rejectIf(g,"unchanged"),h,R.rejectIf(R.isNil,"nil"),a.generate$("json"))}function g(a){return R.equals(R.path(["exports","_"+b],d),a)}function h(a){return d.exports=R.assoc("_"+b,a,d.exports),a}function i(a){return R.threadP(a)(j,k)}function j(a){d.exports=R.thread(d.exports)(R.defaultTo({}),f([b]),R.assocPath([b],{name:"clicknfeat_"+b+".json",url:a}))}function k(){d.queueChangeEventP("Exports."+b)}return R.thread(d)(e,R.condErrorP([[R.equals("nil"),R.always(null)],[R.equals("unchanged"),R.rejectP],[R.T,function(a){return null}]]),i,R.condErrorP([[R.T,R.always(null)]]))}function d(b,c){return R.thread(c)(R.path([].concat(_toConsumableArray(b),["url"])),a.cleanup,R.always(c),R.assocPath([].concat(_toConsumableArray(b),["url"]),null))}var e={create:b,exportP:c},f=R.curry(d);return R.curryService(e),e}angular.module("clickApp.services").factory("stateExports",a),a.$inject=["fileExport"]}(),function(){function a(a,b,c,d,e,f,g,h,i,j,k,l,m){function n(a){return a.game=null,a.onEvent("Game.load",ca.onGameLoad$(a)),a.onEvent("Game.connection.close",ca.onGameConnectionClose$(a)),a.onEvent("Game.command.execute",ca.onGameCommandExecute$(a)),a.onEvent("Game.command.undo",ca.onGameCommandUndo$(a)),a.onEvent("Game.command.replay",ca.onGameCommandReplay$(a)),a.onEvent("Game.command.replayBatch",ca.onGameCommandReplayBatch$(a)),a.onEvent("Game.command.undoLast",ca.onGameCommandUndoLast$(a)),a.onEvent("Game.command.replayNext",ca.onGameCommandReplayNext$(a)),a.onEvent("Game.setCmds",ca.onGameSetCmds$(a)),a.onEvent("Game.setPlayers",ca.onGameSetPlayers$(a)),a.onEvent("Game.newChatMsg",ca.onGameNewChatMsg$(a)),a.onEvent("Game.update",ca.onGameUpdate$(a)),a.onEvent("Game.invitePlayer",ca.onGameInvitePlayer$(a)),a.onEvent("Game.model.create",ca.onGameModelCreate$(a)),a.onEvent("Game.model.copy",ca.onGameModelCopy$(a)),a.onEvent("Game.model.importList",ca.onGameModelImportList$(a)),a.onEvent("Game.model.importFile",ca.onGameModelImportFile$(a)),a.onChangeEvent("Game.model.selection.local.change",ca.onGameModelSelectionLocalChange$(a)),a.onEvent("Game.template.create",ca.onGameTemplateCreate$(a)),a.onChangeEvent("Game.template.selection.local.change",ca.onGameTemplateSelectionLocalChange$(a)),a.onEvent("Game.terrain.create",ca.onGameTerrainCreate$(a)),a.onEvent("Game.terrain.reset",ca.onGameTerrainReset$(a)),a.onEvent("Game.board.set",ca.onGameBoardSet$(a)),a.onEvent("Game.board.setRandom",ca.onGameBoardSetRandom$(a)),a.onEvent("Game.board.importFile",ca.onGameBoardImportFile$(a)),a.onEvent("Game.scenario.set",ca.onGameScenarioSet$(a)),a.onEvent("Game.scenario.setRandom",ca.onGameScenarioSetRandom$(a)),a.onEvent("Game.scenario.refresh",ca.onGameScenarioRefresh$(a)),a.onEvent("Game.scenario.generateObjectives",ca.onGameScenarioGenerateObjectives$(a)),a}function o(a){return R.thread()(function(){return _(a)},function(){return ea(a)},function(){return aa(a)},function(){return fa(a)})}function p(c,e,f,g,h){function i(){return R.promiseAll([c.data_ready,c.user_ready,c.games_ready])}function j(){return f?a.loadOnlineGameP(g,h):a.loadLocalGameP(h,c.local_games)}function k(a){return R.tap(function(){c.changeEventP(a)})}function l(a){return c.eventP("Modes.reset").then(R.always(a))}function m(a){return R.when(function(){return f},d.openP$(R.path(["user","state","name"],c),c),a)}function n(a){c.changeEventP("Game.load.error",a)}return R.threadP(i())(j,k("Game.loading"),da(c),l,b.loadP$(c),R.tap(function(){c.queueChangeEventP("Game.loaded")}),m,da(c),k("Game.load.success"))["catch"](n)}function q(a,b){return R.thread(a.game)(d.cleanup,da(a))}function r(a,c,d,e){return R.threadP(a.game)(b.executeCommandP$(d,e,a),da(a))["catch"](b.actionError$(a))}function t(a,c,d){return R.threadP(a.game)(b.undoCommandP$(d,a),da(a))["catch"](b.actionError$(a))}function u(a,c){return R.threadP(a.game)(b.undoLastCommandP$(a),da(a))["catch"](b.actionError$(a))}function v(a,c,d){return R.threadP(a.game)(b.replayCommandP$(d,a),da(a))["catch"](b.actionError$(a))}function w(a,c,d){return R.threadP(a.game)(b.replayCommandsBatchP$(d,a),da(a))["catch"](b.actionError$(a))}function x(a,c){return R.threadP(a.game)(b.replayNextCommandP$(a),da(a))["catch"](b.actionError$(a))}function y(a,b,c){return R.thread(a.game)(R.assoc(c.where,c.cmds),R.when(function(){return c.where="chat"},R.tap(function(){a.queueChangeEventP("Game.chat")})),da(a))}function z(a,b,c){return R.thread(a.game)(R.assoc("players",c),R.tap(function(){a.queueChangeEventP("Game.players.change")}),da(a))}function A(a,b,c){return R.thread(a.game)(R.over(R.lensProp("chat"),R.compose(R.append(c.chat),R.defaultTo([]))),da(a),function(){a.queueChangeEventP("Game.chat",c.chat)})}function B(a,b,c,d){return R.thread(a.game)(R.over(c,d),da(a))}function C(a,b,c){var d=[s.capitalize(R.pathOr("Unknown",["user","state","name"],a)),"has invited you to join a game"].join(" "),e=self.window.location.hash;return a.eventP("User.sendChatMsg",{to:[c],msg:d,link:e})}function D(a,b,c){var d=arguments.length<=3||void 0===arguments[3]?1:arguments[3];return a.create={base:{x:240,y:240,r:0},models:R.times(function(a){return{info:c,x:20*a,y:0,r:0}},d)},a.eventP("Modes.switchTo","CreateModel")}function E(a,b,c){return a.create=c,a.eventP("Modes.switchTo","CreateModel")}function F(a,b,c){var d=R.pathOr("Unknown",["user","state","name"],a);return a.create=e.buildModelsList(c,d,a.factions.references),a.eventP("Modes.switchTo","CreateModel")}function G(a,c,d){return R.threadP(d)(l.readP$("json"),function(b){return a.create=b,a.eventP("Modes.switchTo","CreateModel")})["catch"](b.actionError$(a))}function H(a,b){var c=g.get("local",a.game.model_selection),d=R.length(c),e=R.path(["_model_selection_listener","stamp"],a);(1!==d||c[0]!==e)&&(K(a),1===d?I(c[0],a):a.queueChangeEventP("Game.model.selection.local.updateSingle",null,null))}function I(a,b){b._model_selection_listener={stamp:a,unsubscribe:b.onChangeEvent("Game.model.change."+a,J(a,b))}}function J(a,b){return function(){return R.threadP(b.game)(R.prop("models"),f.findStampP$(a),function(c){b.queueChangeEventP("Game.model.selection.local.updateSingle",a,c);
})}}function K(a){var b=R.thread(a)(R.path(["_model_selection_listener","unsubscribe"]),R.defaultTo(function(){}));b(),a._model_selection_listener={}}function L(a,b,c){return a.create={base:{x:240,y:240,r:0},templates:[{type:c,x:0,y:0,r:0}]},a.eventP("Modes.switchTo","CreateTemplate")}function M(a,b){var c=k.get("local",a.game.template_selection),d=R.length(c),e=R.path(["_template_selection_listener","stamp"],a);(1!==d||c[0]!==e)&&(P(a),1===d?N(c[0],a):a.queueChangeEventP("Game.template.selection.local.updateSingle",null,null))}function N(a,b){b._template_selection_listener={stamp:a,unsubscribe:b.onChangeEvent("Game.template.change."+a,O(a,b))}}function O(a,b){arguments;return function(){return R.threadP(b.game)(R.prop("templates"),j.findStampP$(a),function(c){b.queueChangeEventP("Game.template.selection.local.updateSingle",a,c)})}}function P(a){var b=R.thread(a)(R.path(["_template_selection_listener","unsubscribe"]),R.defaultTo(function(){}));b(),a._template_selection_listener={}}function Q(a,b,c){return a.create={base:{x:240,y:240,r:0},terrains:[{info:c,x:0,y:0,r:0}]},a.eventP("Modes.switchTo","CreateTerrain")}function S(a,c){return R.threadP(a.game)(R.prop("terrains"),i.all,R.pluck("state"),R.pluck("stamp"),function(b){return a.eventP("Game.command.execute","deleteTerrain",[b])})["catch"](b.actionError$(a))}function T(a,b,d){var e=c.forName(d,a.boards);return a.eventP("Game.command.execute","setBoard",[e])}function U(a,b){for(var d=void 0,e=c.name(a.game.board);e===c.name(a.game.board);)d=a.boards[R.randomRange(0,a.boards.length-1)],e=c.name(d);return a.eventP("Game.command.execute","setBoard",[d])}function V(a,b,c){return R.threadP(c)(l.readP$("json"),function(b){return R.threadP(b)(R.prop("board"),R.rejectIf(R.isNil,"No board"),function(){return a.eventP("Game.command.execute","setBoard",[b.board])},R.always(b),R.path(["terrain","terrains"]),R.rejectIf(R.isEmpty,"No terrain"),function(){return a.eventP("Game.terrain.reset")},function(){return a.eventP("Game.command.execute","createTerrain",[b.terrain,!1])})})["catch"](R.spyAndDiscardError("Import board file"))}function W(a,b,c,d){var e=h.forName(c,d);return a.eventP("Game.command.execute","setScenario",[e])}function X(a,b){for(var c=h.group("SR15",a.scenarios),d=void 0,e=h.name(a.game.scenario);e===h.name(a.game.scenario);)d=c[1][R.randomRange(0,c[1].length-1)],e=h.name(d);return a.eventP("Game.command.execute","setScenario",[d])}function Y(a,b){a.queueChangeEventP("Game.scenario.refresh")}function Z(a,c){function d(b){return R.threadP(b)(R.prop("models"),f.all,R.filter(R.pipe(R.path(["state","info"]),R.head,R.equals("scenario"))),R.map(R.path(["state","stamp"])),R.unless(R.isEmpty,function(b){return a.eventP("Game.command.execute","deleteModel",[b])}))}return R.threadP(a.game)(d,function(){return h.createObjectivesP(a.game.scenario)},function(b){var c=R.path(["ui_state","flip_map"],a);return a.eventP("Game.command.execute","createModel",[b,c])})["catch"](b.actionError$(a))}function $(a,b){return a.game=b,a.queueChangeEventP("Game.change"),b}function _(b){return b._game===b.game?null:(b._game=b.game,R.isNil(R.path(["game","local_stamp"],b))?null:R.thread(b.local_games)(a.updateLocalGame$(b.game),function(a){b.local_games=a,b.queueChangeEventP("Games.local.change")}))}function aa(a){return m.exportP("models",function(a){return R.threadP(a)(R.path(["game","model_selection"]),R.rejectIf(R.isNil,"selection is nil"),g.get$("local"),R.rejectIf(R.isEmpty,"selection is empty"),function(b){return f.copyStampsP(b,R.path(["game","models"],a))},R.rejectIf(R.isEmpty,"selection models not found"))},a)}function ba(a){return R.thread(a)(R.prop("game"),function(a){return{board:a.board,terrain:{base:{x:0,y:0,r:0},terrains:R.thread(a.terrains)(i.all,R.pluck("state"),R.map(R.pick(["x","y","r","info","lk"])))}}})}var ca={create:n,save:o,onGameLoad:p,onGameConnectionClose:q,onGameCommandExecute:r,onGameCommandUndo:t,onGameCommandUndoLast:u,onGameCommandReplay:v,onGameCommandReplayNext:x,onGameCommandReplayBatch:w,onGameSetCmds:y,onGameSetPlayers:z,onGameNewChatMsg:A,onGameUpdate:B,onGameInvitePlayer:C,onGameModelCreate:D,onGameModelCopy:E,onGameModelImportList:F,onGameModelImportFile:G,onGameModelSelectionLocalChange:H,onGameTemplateCreate:L,onGameTemplateSelectionLocalChange:M,onGameTerrainCreate:Q,onGameTerrainReset:S,onGameBoardSet:T,onGameBoardSetRandom:U,onGameBoardImportFile:V,onGameScenarioSet:W,onGameScenarioSetRandom:X,onGameScenarioRefresh:Y,onGameScenarioGenerateObjectives:Z},da=R.curry($),ea=m.exportP$("game",R.prop("game")),fa=m.exportP$("board",ba);return R.curryService(ca),ca}angular.module("clickApp.services").factory("stateGame",a),a.$inject=["games","game","gameBoard","gameConnection","gameFactions","gameModels","gameModelSelection","gameScenario","gameTerrains","gameTemplates","gameTemplateSelection","fileImport","stateExports","allCommands","allTemplates"]}(),function(){function a(a,b,c){function d(a){return a.local_games={},a.games_ready=new self.Promise(function(b){a.onEvent("State.init",q.onStateInit$(a,b))}),a.onEvent("Games.local.create",q.onGamesLocalCreate$(a)),a.onEvent("Games.local.load",q.onGamesLocalLoad$(a)),a.onEvent("Games.local.loadFile",q.onGamesLocalLoadFile$(a)),a.onEvent("Games.local.delete",q.onGamesLocalDelete$(a)),a.onEvent("Games.online.create",q.onGamesOnlineCreate$(a)),a.onEvent("Games.online.load",q.onGamesOnlineLoad$(a)),a.onEvent("Games.online.loadFile",q.onGamesOnlineLoadFile$(a)),a}function e(a){return a}function f(a,c,d){return R.threadP()(b.loadLocalGamesP,r(a),c)}function g(b,c){return R.thread(b.user.state)(a.create,q.loadNewLocalGame$(b))}function h(a,b,c){a.queueChangeEventP("Games.local.load",c)}function i(a,b,d){return R.threadP(d)(c.readP$("json"),q.loadNewLocalGame$(a))}function j(a,c,d){return R.thread(a.local_games)(b.removeLocalGame$(d),r(a))}function k(a,b){a.local_games=b,a.queueChangeEventP("Games.local.change")}function l(a,c){return R.thread(a.local_games)(b.newLocalGame$(c),r(a),function(){a.queueChangeEventP("Games.local.load",R.prop("local_stamp",R.last(a.local_games)))})}function m(b,c){return R.thread(b)(R.pathOr({},["user","state"]),a.create,q.loadNewOnlineGame$(b))}function n(a,b,c){a.queueChangeEventP("Games.online.load","public",c)}function o(a,b,d){return R.threadP(d)(c.readP$("json"),q.loadNewOnlineGame$(a))["catch"](R.spyAndDiscardError("Failed to open online game file"))}function p(a,c){return R.threadP(c)(b.newOnlineGameP,R.prop("private_stamp"),function(b){a.queueChangeEventP("Games.online.load","private",b)})}var q={create:d,save:e,onStateInit:f,onGamesLocalCreate:g,onGamesLocalLoad:h,onGamesLocalLoadFile:i,onGamesLocalDelete:j,loadNewLocalGame:l,onGamesOnlineCreate:m,onGamesOnlineLoad:n,onGamesOnlineLoadFile:o,loadNewOnlineGame:p},r=R.curry(k);return R.curryService(q),q}angular.module("clickApp.services").factory("stateGames",a),a.$inject=["game","games","fileImport"]}(),function(){function a(a,b){function c(a){return a.modes={},a.onEvent("Modes.switchTo",j.onModesSwitchTo$(a)),a.onEvent("Modes.current.action",j.onModesCurrentAction$(a)),a.onEvent("Modes.reset",j.onModesReset$(a)),a.onEvent("Modes.exit",j.onModesExit$(a)),a}function d(a){return a}function e(c,d,e){return R.threadP(c.modes)(a.switchToModeP$(e,c),k(c))["catch"](b.actionError$(c))}function f(c,d,e,f){var g=a.currentModeActionP(e,[c].concat(_toConsumableArray(f)),c.modes),h=R.last(f);return R.exists(R.prop("preventDefault",h))&&h.preventDefault(),self.Promise.resolve(g)["catch"](b.actionError$(c))}function g(b,c){return R.threadP(b)(a.initP,k(b))}function h(b,c){return R.threadP(b.modes)(a.exit$(b),k(b))}function i(a,b){a.modes=b,a.queueChangeEventP("Modes.change")}var j={create:c,save:d,onModesSwitchTo:e,onModesCurrentAction:f,onModesReset:g,onModesExit:h},k=R.curry(i);return R.curryService(j),j}angular.module("clickApp.services").factory("stateModes",a),a.$inject=["modes","game","allModes"]}(),function(){function a(a,c,d,e){function f(a){return a.user={},a.user_ready=new self.Promise(function(b){a.onEvent("State.init",u.onStateInit$(a,b))}),a.onEvent("User.set",u.onUserSet$(a)),a.onEvent("User.toggleOnline",u.onUserToggleOnline$(a)),a.onEvent("User.sendChatMsg",u.onUserSendChatMsg$(a)),a.onEvent("User.connection.close",u.onUserConnectionClose$(a)),a.onEvent("User.setOnlineUsers",u.onUserSetOnlineUsers$(a)),a.onEvent("User.setOnlineGames",u.onUserSetOnlineGames$(a)),a.onEvent("User.newChatMsg",u.onUserNewChatMsg$(a)),a.onChangeEvent("User.change",u.onUserChange$(a)),a}function g(b){return b._user===b.user?null:(b._user=b.user,a.save(b.user))}function h(b,c,d){return R.threadP(b)(a.initP,v(b),function(){b.user_ready.fulfilled=!0},c)}function i(b,c,d){return R.threadP(b.user)(R.assoc("state",d),a.checkOnlineP$(b),v(b))}function j(b,c){return R.threadP(b.user)(a.toggleOnlineP$(b),v(b))}function k(a,b,d){return c.sendChatP$(d,a.user)}function l(b,c){return R.threadP(b.user)(a.online,R.rejectIf(R.not,"User not online when connection close"),function(){return e.promptP("alert","Server connection lost.")["catch"](R.always(null))},function(){return a.toggleOnlineP(b,b.user)},v(b))}function m(a,b,c){return R.thread(a.user)(R.assocPath(["connection","users"],c),v(a))}function n(a,b,c){return R.thread(a.user)(R.assocPath(["connection","games"],c),v(a))}function o(a,b,c){return a.queueChangeEventP("User.chat",c),R.thread(a.user)(R.over(R.lensPath(["connection","chat"]),R.pipe(R.defaultTo([]),R.append(c))),v(a))}function p(b,c){a.online(b.user)?q(b):r(b)}function q(a){R.exists(a._keep_alive_interval)||(a._keep_alive_interval=self.window.setInterval(s(a),1e3*b))}function r(a){R.isNil(a._keep_alive_interval)||(self.window.clearInterval(a._keep_alive_interval),a._keep_alive_interval=null)}function s(a){return function(){d.getP("/api/users/"+a.user.state.stamp).then(R.spyInfo("** keepAlive"))}}function t(a,b){a.user=b,a.queueChangeEventP("User.change")}var u={create:f,save:g,onStateInit:h,onUserSet:i,onUserToggleOnline:j,onUserSendChatMsg:k,onUserConnectionClose:l,onUserSetOnlineUsers:m,onUserSetOnlineGames:n,onUserNewChatMsg:o,onUserChange:p},v=R.curry(t);return R.curryService(u),u}angular.module("clickApp.services").factory("stateUser",a);var b=60;a.$inject=["user","userConnection","http","prompt"]}(),function(){function a(a,b){var c={Move:10,MoveSmall:1,Rotate:15,RotateSmall:5,Shift:10,ShiftSmall:1},d=R.clone(c);return a.register("Misc","Terrain",c,function(a){R.extend(d,a)}),b("terrain",d)}angular.module("clickApp.services").factory("terrain",a),a.$inject=["settings","element"]}(),function(){function a(a,b){function c(a,b){g[a]=b}function d(a){return R.threadP(g)(R.prop(a.type),R.rejectIf(R.isNil,'Create unknown template type "'+a.type+'"'),function(b){return R.threadP(j.createDefaultP())(R.assocPath(["state","type"],a.type),b._create)})}function e(a,b){return R.exists(g[b.state.type])&&R.exists(g[b.state.type][a])}function f(a,b,c){return R.threadP(c)(R.rejectIf(R.complement(k.respondTo$(a)),"Unknown call "+a+" on "+c.state.type+" template"),function(){return g[c.state.type][a].apply(g[c.state.type],[].concat(_toConsumableArray(b),[c]))})}var g={},h={Move:10,MoveSmall:1,Rotate:60,RotateSmall:6,Shift:10,ShiftSmall:1},i=R.clone(h);a.register("Misc","Template",h,function(a){R.extend(i,a)});var j=b("template",i),k=Object.create(j);return R.deepExtend(k,{createDefaultP:d,registerTemplate:c,respondTo:e,callP:f}),R.curryService(k),k}angular.module("clickApp.services").factory("template",a).factory("allTemplates",["aoeTemplate","sprayTemplate","wallTemplate",function(){return{}}]),a.$inject=["settings","element"]}(),function(){function a(a,b){function c(a){return R.assocPath(["state","s"],15,a)}function d(a,b){return R.threadP(a)(function(a){return R.find(R.equals(a),[3,4,5])},R.rejectIf(R.isNil,"Invalid size for an AoE"),function(){return R.assocPath(["state","s"],5*a,b)})}function e(a){return R.path(["state","s"],a)}function f(c,d,e){return R.threadP(e)(R.rejectIf(a.isLocked,"Template is locked"),function(e){c=e.state.r+60*(c-1);var f=R.defaultTo(d,R.path(["state","m"],e));return d=Math.min(d,f),R.thread(e)(R.over(R.lensProp("state"),b.translateInDirection$(10*d,c)),R.assocPath(["state","r"],c),a.checkState)})}function g(a){return R.pathOr(0,["state","m"],a)}function h(a,b){return R.assocPath(["state","m"],a,b)}function i(b,c){return R.threadP(c)(R.rejectIf(a.isLocked,"Template is locked"),function(c){var d=R.thread(c.state)(R.assoc("x",b.x),R.assoc("y",b.y),R.assoc("r",b.r),R.assoc("m",b.m));return R.thread(c)(R.assoc("state",d),a.checkState)})}function j(b,c,d,e){return a.setPositionP(d.state,e)}var k=Object.create(a);return R.deepExtend(k,{_create:c,setSizeP:d,size:e,deviate:f,maxDeviation:g,setMaxDeviation:h,setToRulerP:i,setTargetP:j}),a.registerTemplate("aoe",k),R.curryService(k),k}angular.module("clickApp.models").factory("aoeTemplate",a),a.$inject=["template","point"]}(),function(){function a(a,b,c){function d(a){return R.assocPath(["state","s"],6,a)}function e(a,b){return R.threadP(a)(function(a){return R.find(R.equals(a),[6,8,10])},R.rejectIf(R.isNil,"Invalid size for a Spray"),function(){return R.assocPath(["state","s"],a,b)})}function f(a){return R.path(["state","s"],a)}function g(a){return R.path(["state","o"],a)}function h(c,d,e){return R.threadP(e)(R.rejectIf(a.isLocked,"Template is locked"),function(){return b.baseEdgeInDirectionP$(c,e.state.r,d)},function(b){return R.thread(e)(R.assocPath(["state","o"],d.state.stamp),function(c){return a.setPositionP(b,c)})})}function i(d,e,f,g){return R.threadP(g)(R.rejectIf(a.isLocked,"Template is locked"),function(){return c.directionTo(f.state,e.state)},function(c){return R.threadP(e)(b.baseEdgeInDirectionP$(d,c),function(b){return R.thread(g)(R.assocPath(["state","r"],c),function(c){return a.setPositionP(b,c)})})})}function j(b){function c(c,d){return R.threadP(d)(R.rejectIf(a.isLocked,"Template is locked"),R.assocPath(["state","o"],null),function(d){return a[b](c,d)})}m[b]=c}function k(c,d,e,f){function g(e){return R.isNil(d)?e:R.threadP(d)(b.baseEdgeInDirectionP$(c,e.state.r),function(b){return a.setPositionP(b,e)})}return R.threadP(f)(function(b){return a.rotateLeftP(e,b)},g)}function l(c,d,e,f){function g(e){return R.isNil(d)?e:R.threadP(d)(b.baseEdgeInDirectionP$(c,e.state.r),function(b){return a.setPositionP(b,e)})}return R.threadP(f)(function(b){return a.rotateRightP(e,b)},g)}var m=Object.create(a);R.deepExtend(m,{_create:d,setSizeP:e,size:f,origin:g,setOriginP:h,setTargetP:i,rotateLeftP:k,rotateRightP:l});var n=["moveFrontP","moveBackP","shiftLeftP","shiftRightP","shiftUpP","shiftDownP","setPositionP"];return R.forEach(j,n),a.registerTemplate("spray",m),R.curryService(m),m}angular.module("clickApp.models").factory("sprayTemplate",a),a.$inject=["template","model","point"]}(),function(){function a(a){function b(a){return R.resolveP(a)}var c=Object.create(a);return c._create=b,a.registerTemplate("wall",c),R.curryService(c),c}angular.module("clickApp.models").factory("wallTemplate",a),a.$inject=["template"]}(),function(){function a(a,b,c){function d(a){return R.thread(a)(R.pathOr("",["state","name"]),s.trim,R.length,R.lt(0))}function e(a){return R.thread(a)(R.prop("state"),R.spyWarn("User save"),b.save$(t),R.always(a))}function f(){return R.threadP(t)(b.loadP,R.defaultTo({}),R.spyWarn("User load"),function(a){return{state:a}},c.init)}function g(a){return R.threadP()(f,u.checkOnlineP$(a))}function h(a){return"Object"!==R.type(R.prop("state",a))?"":u.stateDescription(a.state)}function i(){var a=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],b=a.name,c=a.language,d=a.chat,e=a.faction,f=a.game_size,g=a.ck_position,h="";R.exists(b)&&(h+=s(b).trim().capitalize().value());var i=[];return R.exists(c)&&i.push(s(c).trim().value()),R.exists(d)&&i.push(s(d).trim().value()),R.isEmpty(i)||(h+=" ["+i.join(" ")+"]"),R.exists(e)&&!R.isEmpty(e)&&(h+=" - "+R.map(s.capitalize,e).join(",")),R.exists(f)&&(h+="["+s.trim(f)+"pts]"),R.exists(g)&&!R.isEmpty(g)&&(h+=" - likes "+g.join(",")),h}function j(a){return R.path(["state","online"],a)}function k(a,b){return u.online(b)?n(b):m(a,b)}function l(a,b){return R.threadP(b)(R.rejectIf(R.complement(u.online),"No online flag"),function(a){return p(a)["catch"](function(){return o(a)})},function(b){return q(a,b)})["catch"](function(a){return r(b)})}function m(a,b){return R.threadP(b)(R.assocPath(["state","online"],!0),u.checkOnlineP$(a))}function n(a){return r(a)}function o(b){return R.threadP(b)(R.prop("state"),a.postP$("/api/users"),function(a){return R.assoc("state",a,b)})}function p(b){return R.threadP(b)(R.rejectIf(R.compose(R.isNil,R.path(["state","stamp"])),"No valid stamp"),R.prop("state"),a.putP$("/api/users/"+b.state.stamp),function(a){return R.assoc("state",a,b)})}function q(a,b){return R.threadP(b)(c.openP$(a),R.assocPath(["state","online"],!0))}function r(a){return R.thread(a)(R.assocPath(["state","online"],!1),c.close)}var t="clickApp.user",u={isValid:d,save:e,loadP:f,initP:g,description:h,stateDescription:i,online:j,toggleOnlineP:k,checkOnlineP:l};return R.curryService(u),u}angular.module("clickApp.models").factory("user",a),a.$inject=["http","localStorage","userConnection"]}(),function(){function a(a){function b(a){var b={state:{socket:null}};return R.assoc("connection",b,a)}function c(b,c){if(q.active(c))return R.resolveP(c);var d={close:k(b),users:r(b),games:t(b),chat:u(b)};return c=R.assocPath(["connection","state","socket"],null,c),R.threadP()(function(){return a.createP("/api/users/"+c.state.stamp,"user",d)},function(a){return R.assocPath(["connection","state","socket"],a,c)})}function d(b){return R.thread()(function(){q.active(b)&&a.close(b.connection.state.socket)},function(){return R.over(R.lensProp("connection"),j,b)})}function e(a){return R.thread(a)(R.path(["connection","state","socket"]),R.exists)}function f(b,c){return R.threadP(c)(R.rejectIf(R.complement(q.active),"Not active"),function(c){return b=R.thread(b)(R.assoc("type","chat"),R.assoc("from",c.state.stamp)),a.send(b,c.connection.state.socket)})}function g(a,b){return R.thread(b)(R.prop("connection"),v(a),R.defaultTo({name:"Unknown"}),R.prop("name"),i)}function h(a,b){return R.thread(b)(R.defaultTo({}),R.propOr({},"connection"),w(R.defaultTo([],a)),R.pluck("name"),function(a){return R.isEmpty(a)?["Unknown"]:a},R.map(i))}function i(a){return s(a).trim().capitalize().value()}function j(a){return R.thread(a)(R.assocPath(["state","socket"],null),R.assoc("users",[]))}function k(a){return function(){a.queueEventP("User.connection.close")}}function l(a,b){a.queueEventP("User.setOnlineUsers",R.thread(b)(R.propOr([],"users"),R.sortBy(R.compose(R.toLower,R.prop("name")))))}function m(a,b){a.queueEventP("User.setOnlineGames",R.thread(b)(R.propOr([],"games")))}function n(a,b){a.queueEventP("User.newChatMsg",b)}function o(a,b){return R.thread(b)(R.prop("users"),R.find(R.propEq("stamp",a)))}function p(a,b){return R.thread(a)(R.map(R.flip(v)(b)),R.reject(R.isNil))}var q={init:b,openP:c,close:d,active:e,sendChatP:f,userNameForStamp:g,usersNamesForStamps:h},r=R.curry(l),t=R.curry(m),u=R.curry(n),v=R.curry(o),w=R.curry(p);return R.curryService(q),q}angular.module("clickApp.models").factory("userConnection",a),a.$inject=["websocket"]}(),function(){function a(a){function b(a,b){return R.thread(b)(d[a].stringify,function(a){return new self.Blob([a],{type:"text/plain"})},self.URL.createObjectURL)}function c(a){R.isNil(a)||self.URL.revokeObjectURL(a)}self.URL=self.URL||self.webkitURL;var d={json:a},e={generate:b,cleanup:c};return R.curryService(e),e}angular.module("clickApp.services").factory("fileExport",a),a.$inject=["jsonStringifier"]}(),function(){function a(a){function b(a,b){return new self.Promise(function(d,e){var f=new self.FileReader;f.onload=function(b){c[a].parseP(b.target.result).then(d)["catch"](e)},f.onerror=function(){e(["Error reading file"])},f.onabort=function(){e(["Abort reading file"])},f.readAsText(b)})}var c={json:a},d={readP:b};return R.curryService(d),d}angular.module("clickApp.services").factory("fileImport",a),a.$inject=["jsonParser"]}(),function(){function a(a,b,c){function d(a){return a.classList.contains("flipped")}function e(a){var b=a.getBoundingClientRect();return b.width/480}function f(a,b){var c=i.isFlipped(a),d=a.getBoundingClientRect(),e=480*(b.clientX-d.left)/d.width,f=480*(b.clientY-d.top)/d.height;return e=c?480-e:e,f=c?480-f:f,{x:e,y:f}}function g(a,b){var c=i.isFlipped(a),d=a.getBoundingClientRect(),e=b.x*d.width/480,f=b.y*d.height/480;return c&&(e=d.width-e,f=d.height-f),e+=d.left,f+=d.top,{x:e,y:f}}function h(d,e){function f(a){return e.target.classList.contains(a)&&e.target.hasAttribute("data-stamp")}function g(a,b){var c=e.target.getAttribute("data-stamp");return R.threadP(d)(R.prop(b+"s"),a.findStampP$(c),function(a){return{type:s.capitalize(b),target:a}})["catch"](R.always(h))}var h={type:"Map",target:null};return f("template")?g(b,"template"):f("model-base")?g(a,"model"):f("terrain-image")?g(c,"terrain"):R.resolveP(h)}var i={isFlipped:d,zoomFactor:e,eventToMapCoordinates:f,mapToScreenCoordinates:g,findEventTarget:h};return R.curryService(i),i}angular.module("clickApp.services").factory("gameMap",a),a.$inject=["gameModels","gameTemplates","gameTerrains"]}(),function(){function a(){function a(a){return e("GET",a)}function b(a,b){return e("POST",a,b)}function c(a,b){return e("PUT",a,b)}function d(a){return e("DELETE",a)}function e(a,b,c){return new self.Promise(function(d,e){var f=new self.XMLHttpRequest;f.open(a,b),f.responseType="json",R.exists(c)?f.send(JSON.stringify(c)):f.send(),f.onload=function(){f.status>=200&&f.status<300?d(f.response):e(f.statusText)},f.onerror=function(){e(f.statusText)}})}var f={getP:a,postP:b,putP:c,deleteP:d};return R.curryService(f),f}angular.module("clickApp.services").factory("http",a),a.$inject=[]}(),function(){function a(){function a(a){return self.Promise.resolve(a).then(function(a){return JSON.parse(a)})["catch"](function(a){return self.Promise.reject(a.message)})}var b={parseP:a};return R.curryService(b),b}angular.module("clickApp.services").factory("jsonParser",a),a.$inject=[]}(),function(){function a(){function a(a){return JSON.stringify(a,b)}function b(a,b){return s.startsWith(a,"$$")?void 0:b}var c={stringify:a};return R.curryService(c),c}angular.module("clickApp.services").factory("jsonStringifier",a),a.$inject=[]}(),function(){function a(a,b){function c(){return R.thread(self.localStorage.length)(R.range(0),R.map(R.bind(self.localStorage.key,self.localStorage)))}function d(a){return self.localStorage.getItem(a)}function e(b){return R.threadP(b)(i.getItem,a.parseP)}function f(a,b){return self.localStorage.setItem(a,b),b}function g(a,c){return R.thread(c)(b.stringify,i.setItem$(a)),c}function h(a){return self.localStorage.removeItem(a)}var i={keys:c,getItem:d,loadP:e,setItem:f,save:g,removeItem:h};return R.curryService(i),i}angular.module("clickApp.services").factory("localStorage",a),a.$inject=["jsonParser","jsonStringifier"]}(),function(){function a(){function a(a){var b=arguments.length<=1||void 0===arguments[1]?"channel":arguments[1];return R.thread(a)(R.defaultTo({}),R.assoc("_pubSubName",b),R.assoc("_pubSubCache",{}))}function b(a,b,c){return R.thread(c)(R.prop("_pubSubCache"),function(c){return R.thread(c)(R.propOr([],a),R.append(b),function(e){return c[a]=e,d(a,b,c)})})}function c(){for(var a=arguments.length,b=Array(a),c=0;a>c;c++)b[c]=arguments[c];var d=b[0];return R.threadP(b)(R.last,h(d,R.init(b)),h(f,R.init(b)))}function d(a,b,c){return function(){c[a]=R.reject(R.equals(b),c[a])}}function e(a,b,c){function d(b){return R.isEmpty(b)&&a!==f,b}function e(a){return new self.Promise(function(c){var d=void 0;try{d=a.apply(null,b)}catch(e){}c(d)})}return R.threadP(c)(R.pathOr([],["_pubSubCache",a]),d,R.map(e),R.promiseAll,R.always(c))}var f="#watch#",g={init:a,subscribe:b,publishP:c},h=R.curry(e);return R.curryService(g),g}angular.module("clickApp.services").factory("pubSub",a),a.$inject=[]}(),function(){function a(a,b){function c(b,c,d){return new self.Promise(function(e,f){function g(a){e(o),p=!0}function h(a){d.error("socketError",a)}function i(){return p?void d.close():(f("Connection error"),void(p=!0))}function j(b){R.threadP(b.data)(a.parseP,function(a){return R.isNil(d[a.type])?void d.error("Unknown msg type",a):void d[a.type](a)})}function k(a,b){}function l(){}c=R.defaultTo(b,c),d=R.thread(d)(R.over(R.lensProp("error"),R.defaultTo(k)),R.over(R.lensProp("close"),R.defaultTo(l)));var m="ws://",n=m+self.document.location.host+b,o=new self.WebSocket(n),p=!1;o.onopen=g,o.onerror=h,o.onclose=i,o.onmessage=j})}function d(a,c){return R.thread(a)(b.stringify,function(a){return c.send(a)},R.always(c))}function e(a){return a.close(),a}var f={createP:c,send:d,close:e};return R.curryService(f),f}angular.module("clickApp.services").factory("websocket",a),a.$inject=["jsonParser","jsonStringifier"]}(),function(){function a(){function a(a){return i=a,i.doValidate=g,i.doCancel=h,f(),i}function b(a,b,e){function f(c){c.open({prompt_type:a,message:"String"===R.type(b)?[b]:b,input_type:"Number"===R.type(e)?"number":"text",input_value:e})}return R.threadP()(d,f,c)}function c(){return new self.Promise(function(a,b){k={resolve:a,reject:b}})}function d(){return R.exists(i)?i:e()}function e(){return new self.Promise(function(a){j.push(a)})}function f(){R.forEach(function(a){a(i)},j),j.length=0}function g(){var a=i.close();k.resolve(a),k=null}function h(){i.close(),k.reject("canceled"),k=null}var i=void 0,j=[],k=void 0,l={register:a,promptP:b};return R.curryService(l),l}function b(a){function b(b,c){function d(){var a=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],b=a.message,d=a.input_type,e=a.prompt_type,f=a.input_value;self.window.requestAnimationFrame(function(){g.innerHTML=R.defaultTo([],b).join("<br />"),h.setAttribute("type",R.defaultTo("text",d)),h.style.display="prompt"===e?"initial":"none",i.style.display="alert"!==e?"initial":"none",c.style.display="initial",h.focus(),h.value=R.defaultTo(null,f)})}function e(){var a=h.value;return"number"===h.getAttribute("type")&&(a=0===R.length(a)?null:parseFloat(a)),c.style.display="none",a}c=c[0];var f=c.querySelector("form"),g=c.querySelector("p"),h=c.querySelector("input"),i=c.querySelector("button.btn-default");c.style.display="none";var j=a.register({open:d,close:e});f.addEventListener("submit",j.doValidate),i.addEventListener("click",j.doCancel)}var c={restrict:"E",templateUrl:"app/components/prompt/prompt.html",scope:!0,link:b};return c}angular.module("clickApp.directives").factory("prompt",a).directive("prompt",b),a.$inject=[],b.$inject=["prompt"]}(),function(){function a(){function a(a,b){function c(){this.value=null}function d(){var b=e.files;a.clickFile({file:b}),e.blur()}var e=b[0];e.setAttribute("multiple",""),e.onclick=c,e.onchange=d}return{restrict:"A",scope:{clickFile:"&"},link:a}}angular.module("clickApp.directives").directive("clickFile",a),a.$inject=[]}(),function(){function a(){return{restrict:"E",templateUrl:"app/components/games_list/games_list.html",scope:{},link:function(){},controller:"gamesListCtrl",controllerAs:"vm",bindToController:{games:"=",selection:"=",current:"="}}}function b(a){function b(){a.$watch("vm.games",function(){e()})}function c(a){return R.exists(R.find(R.equals(a),f.selection.list))}function d(a){R.exists(f.current)&&f.games[a].public_stamp===f.current||e(a)}function e(a){R.thread(a)(R.defaultTo(R.head(f.selection.list)),R.defaultTo(0),R.min(R.length(f.games)-1),R.max(0),function(a){f.selection.list=[a]})}var f=this;f.selection.list=[],f.isInSelection=c,f.doSetSelection=d,b()}angular.module("clickApp.directives").controller("gamesListCtrl",b).directive("clickGamesList",a),b.$inject=["$scope"]}(),function(){function a(){function a(a,b){function c(b,c){R.exists(h)&&self.clearTimeout(h),f.innerHTML=a.game.currentModeName(),g.innerHTML=c,e.style.display="initial",h=self.setTimeout(d,1e3)}function d(){e.style.display="none",h=null}var e=b[0];e.style.display="none";var f=e.querySelector(".action-error-mode-name"),g=e.querySelector(".action-error-reason");a.onStateChangeEvent("Game.action.error",c,a);var h=void 0}return{restrict:"A",link:a}}angular.module("clickApp.directives").directive("clickGameActionError",a),a.$inject=[]}(),function(){function a(){function a(a,b){function c(){var b=R.last(R.pathOr([],["state","game","dice"],a));if("rollDeviation"!==b.type){var c=R.propOr([],"d",b);if(!(R.length(c)<2)){var e=R.reduce(R.add,0,c)/R.length(c);e>=2||(d.currentTime=0,d.play())}}}var d=b[0].querySelector("audio");a.onStateChangeEvent("Game.dice.roll",c,a)}return{restrict:"E",templateUrl:"app/components/game/bad_dice_notification/bad_dice_notification.html",link:a}}angular.module("clickApp.directives").directive("clickBadDiceNotification",a),a.$inject=[]}(),function(){function a(a,b){function c(){f.msg="",a.onStateChangeEvent("Game.chat",d,a),a.onStateChangeEvent("Game.loaded",d,a),self.window.requestAnimationFrame(d)}function d(){f.chat=R.clone(R.path(["game","chat"],a.state)),a.$digest()}function e(){var c=s.trim(f.msg);R.isEmpty(c)||R.threadP(a.state.game)(b.sendChatP$(R.path(["user","state","name"],a.state),c),function(){f.msg="",a.$digest()})}var f=this;f.doSendChatMessage=e,c()}function b(){return{restrict:"E",templateUrl:"app/components/game/chat_box/game_chat_box.html",scope:!0,controller:"gameChatBoxCtrl",controllerAs:"game_chat",link:function(){}}}angular.module("clickApp.directives").controller("gameChatBoxCtrl",a).directive("clickGameChatBox",b),a.$inject=["$scope","game"],b.$inject=[]}(),function(){function a(a){function b(b,c){function d(c,d){if(!R.isNil(d)&&!R.isNil(d.from)&&d.from!==a.state.user.state.stamp&&d.from!==a.state.user.state.name){var e=!a.stateIs(b.state);e?f.classList.add("go-to-hint"):f.classList.remove("go-to-hint")}}function e(a,c){c.name===b.state&&f.classList.remove("go-to-hint")}var f=c[0];a.onStateChangeEvent(s.capitalize(b.type)+".chat",d,b),a.$on("$stateChangeSuccess",e)}return{restrict:"A",scope:{type:"@clickChatHint",state:"@hintState"},link:b}}angular.module("clickApp.directives").directive("clickChatHint",a),a.$inject=["$rootScope"]}(),function(){function a(a,b){function c(c,f){function g(){if(!R.isNil(R.path(["create","models"],j))){var a=b.isFlipped(h);e(j.create.base,a,k,l)}}var h=document.getElementById("map"),i=h.namespaceURI,j=c.state,k=R.nth(c.index,j.create.models),l=void 0;R.threadP(j.factions)(a.getModelInfoP$(k.info),function(a){l=d(a,document,i,f[0]),g(),c.onStateChangeEvent("Game.create.update",g,c)})}function d(a,b,c,d){var e=b.createElementNS(c,"circle");return e.classList.add("create-model"),e.setAttribute("cx","240"),e.setAttribute("cy","240"),e.setAttribute("r",a.base_radius),d.appendChild(e),e}function e(a,b,c,d){var e=b?-1:1;d.setAttribute("cx",a.x+e*c.x+""),d.setAttribute("cy",a.y+e*c.y+"")}return{restrict:"A",link:c}}angular.module("clickApp.directives").directive("clickGameCreateModel",a),a.$inject=["gameFactions","gameMap"]}(),function(){function a(a,b){function c(c,g){var h=document.getElementById("map"),i=h.namespaceURI,j=c.state,k=R.nth(c.index,j.create.terrains);R.threadP(j.terrains)(a.getInfoP$(k.info),function(a){var l=d(a,document,i,g[0]),m=b.isFlipped(h);f(a,j.create.base,m,k,l),c.onStateChangeEvent("Game.create.update",e(h,j,a,k,l),c)})}function d(a,b,c,d){var e=b.createElementNS(c,"rect");return e.classList.add("create-terrain"),e.setAttribute("x","240"),e.setAttribute("y","240"),e.setAttribute("width",a.img.width),e.setAttribute("height",a.img.height),d.appendChild(e),e}function e(a,c,d,e,g){return function(){var h=b.isFlipped(a);f(d,c.create.base,h,e,g)}}function f(a,b,c,d,e){var f=c?-1:1;e.setAttribute("x",b.x+f*d.x-a.img.width/2+""),e.setAttribute("y",b.y+f*d.y-a.img.height/2+"")}return{restrict:"A",link:c}}angular.module("clickApp.directives").directive("clickGameCreateTerrain",a),a.$inject=["gameTerrainInfo","gameMap"]}(),function(){function a(a){function b(b,c){function d(){if(!R.isNil(R.path(["create","templates"],g))){
var b=a.isFlipped(e);i[j].setPosition(g.create.base,b,h,k)}}var e=document.getElementById("map"),f=e.namespaceURI,g=b.state,h=R.nth(b.index,g.create.templates),j=h.type,k=i[j].create(document,f,c[0]),l=a.isFlipped(e);i[j].setPosition(g.create.base,l,h,k),b.onStateChangeEvent("Game.create.update",d,b)}function c(a,b,c){var d=a.createElementNS(b,"circle");return d.classList.add("create-template-aoe"),d.setAttribute("cx","240"),d.setAttribute("cy","240"),d.setAttribute("r","15"),c.appendChild(d),d}function d(a,b,c,d){var e=b?-1:1;d.setAttribute("cx",a.x+e*c.x+""),d.setAttribute("cy",a.y+e*c.y+"")}function e(a,b,c){var d=a.createElementNS(b,"polygon");return d.classList.add("create-template-spray"),d.setAttribute("points","8.75,0 5.125,-59 10,-60 14.875,-59 11.25,0"),d.setAttribute("transform","translate(230,240)"),c.appendChild(d),d}function f(a,b,c,d){var e=b?-1:1;d.setAttribute("transform",["translate(",a.x+e*c.x-10,",",a.y+e*c.y,")"].join(""))}function g(a,b,c){var d=a.createElementNS(b,"rect");return d.classList.add("create-template-wall"),d.setAttribute("x","220"),d.setAttribute("y","236.25"),d.setAttribute("width","40"),d.setAttribute("height","7.5"),c.appendChild(d),d}function h(a,b,c,d){var e=b?-1:1;d.setAttribute("x",a.x+e*c.x-20+""),d.setAttribute("y",a.y+e*c.y-3.75+"")}var i={aoe:{create:c,setPosition:d},spray:{create:e,setPosition:f},wall:{create:g,setPosition:h}},j={restrict:"A",link:b};return j}angular.module("clickApp.directives").directive("clickGameCreateTemplate",a),a.$inject=["gameMap"]}(),function(){function a(a){function b(){d.dice=R.clone(R.path(["state","game","dice"],a)),a.$digest()}function c(b,c){a.stateEvent("Game.command.execute","rollDice",[b,c])}var d=this;d.doRollDice=c,a.onStateChangeEvent("Game.dice.roll",b,a),self.requestAnimationFrame(b)}function b(){return{restrict:"E",controller:"gameDiceBoxCtrl",controllerAs:"dice_box",templateUrl:"app/components/game/dice_box/dice_box.html",scope:!0,link:function(){}}}angular.module("clickApp.directives").controller("gameDiceBoxCtrl",a).directive("clickGameDiceBox",b),a.$inject=["$scope"],b.$inject=[]}(),function(){function a(){function a(a,b){function c(){e.style.visibility="hidden"}function d(a,b,c){var d=Math.min(b.x,c.x),f=Math.min(b.y,c.y),g=Math.abs(b.x-c.x),h=Math.abs(b.y-c.y);e.style.visibility="visible",e.setAttribute("x",d+""),e.setAttribute("y",f+""),e.setAttribute("width",g+""),e.setAttribute("height",h+"")}var e=b[0];c(),a.onStateChangeEvent("Game.dragBox.enable",d,a),a.onStateChangeEvent("Game.dragBox.disable",c,a)}return{restrict:"A",link:a}}angular.module("clickApp.directives").directive("clickGameDragbox",a),a.$inject=[]}(),function(){function a(a){function b(){var b=s.trim(c.new_label);0!==R.length(b)&&a.stateEvent("Game.command.execute",c.cmd,["addLabel",[b],[c.selection.state.stamp]]).then(function(){c.new_label="",c.doClose(),a.$digest()})}var c=this;c.new_label="",c.doAddLabel=b}function b(a){function b(b,c){function d(a){27===a.keyCode&&e()}function e(){b.edit_label.selection={},m.style.display="none",m.style.visibility="hidden",m.style.left="0px",m.style.top="0px"}function f(a,c,d){b.edit_label.cmd=c,b.edit_label.selection=d,b.edit_label.new_label="",b.$digest(),self.window.requestAnimationFrame(g)}function g(){m.style.display="initial",m.style.visibility="hidden",k(),self.window.requestAnimationFrame(h)}function h(){j(),m.style.visibility="visible",self.window.requestAnimationFrame(function(){n.focus()})}function i(){k(),self.window.requestAnimationFrame(j)}function j(){var c=n.getBoundingClientRect(),d=a.mapToScreenCoordinates(l,b.edit_label.selection.state);m.style.left=d.x-c.width/2+"px",m.style.top=d.y-c.height/2+"px"}function k(){n.style.width=R.length(b.edit_label.new_label)+"em"}var l=document.getElementById("map"),m=c[0],n=m.querySelector("input");e(),b.onStateChangeEvent("Game.editLabel.open",f,b),b.onStateChangeEvent("Game.editLabel.close",e,b),n.addEventListener("keydown",d),b.edit_label.doRefresh=i,b.edit_label.doClose=e}return{restrict:"A",templateUrl:"app/components/game/edit_label/edit_label.html",scope:!0,controller:"clickGameEditLabelCtrl",controllerAs:"edit_label",link:b}}angular.module("clickApp.directives").controller("clickGameEditLabelCtrl",a).directive("clickGameEditLabel",b),a.$inject=["$scope"],b.$inject=["gameMap"]}(),function(){function a(){}function b(a,b){function c(c,d){function e(a,b){o?f():g(a,b)}function f(){o=!1,c.selection={},n.style.display="none",n.style.visibility="hidden",n.style.left="0px",n.style.top="0px"}function g(b,d){o=!0,c.selection=d,a.getModelInfoP(c.selection.state.info,m.factions).then(function(a){c.info=a,c.$digest()}),self.window.requestAnimationFrame(h)}function h(){n.style.display="initial",n.style.visibility="hidden",self.window.requestAnimationFrame(i)}function i(){j(),n.style.visibility="visible"}function j(){var a=n.getBoundingClientRect(),d=b.mapToScreenCoordinates(l,c.selection.state),e=k.getBoundingClientRect(),f=e.height-a.height,g=e.width-a.width,h=Math.max(0,Math.min(f,d.y-a.height/2)),i=Math.max(0,Math.min(g,d.x-a.width/2));n.style.top=h+"px",n.style.left=i+"px"}var k=document.getElementById("viewport"),l=document.getElementById("map"),m=c.state,n=d[0],o=!1;f(),c.onStateChangeEvent("Game.editDamage.toggle",e,c),c.onStateChangeEvent("Game.editDamage.open",g,c),c.onStateChangeEvent("Game.editDamage.close",f,c),c.doClose=f}return{restrict:"A",templateUrl:"app/components/game/edit_damage/edit_damage.html",scope:!0,controller:"clickGameEditDamageCtrl",controllerAs:"edit_damage",link:c}}angular.module("clickApp.directives").controller("clickGameEditDamageCtrl",a).directive("clickGameEditDamage",b),a.$inject=["$scope"],b.$inject=["gameFactions","gameMap"]}(),function(){function a(a){function b(a,b){var c=document.createElementNS(a,"g");c.classList.add("label"),b.appendChild(c);var d=document.createElementNS(a,"rect");d.setAttribute("height","6"),c.appendChild(d);var e=document.createElementNS(a,"text");return c.appendChild(e),{label:c,bckgnd:d,text:e}}function c(b,c,d){var e=a.isFlipped(b);d.label.setAttribute("transform",e?"rotate(180,"+c.x+","+c.y+")":"")}function d(a,b,c,d,h,i){h=R.defaultTo("",h)+"";var j=R.length(h)>0?"visible":"hidden";e(a,c,j,i.label),"visible"===j&&(f(d,h,i.text),self.window.requestAnimationFrame(function(){g(b,d,i.text,i.bckgnd)}))}function e(a,b,c,d){d.style.visibility=c,d.setAttribute("transform",a?"rotate(180,"+b.x+","+b.y+")":"")}function f(a,b,c){c.innerHTML=b,c.setAttribute("x",a.x+""),c.setAttribute("y",a.y+"")}function g(a,b,c,d){var e=c.getBoundingClientRect(),f=e.width/a-2,g=parseFloat(d.getAttribute("height"));d.setAttribute("x",b.x-f/2-1+""),d.setAttribute("y",b.y-(g-1)+""),d.setAttribute("width",f+2+"")}var h={create:b,updateOnFlipMap:c,update:d};return h}angular.module("clickApp.directives").factory("labelElement",a),a.$inject=["gameMap"]}(),function(){function a(){return{restrict:"A",link:b}}function b(a,b){a.onStateChangeEvent("Game.loading",function(){b[0].style.display="block"},a),a.onStateChangeEvent("Game.loaded",function(){b[0].style.display="none"},a)}angular.module("clickApp.directives").directive("clickGameLoading",a),a.$inject=[]}(),function(){function a(){function a(a,b){var c=b[0],d=c.getAttribute("click-log-replay-list");a.$watch(d,function(){self.requestAnimationFrame(function(){c.scrollTop=1e6})})}return{restrict:"A",link:a}}angular.module("clickApp.directives").directive("clickLogReplayList",a),a.$inject=[]}(),function(){function a(a,b,c,d){function e(c,d){function e(){g(o.game.los.local,p.line)}function j(){g(o.game.los.remote,q.line);var c=b.isDisplayed(o.game.los)||"LoS"===a.currentModeName(o.modes);h(o.game.los,c,q.envelope),i(o.factions,o.game.models,b.origin(o.game.los),c,q.origin),i(o.factions,o.game.models,b.target(o.game.los),c,q.target)}var k=d[0],l=document.getElementById("map"),m=document.getElementById("game-under-models"),n=l.namespaceURI,o=c.state,p=f(n,m,k),q=f(n,m,k);c.onStateChangeEvent("Game.los.local.change",e,c),c.onStateChangeEvent("Game.los.remote.change",j,c)}function f(a,b,c){var d=document.createElementNS(a,"g");c.appendChild(d);var e=document.createElementNS(a,"line");e.style["marker-start"]="url(#los-start)",e.style["marker-end"]="url(#los-end)",d.appendChild(e);var f=document.createElementNS(a,"circle");f.classList.add("los-origin"),f.setAttribute("cx","0"),f.setAttribute("cy","0"),f.setAttribute("r","0"),f.style.visibility="hidden",c.appendChild(f);var g=document.createElementNS(a,"circle");g.classList.add("los-target"),g.setAttribute("cx","0"),g.setAttribute("cy","0"),g.setAttribute("r","0"),g.style.visibility="hidden",c.appendChild(g);var h=document.createElementNS(a,"polygon");return h.classList.add("los-envelope"),h.setAttribute("points","0,0 0,0 0,0"),h.style.visibility="hidden",b.insertBefore(h,b.firstChild),{container:d,line:e,origin:f,target:g,envelope:h}}function g(a,b){b.style.visibility=a.display?"visible":"hidden",b.setAttribute("x1",a.start.x+""),b.setAttribute("y1",a.start.y+""),b.setAttribute("x2",a.end.x+""),b.setAttribute("y2",a.end.y+"")}function h(a,b,c){var d=R.pathOr({},["computed","envelope"],a),e=d.left;e=void 0===e?{}:e;var f=e.start;f=void 0===f?{}:f;var g=f.x,h=void 0===g?0:g,i=f.y,j=void 0===i?0:i,k=e.end;k=void 0===k?{}:k;var l=k.x,m=void 0===l?0:l,n=k.y,o=void 0===n?0:n,p=d.right;p=void 0===p?{}:p;var q=p.start;q=void 0===q?{}:q;var r=q.x,s=void 0===r?0:r,t=q.y,u=void 0===t?0:t,v=p.end;v=void 0===v?{}:v;var w=v.x,x=void 0===w?0:w,y=v.y,z=void 0===y?0:y,A=[[h,j].join(","),[m,o].join(","),[x,z].join(","),[s,u].join(",")].join(" ");c.setAttribute("points",A),c.style.visibility=b?"visible":"hidden"}function i(a,b,e,f,g){g.style.visibility="hidden",R.threadP(e)(function(a){return R.exists(a)?c.findStampP(a,b):R.rejectP()},function(b){return!f||R.isNil(b)?null:R.threadP(a)(d.getModelInfoP$(b.state.info),function(a){g.setAttribute("cx",b.state.x+""),g.setAttribute("cy",b.state.y+""),g.setAttribute("r",a.base_radius+""),g.style.visibility="visible"})})["catch"](R.always(null))}return{restrict:"A",link:e}}function b(){function a(a,c){var d=a.state;a.onStateChangeEvent("Game.los.remote.change",function(){b(d.game.los,c[0])},a)}function b(a,b){var c=R.pathOr({},["computed","envelope"],a),d=c.left;d=void 0===d?{}:d;var e=d.start;e=void 0===e?{}:e;var f=e.x,g=void 0===f?0:f,h=e.y,i=void 0===h?0:h,j=d.end;j=void 0===j?{}:j;var k=j.x,l=void 0===k?0:k,m=j.y,n=void 0===m?0:m,o=c.right;o=void 0===o?{}:o;var p=o.start;p=void 0===p?{}:p;var q=p.x,r=void 0===q?0:q,s=p.y,t=void 0===s?0:s,u=o.end;u=void 0===u?{}:u;var v=u.x,w=void 0===v?0:v,x=u.y,y=void 0===x?0:x,z=[[g,i].join(","),[l,n].join(","),[w,y].join(","),[r,t].join(",")].join(" ");b.setAttribute("points",z)}return{restrict:"A",link:a}}function c(a,b){function c(a,b){var c=a.state;d(a,c,b[0]),a.onStateChangeEvent("Game.remote.los.change",function(){d(a,c,c.game.los,b[0])},a)}function d(c,d,e){var f=R.propOr({},"envelope",c),g=f.left;g=void 0===g?{}:g;var h=g.start;h=void 0===h?{}:h;var i=h.x,j=void 0===i?0:i,k=h.y,l=void 0===k?0:k,m=g.end;m=void 0===m?{}:m;var n=m.x,o=void 0===n?0:n,p=m.y,q=void 0===p?0:p,r=f.right;r=void 0===r?{}:r;var s=r.start;s=void 0===s?{}:s;var t=s.x,u=void 0===t?0:t,v=s.y,w=void 0===v?0:v,x=r.end;x=void 0===x?{}:x;var y=x.x,z=void 0===y?0:y,A=x.y,B=void 0===A?0:A,C=[[j,l].join(","),[o,q].join(","),[z,B].join(","),[u,w].join(",")].join(" ");e.setAttribute("points",C);var D=a.isDisplayed(d.game.los)||"LoS"===b.currentModeName(d.modes);e.style.visibility=D?"visible":"hidden"}return{restrict:"A",link:c}}function d(){function a(a){a.digestOnStateChangeEvent("Game.los.remote.change",a)}return{restrict:"A",scope:!0,link:a}}angular.module("clickApp.directives").directive("clickGameLos",a).directive("clickGameLosClip",b).directive("clickGameLosDarkness",c).directive("clickGameLosRefresh",d),a.$inject=["modes","gameLos","gameModels","gameFactions"],b.$inject=[],c.$inject=["gameLos","modes"],d.$inject=[]}(),function(){function a(){function a(a,c){c=c[0];var d=b(c);c.querySelector("#menu-toggle").addEventListener("click",d),a.onStateChangeEvent("Game.toggleMenu",d,a);var e=c.querySelector("#gameview"),f=e.getBoundingClientRect();e.style.width=f.height+"px"}function b(a){var b=void 0;return function(){var c=a.querySelector("#gameview"),d=a.querySelector("#menu"),e=a.querySelector("#dice-osd"),f=a.querySelector("#chat-osd"),g=d.classList.contains("hidden");if(g)c.style.width=b+"px";else{var h=c.getBoundingClientRect();b=h.width,c.style.width=self.window.innerWidth+"px"}c.classList.toggle("resizable"),d.classList.toggle("hidden"),e.classList.toggle("show"),f.classList.toggle("show")}}return{restrict:"A",link:a}}angular.module("clickApp.directives").directive("clickGamePage",a),a.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,c,d){function e(e,g){function h(){function g(b){if(f("mouseDownMap",b,q.getBoundingClientRect()),m(),b.preventDefault(),1===b.which){var c=a.eventToMapCoordinates(q,b);a.findEventTarget(r.game,b).then(function(a){o(c,a),q.addEventListener("mousemove",h)})}}function h(b){if(f("dragMap",b),b.preventDefault(),1===b.which&&(t.now=a.eventToMapCoordinates(q,b),t.active||!s())){var d=t.active?"drag":"dragStart";t.active=!0,"Terrain"===t.target.type&&c.isLocked(t.target.target)&&(t.target={type:"Map",target:null}),e.stateEvent("Modes.current.action",d+t.target.type,[{target:t.target.target,start:t.start,now:t.now},b])}}function i(a){f("mouseLeaveMap",a),a.preventDefault(),q.removeEventListener("mousemove",h),t.active&&p(a)}function j(b){if(f("clickMap",b),b.preventDefault(),1===b.which){q.removeEventListener("mousemove",h);var c=a.eventToMapCoordinates(q,b);t.active?(t.now=c,p(b)):a.findEventTarget(r.game,b).then(u("click",b,c))}}function k(b){f("rightClickMap",b),b.preventDefault();var c=a.eventToMapCoordinates(q,b);a.findEventTarget(r.game,b).then(u("rightClick",b,c))}function l(b){f("moveMap",b),b.preventDefault();var c=a.eventToMapCoordinates(q,b);e.stateEvent("Modes.current.action","moveMap",[c,b])}function m(){var a=[].concat(_toConsumableArray(document.querySelectorAll("input")),_toConsumableArray(document.querySelectorAll("select")),_toConsumableArray(document.querySelectorAll("textarea")));R.forEach(function(a){a.blur()},a)}function n(a,c,d,e){var f=R.thread(c)(b,R.append(a+e.type),R.join("+"));c["click#"]={target:e.target,x:d.x,y:d.y},r.queueChangeEventP("Game.selectionDetail.close"),r.queueChangeEventP("Game.editLabel.close"),r.queueChangeEventP("Game.editDamage.close"),Mousetrap.trigger(f,void 0,c)}function o(a,b){t={active:!1,start:a,target:b,now:null}}function p(a){e.stateEvent("Modes.current.action","dragEnd"+t.target.type,[{target:t.target.target,start:t.start,now:t.now},a]),t={active:!1,start:null,target:null,now:null}}function s(){var a=d.settings().DragEpsilon;return Math.abs(t.now.x-t.start.x)<a&&Math.abs(t.now.y-t.start.y)<a}var t={active:!1,start:null,target:null,now:null},u=R.curry(n);return{down:g,drag:h,leave:i,click:j,rightClick:k,move:l}}function i(){function a(){c||(q.addEventListener("mousemove",s.move),c=!0)}function b(){c&&(q.removeEventListener("mousemove",s.move),c=!1)}var c=!1;return{enable:a,disable:b}}function j(){function a(){r.ui_state=R.thread(r)(R.propOr({},"ui_state"),R.assoc("flip_map",!1)),q.classList.remove("flipped")}function b(){c=document.querySelector("#deploiement-labels"),r.ui_state.flip_map=!q.classList.contains("flipped"),q.classList.toggle("flipped"),r.ui_state.flip_map?c.setAttribute("transform","rotate(180,240,240)"):c.setAttribute("transform",""),r.queueChangeEventP("Game.map.flipped")}var c=void 0;return a(),b}function k(){function a(){var a=p.getBoundingClientRect(),b=Math.min(a.width,a.height);m(b-15)}function b(){var a=d.settings().ZoomFactor,b=n(),c=_slicedToArray(b,2),e=_slicedToArray(c[0],2),f=e[0],g=e[1],h=_slicedToArray(c[1],2),i=h[0],j=h[1],k=q.getBoundingClientRect();f=i>k.width?k.width/a:f,g=j>k.height?k.height/a:g,m(k.width*a),o(f*a,g*a,i,j)}function c(){var a=d.settings().ZoomFactor,b=n(),c=_slicedToArray(b,2),e=_slicedToArray(c[0],2),f=e[0],g=e[1],h=_slicedToArray(c[1],2),i=h[0],j=h[1],k=Math.min(i,j),l=q.getBoundingClientRect();m(Math.max(k-15,l.width/a)),o(f/a,g/a,i,j)}return{"in":b,out:c,reset:a}}function l(){function a(){var a=d.settings().ScrollStep,b=p.scrollLeft;self.window.requestAnimationFrame(function(){p.scrollLeft=b-a})}function b(){var a=d.settings().ScrollStep,b=p.scrollLeft;self.window.requestAnimationFrame(function(){p.scrollLeft=b+a})}function c(){var a=d.settings().ScrollStep,b=p.scrollTop;self.window.requestAnimationFrame(function(){p.scrollTop=b-a})}function e(){var a=d.settings().ScrollStep,b=p.scrollTop;self.window.requestAnimationFrame(function(){p.scrollTop=b+a})}return{left:a,right:b,up:c,down:e}}function m(a){q.style.width=a+"px",q.style.height=a+"px"}function n(){var a=p.getBoundingClientRect(),b=a.width,c=a.height,d=p.scrollLeft+b/2,e=p.scrollTop+c/2;return[[d,e],[b,c]]}function o(a,b,c,d){p.scrollLeft=a-c/2,p.scrollTop=b-d/2}var p=document.querySelector("#viewport"),q=g[0],r=e.state,s=h(),t=i(),u=j(),v=k(),w=l();q.addEventListener("mouseup",s.click),q.addEventListener("mousedown",s.down),q.addEventListener("mouseleave",s.leave),q.addEventListener("dragstart",function(a){a.preventDefault()}),q.addEventListener("contextmenu",s.rightClick),e.onStateChangeEvent("Game.view.flipMap",u,e),e.onStateChangeEvent("Game.moveMap.enable",t.enable,e),e.onStateChangeEvent("Game.moveMap.disable",t.disable,e),e.onStateChangeEvent("Game.view.zoomIn",v["in"],e),e.onStateChangeEvent("Game.view.zoomOut",v.out,e),e.onStateChangeEvent("Game.view.zoomReset",v.reset,e),e.onStateChangeEvent("Game.view.scrollLeft",w.left,e),e.onStateChangeEvent("Game.view.scrollRight",w.right,e),e.onStateChangeEvent("Game.view.scrollUp",w.up,e),e.onStateChangeEvent("Game.view.scrollDown",w.down,e),self.window.requestAnimationFrame(v.reset)}var f=R.bind(console.log,console);return{restrict:"A",link:e}}function b(a){var b=[];return a.shiftKey&&b.push("shift"),a.altKey&&b.push("alt"),a.ctrlKey&&b.push("ctrl"),a.metaKey&&b.push("meta"),b.sort()}angular.module("clickApp.directives").directive("clickGameMap",a),a.$inject=["gameMap","terrain","commonMode"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){function b(a,b){var c=document.createElementNS(a,"circle");c.classList.add("model-ctrl-area"),c.setAttribute("cx","0"),c.setAttribute("cy","0"),c.setAttribute("r","0"),c.style.visibility="hidden",b.appendChild(c);var d=document.createElementNS(a,"circle");return d.classList.add("model-area"),d.setAttribute("cx","0"),d.setAttribute("cy","0"),d.setAttribute("r","0"),d.style.visibility="hidden",b.appendChild(d),[d,c]}function c(b,c,d,e,f){var g=_slicedToArray(f,2),h=g[0],i=g[1];i.setAttribute("cx",e.width/2+""),i.setAttribute("cy",e.height/2+""),a.isCtrlAreaDisplayedP(b,d).then(function(a){if(a){var b=20*(c.focus||c.fury)+c.base_radius;i.setAttribute("r",b+""),i.style.visibility="visible"}else i.style.visibility="hidden"}),h.setAttribute("cx",e.width/2+""),h.setAttribute("cy",e.height/2+""),a.isAreaDisplayed(d)?(h.setAttribute("r",10*d.state.are+c.base_radius+""),h.style.visibility="visible"):h.style.visibility="hidden"}return{create:b,update:c}}angular.module("clickApp.directives").factory("clickGameModelArea",a),a.$inject=["model"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){function b(a,b){var c=document.createElementNS(a,"circle");c.classList.add("color-aura"),c.style.filter="url(#aura-filter)",c.style.visibility="hidden",b.appendChild(c);var d=document.createElementNS(a,"circle");return d.classList.add("state-aura"),d.style.filter="url(#state-aura-filter)",b.appendChild(d),[c,d]}function c(b,c,d,e){var f=_slicedToArray(e,2),g=f[0],h=f[1];h.setAttribute("cx",d.width/2+""),h.setAttribute("cy",d.height/2+""),h.setAttribute("r",1.2*b.base_radius+""),g.setAttribute("cx",d.width/2+""),g.setAttribute("cy",d.height/2+""),g.setAttribute("r",1.2*b.base_radius+""),a.isAuraDisplayed(c)?(g.style.fill=c.state.aur,g.style.visibility="visible"):g.style.visibility="hidden"}return{create:b,update:c}}angular.module("clickApp.directives").factory("clickGameModelAura",a),a.$inject=["model"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){function b(b,c,d,e){var f=document.createElementNS(b,"circle");f.classList.add("model-base"),f.setAttribute("cx",c.img[0].width/2+""),f.setAttribute("cy",c.img[0].height/2+""),f.setAttribute("r",c.base_radius),f.setAttribute("style",["fill:",c.base_color,";"].join("")),f.setAttribute("data-stamp",d.state.stamp),e.appendChild(f);var g=document.createElementNS(b,"title");f.appendChild(g),g.innerHTML=a.descriptionFromInfo(c,d);var h=document.createElementNS(b,"line");h.classList.add("model-los"),h.setAttribute("x1",c.img[0].width/2+""),h.setAttribute("y1",c.img[0].height/2+""),h.setAttribute("x2",c.img[0].width/2+""),h.setAttribute("y2",c.img[0].height/2-c.base_radius+""),e.appendChild(h);var i=document.createElementNS(b,"line");i.classList.add("model-los"),i.setAttribute("x1",c.img[0].width/2-c.base_radius+""),i.setAttribute("y1",c.img[0].height/2+""),i.setAttribute("x2",c.img[0].width/2+c.base_radius+""),i.setAttribute("y2",c.img[0].height/2+""),e.appendChild(i);var j=document.createElementNS(b,"image");j.classList.add("model-image"),j.setAttribute("x","0"),j.setAttribute("y","0"),e.appendChild(j);var k=document.createElementNS(b,"circle");return k.classList.add("model-edge"),k.setAttribute("cx",c.img[0].width/2+""),k.setAttribute("cy",c.img[0].height/2+""),k.setAttribute("r",c.base_radius),e.appendChild(k),[f,h,i,j,k]}function c(a,b,c,d){var e=_slicedToArray(d,5),f=(e[0],e[1],e[2],e[3]);e[4];f.setAttribute("width",c.width+""),f.setAttribute("height",c.height+""),R.exists(c.link)?(f.setAttributeNS("http://www.w3.org/1999/xlink","href",c.link),f.style.visibility="visible"):f.style.visibility="hidden"}return{create:b,update:c}}angular.module("clickApp.directives").factory("clickGameModelBase",a),a.$inject=["model"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b,c,d,e,f){function g(b,c,d){var e=document.createElementNS(b,"rect");e.style.visibility="hidden",e.classList.add("model-charge-path"),c.appendChild(e);var f=document.createElementNS(b,"circle");f.style.visibility="hidden",f.classList.add("model-charge-target"),d.appendChild(f);var g=a.create(b,d);return[e,f,g]}function h(a,b,c){var d=_slicedToArray(c,3),e=d[0],f=d[1],g=d[2];b.removeChild(g.label),b.removeChild(f),a.removeChild(e)}function i(g,h,i,j,k,l,m){var n=_slicedToArray(m,3),o=n[0],p=n[1],q=n[2];if(!b.isCharging(k)&&!b.isPlacing(k))return o.style.visibility="hidden",p.style.visibility="hidden",void a.update(g,h,k.state,k.state,"",q);var r=void 0;if(b.isCharging(k)){var s=c.distanceTo(k.state,k.state.cha.s),t=k.state.cha.s.r,u=c.translateInDirection(400,t,k.state.cha.s);o.setAttribute("width",2*j.base_radius+""),o.setAttribute("height","800"),o.setAttribute("x",u.x-j.base_radius+""),o.setAttribute("y",u.y-400+""),o.setAttribute("transform",["rotate(",t,",",u.x,",",u.y,")"].join("")),o.style.visibility="visible";var v=Math.round(10*s)/100+'"';r=b.chargeMaxLength(k),R.exists(r)&&(v+="/"+r+'"'),a.update(g,h,k.state.cha.s,k.state.cha.s,v,q),f["in"]("local",k.state.stamp,i.game.model_selection)&&R.exists(k.state.cha.t)&&R.threadP(i.game.models)(e.findStampP$(k.state.cha.t),function(a){p.setAttribute("cx",a.state.x+""),p.setAttribute("cy",a.state.y+"");var e=0;b.isMeleeDisplayed("mm",k)&&(e=5),b.isMeleeDisplayed("mr",k)&&(e=20),b.isMeleeDisplayed("ms",k)&&(e=40);var f=c.distanceTo(a.state,k.state);return R.threadP(i.factions)(d.getModelInfoP$(a.state.info),function(a){p.setAttribute("r",a.base_radius+""),f<=e+j.base_radius+a.base_radius?p.classList.add("reached"):p.classList.remove("reached"),p.style.visibility="visible"})})}if(b.isPlacing(k)){var w=c.distanceTo(k.state,k.state.pla.s),x=k.state.pla.s.r,y=c.translateInDirection(400,x,k.state.pla.s);o.setAttribute("width",2*j.base_radius+""),o.setAttribute("height","800"),o.setAttribute("x",y.x-j.base_radius+""),o.setAttribute("y",y.y-400+""),o.setAttribute("transform",["rotate(",x,",",y.x,",",y.y,")"].join("")),o.style.visibility="visible";var z=Math.round(10*w)/100+'"',A=b.placeWithin(k);r=b.placeMaxLength(k),R.exists(r)&&(z+="/"+(A?"w.":"")+r+'"'),a.update(g,h,k.state.pla.s,k.state.pla.s,z,q)}p.style.visibility="hidden"}return{create:g,cleanup:h,update:i}}angular.module("clickApp.directives").factory("clickGameModelCharge",a),a.$inject=["labelElement","model","point","gameFactions","gameModels","gameModelSelection"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a,b){function c(b,c,d){var e=a.create(b,c);e.label.classList.add("counter"),e.bckgnd.setAttribute("height","9");var f=document.createElementNS(b,"image");f.classList.add("model-image"),f.setAttribute("x","0"),f.setAttribute("y","0"),f.setAttribute("width","20"),f.setAttribute("height","20"),f.setAttributeNS("http://www.w3.org/1999/xlink","href","/data/icons/Soul.png"),d.appendChild(f);var g=a.create(b,d);return[e,f,g]}function d(a,b,c){var d=_slicedToArray(c,3),e=d[0];d[1],d[2];b.removeChild(e.label)}function e(c,d,e,h,i,j){var k=_slicedToArray(j,3),l=k[0],m=k[1],n=k[2],o=b.isCounterDisplayed("c",h)?h.state.c:"",p=f(h);a.update(c,d,p.flip,p.text,o,l);var q=b.isCounterDisplayed("s",h)?h.state.s+"":"",r=R.length(q)>0?"visible":"hidden",s=g(i,e,h);m.setAttribute("x",s.text.x-10+""),m.setAttribute("y",s.text.y-10+""),m.style.visibility=r,a.update(c,d,s.flip,s.text,q,n)}function f(a){var b={x:a.state.x,y:a.state.y},c={x:b.x,y:b.y+4};return{text:c,flip:b}}function g(a,b){var c={x:a.width/2,y:a.height/2},d={x:c.x+.8*b.base_radius+5,y:c.y-b.base_radius-5};return{text:d,flip:c}}return{create:c,cleanup:d,update:e}}angular.module("clickApp.directives").factory("clickGameModelCounter",a),a.$inject=["labelElement","model"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){function b(a,b,c){var d=void 0,e=void 0;("warrior"!==b.damage.type||1!==b.damage.n)&&(d=document.createElementNS(a,"line"),d.classList.add("model-damage-bar"),d.setAttribute("x1",b.img[0].width/2-b.base_radius+""),d.setAttribute("y1",b.img[0].height/2+b.base_radius+2+""),d.setAttribute("x2",b.img[0].width/2+b.base_radius+""),d.setAttribute("y2",b.img[0].height/2+b.base_radius+2+""),d.style.stroke="#F00",c.appendChild(d),e=document.createElementNS(a,"line"),e.classList.add("model-damage-bar"),e.setAttribute("x1",b.img[0].width/2-b.base_radius+""),e.setAttribute("y1",b.img[0].height/2+b.base_radius+2+""),e.setAttribute("x2",b.img[0].width/2+b.base_radius+""),e.setAttribute("y2",b.img[0].height/2+b.base_radius+2+""),e.style.stroke="#0F0",c.appendChild(e));var f=void 0,g=void 0;return R.exists(b.damage.field)&&(f=document.createElementNS(a,"line"),f.classList.add("model-damage-bar"),f.setAttribute("x1",b.img[0].width/2-b.base_radius+""),f.setAttribute("y1",b.img[0].height/2+b.base_radius+2+""),f.setAttribute("x2",b.img[0].width/2+b.base_radius+""),f.setAttribute("y2",b.img[0].height/2+b.base_radius+2+""),f.style.stroke="#066",c.appendChild(f),g=document.createElementNS(a,"line"),g.classList.add("model-damage-bar"),g.setAttribute("x1",b.img[0].width/2-b.base_radius+""),g.setAttribute("y1",b.img[0].height/2+b.base_radius+2+""),g.setAttribute("x2",b.img[0].width/2+b.base_radius+""),g.setAttribute("y2",b.img[0].height/2+b.base_radius+2+""),g.style.stroke="#0FF",c.appendChild(g)),[d,e,f,g]}function c(b,c,d,e){var f=_slicedToArray(e,4),g=f[0],h=f[1],i=f[2],j=f[3];if(!R.isNil(g)){if("none"===b.damage.type||a.isWreckDisplayed(c)){if(g.style.visibility="hidden",h.style.visibility="hidden",R.isNil(i))return;return i.style.visibility="hidden",void(j.style.visibility="hidden")}var k=d.width/2+b.base_radius,l=d.width/2-b.base_radius,m=d.height/2+b.base_radius+1,n=c.state.dmg.t/b.damage.total,o=(l-k)*(1-n)+k;if(g.setAttribute("x1",l+""),g.setAttribute("y1",m+""),g.setAttribute("x2",k+""),g.setAttribute("y2",m+""),g.style.visibility="visible",h.setAttribute("x1",o+""),h.setAttribute("y1",m+""),h.setAttribute("x2",k+""),h.setAttribute("y2",m+""),h.style.visibility="visible",!R.isNil(i)){var p=c.state.dmg.f/b.damage.field,q=(l-k)*(1-p)+k;i.setAttribute("x1",l+""),i.setAttribute("y1",m+1+""),i.setAttribute("x2",k+""),i.setAttribute("y2",m+1+""),i.style.visibility="visible",j.setAttribute("x1",q+""),j.setAttribute("y1",m+1+""),j.setAttribute("x2",k+""),j.setAttribute("y2",m+1+""),j.style.visibility="visible"}}}return{create:b,update:c}}angular.module("clickApp.directives").factory("clickGameModelDamage",a),a.$inject=["model"]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){function b(a,b){var c=R.reduce(function(c,d){var e=document.createElementNS(a,"image");
return e.classList.add("model-image"),e.setAttribute("x","0"),e.setAttribute("y","0"),e.setAttribute("width","10"),e.setAttribute("height","10"),e.setAttributeNS("http://www.w3.org/1999/xlink","href",d[1]),e.style.visibility="hidden",b.appendChild(e),R.assoc(d[0],e,c)},{},d),e=document.createElementNS(a,"image");e.classList.add("model-image"),e.setAttribute("x","0"),e.setAttribute("y","0"),e.setAttribute("width","10"),e.setAttribute("height","10"),e.setAttributeNS("http://www.w3.org/1999/xlink","href","/data/icons/Leader.png"),b.appendChild(e);var f=document.createElementNS(a,"image");return f.classList.add("model-image"),f.setAttribute("x","0"),f.setAttribute("y","0"),f.setAttribute("width","10"),f.setAttribute("height","10"),f.setAttributeNS("http://www.w3.org/1999/xlink","href","/data/icons/Lock.png"),f.style.visibility="visible",b.appendChild(f),[c,e,f]}function c(b,c,d,e){var f=_slicedToArray(e,3),g=f[0],h=f[1],i=f[2];return R.thread(g)(R.keys,R.filter(function(b){return a.isEffectDisplayed(b,c)}),function(a){var c=d.width/2-10*R.length(a)/2,e=d.height/2+b.base_radius+1;R.addIndex(R.forEach)(function(a,b){g[a].setAttribute("x",c+10*b+""),g[a].setAttribute("y",e+""),g[a].style.visibility="visible"},a)}),R.thread(g)(R.keys,R.reject(function(b){return a.isEffectDisplayed(b,c)}),R.forEach(function(a){g[a].style.visibility="hidden"})),h.setAttribute("x",d.width/2-.7*b.base_radius-5+""),h.setAttribute("y",d.height/2-.7*b.base_radius-5+""),a.isLeaderDisplayed(c)?h.style.visibility="visible":h.style.visibility="hidden",a.isLocked(c)?(i.setAttribute("x",d.width/2+b.base_radius-5+""),i.setAttribute("y",d.height/2-5+""),void(i.style.visibility="visible")):void(i.style.visibility="hidden")}var d=[["b","/data/icons/Blind.png"],["c","/data/icons/Corrosion.png"],["d","/data/icons/BoltBlue.png"],["f","/data/icons/Fire.png"],["e","/data/icons/BoltYellow.png"],["k","/data/icons/KD.png"],["t","/data/icons/Stationary.png"]];return{create:b,update:c}}angular.module("clickApp.directives").factory("clickGameModelIcon",a),a.$inject=["model"]}(),function(){function a(){function a(a,b,c){var d=document.createElementNS(a,"line");d.classList.add("model-los-selection"),d.setAttribute("x1",b.img[0].width/2+""),d.setAttribute("y1",b.img[0].height/2+""),d.setAttribute("x2",b.img[0].width/2+""),d.setAttribute("y2",b.img[0].height/2-700+""),c.appendChild(d);var e=document.createElementNS(a,"line");return e.classList.add("model-los-selection"),e.setAttribute("x1",b.img[0].width/2-700+""),e.setAttribute("y1",b.img[0].height/2+""),e.setAttribute("x2",b.img[0].width/2+700+""),e.setAttribute("y2",b.img[0].height/2+""),c.appendChild(e),[d,e]}function b(){}return{create:a,update:b}}angular.module("clickApp.directives").factory("clickGameModelLoS",a),a.$inject=[]}();var _slicedToArray=function(){function a(a,b){var c=[],d=!0,e=!1,f=void 0;try{for(var g,h=a[Symbol.iterator]();!(d=(g=h.next()).done)&&(c.push(g.value),!b||c.length!==b);d=!0);}catch(i){e=!0,f=i}finally{try{!d&&h["return"]&&h["return"]()}finally{if(e)throw f}}return c}return function(b,c){if(Array.isArray(b))return b;if(Symbol.iterator in Object(b))return a(b,c);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();!function(){function a(a){function b(a,b){var c=document.createElementNS(a,"path");c.classList.add("model-melee"),c.setAttribute("d",""),b.appendChild(c);var d=document.createElementNS(a,"path");d.classList.add("model-melee"),d.setAttribute("d",""),b.appendChild(d);var e=document.createElementNS(a,"path");return e.classList.add("model-melee"),e.setAttribute("d",""),b.appendChild(e),[c,d,e]}function c(b,c,e,f){var g=_slicedToArray(f,3),h=g[0],i=g[1],j=g[2],k=void 0;a.isMeleeDisplayed("mm",c)?(k=d(5,e,b),h.setAttribute("d",k),h.style.visibility="visible"):h.style.visibility="hidden",a.isMeleeDisplayed("mr",c)?(k=d(20,e,b),i.setAttribute("d",k),i.style.visibility="visible"):i.style.visibility="hidden",a.isMeleeDisplayed("ms",c)?(k=d(40,e,b),j.setAttribute("d",k),j.style.visibility="visible"):j.style.visibility="hidden"}function d(a,b,c){return["M",b.width/2-c.base_radius-a,",",b.height/2," ","L",b.width/2+c.base_radius+a,",",b.height/2," ","A",c.base_radius+a,",",c.base_radius+a," 0 0,0 ",b.width/2-c.base_radius-a,",",b.height/2," ","M",b.width/2,",",b.height/2," ","L",b.width/2,",",b.height/2-c.base_radius-a," "].join("")}return{create:b,update:c}}angular.module("clickApp.directives").factory("clickGameModelMelee",a),a.$inject=["model"]}(),function(){function a(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p){function q(a,c){var d=a.state;b.getModelInfoP(a.model.state.info,d.factions)["catch"](function(a){return self.Promise.reject(a)}).then(function(b){return r(d,b,a.model,c[0],a)})}function r(a,b,c,d,e){var f=s(b,c,d);e.$on("$destroy",t(f)),e.onStateChangeEvent("Game.map.flipped",v(b,e,f),e);var g=y(a,b,e,f);e.onStateChangeEvent("Game.model.change."+c.state.stamp,g,e),g(),e.onStateChangeEvent("Game.model.selection.local.updateSingle",w(e,f),e),e.onStateChangeEvent("Game.template.selection.local.updateSingle",x(e,f),e);var h=u(e,function(c){B(a,b,c,e,f)});e.onStateChangeEvent("Game.scenario.refresh",h,e),e.onStateChangeEvent("Game.scenario.change",h,e)}function s(a,b,c){var d=document.getElementById("map"),e=document.getElementById("game-under-models"),f=document.getElementById("game-over-models"),q=d.namespaceURI,r=i.create(q,c),s=p.create(q,c),t=j.create(q,a,b,c),u=m.create(q,a,c),v=o.create(q,a,c),w=g.create(q,f),x=l.create(q,f,c),y=g.create(q,c),z=n.create(q,c),A=h.create(q,c),B=k.create(q,e,f,c);return{container:c,aura:r,base:t,damage:u,los:v,label:w,counter:x,unit:y,icon:z,area:A,melee:s,charge:B}}function t(a){return function(){var b=document.getElementById("game-under-models"),c=document.getElementById("game-over-models");c.removeChild(a.label.label),l.cleanup(b,c,a.counter),k.cleanup(b,c,a.charge)}}function u(a,b){return function(){for(var d=arguments.length,e=Array(d),f=0;d>f;f++)e[f]=arguments[f];R.threadP(a.state.game.models)(c.findStampP$(a.model.state.stamp),function(a){return b.apply(null,[a].concat(e))})}}function v(a,b,c){return u(b,function(b){var d=document.getElementById("map"),e=D(a,b);g.updateOnFlipMap(d,e.flip,c.label),g.updateOnFlipMap(d,b.state,c.counter[0]),(f.isCharging(b)||f.isPlacing(b))&&g.updateOnFlipMap(d,b.state.cha.s,c.charge[2])})}function w(a,b){return u(a,function(c,d,e,g){return R.isNil(g)||e===c.state.stamp?(b.container.classList.remove("overlap"),void b.container.classList.remove("b2b")):void R.threadP(c)(f.distanceToP$(a.state.factions,g),function(a){return-.1>a?(b.container.classList.add("overlap"),void b.container.classList.remove("b2b")):.1>a?(b.container.classList.remove("overlap"),void b.container.classList.add("b2b")):(b.container.classList.remove("overlap"),void b.container.classList.remove("b2b"))})})}function x(a,b){return u(a,function(c,d,e,g){return R.isNil(g)||"aoe"!==g.state.type?void b.container.classList.remove("under-aoe"):void R.threadP(c)(f.distanceToAoEP$(a.state.factions,g),function(a){0>=a?b.container.classList.add("under-aoe"):b.container.classList.remove("under-aoe")})})}function y(b,c,d,e){return u(d,function(o){var q=document.getElementById("map"),r=a.isFlipped(q),s=a.zoomFactor(q),t=f.isWreckDisplayed(o);(t?f.getWreckImageP(b.factions,o):f.getImageP(b.factions,o)).then(function(a){var q=f.fullLabel(o),t=D(c,o);z(a,o,e),A(b.game.model_selection,o,e),B(b,c,o,d,e),i.update(c,o,a,e.aura),j.update(c,o,a,e.base),m.update(c,o,a,e.damage),g.update(r,s,t.flip,t.text,q,e.label),l.update(r,s,c,o,a,e.counter),C(r,s,a,c,o,e),n.update(c,o,a,e.icon),h.update(b.factions,c,o,a,e.area),p.update(c,o,a,e.melee),k.update(r,s,b,c,o,a,e.charge)})})}function z(a,b,c){c.container.setAttribute("transform",["translate(",b.state.x-a.width/2,",",b.state.y-a.height/2,") rotate(",b.state.r,",",a.width/2,",",a.height/2,")"].join(""))}function A(a,b,c){var e=c.container,f=b.state.stamp;d["in"]("local",f,a)?e.classList.add("local-selection"):e.classList.remove("local-selection"),d["in"]("remote",f,a)?e.classList.add("remote-selection"):e.classList.remove("remote-selection"),d.inSingle("local",f,a)?(e.classList.add("single-local"),e.classList.remove("single-remote")):d.inSingle("remote",f,a)?(e.classList.remove("single-local"),e.classList.add("single-remote")):(e.classList.remove("single-local"),e.classList.remove("single-remote"))}function B(a,b,c,d,f){var g=R.thread(c.state)(R.pick(["x","y"]),R.assoc("radius",b.base_radius));d.app.stateIs("game.setup")&&R.exists(a.game.scenario)&&e.isContesting(g,a.game.scenario)?f.container.classList.add("contesting"):f.container.classList.remove("contesting"),d.app.stateIs("game.setup")&&R.exists(a.game.scenario)&&"wardude"===b.type&&e.isKillboxing(g,a.game.scenario)?f.container.classList.add("killboxing"):f.container.classList.remove("killboxing")}function C(a,b,c,d,e,h){var i=f.unit(e);i=R.exists(i)?i:"";var j=f.isUnitDisplayed(e)?i+"":"";j=R.length(j)>0?"U"+j:j;var k=E(c,d,e);g.update(a,b,k.flip,k.text,j,h.unit)}function D(a,b){var c=b.state.y+a.base_radius+6,d=b.state.y-a.base_radius-2,e=(b.state.r%360+360)%360,f=e>90&&270>e,g={x:b.state.x,y:f?c:d},h={x:g.x,y:g.y-2};return{text:g,flip:h}}function E(a,b){var c={x:a.width/2,y:a.height/2},d={x:c.x-.7*b.base_radius-5,y:c.y-.7*b.base_radius-5};return{text:d,flip:c}}var F={restrict:"A",link:q};return F}function b(){function a(a,b){a.type=b[0].getAttribute("click-game-models-list"),a.digestOnStateChangeEvent("Game.model.create",a)}return{restrict:"A",templateUrl:"app/components/game/model/models_list.html",scope:!0,link:a}}angular.module("clickApp.directives").directive("clickGameModel",a).directive("clickGameModelsList",b),a.$inject=["gameMap","gameFactions","gameModels","gameModelSelection","gameScenario","model","labelElement","clickGameModelArea","clickGameModelAura","clickGameModelBase","clickGameModelCharge","clickGameModelCounter","clickGameModelDamage","clickGameModelIcon","clickGameModelLoS","clickGameModelMelee"],b.$inject=[]}(),function(){function a(a,b,c){function d(a){return R.range(0,a)}function e(a){return n.state&&n.state.dmg.n>a?"mark":""}function f(a,b){return n.state&&n.state.dmg.f>b*n.info.field/2+a?"mark":""}function g(a,b){return n.info[a][b]?n.state&&1===n.state.dmg[a][b]?"mark":"":"none"}function h(){R.isNil(n.state)||a.stateEvent("Game.command.execute","onModels",["resetDamage",[],[n.state.stamp]]).then(m)}function i(b){R.isNil(n.state)||a.stateEvent("Game.command.execute","onModels",["setWarriorDamageP",[o.factions,b],[n.state.stamp]]).then(m)}function j(b){R.isNil(n.state)||a.stateEvent("Game.command.execute","onModels",["setFieldDamageP",[o.factions,b],[n.state.stamp]]).then(m)}function k(b,c){R.isNil(n.state)||R.isNil(n.info[c][b])||a.stateEvent("Game.command.execute","onModels",["setGridDamageP",[o.factions,b,c],[n.state.stamp]]).then(m)}function l(b){R.isNil(n.state)||a.stateEvent("Game.command.execute","onModels",["setGridColDamageP",[o.factions,b],[n.state.stamp]]).then(m)}function m(){return c.findStampP(n.state.stamp,a.state.game.models).then(function(a){n.state=a.state,b.$digest()})}var n=this,o=a.state;n.range=d,n.warriorBoxClass=e,n.fieldBoxClass=f,n.gridBoxClass=g,n.doResetDamage=h,n.doWarriorDamage=i,n.doFieldDamage=j,n.doGridDamage=k,n.doGridColDamage=l}function b(){function a(a){}return{restrict:"E",scope:{},controller:"clickGameModelDamageCtrl",controllerAs:"damage",bindToController:{info:"=",state:"="},templateUrl:"app/components/game/model/damage/model_damage.html",link:a}}angular.module("clickApp.directives").controller("clickGameModelDamageCtrl",a).directive("clickGameModelDamage",b),a.$inject=["$rootScope","$scope","gameModels"],b.$inject=[]}(),function(){function a(a,b,c,d,e,f){function g(a,b){function d(){i(k,o.game.ruler.local,p)}function e(){i(k,o.game.ruler.remote,q);var a=c.isDisplayed(o.game.ruler)||"Ruler"===f.currentModeName(o.modes);l(o.factions,o.game.models,o.game.ruler,a,q.origin),m(o.factions,o.game.models,o.game.ruler,a,q.target)}function g(){j(k,o.game.ruler.local,p),j(k,o.game.ruler.remote,q)}var k=document.getElementById("map"),n=k.namespaceURI,o=a.state,p=h(n,b[0]),q=h(n,b[0]);a.onStateChangeEvent("Game.ruler.local.change",d,a),a.onStateChangeEvent("Game.ruler.remote.change",e,a),a.onStateChangeEvent("Game.map.flipped",g,a)}function h(a,c){var d=document.createElementNS(a,"g");c.appendChild(d);var e=document.createElementNS(a,"line");e.style["marker-start"]="url(#ruler-start)",e.style["marker-end"]="url(#ruler-end)",d.appendChild(e);var f=b.create(a,d),g=document.createElementNS(a,"circle");g.classList.add("ruler-origin"),g.setAttribute("cx","0"),g.setAttribute("cy","0"),g.setAttribute("r","0"),g.style.visibility="hidden",c.appendChild(g);var h=document.createElementNS(a,"circle");return h.classList.add("ruler-target"),h.setAttribute("cx","0"),h.setAttribute("cy","0"),h.setAttribute("r","0"),h.style.visibility="hidden",c.appendChild(h),{container:d,line:e,label:f,origin:g,target:h}}function i(c,d,e){var f=a.isFlipped(c),g=a.zoomFactor(c),h={x:(d.end.x-d.start.x)/2+d.start.x,y:(d.end.y-d.start.y)/2+d.start.y},i=d.display?d.length:"";k(d.display,d,e.line),b.update(f,g,h,h,i,e.label)}function j(a,c,d){var e={x:(c.end.x-c.start.x)/2+c.start.x,y:(c.end.y-c.start.y)/2+c.start.y};b.updateOnFlipMap(a,e,d.label)}function k(a,b,c){c.style.visibility=a?"visible":"hidden",c.setAttribute("x1",b.start.x+""),c.setAttribute("y1",b.start.y+""),c.setAttribute("x2",b.end.x+""),c.setAttribute("y2",b.end.y+"")}function l(a,b,f,g,h){function i(a){return R.threadP(a)(R.rejectIf(R.isNil,"no origin"),function(a){return d.findStampP(a,b)})}function j(a){return!g||R.isNil(a)}var k=c.origin(f);h.style.visibility="hidden",R.threadP(k)(i,R.rejectIf(j,"no display"),function(b){return R.threadP(a)(e.getModelInfoP$(b.state.info),function(a){h.setAttribute("cx",b.state.x+""),h.setAttribute("cy",b.state.y+""),h.setAttribute("r",a.base_radius+""),h.style.visibility="visible"})})["catch"](R.always(null))}function m(a,b,f,g,h){function i(a){return R.threadP(a)(R.rejectIf(R.isNil,"no target"),function(a){return d.findStampP(a,b)})}function j(a){return!g||R.isNil(a)}function k(){c.targetReached(f)?h.classList.add("reached"):h.classList.remove("reached")}var l=c.target(f);h.style.visibility="hidden",R.threadP(l)(i,R.rejectIf(j,"no display"),function(b){return R.threadP(a)(e.getModelInfoP$(b.state.info),function(a){h.setAttribute("cx",b.state.x+""),h.setAttribute("cy",b.state.y+""),h.setAttribute("r",a.base_radius+""),h.style.visibility="visible"})},k)["catch"](R.always(null))}return{restrict:"A",link:g}}angular.module("clickApp.directives").directive("clickGameRuler",a),a.$inject=["gameMap","labelElement","gameRuler","gameModels","gameFactions","modes"]}(),function(){function a(a,b,c,d){function e(){return m.show.info=!1,f()}function f(){return R.threadP()(function(){return o[m.type]()},function(){a.$digest()})}function g(){return R.threadP(n.game)(R.prop("templates"),d.findStampP$(m.element.stamp),function(a){m.element=a.state,m.edit.max_deviation=R.propOr(0,"m",m.element)})}function h(){return R.threadP(n.game)(R.prop("models"),c.findStampP$(m.element.stamp),function(a){m.element=a.state},function(){return b.getModelInfoP(m.element.info,n.factions)},function(a){m.info=a})}function i(a){return s.truncate(a,12)}function j(){var b=m.edit.max_deviation>0?m.edit.max_deviation:null;a.stateEvent("Game.command.execute","onTemplates",["setMaxDeviation",[b],[m.element.stamp]]).then(f)}function k(){var b="template"===m.type?"onTemplates":"onModels",c=s.trim(m.edit.label);0!==R.length(c)&&(a.stateEvent("Game.command.execute",b,["addLabel",[c],[m.element.stamp]]).then(f),m.edit.label="")}function l(b){var c="template"===m.type?"onTemplates":"onModels";a.stateEvent("Game.command.execute",c,["removeLabel",[b],[m.element.stamp]]).then(f)}var m=this,n=a.state;m.edit={label:"",max_deviation:0},m.show={info:!1},m.onOpen=e,m.updateElement=f,m.labelDisplay=i,m.doSetMaxDeviation=j,m.doAddLabel=k,m.doRemoveLabel=l;var o={template:g,model:h}}function b(a){function b(b,c){function d(a,b,c){q.type=b,q.element=c.state,q.edit={label:"",max_deviation:0},q.onOpen().then(function(){self.window.requestAnimationFrame(f)})}function e(){q.element={},c.style.display="none",c.style.visibility="hidden",c.style.left="0px",c.style.top="0px"}function f(){c.style.display="initial",c.style.visibility="hidden",self.window.requestAnimationFrame(g)}function g(){h(),c.style.visibility="visible"}function h(){var b=c.getBoundingClientRect(),d=a.mapToScreenCoordinates(p,q.element),e=o.getBoundingClientRect();i(e,b,d)?c.style.left=j(b,d):c.style.left=k(b,d),l(e,b,d)?c.style.top=m(b,d):c.style.top=n(b,d)}function i(a,b,c){return c.x+b.width<=a.right}function j(a,b){return b.x+"px"}function k(a,b){return Math.max(0,b.x-a.width)+"px"}function l(a,b,c){return c.y+b.height<=a.bottom}function m(a,b){return b.y+"px"}function n(a,b){return Math.max(0,b.y-a.height)+"px"}c=c[0];var o=document.getElementById("viewport"),p=document.getElementById("map"),q=b.selection;q.type="model",e(),b.onStateChangeEvent("Game.selectionDetail.open",d,b),b.onStateChangeEvent("Game.selectionDetail.close",e,b),q.doClose=e}var c={restrict:"A",scope:!0,controller:"clickGameSelectionDetailCtrl",controllerAs:"selection",link:b};return c}angular.module("clickApp.directives").controller("clickGameSelectionDetailCtrl",a).directive("clickGameSelectionDetail",b),a.$inject=["$scope","gameFactions","gameModels","gameTemplates"],b.$inject=["gameMap"]}(),function(){function a(a,b,c){function d(a,c){var d=a.state;R.threadP()(function(){return b.getInfoP(a.terrain.state.info,d.terrains)["catch"](function(a){return self.Promise.reject(a)})},function(b){return e(d,b,a.terrain,c[0],a)})}function e(a,b,c,d,e){var h=f(b,c,d),i=g(a,b,e,h);e.onStateChangeEvent("Game.terrain.change."+c.state.stamp,i,e),i()}function f(a,b,c){var d=document.getElementById("map"),e=d.namespaceURI,f=document.createElementNS(e,"image");f.classList.add("terrain-image"),f.setAttribute("data-stamp",b.state.stamp),f.setAttribute("x","0"),f.setAttribute("y","0"),f.setAttribute("width",a.img.width+""),f.setAttribute("height",a.img.height+""),f.setAttributeNS("http://www.w3.org/1999/xlink","href",a.img.link),c.appendChild(f);var g=document.createElementNS(e,"line");g.classList.add("terrain-los"),g.setAttribute("x1",a.img.width/2+""),g.setAttribute("y1",a.img.height/2+""),g.setAttribute("x2",a.img.width/2+""),g.setAttribute("y2","0"),c.appendChild(g);var h=document.createElementNS(e,"rect");return h.classList.add("terrain-edge"),h.setAttribute("x","0"),h.setAttribute("y","0"),h.setAttribute("width",a.img.width+""),h.setAttribute("height",a.img.height+""),c.appendChild(h),{container:c,image:f,direction:g,edge:h}}function g(b,c,d,e){return function(){R.threadP(d.state.game.terrains)(a.findStampP$(d.terrain.state.stamp),function(a){h(c.img,a,e),i(b.game.terrain_selection,a,e)})["catch"](R.spyAndDiscardError())}}function h(a,b,c){c.container.setAttribute("transform",["translate(",b.state.x-a.width/2,",",b.state.y-a.height/2,") rotate(",b.state.r,",",a.width/2,",",a.height/2,")"].join(""))}function i(a,b,d){var e=d.container,f=b.state.stamp;c["in"]("local",f,a)?e.classList.add("local-selection"):e.classList.remove("local-selection"),c["in"]("remote",f,a)?e.classList.add("remote-selection"):e.classList.remove("remote-selection")}return{restrict:"A",link:d}}function b(){function a(a,b){a.type=b[0].getAttribute("click-game-terrains-list"),a.digestOnStateChangeEvent("Game.terrain.create",a)}return{restrict:"A",templateUrl:"app/components/game/terrain/terrains_list.html",scope:!0,link:a}}angular.module("clickApp.directives").directive("clickGameTerrain",a).directive("clickGameTerrainsList",b),a.$inject=["gameTerrains","gameTerrainInfo","gameTerrainSelection"],b.$inject=[]}(),function(){function a(a,b,c,d,e){function f(b,c){function d(){R.threadP()(function(){return e.findStampP(i.state.stamp,b.state.game.templates)},function(a){return g[a.state.type].update(f,b.state,a,j)})}var f=document.getElementById("map"),h=f.namespaceURI,i=b.template;if(!R.isNil(i)){var j=g[i.state.type].create(h,c[0],i);b.$on("$destroy",function(){g[i.state.type].cleanup(c,j)}),j.container=c[0],b.onStateChangeEvent("Game.map.flipped",function(){a.updateOnFlipMap(f,i.state,j.label)},b),d(),b.onStateChangeEvent("Game.template.change."+i.state.stamp,d,b)}}var g={aoe:b,spray:c,wall:d},h={restrict:"A",scope:!0,link:f};return h}function b(){function a(a,b){a.type=b[0].getAttribute("click-game-templates-list"),a.digestOnStateChangeEvent("Game.template.create",a)}var b={restrict:"A",templateUrl:"app/components/game/template/templates_list.html",scope:!0,link:a};return b}angular.module("clickApp.directives").directive("clickGameTemplate",a).directive("clickGameTemplatesList",b),a.$inject=["labelElement","aoeTemplateElement","sprayTemplateElement","wallTemplateElement","gameTemplates"],b.$inject=[]}(),function(){function a(a,b,c,d){function e(a,b,c){var e=document.createElementNS(a,"circle");e.classList.add("template"),e.classList.add("aoe"),e.setAttribute("data-stamp",c.state.stamp),b.appendChild(e);var f=document.createElementNS(a,"line");f.classList.add("template-aoe-direction"),f.style["marker-end"]="url(#aoe-direction-end)",b.appendChild(f);var g=d.create(a,b);return{aoe:e,dir:f,label:g}}function f(e,f,i,j){var k=f.game.template_selection,l=b["in"]("local",i.state.stamp,k),m=b["in"]("remote",i.state.stamp,k),n=l||m,o=c.isFlipped(e),p=c.zoomFactor(e),q=i.state,r={x:i.state.x,y:i.state.y+i.state.s+5},s=a.fullLabel(i);n?j.container.classList.add("selection"):j.container.classList.remove("selection"),l?j.container.classList.add("local"):j.container.classList.remove("local"),m?j.container.classList.add("remote"):j.container.classList.remove("remote"),g(i,j.aoe),h(i,j.dir),d.update(o,p,q,r,s,j.label)}function g(a,b){b.setAttribute("cx",a.state.x+""),b.setAttribute("cy",a.state.y+""),b.setAttribute("r",a.state.s+"")}function h(a,b){b.setAttribute("x1",a.state.x+""),b.setAttribute("y1",a.state.y+""),b.setAttribute("x2",a.state.x+""),b.setAttribute("y2",a.state.y-a.state.s+""),b.setAttribute("transform","rotate("+a.state.r+","+a.state.x+","+a.state.y+")")}var i={create:e,cleanup:function(){},update:f};return R.curryService(i),i}angular.module("clickApp.directives").factory("aoeTemplateElement",a),a.$inject=["template","gameTemplateSelection","gameMap","labelElement"]}(),function(){function a(a,c,d,e,f,g,h){function i(a,b,c){var d=document.getElementById("game-over-models"),e=document.createElementNS(a,"g");b.appendChild(e);var f=document.createElementNS(a,"polygon");f.classList.add("template"),f.classList.add("spray"),f.setAttribute("data-stamp",c.state.stamp),e.appendChild(f);var g=h.create(a,e),i=document.createElementNS(a,"circle");return i.classList.add("spray-origin"),i.setAttribute("cx","0"),i.setAttribute("cy","0"),i.setAttribute("r","0"),i.style.visibility="hidden",d.appendChild(i),{container:e,spray:f,label:g,origin:i}}function j(a,b){var c=document.getElementById("game-over-models");c.removeChild(b.origin)}function k(b,f,i,j){function k(a){return R.isNil(a)?null:e.findStampP(a,f.game.models)}var o=f.game.template_selection,p=d["in"]("local",i.state.stamp,o),q=d["in"]("remote",i.state.stamp,o),r=p||q,s=r?p?"#0F0":"#FFF":"#C60",t=g.isFlipped(b),u=g.zoomFactor(b),v=i.state,w={x:i.state.x,y:i.state.y+5},x=a.fullLabel(i);l(i,j.container),m(s,i,j.spray),h.update(t,u,v,w,x,j.label),R.threadP(i)(c.origin,k,function(a){return n(f.factions,p,a,j.origin)})}function l(a,b){b.setAttribute("transform",["rotate(",a.state.r,",",a.state.x,",",a.state.y,")"].join(""))}function m(a,c,d){d.setAttribute("transform",["translate(",c.state.x-10,",",c.state.y,")"].join("")),d.setAttribute("points",b[c.state.s+""]),d.style.stroke=a}function n(a,b,c,d){return!b||R.isNil(c)?void(d.style.visibility="hidden"):void R.threadP(a)(f.getModelInfoP$(c.state.info),function(a){d.setAttribute("cx",c.state.x+""),d.setAttribute("cy",c.state.y+""),d.setAttribute("r",a.base_radius+""),d.style.visibility="visible"})}var o={create:i,cleanup:j,update:k};return o}angular.module("clickApp.directives").factory("sprayTemplateElement",a),a.$inject=["template","sprayTemplate","gameTemplateSelection","gameModels","gameFactions","gameMap","labelElement"];var b={6:"8.75,0 5.125,-59 10,-60 14.875,-59 11.25,0",8:"8.75,0 3.5,-78.672 10,-80 16.5,-78.672 11.25,0",10:"8.75,0 1.875,-98.34 10,-100 18.125,-98.34 11.25,0"}}(),function(){function a(a,b,c,d){function e(a,b,c){var e=document.createElementNS(a,"g");b.appendChild(e);var f=document.createElementNS(a,"rect");f.classList.add("template"),f.classList.add("wall"),f.setAttribute("width","40"),f.setAttribute("height","7.5"),f.setAttribute("data-stamp",c.state.stamp),e.appendChild(f);var g=d.create(a,e);return{container:e,wall:f,label:g}}function f(e,f,i,j){var k=f.game.template_selection,l=b["in"]("local",i.state.stamp,k),m=b["in"]("remote",i.state.stamp,k),n=l||m,o=c.isFlipped(e),p=c.zoomFactor(e),q=i.state,r={x:i.state.x,y:i.state.y+2},s=a.fullLabel(i);g(i,j.wall),h(n,l,m,i,j.container),d.update(o,p,q,r,s,j.label)}function g(a,b){b.setAttribute("x",a.state.x-20+""),b.setAttribute("y",a.state.y-3.75+"")}function h(a,b,c,d,e){a?e.classList.add("selection"):e.classList.remove("selection"),b?e.classList.add("local"):e.classList.remove("local"),c?e.classList.add("remote"):e.classList.remove("remote"),e.setAttribute("transform","rotate("+d.state.r+","+d.state.x+","+d.state.y+")")}var i={create:e,cleanup:function(){},update:f};return i}angular.module("clickApp.directives").factory("wallTemplateElement",a),a.$inject=["template","gameTemplateSelection","gameMap","labelElement"]}(),function(){function a(a){function b(b,c){function d(b,c){R.isNil(c)||R.isNil(c.from)||c.from===a.state.user.state.stamp||c.from===a.state.user.state.name||(e.currentTime=0,e.play())}var e=c[0].querySelector("audio");a.onStateChangeEvent(s.capitalize(b.type)+".chat",d,b)}return{restrict:"E",scope:{type:"@"},templateUrl:"app/components/mail_notification/mail_notification.html",link:b}}angular.module("clickApp.directives").directive("clickMailNotification",a),a.$inject=["$rootScope"]}(),function(){function a(){return{restrict:"E",templateUrl:"app/components/user_chat/user_chat.html",scope:!0,controller:"userChatCtrl",controllerAs:"user_chat",link:function(){}}}function b(a){function b(){m.chat={msg:"",to:[]},a.onStateChangeEvent("User.change",c,a),self.window.requestAnimationFrame(c)}function c(){m.user=R.clone(n.user),a.$digest()}function d(a){m.chat.to=R.reject(R.equals(n.user.state.stamp),a)}function e(a){return R.find(R.equals(a),m.chat.to)}function f(a){d(m.userIsInRecipients(a)?R.reject(R.equals(a),m.chat.to):R.append(a,m.chat.to))}function g(){d(R.pluck("stamp",n.user.connection.users))}function h(a){d(R.thread(a)(R.prop("to"),R.append(R.prop("from",a)),R.uniq))}function i(){return R.length(s.strip(m.chat.msg))>0}function j(){return!R.isEmpty(m.chat.to)&&i()}function k(){m.canSendChatMsg()&&R.threadP()(function(){return a.stateEvent("User.sendChatMsg",m.chat)},function(){m.chat.msg="",a.$digest()})}function l(){d(R.pluck("stamp",n.user.connection.users)),m.doSendChatMsg()}var m=this,n=a.state;m.userIsInRecipients=e,m.doToggleRecipient=f,m.doSetAllRecipients=g,m.doSetRecipientsFromChat=h,m.canSendChatMsg=j,m.doSendChatMsg=k,m.doBroadcastChatMsg=l,b()}angular.module("clickApp.directives").controller("userChatCtrl",b).directive("clickUserChat",a),a.$inject=[],b.$inject=["$scope"]}();
...
angular.module('clickApp.services').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/views/game/main/game_main.html',
    "<div><div ng-show=\"state.game | gameConnection:'active'\" class=\"panel panel-info\"><div class=panel-heading>Chat</div><div class=panel-content><click-game-chat-box></click-game-chat-box></div></div><div class=\"panel panel-info\"><div class=panel-heading>Tools</div><div class=panel-content><div class=btn-group><button class=\"btn {{ game.currentModeIs('Ruler') ? 'btn-primary' : 'btn-default' }}\" title=\"{{game.action_bindings['enterRulerMode'] || ''}}\" ng-click=game_main.doUseRuler()>Use<br>Ruler</button> <button class=\"btn {{ (state.game.ruler | gameRuler:'isDisplayed') ? 'btn-primary' : 'btn-default' }}\" ng-click=game_main.doToggleShowRuler()>Show<br>Ruler</button></div><div class=btn-group><button class=\"btn {{ game.currentModeIs('Los') ? 'btn-primary' : 'btn-default' }}\" title=\"{{game.action_bindings['enterLosMode'] || ''}}\" ng-click=game_main.doUseLos()>Use<br>LoS</button> <button class=\"btn {{ (state.game.los | gameLos:'isDisplayed') ? 'btn-primary' : 'btn-default' }}\" ng-click=game_main.doToggleShowLos()>Show<br>LoS</button></div><div class=btn-group><button class=\"btn btn-default\" ng-click=\"game_main.doCreateTemplate('aoe')\">New<br>AoE</button> <button class=\"btn btn-default\" ng-click=\"game_main.doCreateTemplate('spray')\">New<br>Spray</button> <button class=\"btn btn-default\" ng-click=\"game_main.doCreateTemplate('wall')\">New<br>Wall</button></div></div></div><div class=\"panel panel-info\"><div class=panel-heading>Dice</div><div class=panel-content><click-game-dice-box></click-game-dice-box></div></div></div>"
  );

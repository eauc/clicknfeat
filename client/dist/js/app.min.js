...
angular.module('clickApp.services').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('partials/directives/game_dice_box.html',
    "<div><div class=btn-group><button class=\"btn btn-default\" title=\"{{action_bindings['roll1D6'] || ''}}\" ng-click=\"doRollDice(6, 1)\">1D6</button> <button class=\"btn btn-default\" title=\"{{action_bindings['roll2D6'] || ''}}\" ng-click=\"doRollDice(6, 2)\">2D6</button> <button class=\"btn btn-default\" title=\"{{action_bindings['roll3D6'] || ''}}\" ng-click=\"doRollDice(6, 3)\">3D6</button> <button class=\"btn btn-default\" title=\"{{action_bindings['roll4D6'] || ''}}\" ng-click=\"doRollDice(6, 4)\">4D6</button> <button class=\"btn btn-default\" title=\"{{action_bindings['roll5D6'] || ''}}\" ng-click=\"doRollDice(6, 5)\">5D6</button> <button class=\"btn btn-default\" title=\"{{action_bindings['roll1D3'] || ''}}\" ng-click=\"doRollDice(3, 1)\">1D3</button></div><div class=dice-list><div ng-repeat=\"(i,dice) in game.dice.slice(-10).reverse() track by dice.stamp\"><span class=text-primary>[{{::dice.user}}]</span> {{::dice.desc}}</div></div></div>"
  );


  $templateCache.put('partials/directives/games_list.html',
    "<div ng-repeat=\"(i,g) in games\" class=\"clickable {{current && g.public_stamp === current ? 'bg-primary':''}} {{isInSelection(i) ? 'bg-info':''}}\" ng-click=setSelection(i)>{{::g | game:'description'}}</div>"
  );
  ...
  $templateCache.put('partials/game/save.html',
    "<div><button type=button class=\"btn btn-default\" ng-click=updateExports()>Update files</button><div class=\"panel panel-info\"><div class=panel-heading>Save current game</div><div class=panel-body><a class=\"btn btn-default\" ng-disabled=!save.url ng-href={{save.url}} download={{::save.name}}>Download Game File</a></div></div><div class=\"panel panel-info\"><div class=panel-heading>Save current models selection</div><div class=panel-body><a class=\"btn btn-default\" ng-disabled=!selection_save.url ng-href={{selection_save.url}} download={{::selection_save.name}}>Download Models File</a></div></div><div class=\"panel panel-info\"><div class=panel-heading>Save current board and terrain</div><div class=panel-body><a class=\"btn btn-default\" ng-disabled=!board_save.url ng-href={{board_save.url}} download={{::board_save.name}}>Download Board File</a></div></div></div>"
  );


  $templateCache.put('partials/game/scenario.html',
    "<g><circle ng-repeat=\"(i,c) in game.scenario.circle\" ng-attr-cx={{::c.x}} ng-attr-cy={{::c.y}} ng-attr-r={{::c.r}} class=zone></circle><rect ng-repeat=\"(i,r) in game.scenario.rect\" ng-attr-x={{::r.x-r.width/2}} ng-attr-y={{::r.y-r.height/2}} ng-attr-width={{::r.width}} ng-attr-height={{::r.height}} class=zone></rect><circle ng-repeat=\"(i,o) in game.scenario.objectives\" ng-attr-cx={{::o.x}} ng-attr-cy={{::o.y}} r=9.842 class=objective></circle><circle ng-repeat=\"(i,f) in game.scenario.flags\" ng-attr-cx={{::f.x}} ng-attr-cy={{::f.y}} r=7.874 class=objective></circle><g ng-show=\"stateIs('game.setup')\"><rect ng-show=game.scenario.killbox x=140 y=140 width=200 height=200 class=area></rect><circle ng-repeat=\"(i,o) in game.scenario.objectives\" ng-attr-cx={{::o.x}} ng-attr-cy={{::o.y}} r=49.842 class=area></circle><circle ng-repeat=\"(i,f) in game.scenario.flags\" ng-attr-cx={{::f.x}} ng-attr-cy={{::f.y}} r=47.874 class=area></circle></g></g>"
  );
  ...
  $templateCache.put('partials/game/terrains_list.html',
    "<g ng-repeat=\"(i,terrain) in game.terrains[type] track by terrain.state.stamp\" click-game-terrain></g>"
  );

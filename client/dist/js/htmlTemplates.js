angular.module('clickApp.services').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/components/game/cmd_osd/cmd_osd.html',
    "<div class=scroll-container><div class=mode-title><strong>{{game.currentModeName()}}</strong></div><div class=btn-group-vertical><button class=\"btn btn-default\" title=\"{{game.action.bindings['modeBackToDefault'] || ''}}\" ng-click=\"game.doModeAction('modeBackToDefault')\">Back To Default</button> <button class=\"btn btn-default\" title=\"{{game.action.bindings['flipMap'] || ''}}\" ng-click=\"game.doModeAction('flipMap')\">Flip Map</button> <button ng-repeat=\"action in game.action.buttons\" class=\"btn {{:: (action.length === 3 && action[1] !== 'toggle') ? 'btn-info' : 'btn-default' }}\" title=\"{{::game.action.bindings[action[1]] || ''}}\" ng-click=game.doActionButton(action) ng-show=\"action[1] === 'toggle' ||\n" +
    "                     action.length === 2 ||\n" +
  ...
  $templateCache.put('app/components/game/model/over_models_list.html',
    "<g ng-repeat=\"(i,model) in state.game.models.active track by model.state.stamp\" click-game-over-model><g ng-attr-transform={{model.render.transform}} ng-class=\"{\n" +
    "               'remote-selection': model.selection.remote,\n" +
    "               'local-selection': model.selection.local,\n" +
    "               'single-remote': model.selection.single_remote,\n" +
    "               'single-local': model.selection.single_local\n" +
    "               }\"><circle class=model-edge ng-attr-cx={{model.render.cx}} ng-attr-cy={{model.render.cy}} ng-attr-r={{model.render.radius}}></circle><image class=model-image ng-show=model.render.lock.show ng-attr-x={{model.render.lock.x}} ng-attr-y={{model.render.lock.y}} width=10 height=10 xlink:href=/data/icons/Lock.png></image><line class=model-los-selection ng-attr-x1={{model.render.cx}} ng-attr-y1={{model.render.cy}} ng-attr-x2={{model.render.cx}} ng-attr-y2={{model.render.los.dy}}></line><line class=model-los-selection ng-attr-x1={{model.render.los.lx}} ng-attr-y1={{model.render.cy}} ng-attr-x2={{model.render.los.rx}} ng-attr-y2={{model.render.cy}}></line><image class=model-image ng-repeat=\"e in ['b','c','d','e','f','k','l','t']\" ng-show=model.render.effects[e].show ng-attr-x={{model.render.effects[e].x}} ng-attr-y={{model.render.effects[e].y}} width=10 height=10 xlink:href={{model.render.effects[e].link}}></image><g ng-if=model.render.dmg.show><line class=model-damage-bar style=\"stroke: #F00\" ng-attr-x1={{model.render.dmg.lx}} ng-attr-y1={{model.render.dmg.ly}} ng-attr-x2={{model.render.dmg.rx}} ng-attr-y2={{model.render.dmg.ry}}></line><line class=model-damage-bar style=\"stroke: #0F0\" ng-attr-x1={{model.render.dmg.x}} ng-attr-y1={{model.render.dmg.ly}} ng-attr-x2={{model.render.dmg.rx}} ng-attr-y2={{model.render.dmg.ry}}></line></g><g ng-if=model.render.field.show><line class=model-damage-bar style=\"stroke: #066\" ng-attr-x1={{model.render.field.lx}} ng-attr-y1={{model.render.field.ly}} ng-attr-x2={{model.render.field.rx}} ng-attr-y2={{model.render.field.ry}}></line><line class=model-damage-bar style=\"stroke: #0FF\" ng-attr-x1={{model.render.field.x}} ng-attr-y1={{model.render.field.ly}} ng-attr-x2={{model.render.field.rx}} ng-attr-y2={{model.render.field.ry}}></line></g><g click-game-element-label=model.render.label></g><g click-game-element-label=model.render.counter></g><image class=model-image ng-show=model.render.souls.show ng-attr-x={{model.render.souls.cx}} ng-attr-y={{model.render.souls.cy}} width=20 height=20 ng-attr-transform={{model.render.souls.transform}} xlink:href=/data/icons/Soul.png></image><g click-game-element-label=model.render.souls></g><g click-game-element-label=model.render.unit></g></g><g click-game-element-label=model.render.path.length></g><circle class=model-charge-target ng-show=model.render.charge_target.show ng-class=\"{ reached: model.render.charge_target.reached }\" ng-attr-cx={{model.render.charge_target.cx}} ng-attr-cy={{model.render.charge_target.cy}} ng-attr-r={{model.render.charge_target.radius}}></circle></g>"
  );


  $templateCache.put('app/components/game/model/under_models_list.html',
    "<g ng-repeat=\"(i,model) in state.game.models.active track by model.state.stamp\" click-game-under-model><rect class=model-charge-path ng-show=model.render.path.show ng-attr-x={{model.render.path.x}} ng-attr-y={{model.render.path.y}} ng-attr-width={{2*model.render.radius}} height=800 ng-attr-transform={{model.render.path.transform}}></rect><g ng-attr-transform={{model.render.transform}} ng-class=\"{\n" +
    "               'remote-selection': model.selection.remote,\n" +
    "               'local-selection': model.selection.local,\n" +
    "               'single-remote': model.selection.single_remote,\n" +
    "               'single-local': model.selection.single_local\n" +
  ...
  $templateCache.put('app/components/game/template/templates_list.html',
    ...
    "             }\"><circle ng-show=\"render.type==='aoe'\" class=\"template aoe\" data-stamp={{render.stamp}} ng-attr-cx={{render.x}} ng-attr-cy={{render.y}} ng-attr-r={{render.radius}}></circle><line ng-show=\"render.type==='aoe'\" class=template-aoe-direction style=\"marker-end: url(#aoe-direction-end)\" ng-attr-x1={{render.x}} ng-attr-y1={{render.y}} ng-attr-x2={{render.dx}} ng-attr-y2={{render.dy}} ng-attr-transform={{render.dtransform}}></line><polygon ng-show=\"render.type==='spray'\" class=\"template spray\" data-stamp={{render.stamp}} ng-attr-points={{render.points}} ng-attr-transform={{render.transform}}></polygon><rect ng-show=\"render.type==='wall'\" class=\"template wall\" data-stamp={{render.stamp}} ng-attr-x={{render.x}} ng-attr-y={{render.y}} width=40 height=7.5 ng-attr-transform={{render.transform}}></rect><g click-game-element-label=render.label></g><circle class=spray-origin ng-if=render.origin ng-attr-cx={{render.origin.cx}} ng-attr-cy={{render.origin.cy}} ng-attr-r={{render.origin.radius}}></circle></g>"
  );


  $templateCache.put('app/components/game/terrain/terrains_list.html',
    "<g ng-repeat=\"(i,terrain) in state.game.terrains[type] track by terrain.state.stamp\" click-game-terrain ng-attr-transform={{pos.transform}} ng-class=\"{\n" +
    "             'local-selection': selection.local,\n" +
    "             'remote-selection': selection.remote\n" +
    "             }\"><image class=terrain-image data-stamp=null x=0 y=0 width=0 height=0></image><rect class=terrain-edge x=0 y=0 width=0 height=0></rect></g>"
  );
  ...
  $templateCache.put('app/views/game/game.html',
    ...
    "                       marker-end: url(#los-end)\" ng-show=render.remote.show ng-attr-x1={{render.remote.x1}} ng-attr-y1={{render.remote.y1}} ng-attr-x2={{render.remote.x2}} ng-attr-y2={{render.remote.y2}}></line><circle class=los-origin ng-if=render.origin ng-attr-cx={{render.origin.cx}} ng-attr-cy={{render.origin.cy}} ng-attr-r={{render.origin.radius}}></circle><circle class=los-target ng-if=render.target ng-attr-cx={{render.target.cx}} ng-attr-cy={{render.target.cy}} ng-attr-r={{render.target.radius}}></circle></g><g id=game-create-terrains><g ng-repeat=\"(index, terrain) in state.create.terrains\" click-game-create-terrain><rect class=create-terrain ng-attr-x={{pos.x}} ng-attr-y={{pos.y}} width=0 height=0></rect></g></g><g id=game-create-models><g ng-repeat=\"(index, model) in state.create.models\" click-game-create-model><circle class=create-model ng-attr-cx={{pos.x}} ng-attr-cy={{pos.y}} ng-attr-r={{pos.radius}}></circle></g></g><g id=game-create-templates><g ng-repeat=\"(index, template) in state.create.templates\" click-game-create-template><circle ng-show=\"pos.type==='aoe'\" class=create-template-aoe ng-attr-cx={{pos.x}} ng-attr-cy={{pos.y}} r=15></circle><polygon ng-show=\"pos.type==='spray'\" class=create-template-spray points=\"8.75,0 5.125,-59 10,-60 14.875,-59 11.25,0\" ng-attr-transform={{pos.transform}}></polygon><rect ng-show=\"pos.type==='wall'\" class=create-template-wall ng-attr-x={{pos.x}} ng-attr-y={{pos.y}} width=40 height=7.5></rect></g></g><rect id=game-dragbox click-game-dragbox></rect></svg></div></div><div id=menu><button id=menu-toggle class=\"btn btn-default\" title=\"Toggle menu\"><span class=\"glyphicon glyphicon-chevron-left\"></span> <span class=\"glyphicon glyphicon-chevron-right\"></span></button><div id=menu-content><p><strong>{{state.game | game:'description'}}</strong><form class=form-inline ng-show=\"state.game | gameConnection:'active'\" ng-submit=game.doInvitePlayer()><div class=form-group><div class=input-group><span class=input-group-btn><button type=submit class=\"btn btn-default\">Invite Player</button></span><select class=form-control ng-options=\"u.stamp as (u.name | capitalize)\n" +

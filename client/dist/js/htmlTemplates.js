angular.module('clickApp.services').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/components/game/model/over_models_list.html',
    ...
    "               'single-remote': model.selection.single_remote,\n" +
    "               'single-local': model.selection.single_local\n" +
    "               }\"><circle class=model-edge ng-attr-cx={{model.render.cx}} ng-attr-cy={{model.render.cy}} ng-attr-r={{model.render.radius}}></circle><image class=model-image ng-show=model.render.lock.show ng-attr-x={{model.render.lock.x}} ng-attr-y={{model.render.lock.y}} width=10 height=10 xlink:href=/data/icons/Lock.png></image><line class=model-los-selection ng-attr-x1={{model.render.cx}} ng-attr-y1={{model.render.cy}} ng-attr-x2={{model.render.cx}} ng-attr-y2={{model.render.los.dy}}></line><line class=model-los-selection ng-attr-x1={{model.render.los.lx}} ng-attr-y1={{model.render.cy}} ng-attr-x2={{model.render.los.rx}} ng-attr-y2={{model.render.cy}}></line><image class=model-image ng-repeat=\"e in model.render.effects\" ng-show=e.show ng-attr-x={{e.x}} ng-attr-y={{e.y}} width=10 height=10 xlink:href=\"\" ng-attr-xlink:href={{e.link}}></image><g ng-if=model.render.dmg.show><line class=model-damage-bar style=\"stroke: #F00\" ng-attr-x1={{model.render.dmg.lx}} ng-attr-y1={{model.render.dmg.ly}} ng-attr-x2={{model.render.dmg.rx}} ng-attr-y2={{model.render.dmg.ry}}></line><line class=model-damage-bar style=\"stroke: #0F0\" ng-attr-x1={{model.render.dmg.x}} ng-attr-y1={{model.render.dmg.ly}} ng-attr-x2={{model.render.dmg.rx}} ng-attr-y2={{model.render.dmg.ry}}></line></g><g ng-if=model.render.field.show><line class=model-damage-bar style=\"stroke: #066\" ng-attr-x1={{model.render.field.lx}} ng-attr-y1={{model.render.field.ly}} ng-attr-x2={{model.render.field.rx}} ng-attr-y2={{model.render.field.ry}}></line><line class=model-damage-bar style=\"stroke: #0FF\" ng-attr-x1={{model.render.field.x}} ng-attr-y1={{model.render.field.ly}} ng-attr-x2={{model.render.field.rx}} ng-attr-y2={{model.render.field.ry}}></line></g><g click-game-element-label=model.render.counter></g><image class=model-image ng-show=model.render.souls.show ng-attr-x={{model.render.souls.cx}} ng-attr-y={{model.render.souls.cy}} width=20 height=20 ng-attr-transform={{model.render.souls.transform}} xlink:href=/data/icons/Soul.png></image><g click-game-element-label=model.render.souls></g><g click-game-element-label=model.render.unit></g></g><g click-game-element-label=model.render.label ng-attr-transform={{model.render.label_transform}}></g><g click-game-element-label=model.render.path.length></g><circle class=model-charge-target ng-show=model.render.charge_target.show ng-class=\"{ reached: model.render.charge_target.reached }\" ng-attr-cx={{model.render.charge_target.cx}} ng-attr-cy={{model.render.charge_target.cy}} ng-attr-r={{model.render.charge_target.radius}}></circle></g>"
  );
  ...
  $templateCache.put('app/components/game/scenario/scenario.html',
    "<g><circle ng-repeat=\"(i,c) in state.game.scenario.circle\" ng-attr-cx={{::c.x}} ng-attr-cy={{::c.y}} ng-attr-r={{::c.r}} class=zone></circle><rect ng-repeat=\"(i,r) in state.game.scenario.rect\" ng-attr-x={{::r.x-r.width/2}} ng-attr-y={{::r.y-r.height/2}} ng-attr-width={{::r.width}} ng-attr-height={{::r.height}} class=zone></rect><circle ng-repeat=\"(i,o) in state.game.scenario.objectives\" ng-attr-cx={{::o.x}} ng-attr-cy={{::o.y}} r=9.842 class=objective></circle><circle ng-repeat=\"(i,f) in state.game.scenario.flags\" ng-attr-cx={{::f.x}} ng-attr-cy={{::f.y}} r=7.874 class=objective></circle><g ng-show=\"app.stateIs('game.setup')\"><rect ng-show=state.game.scenario.killbox x=140 y=140 width=200 height=200 class=area></rect><circle ng-repeat=\"(i,o) in state.game.scenario.objectives\" ng-attr-cx={{::o.x}} ng-attr-cy={{::o.y}} r=49.842 class=area></circle><circle ng-repeat=\"(i,f) in state.game.scenario.flags\" ng-attr-cx={{::f.x}} ng-attr-cy={{::f.y}} r=47.874 class=area></circle></g></g>"
  );

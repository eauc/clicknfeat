angular.module('clickApp.services').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/components/game/zoom_osd/zoomOsd.html',
  ...
  $templateCache.put('app/views/game/game.html',
    ...
    "                         stroke-width:2px\"></marker></defs></svg></div></div><div id=menu><button id=menu-toggle class=\"btn btn-default\" title=\"Toggle menu\"><span class=\"glyphicon glyphicon-chevron-left\"></span> <span class=\"glyphicon glyphicon-chevron-right\"></span></button><div id=menu-content><p><strong>{{state.game | game:'description'}}</strong></p><ul class=\"nav nav-tabs\"><li class=\"{{stateIs('game.main') ? 'active' : ''}}\" ng-click=\"goToState('^.main')\"><a class=\"{{ game.hints.go_to_main ? 'go-to-hint' : ''}}\">Main</a></li></ul><div ui-view id=menu-view class=\"{{game.menuDisabled() ? 'disabled' : ''}}\"></div></div></div></div>"
  );
  ...
  $templateCache.put('app/views/game/setup/setup.html',
